...
<head>
    ...
    var lcstatus = '';
     ...
     $(function(){ 
     $('#dg').edatagrid({
		url: '<?php echo base_url(); ?>/index.php/master/load_lpsal_awal',
        idField:'id',            
        rownumbers:"true", 
        fitColumns:"true",
        singleSelect:"true",
    ...
    function hitung(){
		...
		$(document).ready(function(){
            $.ajax({
                type: "POST",
                url: '<?php echo base_url(); ?>/index.php/akuntansi/hitung_lpsal_pemda',
        ...
        if(lcstatus=='tambah'){ 
            ...
            $(document).ready(function(){
                $.ajax({
                    ...
                    data: ({tabel:'map_lpsal',kolom:lcinsert,nilai:lcvalues,cid:'kode',lcid:cno}),
                    dataType:"json",
                    success:function(data){
                        status = data;
                        if (status=='0'){
            ...
            lcquery = "UPDATE map_lpsal SET uraian='"+curaian+"',seq='"+cseq+"',thn_m1='"+lntotal+"' where nor='"+cno+"'";
            //alert(lcquery);
            $(document).ready(function(){
            $.ajax({
                type: "POST",
                url: '<?php echo base_url(); ?>/index.php/master/update_master',
                data: ({st_query:lcquery,tabel:'lpsal'}),
                dataType:"json",
                success:function(data){					
                        status = data;
                        if (status=='0'){
...
<div id="content"> 
<div id="accordion">
<h3 align="center"><u><b><a href="#" id="section1">LPSAL TAHUN LALU</a></b></u></h3>
    <div>
    <p align="right">         
        ...
        <table id="dg" title="Listing LPSAL TAHUN LALU" style="width:870px;height:350px;" >  
        </table>
		<table style="width:870px;" >  
			<tr align="center">				
				<td><a class="easyui-linkbutton" iconCls="icon-ok" plain="true" onclick="javascript:hitung()">Proses Perhitungan LPSAL Tahun Berjalan</a>
			<!--	</td>
			</tr>
			<tr align="center">
				<td>-->
