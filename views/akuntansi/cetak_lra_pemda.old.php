...
<head>
  ...
  <style>   
    ...
    function cetak(){
			...
			if (ctk=='1'){
				var url ="<?php echo site_url(); ?>/akuntansi/cetak_lra_pemda";
			} else{
				var url ="<?php echo site_url(); ?>/akuntansi/cetak_lra_skpd";
			}	
...
<div id="content">
<h3>CETAK RINGKASAN LAPORAN REALISASI ANGGARAN (LRA) - FORMAT PERMENDAGRI 64</h3>
<div id="accordion">
    <p align="right">         
        <table>          
