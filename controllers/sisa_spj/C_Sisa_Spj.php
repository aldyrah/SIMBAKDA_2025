...
b.no_bukti,d.kd_kegiatan,d.kd_rek5,b.total AS jum_spj, c.total  
           ...
           LEFT JOIN trdtransout_ppkd d ON d.no_bukti = b.no_bukti
          ...
          (SELECT SUM(total) AS pengembalian_kas FROM trhkasin_pkd d WHERE d.tk = a.no_sp2d) AS pengembalian_kas
          FROM trhsp2d a WHERE a.jns_spp = '3' AND a.kd_skpd = '$lcskpd' and month(a.tgl_kas)='$bulana'"; 
         ...
         $cRet .="<table style=\"border-collapse:collapse;\" width=\"100%\" align=\"center\" border=\"0\" cellspacing=\"1\" cellpadding=\"1\">
            <tr>
                <td align=\"center\" colspan=\"16\" style=\"font-size:16px;border: solid 1px white;border-bottom:none;\"><b>REKAPITULASI SISA TU</b></td>
            </tr>
           ...
           (SELECT SUM(total) FROM trhkasin_pkd WHERE tk=a.no_sp2d ) AS pengembalian_kas
  ...
  foreach ($hasil_sp2d->result() as $row){
      $nosp2d = $row->no_sp2d;
         $kd_rek5sp2d = $row->kd_rek5;
          ...
          $n_tot_sp2d = $n_tot_sp2d + $nilai_sp2d;
          $j_tot_sp2d = number_format($n_tot_sp2d ,0,',','.');
             $n_kas = $row->pengembalian_kas;
             $j_pengembalian_kas = number_format($n_kas ,0,',','.');
    ...
    $cRet .= 
               ...
               $sql_spj = "SELECT a.no_bukti,b.kd_kegiatan,b.kd_rek5,a.total FROM trhtransout_ppkd a 
INNER JOIN trdtransout_ppkd b ON a.no_bukti=b.no_bukti WHERE a.no_sp2d = '$no_sp2d'
...
$n_jum_spj=0; 
 ...
 $no_bukti = $row->no_bukti;
  ...
  $cRet .= 
           ...
           $sisa_sp2d = $n_tot_sp2d - ($n_jum_spj+$n_kas);
        ...
        $cRet .= 
         ...
         $cRet .="      
          ...
          $cRet .="<table  width=\"100%\" align=\"center\" cellspacing=\"1\" cellpadding=\"1\">
                  ...
                  <tr>
                     <td align=\"left\" width=\"10%\" style=\"font-size:16px\">1. TOTAL SP2D : $j_tot_sp2d</td>
                  </tr>";
          ...
          $cRet .=         
                  "<tr>
                       <td align=\"left\" width=\"10%\" style=\"font-size:16px\">3. PENGEMBALIAN KAS :$j_pengembalian_kas</td>
                  </tr>"; 
          $cRet .=         
                  "<tr>
           ...
           $cRet .="<table style=\"border-collapse:collapse;\" width=\"100%\" align=\"center\" border=\"1\" cellspacing=\"1\" cellpadding=\"1\">
            <thead>
                <tr>
                    ...
                    <td bgcolor=\"#CCCCCC\" align=\"center\" width=\"10%\" style=\"font-size:12px\"><b>TANGGAL KAS SP2D</b></td>
                    ...
                    <td bgcolor=\"#CCCCCC\" align=\"center\" width=\"10%\" style=\"font-size:12px\"><b>SISA TU</b></td>
        ...
        foreach ($hasil->result() as $row){
          ...
          $n_kembalian_kas = $row->pengembalian_kas;
          $j_kembalian_kas = number_format($n_kembalian_kas ,0,',','.');
          $n_sisa_tu = number_format($sisa_tu ,0,',','.');
          $akhir=$nilai-($nilai_spj+$n_kembalian_kas);
          $akhirn = number_format($akhir ,0,',','.');
            ...
            $cRet .= "<tr>
                    ...
                    <td align=\"right\" style=\"font-size:12px\">$j_kembalian_kas</td>
                    <td align=\"right\" style=\"font-size:12px\">$akhirn</td>
...
ON a.no_sp2d=b.no_sp2d WHERE MONTH(b.tgl_kas)='$bulana' AND b.jns_spp='3'";  
...
ON a.tk=b.no_sp2d WHERE MONTH(b.tgl_kas)='$bulana' AND b.jns_spp='3' AND b.kd_skpd='1.20.05.01'";  
