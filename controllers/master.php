...
/* 	
    ...
    function ambil_kel1() {
       ...
       // $sql = "SELECT kd_kelompok, nm_kelompok FROM mkelompok1 where upper(kd_kelompok) like upper('%$lccr%') or upper(nm_kelompok) like upper('%$lccr%') ";
         $sql = "SELECT a.kd_kelompok,a.nm_kelompok,(SELECT COUNT(kd_brg)+1 AS jml FROM mbarang WHERE kd_kelompok=a.kd_kelompok ) AS jml FROM mkelompok1 a where upper(kd_kelompok) like upper('%$lccr%') or upper(nm_kelompok) like upper('%$lccr%') ";
