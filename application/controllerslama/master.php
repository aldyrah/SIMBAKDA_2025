...
/* 	
    ...
    function ambil_kel1() {
       ...
       // $sql = "SELECT kd_kelompok, nm_kelompok FROM mkelompok1 where upper(kd_kelompok) like upper('%$lccr%') or upper(nm_kelompok) like upper('%$lccr%') ";
        $sql = "SELECT kd_kelompok, nm_kelompok,(select count(kd_brg)+1 AS jml FROM mbarang where kd_kelompok=a.kd_kelompok)as jml FROM mkelompok1 a where upper(kd_kelompok) like upper('%$lccr%') or upper(nm_kelompok) like upper('%$lccr%') ";
        $query1 = $this->db->query($sql);  
        $result = array();
        $ii = 0;
        foreach($query1->result_array() as $resulte)
