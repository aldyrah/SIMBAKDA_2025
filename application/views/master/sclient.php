...
<head>
    ...
    function get_sclient()
        {
            ...
            $.ajax({
                    ...
                    success:function(data){
							...
							$("#ingat6").attr("value",data.ingat6);
							$("#ingat7").attr("value",data.ingat7);
                            $("#no_qanun").attr("value",data.no_qanun);
                            $("#tgl_qanun").datebox("setValue",data.tgl_qanun);
                            $("#no_perbup").attr("value",data.no_perbup);
							$("#bupati").attr("value",data.bupati);
                            $("#tgl_perbup").datebox("setValue",data.tgl_perbup);

                            $("#no_qanun_ubah").attr("value",data.no_qanun_ubah);
                            $("#tgl_qanun_ubah").datebox("setValue",data.tgl_qanun_ubah);
                            $("#no_perbup_ubah").attr("value",data.no_perbup_ubah);
                            $("#tgl_perbup_ubah").datebox("setValue",data.tgl_perbup_ubah);
    ...
    function kosong(){
		...
		$("#ingat7").attr("value",'');
        $("#no_qanun").attr("value",'');
		$("#tgl_qanun").datebox("setValue",'');
        $("#no_perbup").attr("value",'');
		$("#tgl_perbup").datebox("setValue",'');
        $("#bupati").attr("value",'');


        $("#no_qanun_ubah").attr("value",'');
        $("#tgl_qanun_ubah").datebox("setValue",'');
        $("#no_perbup_ubah").attr("value",'');
        $("#tgl_perbup_ubah").datebox("setValue",'');
    }
       ...
       function simpan()
       {
		...
		var cingat6 = document.getElementById('ingat6').value;
		var cingat7 = document.getElementById('ingat7').value;
        var cno_qanun = document.getElementById('no_qanun').value;
        var ctgl_qanun = $('#tgl_qanun').datebox('getValue');
        var cno_perbup = document.getElementById('no_perbup').value;
        var ctgl_perbup = $('#tgl_perbup').datebox('getValue');
        var cbupati = document.getElementById('bupati').value;


        var cno_qanun_ubah = document.getElementById('no_qanun_ubah').value;
        var ctgl_qanun_ubah = $('#tgl_qanun_ubah').datebox('getValue');
        var cno_perbup_ubah = document.getElementById('no_perbup_ubah').value;
        var ctgl_perbup_ubah = $('#tgl_perbup_ubah').datebox('getValue');
        // alert(rek_lo);       
        if (cskpd==''){
            ...
            $(document).ready(function(){
                $.ajax({
                    ...
                    data: ({tabel:'sclient',cskpd:cskpd,cthn:cthn,cprov:cprov,ckab:ckab,cibu:cibu,ctgl_rka:ctgl_rka,ctgl_dpa:ctgl_dpa,ctgl_ubah:ctgl_ubah,
                            ...
                            cingat4:cingat4,cingat5:cingat5,cingat6:cingat6,cingat7:cingat7,cno_qanun:cno_qanun,ctgl_qanun:ctgl_qanun,cno_perbup:cno_perbup,ctgl_perbup:ctgl_perbup,cbupati:cbupati,
                            cno_qanun_ubah:cno_qanun_ubah,ctgl_qanun_ubah:ctgl_qanun_ubah,cno_perbup_ubah:cno_perbup_ubah,ctgl_perbup_ubah:ctgl_perbup_ubah}),
                    dataType:"json"
                });
            });    
        ...
        <h3 align="center"><u><b><a href="#" id="section1">MASTER CLIENT</a></b></u></h3>
            <div>
                    ...
                    <tr>
                      ...
                      <td width="29%"><input type="text" id="kab" style="width: 300px;"/></td>
                        <td width="21%"></td>
                      <td width="31%"><input type='hidden' id="prov" name="prov" style="width: 140px;" /></td>
                   ...
                   <tr>
                        <td> INGAT 5</td>
                        <td><textarea rows="1" cols="50" id="ingat5" style="width: 250px;"></textarea>
                        </td> 
						<td> INGAT 6</td>
                        <td><textarea rows="1" cols="50" id="ingat6" style="width: 250px;"></textarea>
                        </td>
                    </tr>
					<tr>
                        <td>INGAT 7</td>
                        <td><textarea rows="1" cols="50" id="ingat7" style="width: 250px;"></textarea>
                        </td> 
                     </tr>
                        
                        
                    <tr>                        
                        <td width="21%">NOMOR QANUN</td>
                        <td width="31%"><input id="no_qanun" style="width: 140px;" /></td>
                        <td>TANGGAL QANUN</td>
                        <td><input type="text" id="tgl_qanun" style="width: 140px;" /></td>
                    </tr>
                        
                    <tr>                        
                        <td width="21%">NOMOR PERBUP</td>
                        <td width="31%"><input id="no_perbup" style="width: 140px;" /></td>
                        <td>TANGGAL PERBUP</td>
                        <td><input type="text" id="tgl_perbup" style="width: 140px;" /></td>
                    </tr>
                    <tr>                        
                        <td width="21%">NOMOR QANUN PERUBAHAN</td>
                        <td width="31%"><input id="no_qanun_ubah" style="width: 140px;" /></td>
                        <td>TANGGAL QANUN PERUBAHAN</td>
                        <td><input type="text" id="tgl_qanun_ubah" style="width: 140px;" /></td>
                    </tr>
                        
                    <tr>                        
                        <td width="21%">NOMOR PERBUP PERUBAHAN</td>
                        <td width="31%"><input id="no_perbup_ubah" style="width: 140px;" /></td>
                        <td>TANGGAL PERBUP PERUBAHAN</td>
                        <td><input type="text" id="tgl_perbup_ubah" style="width: 140px;" /></td>
                    </tr>
                    <tr>
                        <td> NAMA BUPATI</td>
                        <td colspan="3" ><input type="text" id="bupati" name="bupati" style="width: 140px;" /></textarea>
                        </td> 
                    </tr>
                    <tr>
