  ...
  onSelect:function(rowIndex,rowData){
    ...
    function simpan_spm(){        
            ...
            $.ajax({
                ...
                data     : ({st_query:lcquery,skpda:skpd}),
                dataType : "json",
   ...
   function KKK(){
          $.ajax({
            url:'<?php echo base_url(); ?>index.php/tukd/SC',
            type: "POST",
            dataType:"json",                         
            success:function(data){
...
if(keamanan==''){
      document.getElementById("p1").innerHTML="BELUM ADA KUNCI TERBUKA";                 }else{
      document.getElementById("p1").innerHTML="KUNCI TERBUKA YAITU SKPD"+keamanan+"-"+n;        
        }            
          }  
            });
   }
...
<h5 align="center"><b><a href="#" id="section1">KEAMANAN TU</a></b></h5>
 ...
 <fieldset>
     <table align="center" style="width:100%;" border="0">  
      <tr>
        <td colspan="3" align="center" style="border-top:solid 1px red;border-bottom:solid 1px red">KETIKA SUDAH BUKA KUNCI JANGAN LUPA UNTUK DI KUNCI KEMBALI</td>
