...
<script type="text/javascript">
  ...
  function cetak($cek){
    ...
    var url     = "<?php echo site_url(); ?>/laporan_inventaris/lap_kib_d_dh";
      ...
      if(ctk=='1'){
        ...
        if(bulan=='' && blnthn=='01'){
          ...
          if(blnthn=='01'){
            ...
            lc = '?pilih='+cpilih+'&tampil='+cini+'&skpd='+cskpd+'&nmskpd='+cnmskpd+'&bidang='+cbid+'&nmbid='+cnm_bid+'&jenis='+jenis+'&nmjenis='+nmjenis+'&tahun1='+tahun1+'&tahun2='+tahun2+'&tglcetak='+lctgl2+'&pilctk='+pilctk+'&spasi='+spasi+'&blnthn='+blnthn;
          }
        ...
        if(tahun1=='' || tahun2==''){
          ...
          lc = '?pilih='+cpilih+'&tampil='+cini+'&skpd='+cskpd+'&nmskpd='+cnmskpd+'&bidang='+cbid+'&nmbid='+cnm_bid+'&tahun1='+tahun1+'&tahun2='+tahun2+'&tglcetak='+lctgl2+'&pilctk='+pilctk+'&jenis='+jenis+'&spasi='+spasi+'&nmjenis='+nmjenis;
        }
...
<div id="content1"> 
    ...
    KARTU INVENTARIS JALAN,IRIGASI DAN JARINGAN (KOMPILASI)</b></h3>
    <fieldset>
