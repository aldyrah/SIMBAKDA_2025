    ...
    //if(oto=='01'){
      if(ctk=='1'){
        if(cskpd==''){
          ...
          lc = '?pilih='+cpilih+'&tampil='+cini+'&skpd='+cskpd+'&nmskpd='+cnmskpd+'&bidang='+cbid+'&nmbid='+cnm_bid+'&bulan='+bulan+'&tahun='+tahun+'&tglcetak='+lctgl2+'&pilctk='+pilctk+'&jenis='+jenis+'&nmjenis='+nmjenis+'&smtr='+semester;
        }
      }else if(ctk=='2'){
        if(cskpd==''){
          swal({
            ...
            <tr>
              <td colspan="3">
                <div id="div_semester">
                  ...
                  <td width="1%" >:</td>
                  <td width="79%" ><select  name="semester" id="semester" >
                   <option value="">...Pilih Semester... </option>
                   <option value="6" >1 | Semester 1</option>
                   <option value="12">2 | Semester 2</option>
                   </select>
                    </td>
                  </table>
                </div>
