...
<script type="text/javascript">
  ...
  function cetak($cek){
    ...
    var url     = "<?php echo site_url(); ?>/laporan_inventaris/rekap_penyusutan_dh_all";
      ...
      if(ctk=='1'){
        ...
        if(bulan=='' && blnthn=='01'){
          ...
          if(blnthn=='01'){
            ...
            lc = '?pilih='+cpilih+'&tampil='+cini+'&skpd='+cskpd+'&nmskpd='+cnmskpd+'&bidang='+cbid+'&nmbid='+cnm_bid+'&tahun1='+tahun1+'&tahun2='+tahun2+'&tahun3='+tahun3+'&tglcetak='+lctgl2+'&pilctk='+pilctk+'&jenis='+jenis+'&nmjenis='+nmjenis+'&blnthn='+blnthn+'&ttd='+cttd;
          }
          // alert(lc);
...
<div id="content1"> 
    <h3 align="center"><b>REKAP KIB PENYUSUTAN</b></h3>
    <fieldset>
