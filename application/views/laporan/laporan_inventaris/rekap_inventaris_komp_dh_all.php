...
<script type="text/javascript">
  ...
  function cetak($cek){
    ...
    var url     = "<?php echo site_url(); ?>/laporan_inventaris/rekap_buku_invent_dh_all";
    ...
    //if(oto=='01'){
      if(ctk=='1'){
        ...
        if(bulan=='' && blnthn=='01'){
          ...
          if(blnthn=='01'){
            lc = '?pilih='+cpilih+'&tampil='+cini+'&nmskpd='+cnmskpd+'&bidang='+cbid+'&nmbid='+cnm_bid+'&bulan='+bulan+'&tahun='+tahun+'&tglcetak='+lctgl2+'&pilctk='+pilctk+'&jenis='+jenis+'&nmjenis='+nmjenis+'&blnthn='+blnthn+'&ttd='+cttd;
          //alert(lc);
          }else{
            lc = '?pilih='+cpilih+'&tampil='+cini+'&skpd='+cskpd+'&nmskpd='+cnmskpd+'&bidang='+cbid+'&nmbid='+cnm_bid+'&tahun1='+tahun1+'&tahun2='+tahun2+'&tglcetak='+lctgl2+'&pilctk='+pilctk+'&jenis='+jenis+'&nmjenis='+nmjenis+'&blnthn='+blnthn+'&ttd='+cttd;
           //alert(lc);
          }
    ...
    $(function(){
      ...
      $('#ttd').combogrid({  
      panelWidth:500,  
      url: '<?php echo base_url(); ?>/index.php/laporan_inventaris/pilih_ttd_all',  
      idField:'nip',                    
      textField:'nama',
      mode:'remote',  
      fitColumns:true,  
...
<div id="content1"> 
    ...
    <fieldset>
     <table align="center" style="width:100%;" border="0">
            <tr>
                <td><input type="radio" name="cetak" value="1" onclick="opt(this.value)" />Keseluruhan &ensp;</td>
