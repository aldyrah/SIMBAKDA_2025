...
<script type="text/javascript">
  ...
  function cetak($cek){
    ...
    var url     = "<?php echo site_url(); ?>/laporan_inventaris/lap_kib_d_susut_2konsep";
...
<div id="content1"> 
    ...
    KARTU INVENTARIS JALAN, IRIGASI DAN JARINGAN (KOMPILASI)<br>
  DENGAN KONSEP BULAN DAN TAHUN</b></h3>
    <fieldset>
