...
<script type="text/javascript">
  ...
  function cetak($cek){
    ...
    if(ctk==''){
      swal({
          title: "Error!",
          text: "MOHON DILENGKAPI CETAK SKPD ATAU UNIT!!",
          type: "error",
    ...
    var url     = "<?php echo site_url(); ?>/laporan_inventaris/rekap_buku_invent_dh_penyusutan";
    var jenis   = $('#jenis').combogrid('getValue');
    var ttd   = $('#ttd').combogrid('getValue');
    var bb   = $('#bb').combogrid('getValue');
   // alert(ttd);
    ...
    //if(oto=='01'){
      if(ctk=='1'){
        ...
        if(bulan=='' && blnthn=='01'){
          ...
          if(blnthn=='01'){
            lc = '?pilih='+cpilih+'&tampil='+cini+'&skpd='+cskpd+'&nmskpd='+cnmskpd+'&bidang='+cbid+'&nmbid='+cnm_bid+'&bulan='+bulan+'&tahun='+tahun+'&tglcetak='+lctgl2+'&pilctk='+pilctk+'&jenis='+jenis+'&nmjenis='+nmjenis+'&blnthn='+blnthn+'&ttd='+ttd+'&bb='+bb;
          }else{
            lc = '?pilih='+cpilih+'&tampil='+cini+'&skpd='+cskpd+'&nmskpd='+cnmskpd+'&bidang='+cbid+'&nmbid='+cnm_bid+'&tahun1='+tahun1+'&tahun2='+tahun2+'&tahun3='+tahun3+'&tglcetak='+lctgl2+'&pilctk='+pilctk+'&jenis='+jenis+'&nmjenis='+nmjenis+'&blnthn='+blnthn;
          }
    ...
    $(function(){
      $('#kdskpd').combogrid({  
           ...
           onSelect:function(rowIndex,rowData){
               ...
               $('#ttd').combogrid({url: '<?php echo base_url(); ?>/index.php/laporan_inventaris/pilih_ttd',queryParams:({skpd:lcskpd})});
               $('#bb').combogrid({url: '<?php echo base_url(); ?>/index.php/laporan_inventaris/pilih_bb',queryParams:({skpd:lcskpd})});         
      ...
      $('#ttd').combogrid({  
      panelWidth:500,  
      url: '<?php echo base_url(); ?>/index.php/laporan_inventaris/pilih_ttd',  
      idField:'nip',                    
      textField:'nama',
      mode:'remote',  
      fitColumns:true,  
      ...
      onSelect:function(rowIndex,rowData){
       ...
       $('#bb').combogrid({  
      panelWidth:500,  
      url: '<?php echo base_url(); ?>/index.php/laporan_inventaris/pilih_bb',  
      idField:'nip',                    
      textField:'nama',
      mode:'remote',  
      fitColumns:true,  
...
<div id="content1"> 
    <h3 align="center"><b>REKAP PENYUSUTAN BARANG </b></h3>
    <fieldset>
     <table align="center" style="width:100%;" border="0">
            ...
            <!--  <tr>
            <table style="width:100%;" border="0">
        <td width="20%px">Penandatangan</td>
        <td width="1%">:</td>
        <td><input id="ttd" name="ttd" style="width: 140px;"></td>
      </tr> -->
      <tr>
      <table style="width:100%;" border="0">
        <td width="20%px">Penandatangan</td>
         <td width="1%">:</td>
        <td><input id="ttd" name="ttd" style="width: 150px;" />&nbsp;&nbsp;&nbsp;BB &nbsp;&nbsp;&nbsp;&nbsp;<input id="bb" name="bb" style="width: 150px;" /></td>
      </tr>
