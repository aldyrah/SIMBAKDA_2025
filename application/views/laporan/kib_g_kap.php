...
<script type="text/javascript">
  ...
  function cetak($cek){
    ...
    /*if(ctk==''){
      swal({
          title: "Error!",
          text: "MOHON DILENGKAPI CETAK SKPD !!",
          type: "error",
    ...
    var url     = "<?php echo site_url(); ?>/laporan_inventaris/lap_kap_g";
    ...
    //if(oto=='01'){
      //if(ctk=='1'){
        ...
        if(bulan=='' ){
          ...
          //if(blnthn=='01'){
            lc = '?pilih='+cpilih+'&skpd='+cskpd+'&nmskpd='+cnmskpd+'&bulan='+bulan+'&tahun3='+tahun3+'&tglcetak='+lctgl2;
          //}else{
      ...
      /*}else if(ctk=='2'){
        if(cskpd==''){
          ...
          if(blnthn=='01'){
            lc = '?pilih='+cpilih+'&tampil='+cini+'&skpd='+cskpd+'&nmskpd='+cnmskpd+'&bidang='+cbid+'&nmbid='+cnm_bid+'&bulan='+bulan+'&tahun3='+tahun3+'&tglcetak='+lctgl2+'&pilctk='+pilctk+'&jenis='+jenis+'&nmjenis='+nmjenis+'&blnthn='+blnthn;
          }else{
            lc = '?pilih='+cpilih+'&tampil='+cini+'&skpd='+cskpd+'&nmskpd='+cnmskpd+'&bidang='+cbid+'&nmbid='+cnm_bid+'&tahun1='+tahun1+'&tahun2='+tahun2+'&tglcetak='+lctgl2+'&pilctk='+pilctk+'&jenis='+jenis+'&nmjenis='+nmjenis+'&blnthn='+blnthn;
          }
...
<div id="content1"> 
    <h3 align="center"><b>LAPORAN KAPITALISASI KIB D</b></h3>
    <fieldset>
            ...
            <tr>
                ...
                <div id="pilihancetak">
                        <table style="width:100%;" border="0">
							...
							<td><input type="radio" name="cetak2" value="01" id="status" onclick="opt2(this.value)" />Periode Bulan dan Tahun&ensp;</td>
                        </table>
                </div>
                </td>
            </tr>
