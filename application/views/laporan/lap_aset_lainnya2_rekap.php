	...
	function openWindow($cek){
		...
		iz = '?kd_skpd='+cskpd+'&kd_bid='+cbidang+'&nm_skpd='+cnmskpd+'&nm_bid='+cnmbid+'&bend='+cbend+'&tahu='+ctahu+'&nmbend='+cnmbend+'&nmtahu='+cnmtahu+'&tgl_reg='+tgl_reg+'&tahun='+ctahun+'&tgl='+ctgl+'&fa='+cpilih;
