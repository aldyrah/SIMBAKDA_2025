...
<script type="text/javascript">
    ...
    function cetak(format) {
        ...
        var baseDocLocation = 'http://10.10.11.44/simbakda_2024/lam_semester1/3.A/';
        var docLocation;

        if (urut == 1) {
            docLocation = baseDocLocation + '3. GEDUNG DAN BANGUNAN 0.4.3';
        } else if (urut == 3) {
...
<div id="content1"> 
    <h1 align="center"><b>CETAK GEDUNG DAN BANGUNAN</b></h1>
    <fieldset>
        <table align="center" style="width:100%;" border="0">
            <select id="itemsList" onchange="gettingList()">
                <option>SILAHKAN PILIH GEDUNG DAN BANGUNAN</option>
                <option value="1">GEDUNG DAN BANGUNAN 0.4.3</option>
