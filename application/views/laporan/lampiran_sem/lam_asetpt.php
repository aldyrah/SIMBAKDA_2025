...
<script type="text/javascript">
    ...
    function cetak(format) {
        ...
        var baseDocLocation = 'http://10.10.11.44/simbakda_2024/lam_semester1/7.A/';
        var docLocation;

        if (urut == 1) {
            docLocation = baseDocLocation + '7. ASET KEMITRAAN PIHAK KETIGA 0.4.7';
        } else if (urut == 2) {
...
<div id="content1"> 
    <h1 align="center"><b>CETAK LAPORAN KEMITRAAN PIHAK KETIGA</b></h1>
    <fieldset>
        <table align="center" style="width:100%;" border="0">
            <select id="itemsList" onchange="gettingList()">
                <option>SILAHKAN PILIH LAPORAN KEMITRAAN PIHAK KETIGA</option>
                <option value="1">ASET KEMITRAAN PIHAK KETIGA 0.4.7</option>
                <option value="2">LAMPIRAN ASET KEMITRAAN PIHAK KETIGA 0.4.7.2</option>
                <option value="3">LAMPIRAN ASET KEMITRAAN PIHAK KETIGA 0.4.7.1</option>
            </select>
