...
<script type="text/javascript">
    ...
    function cetak(format) {
        ...
        var baseDocLocation = 'http://10.10.11.44/simbakda_2025/lam_semester1/6.A/';
        var docLocation;

        if (urut == 1) {
            docLocation = baseDocLocation + '6. KONSTRUKSI DALAM PENGERJAAN 0.4.6';
        } else if (urut == 3) {
...
<div id="content1"> 
    <h1 align="center"><b>CETAK LAPORAN KONSTRUKSI DALAM PENGERJAAN</b></h1>
    <fieldset>
        <table align="center" style="width:100%;" border="0">
            <select id="itemsList" onchange="gettingList()">
                <option>SILAHKAN PILIH LAPORAN KONSTRUKSI DALAM PENGERJAAN</option>
                <option value="1">KONSTRUKSI DALAM PENGERJAAN 0.4.6</option>
                <option value="3">LAMPIRAN KONSTRUKSI DALAM PENGERJAAN 0.4.6</option>
            </select>
