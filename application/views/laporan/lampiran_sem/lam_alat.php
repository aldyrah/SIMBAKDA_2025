...
<script type="text/javascript">
    ...
    function cetak(format) {
        ...
        var baseDocLocation = 'http://10.10.11.44/simbakda_2024/lam_semester1/1.A/';
        var docLocation;

        if (urut == 1) {
            docLocation = baseDocLocation + '1. PERALATAN DAN MESIN 0.4.2';
        } else if (urut == 3) {
...
<div id="content1"> 
    <h1 align="center"><b>CETAK LAPORAN PERALATAN DAN MESIN</b></h1>
    <fieldset>
        <table align="center" style="width:100%;" border="0">
            <select id="itemsList" onchange="gettingList()">
                <option>SILAHKAN PILIH LAPORAN PERALATAN DAN MESIN</option>
                <option value="1">PERALATAN DAN MESIN 0.4.2</option>
                <option value="3">LAMPIRAN PERALATAN DAN MESIN 0.4.2</option>
            </select>
