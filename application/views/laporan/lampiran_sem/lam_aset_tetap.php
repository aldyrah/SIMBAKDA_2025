...
<script type="text/javascript">
    ...
    function cetak(format) {
        ...
        var baseDocLocation = 'http://10.10.11.44/simbakda_2024/lam_semester1/5. ASET TETAP LAINNYA 0.4.5/';
        var docLocation;

        if (urut == 1) {
            docLocation = baseDocLocation + '5.  ASET TETAP LAINNYA 0.4.5';
        } else {
...
<div id="content1"> 
    <h1 align="center"><b>CETAK LAPORAN ASET TETAP LAINNYA</b></h1>
    <fieldset>
        <table align="center" style="width:100%;" border="0">
            <select id="itemsList" onchange="gettingList()">
                <option>SILAHKAN PILIH LAPORAN ASET TETAP LAINNYA</option>
                <option value="1">ASET TETAP LAINNYA 0.4.5</option>
            </select>
