...
<script type="text/javascript">
    ...
    function cetak(format) {
        ...
        var baseDocLocation = 'http://10.10.11.44/simbakda_2024/lam_semester1/10.A/';
        var docLocation;

        if (urut == 1) {
            docLocation = baseDocLocation + '10. PERSEDIAAN RUSAK  ATAU USANG 0.4.10';
        } else if (urut == 2) {
...
<div id="content1"> 
    <h1 align="center"><b>CETAK LAPORAN PERSEDIAAN RUSAK ATAU USANG</b></h1>
    <fieldset>
        <table align="center" style="width:100%;" border="0">
            <select id="itemsList" onchange="gettingList()">
                <option>SILAHKAN PILIH LAPORAN PERSEDIAAN RUSAK ATAU USANG</option>
                <option value="1">PERSEDIAAN RUSAK  ATAU USANG 0.4.10</option>
                <option value="2">LAMPIRAN PERSEDIAAN RUSAK  ATAU USANG 0.4.10</option>
            </select>
