...
<script type="text/javascript">
    ...
    $("#price").hide();
      ...
      function cetak(){
        ...
        if (urut == 11){
          var docLocation = 'http://localhost/MAPPI/simbakda_2023/files/b/11.pdf';
          window.open(docLocation,"resizeable,scrollbar"); 


        }else if (urut==21){
          var docLocation = 'http://localhost/MAPPI/simbakda_2023/files/b/21.pdf';
          window.open(docLocation,"resizeable,scrollbar"); 
        }else if (urut==23){
          var docLocation = 'http://localhost/MAPPI/simbakda_2023/files/b/23.pdf';
          window.open(docLocation,"resizeable,scrollbar"); 
        }else if (urut==31){
          var docLocation = 'http://localhost/MAPPI/simbakda_2023/files/b/31.pdf';
          window.open(docLocation,"resizeable,scrollbar"); 
        }else if (urut==33){
          var docLocation = 'http://localhost/MAPPI/simbakda_2023/files/b/33.pdf';
          window.open(docLocation,"resizeable,scrollbar"); 
        }else{
...
<div id="content1"> 
    ...
    <option value="11">FORMAT IV.B.1.1</option>
    <option value="21">FORMAT IV.B.2.1</option>
    <option value="23">FORMAT IV.B.2.3</option>
    <option value="31">FORMAT IV.B.3.2</option>
    <option value="33">FORMAT IV.B.3.3</option>
