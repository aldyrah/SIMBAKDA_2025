...
<script type="text/javascript">
    ...
    function cetak(format) {
        ...
        if (urut == 1) {
            docLocation = 'http://10.10.11.44/simbakda_2024/laporan/i. Persediaan LAMPIRAN IV.I.1/Persediaan LAMPIRAN IV.I.1';
        } else {
...
<div id="content1"> 
    <h1 align="center"><b>CETAK LAPORAN PERSEDIAAN</b></h1>
    <fieldset>
        <table align="center" style="width:100%;" border="0">
            <select id="itemsList" onchange="gettingList()">
                <option>SILAHKAN PILIH LAPORAN PERSEDIAAN</option>
                <option value="1">LAMPIRAN IV.I.1</option>
            </select>
