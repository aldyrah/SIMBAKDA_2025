...
<script type="text/javascript">
    ...
    function cetak(format) {
        ...
        if (urut == 1) {
            docLocation = 'http://10.10.11.44/simbakda_2024/laporan/f. LAPORAN REKLASIFIKASI LAMPIRAN IV F.1.1/LAMPIRAN IV.F.1.1';
        } else {
...
<div id="content1"> 
    <h1 align="center"><b>CETAK LAPORAN REKLASIFIKASI</b></h1>
    <fieldset>
        <table align="center" style="width:100%;" border="0">
            <select id="itemsList" onchange="gettingList()">
                <option>SILAHKAN PILIH LAPORAN REKLASIFIKASI</option>
                <option value="1">FORMAT IV.F.1.1</option>
            </select>
