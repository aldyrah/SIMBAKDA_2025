...
<script type="text/javascript">
    ...
    function cetak(format) {
        ...
        if (urut == 1) {
            docLocation = 'http://10.10.11.44/simbakda_2024/laporan/d. LAMPIRAN Pengeluaran Internal Pengguna Barang IV.D.1/LAMPIRAN IV.D.1';
        } else {
...
<div id="content1"> 
    <h1 align="center"><b>CETAK LAPORAN PENGELUARAN INTERNAL PENGGUNAAN BARANG</b></h1>
    <fieldset>
        <table align="center" style="width:100%;" border="0">
            <select id="itemsList" onchange="gettingList()">
                <option>SILAHKAN PILIH LAPORAN PENGELUARAN INTERNAL PENGGUNAAN BARANG</option>
                <option value="1">Format IV.D.1</option>
            </select>
