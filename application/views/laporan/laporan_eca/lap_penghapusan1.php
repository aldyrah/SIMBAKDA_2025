...
<script type="text/javascript">
    ...
    $("#price").hide();
      ...
      function cetak(){
        ...
        if (urut == 11){
          var docLocation = 'http://localhost/MAPPI/simbakda_2023/files/k/11.pdf';
          window.open(docLocation,"resizeable,scrollbar"); 


        }else if (urut==12){
          var docLocation = 'http://localhost/MAPPI/simbakda_2023/files/k/12.pdf';
          window.open(docLocation,"resizeable,scrollbar"); 
        }else if (urut==13){
          var docLocation = 'http://localhost/MAPPI/simbakda_2023/files/k/13.pdf';
          window.open(docLocation,"resizeable,scrollbar"); 
        }else if (urut==14){
          var docLocation = 'http://localhost/MAPPI/simbakda_2023/files/k/14.pdf';
          window.open(docLocation,"resizeable,scrollbar"); 
        }else{
...
<div id="content1"> 
    ...
    <option value="11">FORMAT IV.K.1.1</option>
    <option value="12">FORMAT IV.K.1.2</option>
    <option value="13">FORMAT IV.K.1.3</option>
    <option value="14">FORMAT IV.K.1.4</option>
</select>
