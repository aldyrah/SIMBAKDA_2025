...
<script type="text/javascript">
    ...
    function cetak(format) {
        ...
        if (urut == 1) {
            docLocation = 'http://10.10.11.44/simbakda_2024/laporan/c. LAPORAN PENERIMAAN INTERNAL PENGGUNA BARANG LAMPIRAN IV.C.1/LAMPIRAN IV.C.1';
        } else {
...
<div id="content1"> 
    <h1 align="center"><b>LAPORAN PENERIMAAN INTERNAL PENGGUNAAN BARANG</b></h1>
    <fieldset>
        <table align="center" style="width:100%;" border="0">
            <select id="itemsList" onchange="gettingList()">
                <option>SILAHKAN PILIH LAPORAN PENERIMAAN INTERNAL PENGGUNAAN BARANG</option>
                <option value="1">LAMPIRAN IV.C.1</option>
            </select>
