...
<script type="text/javascript">
    ...
    function cetak(format) {
        ...
        if (urut == 1) {
            docLocation = 'http://10.10.11.44/simbakda_2024/laporan/j. Laporan Pengamanan LAMPIRAN IV.J/LAMPIRAN IV.J.1.1';
        } else if (urut == 2) {
            docLocation = 'http://10.10.11.44/simbakda_2024/laporan/j. Laporan Pengamanan LAMPIRAN IV.J/LAMPIRAN IV.J.1.3';
        } else if (urut == 3) {
            docLocation = 'http://10.10.11.44/simbakda_2024/laporan/j. Laporan Pengamanan LAMPIRAN IV.J/LAMPIRAN IV.J.2.1';
        } else if (urut == 4) {
            docLocation = 'http://10.10.11.44/simbakda_2024/laporan/j. Laporan Pengamanan LAMPIRAN IV.J/LAMPIRAN IV.J.2.3';
        } else {
...
<div id="content1"> 
    <h1 align="center"><b>CETAK LAPORAN PENGAMANAN</b></h1>
    <fieldset>
        <table align="center" style="width:100%;" border="0">
            <select id="itemsList" onchange="gettingList()">
                <option>SILAHKAN PILIH LAPORAN PENGAMANAN</option>
                <option value="1"> FORMAT IV.J.1.1</option>
                <option value="2"> FORMAT IV.J.1.3</option>
                <option value="3"> FORMAT IV.J.2.1</option>
                <option value="4"> FORMAT IV.J.2.3</option>
            </select>
