...
<script type="text/javascript">
    ...
    $("#price").hide();
      ...
      function cetak(){
        ...
        if (urut == 11){
          var docLocation = 'http://localhost/MAPPI/simbakda_2023/files/j/11.pdf';
          window.open(docLocation,"resizeable,scrollbar"); 


        }else if (urut==13){
          var docLocation = 'http://localhost/MAPPI/simbakda_2023/files/j/13.pdf';
          window.open(docLocation,"resizeable,scrollbar"); 
        }else if (urut==21){
          var docLocation = 'http://localhost/MAPPI/simbakda_2023/files/j/21.pdf';
          window.open(docLocation,"resizeable,scrollbar"); 
        }else if (urut==23){
          var docLocation = 'http://localhost/MAPPI/simbakda_2023/files/j/23.pdf';
          window.open(docLocation,"resizeable,scrollbar"); 
        }else{
...
<div id="content1"> 
    ...
    <option value="11"> FORMAT IV.J.1.1</option>
    <option value="13"> FORMAT IV.J.1.3</option>
    <option value="21"> FORMAT IV.J.2.1</option>
    <option value="23"> FORMAT IV.J.2.3</option>
</select>
