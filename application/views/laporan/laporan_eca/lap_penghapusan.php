...
<script type="text/javascript">
    ...
    function cetak(format) {
        ...
        if (urut == 1) {
            docLocation = 'http://10.10.11.44/simbakda_2024/laporan/k. Laporan Penghapusan LAMPIRAN IV.K/LAMPIRAN IV.K.1.1';
        } else if (urut == 2) {
            docLocation = 'http://10.10.11.44/simbakda_2024/laporan/k. Laporan Penghapusan LAMPIRAN IV.K/LAMPIRAN IV.K.2.1';
        } else if (urut == 3) {
            docLocation = 'http://10.10.11.44/simbakda_2024/laporan/k. Laporan Penghapusan LAMPIRAN IV.K/LAMPIRAN IV.K.3.1';
        } else if (urut == 4) {
            docLocation = 'http://10.10.11.44/simbakda_2024/laporan/k. Laporan Penghapusan LAMPIRAN IV.K/LAMPIRAN IV.K.4.1.2';
        } else { 
...
<div id="content1"> 
    <h1 align="center"><b>CETAK LAPORAN PENGHAPUSAN</b></h1>
    <fieldset>
        <table align="center" style="width:100%;" border="0">
            <select id="itemsList" onchange="gettingList()">
                <option>SILAHKAN PILIH LAPORAN PENGHAPUSAN</option>
                <option value="1">LAMPIRAN IV.K.1.1</option>
                <option value="2">LAMPIRAN IV.K.2.1</option>
                <option value="3">LAMPIRAN IV.K.3.1</option>
                <option value="4">LAMPIRAN IV.K.4.1.2</option>
            </select>
