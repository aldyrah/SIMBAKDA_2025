...
<script type="text/javascript">
    ...
    function cetak(format) {
        ...
        if (urut == 1) {
            docLocation = 'http://10.10.11.44/simbakda_2024/laporan/h. Penyusutan-Amortisasi LAMPIRAN IV.H.1/Penyusutan-Amortisasi LAMPIRAN IV.H.1';
        } else {
    ...
    <fieldset>
        <table align="center" style="width:100%;" border="0">
            <select id="itemsList" onchange="gettingList()">
                ...
                <option value="1">LAMPIRAN IV.H.1</option>
            </select>
