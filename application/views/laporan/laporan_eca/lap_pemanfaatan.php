...
<script type="text/javascript">
    ...
    function cetak(format) {
        ...
        if (urut == 1) {
            docLocation = 'http://10.10.11.44/simbakda_2024/laporan/e. Laporan Pemanfaatan LAMPIRAN IV.E/LAMPIRAN IV.E.1';
        } else if (urut == 3) {
            docLocation = 'http://10.10.11.44/simbakda_2024/laporan/e. Laporan Pemanfaatan LAMPIRAN IV.E/LAMPIRAN IV.E.3';
        } else {
...
<div id="content1"> 
    <h1 align="center"><b>CETAK LAPORAN PEMANFAATAN</b></h1>
    <fieldset>
        <table align="center" style="width:100%;" border="0">
            <select id="itemsList" onchange="gettingList()">
                <option>SILAHKAN PILIH LAPORAN PEMANFAATAN</option>
                <option value="1">Format IV.E.1</option>
                <option value="3">Format IV.E.3</option>
            </select>
