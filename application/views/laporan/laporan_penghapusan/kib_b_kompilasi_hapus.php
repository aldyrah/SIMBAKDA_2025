...
<script type="text/javascript">
  ...
  function cetak($cek){
    ...
    alert(cjenis_aset);
    var url     = "<?php echo site_url(); ?>/laporan_penghapusan/lap_kib_b_hapus";
    ...
    //if(oto=='01'){
      if(ctk=='1'){
        ...
        if(bulan=='' && blnthn=='01'){
          ...
          if(blnthn=='01'){
            lc = '?pilih='+cpilih+'&tampil='+cini+'&skpd='+cskpd+'&nmskpd='+cnmskpd+'&bidang='+cbid+'&nmbid='+cnm_bid+'&jenis='+jenis+'&nmjenis='+nmjenis+'&bulan='+bulan+'&tahun='+tahun+'&tglcetak='+lctgl2+'&pilctk='+pilctk+'&blnthn='+blnthn;
          }else{
            lc = '?pilih='+cpilih+'&tampil='+cini+'&skpd='+cskpd+'&nmskpd='+cnmskpd+'&bidang='+cbid+'&nmbid='+cnm_bid+'&jenis='+jenis+'&nmjenis='+nmjenis+'&tahun1='+tahun1+'&tahun2='+tahun2+'&tahun3='+tahun3+'&tglcetak='+lctgl2+'&pilctk='+pilctk+'&blnthn='+blnthn;
          }
