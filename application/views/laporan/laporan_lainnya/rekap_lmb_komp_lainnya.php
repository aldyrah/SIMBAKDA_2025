<script type="text/javascript">
	...
	function openWindow($cek){
		...
		var url			= "<?php echo site_url(); ?>/laporan_lainnya/rekap_lmb_komp_lainnya";
		
		
		if (oto=='01'){
				iz = '?kd_skpd='+cskpd+'&nm_skpd='+cnmskpd+'&kd_bid='+cbidang+'&nm_bid='+cnmbid+'&lctahu='+lctahu+'&lcbend='+lcbend+'&cnmbend='+cnmbend+'&cnmtahu='+cnmtahu+'&lctgl2='+lctgl2+'&tgl_awal='+tgl_awal+'&tgl_akhir='+tgl_akhir+'&tgl_reg='+tgl_reg+'&fa='+cpilih;
...
<div id="content1"> 
    <h3 align="center"><b>REKAP LAPORAN MUTASI BARANG LAINNYA</b></h3>
    <fieldset>
