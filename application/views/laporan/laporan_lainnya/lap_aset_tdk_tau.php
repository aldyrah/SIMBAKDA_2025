	...
	function openWindow($cek){
		...
		if (cpilih == '3'){				
		var url			= "<?php echo site_url(); ?>/laporan_lainnya/lap_aset_tdk_taux";
		}else if(cpilih != '3'){
		var url			= "<?php echo site_url(); ?>/laporan_lainnya/lap_tdk_tau";
		}
...
<div id="content1"> 
    <h3 align="center"><b>CETAK LAPORAN ASET DIKETAHUI KEBERADAANNYA</b></h3>
    <fieldset>
