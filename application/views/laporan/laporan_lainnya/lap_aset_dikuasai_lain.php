	...
	function openWindow($cek){
		...
		if (cpilih == '3'){				
		var url			= "<?php echo site_url(); ?>/laporan_lainnya/lap_aset_dikuasai_lainx";
		}else if(cpilih != '3'){
		var url			= "<?php echo site_url(); ?>/laporan_lainnya/lap_dikuasai_lain";
		}
...
<div id="content1"> 
    <h3 align="center"><b>CETAK LAPORAN ASET DIKUASAI PIHAK LAIN</b></h3>
    <fieldset>
