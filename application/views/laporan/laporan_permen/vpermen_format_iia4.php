...
<script type="text/javascript">
  ...
  function cetak($cek){
    ...
    var url     = "<?php echo site_url(); ?>/laporan_permen/permen_format_iia4";
    var sh      = ""; 
...
//         url: '<?php echo base_url(); ?>index.php/master/ambil_barang', // URL untuk mengambil data
//         columns: [[
...
$(document).ready(function() {
    ...
    $('#nama_barang').combogrid({
        ...
        textField: 'kd_brg',
        mode: 'remote', // Mode pencarian remote
        url: '<?php echo base_url(); ?>index.php/master/ambil_barang4', // URL untuk mengambil data
        columns: [[
            {field: 'kd_brg', title: 'Kode Barang', width: 200},
            {field: 'nm_brg', title: 'Nama Barang', width: 300},
        ...
        onSelect: function(rowIndex, rowData) {
            ...
            $.ajax({
                url: '<?php echo base_url(); ?>index.php/master/get_no_dokumen4',  // Ganti dengan URL controller Anda
                type: 'POST',
...
<div id="content1"> 
    ...
    ASET TETAP GEDUNG DAN BANGUNAN</b></h3>
    <fieldset>
