...
<script type="text/javascript">
  ...
  function cetak($cek){
    ...
    var url     = "<?php echo site_url(); ?>/laporan_permen/permen_format_iia1";
    var sh      = ""; 
...
$(document).ready(function() {
    ...
    $('#nama_barang').combogrid({
        ...
        onSelect: function(rowIndex, rowData) {
            ...
            $.ajax({
                url: '<?php echo base_url(); ?>index.php/master/get_no_dokumen',  // Ganti dengan URL controller Anda
                type: 'POST',
...
<div id="content1"> 
    ...
    ASET LANCAR BERUPA PERSEDIAAN</b></h3>
    <fieldset>
