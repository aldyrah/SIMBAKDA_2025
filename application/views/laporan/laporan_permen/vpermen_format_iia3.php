...
<script type="text/javascript">
  ...
  function cetak($cek){
    ...
    var url     = "<?php echo site_url(); ?>/laporan_permen/permen_format_iia3";
    var sh      = ""; 
...
//         url: '<?php echo base_url(); ?>index.php/master/ambil_barang3', // URL untuk mengambil data
//         columns: [[
...
$(document).ready(function() {
    ...
    $('#nama_barang').combogrid({
        ...
        onSelect: function(rowIndex, rowData) {
            ...
            $.ajax({
                url: '<?php echo base_url(); ?>index.php/master/get_no_dokumen3',  // Ganti dengan URL controller Anda
                type: 'POST',
...
<div id="content1"> 
    ...
    ASET TETAP PERALATA DAN MESIN</b></h3>
    <fieldset>
