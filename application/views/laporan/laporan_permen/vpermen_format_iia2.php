...
<script type="text/javascript">
  ...
  function cetak($cek){
    ...
    var url     = "<?php echo site_url(); ?>/laporan_permen/permen_format_iia2";
    var sh      = ""; 
...
$(document).ready(function() {
    ...
    $('#nama_barang').combogrid({
        ...
        onSelect: function(rowIndex, rowData) {
            ...
            $.ajax({
                url: '<?php echo base_url(); ?>index.php/master/get_no_dokumen2',  // Ganti dengan URL controller Anda
                type: 'POST',
