...
<script type="text/javascript">
  ...
  function cetak($cek){
    ...
    var url     = "<?php echo site_url(); ?>/laporan_permen/permen_format_iia10";
    var sh      = ""; 
...
//         url: '<?php echo base_url(); ?>index.php/master/ambil_barang10', // URL untuk mengambil data
//         columns: [[
...
$(document).ready(function() {
    ...
    $('#nama_barang').combogrid({
        ...
        onSelect: function(rowIndex, rowData) {
            ...
            $.ajax({
                url: '<?php echo base_url(); ?>index.php/master/get_no_dokumen10',  // Ganti dengan URL controller Anda
                type: 'POST',
