...
<script type="text/javascript">
    ...
    function cetak(format) {
        ...
        var baseDocLocation = 'http://10.10.11.44/simbakda_2024/lam_semester2/9.A/';
        var docLocation;

        if (urut == 1) {
            docLocation = baseDocLocation + '9.  ASET LAIN-LAIN 0.4.9';
        } else if (urut == 2) {
...
<div id="content1"> 
    <h1 align="center"><b>CETAK LAPORAN ASET LAIN-LAIN</b></h1>
    <fieldset>
        <table align="center" style="width:100%;" border="0">
            <select id="itemsList" onchange="gettingList()">
                <option>SILAHKAN PILIH LAPORAN ASET LAIN-LAIN</option>
                <option value="1">ASET LAIN-LAIN 0.4.9</option>
                <option value="2">LAMPIRAN ASET LAIN-LAIN 0.4.9.1</option>
                <option value="3">LAMPIRAN ASET LAIN-LAIN 0.4.9.2</option>
                <option value="4">LAMPIRAN ASET LAIN-LAIN 0.4.9.3</option>
                <option value="5">LAMPIRAN ASET LAIN-LAIN 0.4.9.4</option>
            </select>
