...
<script type="text/javascript">
    ...
    function cetak(format) {
        ...
        var baseDocLocation = 'http://10.10.11.44/simbakda_2024/lam_semester2/2.A/';
        var docLocation;

        if (urut == 1) {
            docLocation = baseDocLocation + '2. TANAH 0.4.1';
        } else if (urut == 3) {
...
<div id="content1"> 
    <h1 align="center"><b>CETAK LAPORAN TANAH</b></h1>
    <fieldset>
        <table align="center" style="width:100%;" border="0">
            <select id="itemsList" onchange="gettingList()">
                <option>SILAHKAN PILIH LAPORAN TANAH</option>
                <option value="1">TANAH 0.4.1</option>
                <option value="3">LAMPIRAN TANAH 0.4.1</option>
            </select>
