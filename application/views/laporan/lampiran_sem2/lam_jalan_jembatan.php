...
<script type="text/javascript">
    ...
    function cetak(format) {
        ...
        var baseDocLocation = 'http://10.10.11.44/simbakda_2024/lam_semester2/4.A/';
        var docLocation;

        if (urut == 1) {
            docLocation = baseDocLocation + '4. JALAN DAN JEMBATAN  0.4.4';
        } else if (urut == 3) {
...
<div id="content1"> 
    <h1 align="center"><b>CETAK JALAN DAN JEMBATAN</b></h1>
    <fieldset>
        <table align="center" style="width:100%;" border="0">
            <select id="itemsList" onchange="gettingList()">
                <option>SILAHKAN PILIH JALAN DAN JEMBATAN</option>
                <option value="1">JALAN DAN JEMBATAN  0.4.4</option>
                <option value="3">LAMPIRAN JALAN DAN JEMBATAN  0.4.4</option>
            </select>
