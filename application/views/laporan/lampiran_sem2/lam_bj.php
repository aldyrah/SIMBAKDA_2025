...
<script type="text/javascript">
    ...
    function cetak(format) {
        ...
        var baseDocLocation = 'http://10.10.11.44/simbakda_2024/lam_semester2/11.A/';
        var docLocation;

        if (urut == 1) {
            docLocation = baseDocLocation + '11. BARANG BERSEJARAH 0.4.11';
        } else if (urut == 2) {
...
<div id="content1"> 
    <h1 align="center"><b>CETAK LAPORAN BARANG BERSEJARAH</b></h1>
    <fieldset>
        <table align="center" style="width:100%;" border="0">
            <select id="itemsList" onchange="gettingList()">
                <option>SILAHKAN PILIH LAPORAN ARANG BERSEJARAH</option>
                <option value="1">11. BARANG BERSEJARAH 0.4.11</option>
                <option value="2">11.A BARANG BERSEJARAH 0.4.11</option>
            </select>
