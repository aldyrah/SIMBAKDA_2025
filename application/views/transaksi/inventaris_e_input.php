...
$('#metode').combogrid({  
  ...
  function cek_status(no_dokumen){
   ...
   function cari(){
    ...
    function simpan(){
        ...
        var bida       = $('#bida').combogrid('getValue');//document.getElementById('bida').value;       
 ...
 function nomer_akhir(){
        ...
        var reg 	='no_reg'
        var kd_unit	= lcskpd;
        var brg= $('#kdbrg').combogrid('getValue');//document.getElementById('kdbrg').value; 
        $.ajax({
            type: "POST",
