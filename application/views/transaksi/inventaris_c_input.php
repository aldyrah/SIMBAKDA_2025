...
/*	$('#bida').combogrid({  
  ...
  function riwayat(){
    ...
    var del = confirm("Apakah Anda Yakin ingin menghapus data   "+id_brg+"?");
        ...
        $(document).ready(function(){
         $.post(urll,({no:id_barang,dok:nodok,no_urut:no_furut,kdbrg:kdbrg}),function(data){
            status = data;
            if (status=='0'){
                alert('Gagal Hapus..!!');
                exit();
