...
//this view has been modified by wisnu msm MAPPI 
//wisnu
$(document).ready(function(){
      $('#jumlah').maskMoney({thousands:',', decimal:'.', precision:0});
      // $('#jumlah_2').maskMoney({thousands:',', decimal:'.', precision:0});
    });    
...
$(function(){ 
    $('#trh').edatagrid({
        ...
        columns:[[
            ...
            {field:'st_inp',title:'INP',width:30,hidden:true},
            {field:'no_bukti',title:'Nomor Bukti',width:30},
    	    {field:'no_dokumen',title:'Nomor Dokumen',width:200},
            {field:'tgl_dokumen',title:'Tanggal',width:30},
            {field:'nm_comp',title:'Rekanan',width:100},
            {field:'nm_skpd',title:'OPD',width:100} ,
        ...
        onSelect:function(rowIndex,rowData){
            ...
            sts_inp     = rowData.st_inp;    
            getData(no_bukti,no,tgl,nilkon,nilapbd,kdcomp,nmcomp,kdmilik,kdwilayah,kduskpd,kd_unit,jnsdana,tahunang,buktibyr,dasaroleh,nooleh,tgloleh,tahunoleh,tot,cr_oleh,no_renc,no_awas,nrek5,sts_kdp,sts_inp);            
            updt = 't';       
        },
    ...
    $('#trd').edatagrid({                
        ...
        {field:'no_spp',title:'No SPP',width:150 }  ,
        {field:'tgl_spp',title:'TGL SPP',width:100,hidden:true }  ,
        {field:'nilai_spp',title:'Nilai SPP',width:100,align:'right' }  ,
  ...
  $('#thn').combogrid({  
	 ...
	 $('#unit').combogrid({  
         ...
         $('#unit2').combogrid({  
            ...
            onSelect:function(rowIndex,rowData){
               ...
               ckd_lokasi = rowData.kd_lokasi;  
               cnm_lokasi = rowData.nm_lokasi;          
               $('#nmunit2').attr('value',rowData.nm_skpd);        
               $('#mlokasi2').attr('value',ckd_lokasi);        
               $('#nmlokasi2').attr('value',cnm_lokasi);
               //$('#kegiatan_2').combogrid({url:'<?php echo base_url(); ?>index.php/master/ambil_giat',
    ...
    $('#paket').combogrid({  
            ...
            columns:[[  
               {field:'kd_paket',title:'Kode Paket',width:40},  
               {field:'nm_paket',title:'Nama Paket',width:100}
               // {field:'kd_lokasi',title:'Kode Unit',width:100},  
               // {field:'nm_lokasi',title:'Nama Unit',width:250}    
            ]],  
            onSelect:function(rowIndex,rowData){
    ...
    $('#dana').combobox({           
        ...
        {kode:'5',nama:'APBDESA'},{kode:'6',nama:'BOS'}]
    });
    ...
    $('#bukti').combobox({           
        ...
        textField:'nama',
        width:150,
        data:[{kode:'2',nama:'SPM'},{kode:'3',nama:'BUKTI SETORAN'},{kode:'4',nama:'SP2D'}]
    });
    ...
    $('#dasar').combobox({           
        ...
        textField:'nama',        
        width:250,
        data:[{kode:'1',nama:'BERITA ACARA SERAH TERIMA BARANG'},{kode:'2',nama:'SERTIFIKAT'}]
    });
    ...
    $('#nospp').combogrid({  
                  ...
                  /* idField    : 'no_sp2d',  
                   ...
                   //multiple   : true,  
                   columns:[[  
                       {field:'no_spp',title:'No SPP',width:200},  
                       {field:'tgl_spp',title:'Tanggal SPP',width:80},
                       {field:'nilai2',title:'Nilai',width:100,align:'right'},
                       {field:'keperluan',title:'Keterangan',width:320}    
                   ]],  
                   onSelect:function(rowIndex,rowData){
                    nil=rowData.nilai;
                    $('#tglspp').datebox("setValue",rowData.tgl_spp);
                    $('#nilspp').attr('value',rowData.nilai2);
                    $('#nilspp_hide').attr('value',number_format(nil,2,'.',''));
    ...
    $('#nosp2d_u').combogrid({  
            ...
            columns:[[  
               ...
               {field:'nm_kegiatan',title:'Nama Kegiatan',width:350}
            ]],  
            onSelect:function(rowIndex,rowData){
                giat = rowData.kd_kegiatan;
                $('#nm_kegiatan_2').attr('value',rowData.nm_kegiatan);
                $('#rekening_2').combogrid({url:'<?php echo base_url(); ?>index.php/master/ambil_kdrek5',
                queryParams:({giat:giat})});
            } 
         });

         $('#rekening_2').combogrid({  
            panelWidth:500,  
            width:200,
            idField:'kd_rek5',  
            textField:'kd_rek5',  
            ...
            onSelect:function(rowIndex,rowData){
                $('#nm_rekening_2').attr('value',rowData.nm_rek5);
...
$(function(){
    $('#cmbjenis').combogrid({           
 	...
 	$('#cmbjenis_2').combogrid({           
        ...
        onSelect:function(rowIndex,rowData){
            ...
            $('#nmgolongan_2').attr('value',ngol);
            $('#bidang_2').combogrid('clear');
            $('#kdbarang_2').combogrid('clear');
            $('#nmbidang_2').attr('value','');
            $('#nmkelompok_2').attr('value','');
            ...
            $('#total2').attr('value','');
            if(cgol=='01' || cgol=='03' || cgol=='04'){
                $('#jumlah_2').attr('value','1');
            }
            //$('#ket').attr('value','');
           $('#bidang_2').combogrid({url:'<?php echo base_url(); ?>index.php/master/ambil_bidang',
		   // ('#kdbarang_2').combogrid({url:'<?php echo base_url(); ?>index.php/master/ambil_brg_dh',
            queryParams:({gol:cgol})
        });            
        }                    
    }); 
     ...
     $('#bidang_2').combogrid({  
            ...
            columns:[[  
             ...
             onSelect:function(rowIndex,rowData){
                bidang=rowData.bidang;
                nmbidang=rowData.nm_bidang;
                $('#nmbidang_2').attr('value',nmbidang);
                $('#kdbarang_2').combogrid("clear");
                $('#nmkelompok_2').attr('value',''); 
                $('#kdbarang_2').combogrid({url:'<?php echo base_url(); ?>index.php/master/ambil_brg_dh',
               queryParams:({bidang:bidang})});            
        ...
        panelWidth:550, 
            ...
            columns:[[  
             ...
             onSelect:function(rowIndex,rowData){
                ...
                ckd_kelompok   = rowData.kd_brg;                                                        
                cnmkelompok   = rowData.nm_brg;
                $('#nmkelompok_2').attr('value',cnmkelompok);
            }                                                          
   ...
   $('#nomor').combogrid({  
            ...
            columns:[[  
                {field:'no_kontrak',title:'No Kontrak',width:250},  
                {field:'nilai2',title:'Nilai Kontrak',width:100,align:'right'},
                {field:'nm_rek5',title:'Nm Rek',width:300},
				{field:'kode',title:'Kode Rekanan',width:80},
				{field:'nmrekan',title:'Nm Rekanan',width:170},
            ...
            onSelect:function(rowIndex,rowData){
                ...
                $('#spp').attr('value',rowData.no_spp);
				$('#compy').attr('value',rowData.kode);
				$('#nmcompy').attr('value',rowData.nmrekan);
...
function spp_dh(){
    ...
    $('#nospp').combogrid({  
                   ...
                   textField  : 'no_spp',  
                   mode       : 'remote',
                   url        : '<?php echo base_url(); ?>index.php/master/ambil_spp',
                   queryParams :({kdskpd:kduskpd,spp:spp,giat:giat,rek:rek,jns:jns,nom:nom}),  
                   columns:[[  
                       {field:'no_spp',title:'No SPP',width:200},  
                       {field:'tgl_spp',title:'Tanggal SPP',width:80},
                       {field:'nilai2',title:'Nilai',width:100,align:'right'},
...
function kegiatan(){
    var kduskpd     = $('#unit2').combogrid('getValue');
   ...
   $(function(){
    $('#kegiatan_2').combogrid({  
            ...
            textField:'kd_kegiatan',  
            mode:'remote', 
            url        : '<?php echo base_url(); ?>index.php/master/ambil_giat',
            queryParams :({skpd:kduskpd}),                     
            columns:[[  
               {field:'kd_kegiatan',title:'Kode Kegiatan',width:150},  
               {field:'nm_kegiatan',title:'Nama Kegiatan',width:350}
            ]],  
...
function kosong(){
    ...
    $('#sts_kdp').attr('value','');
    $("#sts_kdp").attr("disabled",false);
    $('#unit').combogrid('enable');

    $('#unit2').combogrid('setValue',skpd);
    $('#unit2').combogrid("clear");
    $('#unit2').combogrid('enable');
    $('#mlokasi2').attr('value','');
    $('#tahun2').combobox('setValue',cthn);
    $('#txtnodok_h').attr('value','');
    $('#spp').attr('value','');
    $('#tanggal2').datebox('setValue',cdate);
    $('#nilkont2').attr('value','');
    $('#nilapbd2').attr('value','');
    $('#compy2').combobox('setValue','');
    $('#dana2').combobox('setValue','');
    $('#bukti2').combobox('setValue','');
    $('#dasar2').combobox('setValue','');
    $('#dsno2').attr('value','');
    $('#dstgl2').datebox('setValue',cdate);
    $('#thn2').combobox('setValue','');    
    $('#perolehan2').combobox('setValue','');
    $('#krg').attr('value','');
    $('#nmunit2').attr('value',''); 
    $('#nmlokasi2').attr('value','');
    $('#total').attr('value','0');
    $("#total2").attr('value','');   
    $('#nomor2').attr('value',''); 
    $('#nomor2').attr("disabled",false);
    $('#sts_kdp2').attr('value','');
    $("#sts_kdp2").attr("disabled",false);
    $("#nomor2").attr("disabled",false);
...
function kosong2(){ 
    ...
    if(sts_inp=='1'){
        ...
        $("#dialog-modal :checkbox").attr("checked",false);
        var nkonxx = document.getElementById('nilkont2').value;
        $('#cmbjenis_2').combogrid('clear');
        $('#bidang_2').combogrid('setValue','');
        $('#sbrdana').combobox('setValue','');
        $('#nmbrg_2').attr('value','');
        $('#kegiatan_2').combogrid('clear');
        $('#nosp2d_2').attr('setValue','');
        $('#rekening_2').combogrid('clear');
        $('#jumlah_2').attr('value','');
        $('#harga_2').attr('value','');
        $('#total1_2').attr('value','');
        $('#nilppn_2').attr('value','');
        $('#total2_2').attr('value','');
        $('#nmgolongan_2').attr('value','');
        $('#nmbidang_2').attr('value','');
        $('#nmkelompok_2').attr('value','');
        $('#kdbarang_2').combogrid('clear');
        $('#nm_kegiatan_2').attr('value','');
        $('#nm_rekening_2').attr('value','');
        $('#nilkon1_2').attr('value',nkonxx);
...
function getData(no_bukti,no,tgl,nilkon,nilapbd,kdcomp,nmcomp,kdmilik,kdwilayah,kduskpd,kd_unit,jnsdana,tahunang,buktibyr,dasaroleh,nooleh,tgloleh,tahunoleh,tot,cr_oleh,no_renc,no_awas,nrek5,sts_kdp,sts_inp)
  {
    ...
    if(sts_inp=='1'){
        ...
        $('#compy').attr('value',kdcomp);
    $('#nmcompy').attr('value',nmcomp);
        $('#mlokasi').attr('value',kd_unit); 
        $('#unit').combogrid('setValue',kduskpd);
        $('#unit').combogrid('disable');
        ...
        //$('#txtnodok_h').attr('value',no);
        //$('#nomor_bukti').attr('value',no_bukti);
        $('#nomor2').attr('value',no);
        $('#nomor2').attr('disabled',true);
        $('#unit2').combogrid('disable');
        $('#tanggal2').datebox('setValue',tgl);
        $('#nilkont2').attr('value',nilkon);
        $('#nkon_hide2').attr('value',nrek5);
        $('#nkon2').attr('value',number_format(nrek5,2,'.',','));
        $('#nilapbd2').attr('value',nilapbd);
        $('#compy2').combobox('setValue',kdcomp);
        $('#mlokasi2').attr('value',kd_unit); 
        $('#unit2').combogrid('setValue',kduskpd);
        $('#dana2').combobox('setValue',jnsdana);
        $('#tahun2').combobox('setValue',tahunang);
        $('#bukti2').combobox('setValue',buktibyr);
        $('#dasar2').combobox('setValue',dasaroleh);
        $('#dsno2').attr('value',nooleh);
        $('#dstgl2').datebox('setValue',tgloleh);
        $('#thn2').combobox('setValue',tahunoleh);    
        $('#total').attr('value',number_format(tot,2,'.',','));
        $('#totbel').attr('value',number_format(tot,2,'.',','));
        $('#totbel_hide').attr('value',tot);
        $('#perolehan2').combobox('setValue',cr_oleh);
        $('#sts_kdp2').attr('value',sts_kdp);
    }
...
function getDetail(no,cjns,cnmjns,kdbrg,nmbrg,sdana,nospp,tglspp,nilspp,nilkont,kdgiat,kdrek5,jml,hrg,cppn,tot,ket,invt)
{
    kosong2();
    updt = 't';
    ...
    $("#nospp").combogrid("setValue",nospp);
    $("#tglspp").datebox("setValue",tglspp);
    $("#nilspp").attr("value",nilspp);
     ...
     $(function(){
            $('#trd').edatagrid({
                ...
                onDblClickRow:function(rowIndex,rowData){
                    ...
                    nilai_spp=number_format(rowData.nilai_spp,2,'.',',');
...
function update_detail(idx){    
    ...
    nilspp     = document.getElementById('nilspp').value;
    ...
    if(sts_inp=='1'){
     ...
     //       $('#harga').attr('value',0);
      ...
      //  }
		...
		//alert(tot_trans);
        kont    = angka(document.getElementById('nkon').value);
        jml     = angka(document.getElementById('jumlah_2').value);
        hrg     = angka(document.getElementById('harga_2').value);
        chk     = document.getElementById('ppn_2').checked;
        total   = jml * hrg;//jml * (kont/jml);//hrg ; 
        tt      = tot_trans+total;
        if (chk==true){
            totppn = total * 10/100;
...
function hitung_update(){
	...
	kont    = angka(document.getElementById('nilkon1').value); 
	//alert(kont);
    jml     = angka(document.getElementById('jumlah').value); 
	//alert(jml);
    hrg     = angka(document.getElementById('harga').value); 
    //totbel  = angka(document.getElementById('totbel_hide').value); 
	totbel  = angka(document.getElementById('nilspp').value); 
	//alert(totbel);
...
function hapus(){
      ...
      if(invent==1){
        sweetAlert("Oooppsss...!!!", "Data Sudah Di-Inventariskan dan Tidak Bisa Dihapus", "error"); //alert('Data Sudah Di-Inventariskan dan Tidak Bisa Dihapus');
        exit();
      }else{
...
function tambah_detail(){  
    ...
    var nomor = document.getElementById('nomor2').value;
        if(nomor==''){
            sweetAlert("MAAF..!!", "Nomor Dokumen Tidak Boleh Kosong....", "error");
            exit();
        }
    var jnsdana     = $('#dana2').combobox('getValue');
        if(jnsdana==''){
            sweetAlert("MAAF..!!", "Jenis Dana Tidak Boleh Kosong....", "error");
            exit();
        }
        var buktibyr    = $('#bukti2').combobox('getValue');
        if(buktibyr==''){
            sweetAlert("MAAF..!!", "Bukti Pembayaran Tidak Boleh Kosong....", "error");
            exit();
        }
        var cr_oleh     = $('#perolehan2').combobox('getValue');
        if(cr_oleh==''){
            sweetAlert("MAAF..!!", "Cara Perolehan Tidak Boleh Kosong....", "error");
            exit();
        }
        var dasaroleh   = $('#dasar2').combobox('getValue');
        if(dasaroleh==''){
            sweetAlert("MAAF..!!", "Dasar Perolehan Tidak Boleh Kosong....", "error");
            exit();
        }
        var nooleh      = document.getElementById('dsno2').value;
        if(nooleh==''){
            sweetAlert("MAAF..!!", "Nomor Perolehan Tidak Boleh Kosong....", "error");
            exit();
        }
    var skpd = $('#unit2').combogrid('getValue');
        if(skpd==''){
            sweetAlert("MAAF..!!", "Kode SKPD Tidak Boleh Kosong....", "error");
            exit();
        }
    var kdp = document.getElementById('sts_kdp2').value;
        if(kdp==''){
            sweetAlert("MAAF..!!", "Status KDP Tidak Boleh Kosong....", "error");
            exit();
        }

    $("#dialog-modal-manual").dialog('open');
    var nkonxx = document.getElementById('nilkont2').value;
    $('#nilkon1_2').attr('value',nkonxx);
    
    $('#tglad').datebox('setValue','');
    $('#nilkon1').attr('value',nilkont);
    $('#nilkon1_hide').attr('value',nilkont_hide); 
    $('#nilsp2d_2').attr('value','');
    $('#cmbjenis_2').combogrid("clear");
    $('#sbrdana').combobox('setValue',sbrdana);
    $('#nmbrg_2').attr('value','');
    $('#bidang_2').combogrid('setValue','');
    $('#nosp2d_2').attr('value','');
    $('#kegiatan_2').combogrid('setValue','');
    $('#nm_kegiatan_2').attr('value','');
    $('#jumlah_2').attr('value','');
    $('#harga_2').attr('value','');
    $('#total1_2').attr('value','');
...
function tutup(){ 
    ...
    $("#dialog-modal-manual").dialog('close');
...
function simpan(){
    ...
    if(sts_inp=='1'){
        ...
        var kdcomp      = document.getElementById('compy').value; 
		var nmcomp      = document.getElementById('nmcompy').value; 
        ...
        var kduskpd     = $('#unit').combogrid('getValue');
        var paket       = $('#paket').combogrid('getValue');  
        ...
        var no          = document.getElementById('nomor2').value; //$('#nomor').combogrid('getValue');   
        var tgl         = $('#tanggal2').datebox('getValue');  
        var nilkon      = angka(document.getElementById('nilkont2').value);  
        var nilapbd     = angka(document.getElementById('nilapbd').value);  
        var kdcomp      = $('#compy2').combobox('getValue');  
        var kdmilik     = document.getElementById('milik').value; //$('#milik').combobox('getValue');  
        var kdwilayah   = document.getElementById('wilayah').value;// $('#wilayah').combobox('getValue');  
        var kduskpd     = $('#unit2').combogrid('getValue');  
        var mlokasi     = document.getElementById('mlokasi2').value;  
        var jnsdana     = $('#dana2').combobox('getValue');  
        var tahunang    = $('#tahun2').combobox('getValue');  
        var buktibyr    = $('#bukti2').combobox('getValue');  
        var dasaroleh   = $('#dasar2').combobox('getValue');  
        var nooleh      = document.getElementById('dsno2').value;  
        var tgloleh     = $('#dstgl2').datebox('getValue');  
        var tahunoleh   = '<?php echo ($this->session->userdata('ta_simbakda')); ?>';   
        var tot         = angka(document.getElementById('total').value);     
        var cr_oleh     = $('#perolehan2').combobox('getValue');
        var nkon        = document.getElementById('nkon_hide').value;
        ...
        var no_renc     = '';//$('#nomor_rencana').combogrid('getValue');
        var no_awas     = '';//$('#nomor_awas').combogrid('getValue');
        var sts_kdp     = document.getElementById('sts_kdp2').value;
    }
  ...
  /*  if(sts_inp=='1'){
         if(sel>0){
        sweetAlert("MAAF..!!", "Nilai Transaksi aaaaaaaaaa Kurang dari Nilai Kontrak", "error");
       ...
       /*  if (no==''){
        ...
        if (kduskpd==''){
            sweetAlert("MAAF..!!", "OPD mohon diisi", "error");
            exit();
        }
    //}
        //   alert(sel);
   ...
   // $('#c_simpan').linkbutton("disable");
    ...
    $(document).ready(function(){
        $.ajax({
            type: "POST",       
            dataType : 'json',         
            data: ({tabel:'trh_isianbrg',no_bukti:no_bukti,no:no,tgl:tgl,nilkon:nilkon,nilapbd:nilapbd,kdcomp:kdcomp,nmcomp:nmcomp,kd_unit:kduskpd,kdmilik:kdmilik,kdwilayah:kdwilayah,mlokasi:mlokasi,jnsdana:jnsdana,tahunang:tahunang,buktibyr:buktibyr,dasaroleh:dasaroleh,nooleh:nooleh,tgloleh:tgloleh,tahunoleh:tahunoleh,tot:tot,cr_oleh:cr_oleh,no_renc:no_renc,no_awas:no_awas,sts_kdp:sts_kdp,sts_inp:st_inp,paket:paket}),
...
function simpan_detail_dh(){
    ...
    var rows = $('#trd').datagrid('getSelections');
        ...
        for(var i=0; i<rows.length; i++){
                ...
                no_spp     =rows[i].no_spp;
                tgl_spp    =rows[i].tgl_spp;
                nilai_spp  =angka(rows[i].nilai_spp);
                ...
                if(i>0){
                    csql = csql+","+"('"+no_bukti+"','"+no_dokumen+"','"+kd_unit+"','"+kd_uskpd+"','"+jns+"','"+nmjns+"','"+kd_bidang+"','"+cnmbidang+"','"+kd_brg+"','"+nm_brg+"','"+kd_kegiatan+"','"+nm_kegiatan+"','"+kd_rek5+"','"+nm_rek5+"','"+jumlah+"','"+harga+"','"+total+"','"+no_spp+"','"+tgl_spp+"','"+nilai_spp+"','"+keterangan+"','"+invent+"','"+ppn+"','"+cidx+"','"+s_dana+"','"+jns+"','"+nilai_kontrak+"')";
                } else {

                    csql = "values('"+no_bukti+"','"+no_dokumen+"','"+kd_unit+"','"+kd_uskpd+"','"+jns+"','"+nmjns+"','"+kd_bidang+"','"+cnmbidang+"','"+kd_brg+"','"+nm_brg+"','"+kd_kegiatan+"','"+nm_kegiatan+"','"+kd_rek5+"','"+nm_rek5+"','"+jumlah+"','"+harga+"','"+total+"','"+no_spp+"','"+tgl_spp+"','"+nilai_spp+"','"+keterangan+"','"+invent+"','"+ppn+"','"+cidx+"','"+s_dana+"','"+jns+"','"+nilai_kontrak+"')";                                            
                } 
        }
                $(document).ready(function(){
                $.ajax({
...
function append_save(){
    ...
    if(sts_inp=='1'){
        ...
        var tglspp     = $('#tglspp').datebox('getValue');    
        var nilspp     = document.getElementById('nilspp').value;    
        ...
        var no_dokumen  = document.getElementById('nomor2').value;    
        var cjns        = $('#cmbjenis_2').combobox('getValue');     
        var nmjns       = document.getElementById('nmgolongan_2').value;     
        var cbdg        = $('#bidang_2').combobox('getValue');    
        var cnmbidang   = document.getElementById('nmbidang_2').value;   
        var kdbrg       = $('#kdbarang_2').combogrid('getValue');     
        var cnmbrg      = document.getElementById('nmkelompok_2').value;     
        var nosp2d      = document.getElementById('nosp2d_2').value; //$('#nosp2d_2').combogrid('getValue');   
        //var tglsp2d     = $('#tglad').datebox('getValue');    
        //var nilsp2d     = document.getElementById('nilsp2d_2').value;    
        //var nilkont     = angka(document.getElementById('nilkon1_2').value);    
        //var kdgiat      = $('#kegiatan_2').combogrid('getValue');//document.getElementById('kegiatan_2').value;    
        //var nmkegi      = document.getElementById('nm_kegiatan_2').value;      
        //var kdrek5      = $('#rekening_2').combogrid('getValue');   
        //var nmrek5      = document.getElementById('nm_rekening_2').value;    
        var jml         = document.getElementById('jumlah_2').value;     
        var hrg         = document.getElementById('harga_2').value;         
        var tot1        = document.getElementById('total2_2').value;       
        var cppn        = document.getElementById('nilppn_2').value;          
        var tot         = angka(document.getElementById('total2_2').value);       
        var ket         = document.getElementById('ket_2').value;         
        var total       = angka(document.getElementById('total').value);   
        var kd_unit     = document.getElementById('mlokasi2').value;     
        var kd_uskpd    = $('#unit2').combogrid('getValue');     
        var sdana       = $('#dana2').combobox('getValue');      
        var invt        ='';    
        var totalseluruh=0;
        ...
        if(nospp==''){
            alert('Nomor SPP harap diisi.....');
            exit();
        }

        if(nilspp==''){
            alert('Nilai SPP harap diisi.....');
            exit();
        }

        if(tglspp==''){
            alert('Tanggal SPP harap diisi.....');
            exit();
        }

        if(nilkont==''){
            alert('Nilai Kontrak harap diisi.....');
            exit();
        }

        if(kdgiat==''){
            alert('Kode Kegiatan harap diisi.....');
            exit();
        }

        if(kdrek5==''){
            alert('Kode Rekening harap diisi.....');
            exit();
        }
    ...
    if(tot!=0){
        ...
        $('#trd').edatagrid('appendRow',{idx:pidx,nomor_bukti:no_bukti,no_dokumen:no_dokumen,jns:cjns,nm_jenis:nmjns,kd_bidang:cbdg,nm_bidang:cnmbidang,kd_brg:kdbrg,nm_brg:cnmbrg,kd_unit:kd_unit,kd_uskpd:kd_uskpd,s_dana:sdana,no_spp:nospp,tgl_spp:tglspp,nilai_spp:nilspp,nilai_kontrak:nilkont,kd_kegiatan:kdgiat,nm_kegiatan:nmkegi,kd_rek5:kdrek5,nm_rek5:nmrek5,jumlah:jml,harga:hrg,ppn:cppn,total:tot1,keterangan:ket,invent:invt});
...
function cetak(){
    ...
    var thn    = $('#thn').combogrid('getValue');
    $(function(){ 
     $('#trh').edatagrid({
        url: '<?php echo base_url(); ?>/index.php/transaksi/trh_isianbrg',
        queryParams:({cari:kriteria,cari1:thn})
        });        
     });
    } 
    ...
    function opt1(val){        
        ...
        if (ctk1==1){
            ...
            // $('#man').show();
            $('#paket').hide();
            $('#paket').combogrid("disable","disable");
        }           
    }
...
<div id="tabs" class="easyui-tabs">
    ...
    <div id="tabs-1">
        <div>
            ...
            <p align="right">
               <td>Tahun:&nbsp;<input type="text" value="" id="thn" style="width:50px;"/></td>
    ...
    <div id="tabs-2">  
        ...
        <table>
            <tr style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;">
              <td style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;" colspan="5"><b>Auto</b><input type="radio" value="1" id="status_am1" name="status_am" onclick="opt(this.value)"/><b>Manual</b><input type="radio" value="2" id="status_am2" name="status_am" onclick="opt(this.value)"/></td>
            </tr>
            <tr>
                <td>No. Bukti</td>
                <td>:</td>
                <td><input id="nomor_bukti" name="nomor_bukti" style="width: 150px;" /></td>
                 <td hidden="true" style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;border-right-style:hidden;">
    ...
    <div id="oto">
        <table align="center" border="0">
            ...
            <tr>
                <td >No. Dokumen</td>
                <td>:</td>
                <td><input type="text" id="nomor" name="nomor" style="width: 140px;" />
				<input type="hidden" id="spp" name="spp" style="width: 140px;" /><input type="hidden" id="jns_spp" name="jns_spp" style="width: 140px;" /></td>
                <td width="50px"></td>
                <td width="100px">Sumber Pendanaan</td>
                <td>:</td>
            ...
            <tr>
                ...
                <td>:</td>
                <td><input id="compy" name="compy" style="width:90px;" disabled="true"/><input id="nmcompy" name="nmcompy" style="width:200px;" disabled="true"/></td>
                <td></td>
            ...
            <tr>
                ...
                <td> <select name="milik" id="milik" style="height: 27px; width: 200px;">
                     <option value="03">KABUPATEN MAPPI</option>     
            ...
            <tr>
                <td hidden="true">PAKET</td>
                <td hidden="true">:</td>
                <!-- <td><input id="paket" name="paket" style="width: 140px;" /> </td> -->
              <td hidden="true"><input type="text" id="paket" name="paket" style="width: 140px;" /> </td>
                <td></td>
                
            </tr>
            <tr>
                <td >*Keterangan</td>
                <td colspan="6">Nilai Transaksi di SPP &nbsp;&nbsp;:&nbsp;&nbsp;
                  <input id="nkon" name="nkon" style="width: 140px;text-align: right;" disabled="true"><input type="hidden" id="nkon_hide" name="nkon_hide" style="width: 140px;text-align: right;" disabled="true">&nbsp;&nbsp;
        ...
        <table align="center" border="0">
            ...
            <tr>
                <td >No. Dokumen</td>
                <td>:</td>
                <td><input type="text" id="nomor2" name="nomor2" style="width: 200px;" /><input type="hidden" id="spp" name="spp" style="width: 140px;" /><input type="hidden" id="jns_spp" name="jns_spp" style="width: 140px;" /></td>
                <td width="50px"></td>
                <td width="100px">Jenis Dana</td>
                <td>:</td>
                <td><input type="text" id="dana2" style="width: 140px;" /></td>                
            </tr>
            <tr hidden="true">
                <td>No.Dok.Perencanaan</td>
                <td>:</td>
            ...
            <tr>       
                <td>Tanggal Dokumen</td>
                <td>:</td>
                <td><input type="text" id="tanggal2" style="width: 140px;" /></td>
                <td></td>
                <td>Tahun Anggaran</td>
                <td>:</td>
                <td><input type="text" id="tahun2" style="width: 140px;" /></td>     
            </tr>
            <tr>
                <td >Nilai Kontrak</td>
                <td>:</td>
                <td><input type="text" id="nilkont2" name="nilkont2" style="width: 140px;text-align: right;" onkeypress="return(currencyFormat(this,',','.',event))"/></td>
                <td></td>
                <td >Bukti Pembayaran</td>
                <td>:</td>
                <td><input type="text" id="bukti2" style="width: 140px;" /></td> 
            </tr>
            <tr>
                <td>Sisa Pagu APBD</td> 
                <td>:</td>
                <td><input type="text" id="nilapbd2" name="nilapbd2" style="width: 140px;text-align: right;"  readonly/></td>
                <td></td>
                <td >Cara Perolehan</td>
                <td>:</td>
                <td><input type="text" id="perolehan2" style="width: 140px;" /></td>
                                               
            </tr>       
            <tr>
                <td>Perusahaan/Rekanan</td>
                <td>:</td>
                <td><input id="compy2" name="compy2" style="width: 140px;" value="" />  </td>
                <td></td>
                <td >Dasar Perolehan</td>
                <td>:</td>
                <td><input type="text" id="dasar2" style="width: 140px;" /></td>  
            ...
            <tr>
                ...
                <td>&nbsp;&nbsp;&nbsp;&nbsp;a.Nomor</td>
                <td>:</td>
                <td><input type="text" id="dsno2" style="width: 140px;" /></td>    
            ...
            <tr>
                ...
                <td>&nbsp;&nbsp;&nbsp;&nbsp;b.Tanggal</td>
                <td>:</td>
                <td><input type="text" id="dstgl2" style="width: 140px;" /></td>
            ...
            <tr>
                ...
                <td >Status KDP</td>
                <td >:</td>
                <td ><select name="sts_kdp2" id="sts_kdp2" style="height: 27px; width: 140px;">
                     <option value="">-----</option>
                     <option value="K">KDP</option> 
                     <option value="B">Bukan KDP</option>
                     <option value="L">Pencairan Lanjutan KDP</option>     
            ...
            <tr>
                <td>OPD</td>
                <td>:</td>
                <td><input id="unit2" name="unit2" style="width: 140px;" value=""/> </td>
                <td></td>
                <td  colspan="3"><input id="nmunit2" name="nmunit2" style="width: 350px; border:0;" readonly="true" value=""/>
                </td>
                <td  hidden="true">:</td>
                <!--td  hidden="true"><input type="text" id="thn2" style="width: 140px;" /></td-->
            </tr>
            <tr>
                <td>Unit Kerja</td>
                <td>:</td>
                <td><input id="mlokasi2" name="mlokasi2" style="width: 350px; border:0;" readonly="true" value=""/> </td>
                <td></td>
                <td  colspan="3">
                <input id="nmlokasi2" name="nmlokasi2" style="width: 350px; border:0;" readonly="true" value=""/></td>
                <td  hidden="true">:</td>
                <!--td  hidden="true"><input type="text" id="thn2" style="width: 140px;" /></td-->
            </tr>
            <tr>
                ...
                <td colspan="6">Nilai Transaksi di SPP &nbsp;&nbsp;:&nbsp;&nbsp;
                  <input id="nkon" name="nkon" style="width: 140px;text-align: right;" disabled="true"><input type="hidden" id="nkon_hide" name="nkon_hide" style="width: 140px;text-align: right;" disabled="true">&nbsp;&nbsp;
                    Total Transaksi &nbsp;&nbsp;:&nbsp;&nbsp;<input id="totbel2" name="totbel2" style="width: 140px;text-align: right;" disabled="true"><input type="hidden" id="totbel_hide" name="totbel_hide" style="width: 140px;text-align: right;" disabled="true"></td>
            </tr>
        </table>
        </div> 
        <br />
    ...
    <fieldset title="Bukti / SPP">
        <table>
            ...
            <tr>
                <td>No. SPP</td>
                <td>:</td>
                <td><input type="text" id="nospp" name="nospp" style="width: 200px;"/></td>
            </tr>
            <tr>
                <td>Tanggal SPP</td>
                <td>:</td>
                <td><input type="text" id="tglspp" style="width: 140px;"/></td>
            </tr>            
            <tr>
                <td>Nilai SPP</td>
                <td>:</td>
                <td><input type="text" id="nilspp" name="nilspp" style="width: 140px;text-align:right;" readonly="true"  /><input type="hidden" id="nilspp_hide" name="nilspp_hide" style="width: 140px;text-align:right;" readonly="true"  /></td>
...
<div id="dialog-modal-aaa" title="MOHON TUNGGU SEBENTAR">
    ...
    <div id="dialog-modal-manual" title="Input Barang" >
    <p class="validateTips" >Semua Inputan Harus Di Isi.</p>     
    <fieldset title="Spesifikasi Barang" >    
        <table>
            <tr>
                <td>Golongan Barang</td>
                <td>:</td>
                <td><input id="cmbjenis_2" name="cmbjenis_2" style="width: 200px;" />&nbsp;&nbsp;<input type="text" id="nmgolongan_2" name="nmgolongan_2" style="width: 200px;border: 0;" readonly="true"/></td>
            </tr>
            <tr>
                <td>Bidang Barang</td>
                <td>:</td>
                <td><input  id="bidang_2" name="bidang_2" style="width: 200px;" />&nbsp;&nbsp;<input type="text" id="nmbidang_2" name="nmbidang_2" style="width: 200px;border: 0;" readonly="true"/></td>
            </tr>
            <tr>
                <td>Kode Barang</td>
                <td>:</td>
                <td><input  id="kdbarang_2" name="kdbarang_2" style="width: 200px;" />&nbsp;&nbsp;<input type="text" id="nmkelompok_2" name="nmkelompok_2" style="width: 300px;border: 0;" readonly="true"/></td>
            </tr>
    ...
    <fieldset title="Bukti / SP2D">
        <table>
            <tr hidden="true">
                <td>Sumber Dana</td>
                <td>:</td>
                <td><input type="text" id="sbrdana" style="width: 140px;" disabled/></td>
            </tr>
            <tr>
                <td>No. SP2D</td>
                <td>:</td>
                <td><input type="text" id="nosp2d_2" name="nosp2d_2" style="width: 200px;" disabled/></td>
            </tr>
            <tr>
                <td>Tanggal SP2D</td>
                <td>:</td>
                <td><input type="text" id="tglsp2d_2" style="width: 140px;" disabled/></td>
            </tr>            
            <tr>
                <td>Nilai SP2D</td>
                <td>:</td>
                <td><input type="text" id="nilsp2d_2" name="nilsp2d_2" style="width: 140px;text-align:right;" onkeypress="return(currencyFormat(this,',','.',event))" disabled/></td>
                <td>Nilai Kontrak &nbsp; :&nbsp;&nbsp;<input type="text" id="nilkon1_2" name="nilkon1_2" style="width: 140px;text-align:right;" onkeypress="return(currencyFormat(this,',','.',event))" disabled/></td>
            </tr>
            <tr>
                <td>Kegiatan</td>
                <td>:</td>
                <td><input type="text" id="kegiatan_2" name="kegiatan_2" style="width: 200px;" disabled /></td>
                <td><input type="text" id="nm_kegiatan_2" name="nm_kegiatan_2" style="width: 300px;border:0;" readonly="true" /></td>
            </tr>
            <tr>
                <td>Rekening</td>
                <td>:</td>
                <td><input type="text" id="rekening_2" name="rekening_2" style="width: 200px;" readonly="true" disabled/></td>
                <td><input type="text" id="nm_rekening_2" name="nm_rekening_2" style="width: 300px;border:0;" readonly="true" /></td>
            </tr>
        </table>
    </fieldset>
    <fieldset title="Keterangan Barang">
        <table>
            <tr>
                <td>Jumlah</td>
                <td>:</td>
                <td><input type="text" id="jumlah_2" style="width: 140px;text-align: right;" onclick="javascript:select();" onkeyup="hitung();" />&nbsp;&nbsp;&nbsp;
                    <a class="easyui-linkbutton" iconCls="calculator.png" plain="false" onclick="javascript:hitung_update();">Hitung</a>
                </td>
            </tr>
            <tr>
                <td>Harga Satuan</td>
                <td>:</td>
                <td><input type="text" id="harga_2" style="width: 140px;text-align: right;" onkeyup="hitung();" onkeypress="return(currencyFormat(this,',','.',event))" /></td>
            </tr>
            <tr>
                <td hidden="true">Total Harga</td>
                <td hidden="true">:</td>
                <td hidden="true"><input type="text" id="total1_2" style="width: 140px;text-align: right;"  readonly="true"/></td>
            </tr>
            <tr>
                <td hidden="true">PPN&nbsp;&nbsp;&nbsp;<input type="checkbox" id="ppn_2" onclick="hitung();" /></td>
                <td hidden="true">:</td>
                <td hidden="true"><input type="text" id="nilppn_2" style="width: 140px;text-align: right;" readonly="true"/></td>
            </tr>
            <tr>
                <td>Total</td>
                <td>:</td>
                <td><input type="text" id="total2_2" style="width: 140px;text-align: right;" readonly="true"/></td>
            </tr>
            <tr>
                <td>Tanggal Pengadaan</td>
                <td>:</td>
                <td><input type="text" id="tglad" style="width: 140px;" /></td>
            </tr>   
            <tr>
                <td>Keterangan</td>
                <td>:</td>
                <td><textarea id="ket_2" style="width: 450px; height: 40px;"></textarea></td>
            </tr>
        </table>
    </fieldset>
    <fieldset>
