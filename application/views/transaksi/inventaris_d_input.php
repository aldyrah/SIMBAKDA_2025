...
<script type="text/javascript">
    ...
    var no_urut=0;
     ...
     $(function(){
      ...
      bidang      = rowData.kd_bidang;
           get(no_dokumen,kd_brg,kd_unit,kd_uskpd,nm_brg,jumlah,harga,total,keterangan,s_dana,kd_milik,kd_wilayah,b_dasar,b_nomor,tahun,b_tanggal,kd_cr_oleh,kdgol,bidang);
           //lutji();
  ...
  $('#kdbrg').combogrid({
    ...
    $('#skpd').combogrid({  
     ...
     $('#dg').edatagrid({
        ...
        onDblClickRow:function(rowIndex,rowData){
          ...
          get1(id_barang,noreg,no,no_oleh,tgl_reg,tgl_oleh,nodok,kdbrg,detail_brg,kd_tnh,kondi,sta_thn,pj,ls,lb,perolehan,dsr,tahun,jumlah,ket,nilai,nilai_baru,kd_skpd,kd_unit,milik,wilayah,penggunaan,konstruksi,alamat1,alamat2,alamat3,foto,foto2,foto3,metode,masa_manfaat,nilai_sisa,lat,lon,kdgol,bidang,nmbrg);
    ...
    function get(no_dokumen,kd_brg,kd_unit,kd_uskpd,nm_brg,jumlah,harga,total,keterangan,s_dana,kd_milik,kd_wilayah,b_dasar,b_nomor,tahun,b_tanggal,kd_cr_oleh,kdgol,bidang){
    ...
    function get1(id_barang,noreg,no,no_oleh,tgl_reg,tgl_oleh,nodok,kdbrg,detail_brg,kd_tnh,kondi,sta_thn,pj,ls,lb,perolehan,dsr,tahun,jumlah,ket,nilai,nilai_baru,kd_skpd,kd_unit,milik,wilayah,penggunaan,konstruksi,alamat1,alamat2,alamat3,foto,foto2,foto3,metode,masa_manfaat,nilai_sisa,lat,lon,kdgol,bidang,nmbrg){ //get1(id_barang,noreg,no,no_oleh,tgl_reg,tgl_oleh,nodok,kdbrg,detail_brg,kd_tnh,kondi,sta_thn,pj,ls,lb,perolehan,dsr,tahun,jumlah,ket,nilai,nilai_baru,kd_unit,milik,wilayah,penggunaan,konstruksi,alamat1,alamat2,alamat3,foto,foto2,foto3,metode,masa_manfaat,nilai_sisa,lat,lon){
           ...
           $("#lon").attr("value",lon);
           $("#gol").attr("value",kdgol);
           $("#bida").combogrid("setValue",bidang);
               ...
               <td width="50%" valign="top">
                    <table align="left" style="width:100%;" border="0">
                       ...
                       <tr>
                            <td>No Dokumen</td>
                            <td>:</td>
                            <td><input id="nodok" name="nodok" style="width:250px;" disabled="true"/></td>
                       </tr>
						<tr>
