...
<script type="text/javascript">
    ...
    url: '<?php echo base_url(); ?>index.php/transaksi/ambil_kib_e_kap',
      ...
      get1(no_bukti,tgl_kap,no_reg,id_barang,no,tgl_reg,no_dokumen,bidang,nm_bidang,kd_brg,nm_brg,nilai,total,judul,spesifikasi,asal,cipta,tahun_terbit,penerbit,kd_bahan,jenis,tipe,kd_satuan,jumlah,kondisi,keterangan,kd_lokasi2,kd_ruang,kd_skpd,kd_unit,no_mutasi,no_pindah,no_hapus,tahun,tgl_sp2d,foto,no_urut,metode,masa_manfaat,nilai_sisa,tgl_perolehan,hrg_perolehan,tmbh_manfaat,ket_kap,total_oleh_kap,jns_trans,sts_reklas);  
      load_detail(no_bukti,kd_skpd);
            ...
            columns:[[  
             ...
             onSelect:function(rowIndex,rowData){
                ...
                if(lcstatus =='tambah'){
                  ...
                  $('#tahun').attr('value','');
                  $('#alamat1').attr('value','');
                  $('#kib').combogrid({url:'<?php echo base_url(); ?>index.php/transaksi/kib_e_kap',
...
<h3><a href="#" id="section1"><i>LIST KAPITALISASI KIB E</i></a></h3>
    <div>
      <p align="left">
    ...
    <p align="center">
      <table align="center" id="dg" title="LIST KAPITALISASI KIB E" style="width:940px;height:350px;" >  
        </table>
    </p>
    </div> 

<h3><a href="#" id="section2"><i>INPUT KAPITALISASI KIB E</i></a></h3>
<div >
