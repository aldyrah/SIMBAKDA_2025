        ...
        if (skpd_lama == ''){
         ...
         $(document).ready(function(){
            $.ajax({
                type: "POST",       
                dataType : 'json',         
                data: ({tabel:'trh_penghapusan',no_hapus:cno_urut,tanggal:ctgl_hps,skpdb:skpd_baru,unitb:unit_baru,cuskpd:skpd_lama,unit_lama:unit_lama,ket:cket,no_bukti:no_bukti,jenis:cjenis}),
    ...
    <div id="tabs-1">
        <div>
            <p align="right">
                ...
                <input id="txtcari" class="easyui-searchbox" 
