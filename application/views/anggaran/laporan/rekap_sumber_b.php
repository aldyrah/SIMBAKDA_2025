...
$(function(){ 
	...
	{   var ttdd = $('#ttd').combogrid("getValue");
		...
		var ANGG = document.getElementById('ANGG').value;
	
		//var space = document.getElementById('space').value;
		if(ctk=='1'){
			var url    = "<?php echo site_url(); ?>/rka/rekap_sumber_b/1/";  
			lc= '';
		
		}else if(ctk=='2'){
			var url    = "<?php echo site_url(); ?>/rka/rekap_sumber_bl_btl/1/";  
			lc= '';
		}else if(ctk=='3'){
			var url    = "<?php echo site_url(); ?>/rka/rekap_reali_spd2/1/";  
			lc= '?angg='+ANGG;
		}else if(ctk=='4'){
			var url    = "<?php echo site_url(); ?>/rka/rekap_reali_spd2/2/";  
			lc= '?bulan='+bulan+'&angg='+ANGG;
		}else if(ctk=='5'){
			var url    = "<?php echo site_url(); ?>/rka/preview_real_spd_baru/1/";  
			lc= '?tgl1='+tgl1+'&tgl2='+tgl2+'&angg='+ANGG;
		}else if(ctk=='6'){
			var url    = "<?php echo site_url(); ?>/rka/preview_real_sp2d_cair/1/";  
			lc= '';
			}else if(ctk=='7'){
			var url    = "<?php echo site_url(); ?>/rka/rekap_dpal/1/";  
			lc= '';
		}
	...
	{   var ttdd = $('#ttd').combogrid("getValue");
		...
		//var space = document.getElementById('space').value;
		if(ctk=='1'){
			var url    = "<?php echo site_url(); ?>/rka/rekap_sumber_b/2/";  
			lc= '';
		
		}else if(ctk=='2'){
			var url    = "<?php echo site_url(); ?>/rka/rekap_sumber_bl_btl/2/";  
			lc= '';
			...
			var url    = "<?php echo site_url(); ?>/rka/preview_real_spd_baru/2/";  
			lc= '?tgl1='+tgl1+'&tgl2='+tgl2+'&angg='+ANGG;	
		}else if(ctk=='6'){
			var url    = "<?php echo site_url(); ?>/rka/preview_real_sp2d_cair/2/";  
			lc= '';
			
			}else if(ctk=='7'){
			var url    = "<?php echo site_url(); ?>/rka/rekap_dpal/2/";  
			lc= '';
...
<h5 align="center"><b><a href="#" id="section1">LAPORAN - LAPORAN</a></b></h5>
 ...
 <fieldset>
     <table align="center" style="width:100%;" border="0">
			<tr>
			  <td width="99%" align="left"><input type="radio" name="cetak" value="1" onclick="opt(this.value)" />
			  &nbsp;REKAP SUMBER DANA</td>
			  <td width="1%" align="left">&nbsp;</td>
			</tr>
<tr><td width="99%" align="left"><input type="radio" name="cetak" value="2" onclick="opt(this.value)" />
			  &nbsp;REKAP BL &amp; BTL  PER SKPD</td>
			  <td width="1%" align="left">&nbsp;</td>
			</tr>
            
        <tr><td width="99%" align="left"><input type="radio" name="cetak" value="3" onclick="opt(this.value)" />
			  &nbsp;REALISASI SPD PER SUMBER DANA BL & BTL</td>
			  <td width="1%" align="left">&nbsp;</td>
			</tr>    
             <tr><td width="99%" align="left"><input type="radio" name="cetak" value="4" onclick="opt(this.value)" />
			  &nbsp;REALISASI ANGGARAN TERHADAP SPD SUMBER DANA</td>
			  <td width="1%" align="left">&nbsp;</td>
			</tr>    
                         <tr><td width="99%" align="left"><input type="radio" name="cetak" value="5" onclick="opt(this.value)" />
			  &nbsp;REALISASI ANGGARAN TERHADAP SPD </td>
			  <td width="1%" align="left">&nbsp;</td>
			</tr> 
				<tr><td width="99%" align="left"><input type="radio" name="cetak" value="6" onclick="opt(this.value)" />
			  &nbsp;REALISASI REALISASI SP2D PER PROGRAM, KEGIATAN </td>
			  <td width="1%" align="left">&nbsp;</td>
			</tr>    			
            
            	<tr><td width="99%" align="left"><input type="radio" name="cetak" value="7" onclick="opt(this.value)" />
			  &nbsp;REKAP DPAL </td>
			  <td width="1%" align="left">&nbsp;</td>
			</tr>    			
...
<div id="div_ptd">
		 ...
		 <div id="div_ttd">
		  ...
		  <div id="div_nilai">
			<table style="width:100%;" border="0">
				<td width="20%" style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;">&nbsp;ANGGARAN</td>
				<td width="1%" style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;">:</td>
				<td width="79%" style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;"><select  name="ANGG" id="ANGG" >
							 <option value="">...... </option>
