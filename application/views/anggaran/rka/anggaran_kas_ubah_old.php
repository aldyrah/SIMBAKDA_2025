     ...
     $(document).ready(function() {
      ...
      $(function(){  
            $('#ck').combogrid({  
                ...
                mode:'remote',
                url:'<?php echo base_url(); ?>index.php/rka/load_giatx',  
                columns:[[  
     ...
     function giat(kode){
          $(function(){  
            $('#ck').combogrid({  
                ...
                textField:'kd_kegiatan',  
                mode:'remote',
                url:'<?php echo base_url(); ?>index.php/rka/load_giatx/'+kode,
                onSelect:function(rowIndex,rowData){
        ...
        if(skpdx==''){
			...
			$(function(){      
			 $.ajax({
				...
				dataType:"json",
				url:"<?php echo base_url(); ?>index.php/rka/simpan_trskpd_all_ubah",
				success:function(data){
					if (data = 1){
        ...
        if(skpdx==''){
			...
			$(function(){      
			 $.ajax({
				...
				data: ({csts:'susun',cskpd:skpdx}),
				dataType:"json",
				url:"<?php echo base_url(); ?>index.php/rka/simpan_trskpd_four_ubah",
				success:function(data){
					if (data = 1){
						alert('Data Berhasil di Proses...!!!');
					}else{
