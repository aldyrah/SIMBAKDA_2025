<script>
    ...
    $(document).ready(function(){
        $(".link").click(function (){
            ...
            var cetakan5 = "<?php echo site_url(); ?>/rka/preview_perda1pdf_rinci2a";
            var cetakan6 = "<?php echo site_url(); ?>/rka/PEGAWAI";
            var cetakan7 = "<?php echo site_url(); ?>/rka/DANAPENYESUAIAN";
            var cetakan8 = "<?php echo site_url(); ?>/rka/PEMBIAYAAN";
                             var cetakan9 = "<?php echo site_url(); ?>/rka/menteri";
            var halaman  = $("#hal").val();
            var cek = "";
            if($("#ttd").is(":checked")){
                cek = "y";
            ...
            if(cetakan=="1"){
                ...
                $(this).attr("href", cetakan5 + "/" + halaman + "/" + 1);
            }else if(cetakan=="6"){
                $(this).attr("href", cetakan5 + "/" + halaman + "/" + 2);
            }else if(cetakan=="7"){
                $(this).attr("href", cetakan6 + "/" + halaman + "/" + 1);
            }else if(cetakan=="8"){
                $(this).attr("href", cetakan6 + "/" + halaman + "/" + 2);
            }else if(cetakan=="9"){
                $(this).attr("href", cetakan7 + "/" + halaman + "/" + 1);
            }else if(cetakan=="10"){
                $(this).attr("href", cetakan7 + "/" + halaman + "/" + 2);
                
                }else if(cetakan=="11"){
                $(this).attr("href", cetakan8 + "/" + halaman + "/" + 1);
            }else if(cetakan=="12"){
                $(this).attr("href", cetakan8 + "/" + halaman + "/" + 2);
                 }else if(cetakan=="13"){
                $(this).attr("href", cetakan9 + "/" + halaman + "/" + 1);
            }else if(cetakan=="14"){
                $(this).attr("href", cetakan9 + "/" + halaman + "/" + 2);
            }else{
   ...
   <h1>
     <center>   <?php echo $page_title; ?></center><hr>
        ...
        <table style="width: 100%">
            ...
            <tr>
                <td>
                     cetak Lampiran - Rincian 2A
                    <a class="link" name ="5" href="" target='_blank'>
                        <img src="<?php echo base_url(); ?>assets/images/icon/print_pdf.png" width="25" height="23" title="cetak"/></a>
                     <a class="link" name ="6" href="" target='_blank'>
                        <img src="<?php echo base_url(); ?>assets/images/icon/excel.jpg" width="25" height="23" title="cetak"/></a>
                </td>
                <TD>
                     PEGAWAI
                    <a class="link" name ="7" href="" target='_blank'>
                        <img src="<?php echo base_url(); ?>assets/images/icon/print_pdf.png" width="25" height="23" title="cetak"/></a>
                     <a class="link" name ="8" href="" target='_blank'>
                        <img src="<?php echo base_url(); ?>assets/images/icon/excel.jpg" width="25" height="23" title="cetak"/></a>
            ...
            <tr>
                <td>
                     DANA PENYESUAIAN
                    <a class="link" name ="9" href="" target='_blank'>
                        <img src="<?php echo base_url(); ?>assets/images/icon/print_pdf.png" width="25" height="23" title="cetak"/></a>
                     <a class="link" name ="10" href="" target='_blank'>
                        <img src="<?php echo base_url(); ?>assets/images/icon/excel.jpg" width="25" height="23" title="cetak"/></a>
                </td>
                <TD>
                     PEMBIAYAAN
                    <a class="link" name ="11" href="" target='_blank'>
                        <img src="<?php echo base_url(); ?>assets/images/icon/print_pdf.png" width="25" height="23" title="cetak"/></a>
                     <a class="link" name ="12" href="" target='_blank'>
                        <img src="<?php echo base_url(); ?>assets/images/icon/excel.jpg" width="25" height="23" title="cetak"/></a>
              ...
              <tr>
                <td>
                     DANA ringkasan belanja
                    <a class="link" name ="13" href="" target='_blank'>
                        <img src="<?php echo base_url(); ?>assets/images/icon/print_pdf.png" width="25" height="23" title="cetak"/></a>
                     <a class="link" name ="14" href="" target='_blank'>
                        <img src="<?php echo base_url(); ?>assets/images/icon/excel.jpg" width="25" height="23" title="cetak"/></a>
                </td>
                <TD>
