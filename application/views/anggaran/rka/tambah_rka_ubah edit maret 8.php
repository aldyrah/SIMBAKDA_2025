...
<h3><a href="#" id="section2">Rincian Rekening Perubahan</a></h3>
    ...
    <div>
        ...
        <tr style="border-style: hidden;">
			...
			<B>Total</B>&nbsp;&nbsp;&nbsp;&nbsp;<input class="right" type="text" name="rektotal_rinci" id="rektotal_rinci"  style="width:130px" align="right" readonly="true" />&nbsp;&nbsp;<input class="right" type="text" name="rektotal_rinci_ubah" id="rektotal_rinci_ubah"  style="width:130px" align="right" readonly="true" />
            <input class="right" type="hidden" name="nreal" id="nreal"  style="width:130px" align="right" readonly="true" />
