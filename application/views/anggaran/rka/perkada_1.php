<script>
    ...
    $(document).ready(function(){
        $(".link").click(function (){
            ...
            var halaman  = $("#hal").val();
			if(cetakan=="1"){
				$(this).attr("href", cetakan1 + "/" + halaman + "/" + 1 + "/" + 2);
			}else if(cetakan=="2"){
				$(this).attr("href", cetakan2 + "/" + halaman + "/" + 2 + "/" + 2);
			}else if(cetakan=="3"){
				$(this).attr("href", cetakan3 + "/" + halaman + "/" + 1 + "/" + 2);
			}else if(cetakan=="4"){
				$(this).attr("href", cetakan4 + "/" + halaman + "/" + 2 + "/" + 2);
			}else{
				 $(this).attr("href", cetakan + "/" + halaman + "/" + 2);
			}
            //return false;
        });
    });
