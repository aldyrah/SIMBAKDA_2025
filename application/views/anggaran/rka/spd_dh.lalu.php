...
<head>
  ...
  function validate_giat(){ 
    ...
    var sdana = $('#sdana').combogrid('getValue');//document.getElementById('sdana').value; 
   ...
   <p>       
        <table align="center" border='1' style="width:870px;">
            ...
            <tr style="border-bottom-style:hidden;padding:3px;border-spacing:5px 5px 5px 5px;">
                ...
                <td style="border-bottom-style:hidden;padding:3px;border-spacing:5px 5px 5px 5px;">&nbsp;<input type="text" id="sdana" style="width: 180px;"/></td>
            </tr>            
            <tr style="border-bottom-style:hidden;padding:3px;border-spacing:5px 5px 5px 5px;">
            ...
            <tr style="padding:3px;border-spacing:5px 5px 5px 5px;">
                <td style="padding:3px;border-spacing:5px 5px 5px 5px;border-bottom-style:hidden;" colspan="5" align="right"><a class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="javascript:kosong();">Tambah</a>
		            ...
		            <a class="easyui-linkbutton" id="hapus" iconCls="icon-remove" plain="true" onclick="javascript:passwd();">Hapus</a>
        ...
        <div id="toolbar" align="right">
			   		...
			   		<a class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="javascript:tambah();">Tambah Detail</a>
            <a class="easyui-linkbutton" iconCls="icon-remove" plain="true" onclick="javascript:hapus_giat();">Hapus Detail</a>
...
<div id="dialog-modal" title="Input Detail">
    ...
    <table border="0">
        ...
        <tr> 
           ...
           <td>:</td>
           <td colspan="3"><input type="text" id="anggaran_ubah" style="text-align: right;" readonly="true" style="border:0;width: 400px;"/><input type="hidden" id="anggaran" style="text-align: right;" readonly="true" style="border:0;width: 400px;"/></td>
        </tr>
        <tr> 
        ...
        <tr> 
           ...
           <td>:</td>
           <td colspan="3"><input type="text" id="sisa" style="text-align: right;" readonly="true" style="border:0;width: 400px;"/></td>
        </tr>
        <tr> 
           <td width="30%">Nilai</td>
           <td>:</td>
           <td colspan="3"><input type="text" id="nilai" style="text-align: right;" onkeyup="javascript:sisa_spd();" /></td>
        </tr>
        <tr> 
           <td width="30%">Selisih</td>
           <td>:</td>
           <td colspan="3"><input type="text" id="selisih" readonly="true" style="text-align: right;" onkeyup="javascript:sisa_spd();" /></td>
        </tr>
    </table>  
    </fieldset>
    <fieldset>
