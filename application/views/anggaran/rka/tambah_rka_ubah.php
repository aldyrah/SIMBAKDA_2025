    ...
    $(function(){
		...
		$(function(){      
         $.ajax({
            type: 'POST',
            data:({skpd:kode}),
            url:"<?php echo base_url(); ?>index.php/rka/load_sum_skpd_ms_ubah",
            dataType:"json",
      ...
      function(data){
        ...
        function simpan(baru,lama,nilai,sdana){		
    		...
    		if (lama==''){
    			...
    			$(function(){
    				$('#dg').edatagrid({
    				     url: '<?php echo base_url(); ?>/index.php/rka/tsimpan_tn/'+cskpd+'/'+cgiat+'/'+baru+'/'+lama+'/'+nilai+'/'+sdana,
    					 idField:'id',
    					 toolbar:"#toolbar",              
    					 rownumbers:"true", 
    					 fitColumns:"true",
        ...
        $(function(){
			...
			$('#dg1').edatagrid({
				...
				columns:[[
                    ...
                    {field:'volume1',title:'V ',width:35,align:'right'},
                    {field:'satuan1',title:'S ',width:50,align:'center'},
					{field:'volume',title:'T-VL',width:35,align:'center'},
					{field:'harga1',title:'Harga',width:90,align:'right'},
				    ...
				    {field:'volume_ubah',title:'T-VL Ubah',width:35,align:'center'},
...
exit();
            ...
            $('#dg1').edatagrid('updateRow',{index: idx_ins_edit,row:{uraian:uraian_edit,volume_ubah1:vol1_edit,satuan_ubah1:sat1_edit,volume_ubah:tvol_edit,harga_ubah1:fharga_edit,total_ubah:ftotal_edit}});
            $("#dg1").datagrid("unselectAll");
  ...
  function detsimpan(){    
       ...
       if(again1x < 0){
        alert("Nilai Perubahan Tidak Boleh Lebih Kecil Dari Yang Telah Direalisasikan Senilai "+nilaireal+" ...!!!!");
         exit();
       }

       if(xxx < 0){
        alert("Nilai Perubahan Senilai "+cekkk+" Tidak Boleh Lebih Kecil Dari Yang Telah Direalisasikan Senilai "+nilaireal+" ...!!!!");
         exit();
       }
        ...
        for(var i=0;i<rows.length;i++){     
			...
			//no_po,no_trdrka,uraian,volume1,satuan1,tvolume,harga1,total,volume_ubah1,satuan_ubah1,tvolume_ubah,harga_ubah1,total_ubah
        } 
		 $.ajax({
			type: "POST",
			url: '<?php echo base_url(); ?>/index.php/rka/tsimpan_rinci_toni2',
   ...
   function detsimpan_ubah(){    
        ...
        for(var i=0;i<rows.length;i++){     
		 ...
		 $.ajax({
			type: "POST",
			url: '<?php echo base_url(); ?>/index.php/rka/tsimpan_rinci_toni_ubah',
			data: ({no:norka,sql:csql,skpd:cskpd,giat:cgiat}),
			dataType:"json",
			success:function(data){    
				status = data.pesan;  
   ...
   var cgiat = document.getElementById('giat').value;
    ...
    function append_save() {
       ...
       var cek_sel=angka(document.getElementById('nilkeg').value);   
			...
			$('#dg1').edatagrid('appendRow',{id:id,uraian:uraian,volume1:'',satuan1:'',volume:'',harga1:'',total:'',volume_ubah1:vol1,satuan_ubah1:sat1,volume_ubah:tvol,harga_ubah1:fharga,total_ubah:ftotal});
            $("#dg1").datagrid("unselectAll");
    ...
    function kosong(){
        ...
        var keg = $('#kdgiat').combogrid("getValue");
            ...
            var url    = "<?php echo site_url(); ?>/rka/preview_rka221_ubah/";  
            //lc= '?skpd='+skpd+'&keg='+keg;
    ...
    function cetak2(){
        ...
        var keg = $('#kdgiat').combogrid("getValue");
            ...
            var url    = "<?php echo site_url(); ?>/rka/preview_dppa221/";  
            //lc= skpd/keg/1;
            window.open(url+skpd+'/'+keg+'/'+1, '_blank');
            window.focus();
    }
   ...
   <div  style="height:700px;">      
       ...
       <table id="dg" title="Input Rekening Rencana Kegiatan Anggaran Perubahan" style="width:880px;height:400px;" >          
        ...
        <div id="toolbarx">
			...
			<td align="left">
                    <button id="print" class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:cetak()">Cetak RKA UBAH</button>&nbsp;&nbsp;&nbsp;&nbsp;
                    <button id="print" class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:cetak2()">Cetak DPPA</button>
            </td >
...
<h3><a href="#" id="section2">Rincian Rekening Perubahan</a></h3>
    ...
    <div>
        ...
        <tr style="border-spacing:3px ;padding:3px 3px 3px 3px;border-collapse:collapse;border-bottom-style:hidden;">
            <td colspan='4' style="border-spacing:3px ;padding:3px 3px 3px 3px;border-collapse:collapse;border-bottom-style:hidden;"><input type="hidden" id="noid" style="width: 200px;" /><input type="hidden" id="nopo" style="width: 200px;" /><input type="hidden" id="reke" style="width: 200px;" /></td>
        </tr>
        <tr style="border-spacing:3px ;padding:3px 3px 3px 3px;border-collapse:collapse;border-bottom-style:hidden;">
			...
			<td style="border-bottom-style:hidden; border-spacing:3px ;padding:3px 3px 3px 3px;border-collapse:collapse;" colspan="3"><input type="text" id="uraian" style="width: 800px;" onkeypress="javascript:enter(event.keyCode,'vol1');"/></td>
        </tr>
        <tr style="border-spacing:3px ;padding:3px 3px 3px 3px;border-collapse:collapse;border-bottom-style:hidden;">
        ...
        <tr style="border-spacing:3px ;padding:3px 3px 3px 3px;border-collapse:collapse;">
            ...
            <td style="border-spacing:3px ;padding:3px 3px 3px 3px;border-bottom-color:black;" width="620px"><input type="text" id="harga" style="width: 175px; text-align: right;"  onkeypress="javascript:enter(event.keyCode,'uraian');return(currencyFormat(this,',','.',event))"/>
            </td>
        </tr>   
        </table>
...
<div id="dialog-modal-edit" title="Edit Rincian Rekening">
    ...
    <table border='0' style="width:800px;">
        ...
        <tr>
			<td>Uraian&nbsp;&nbsp;&nbsp;</td>
			<td colspan="3"><input type="text" id="uraian_edit" style="width: 800px;" onkeypress="javascript:enter(event.keyCode,'vol1_edit');"/></td>
        </tr>
        <tr>
            <td></td>
        ...
        <tr>
            <td></td>
            <td style="width: 90px;"><input type="text" id="vol1_edit" style="width: 90px;" onkeypress="javascript:enter(event.keyCode,'sat1_edit');"/></td>
            ...
            <td style="width: 620px;"><input type="text" id="harga_edit" style="width: 175px; text-align: right;"  onkeypress="javascript:doSomething(this, event); return(currencyFormat(this,',','.',event))"/>
            </td>
        </tr>  
