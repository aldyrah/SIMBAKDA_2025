<script>
	...
	$(".link").click(function (){
			...
			var skpd = a;
			var cetak ="1";
			var cetakan1 = "<?php echo site_url(); ?>/rka/preview_dpa221dh";
	...
	<div id="content">        
    	<h1>
			<?php echo $page_title; ?><span><a href="<?php echo site_url(); ?>/rka/dpa221">Kembali</a></span>
        ...
        <table class="narrow">
            ...
            <tr>
                ...
                <td><a href="<?php echo site_url(); ?>/rka/preview_dpa221/<?php echo $kegiatan->kd_skpd; ?>/<?php echo $kegiatan->giat; ?>/<?php echo '1';?>"target='_blank'><img src="<?php echo base_url(); ?>assets/images/icon/print_pdf.png" width="25" height="23" title="cetak"/></a></td>
                <td><a href="<?php echo site_url(); ?>/rka/preview_dpa221/<?php echo $kegiatan->kd_skpd; ?>/<?php echo $kegiatan->giat; ?>/<?php echo '2';?>"><img src="<?php echo base_url(); ?>assets/images/icon/excel.jpg" width="25" height="23" title="cetak"/></a></td>
            </tr>
            <?php endforeach; ?>
        </table>
