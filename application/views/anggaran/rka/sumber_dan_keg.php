	...
	function opt1(val){        
		...
		//	alert("iki");
			...
			if (sdana ==''){
				...
				alert("isi dulu sumber dana");
				exit();
				}
			
			var url    = "<?php echo site_url(); ?>/rka/lp_sumberdana/1/";  
			lc= '?sumber='+sdana+'&skpd='+skpd;
		...
		function cetak_ex()
        {
			...
			var url    = "<?php echo site_url(); ?>/rka/lp_sumberdana/2/";  
			lc= '?sumber='+sdana+'&skpd='+skpd;
				window.open(url+lc, '_blank');
				window.focus();
        }
...
<div id="content"> 
<div id="accordion">
<h5 align="center"><b><a href="#" id="section1">Laporan Sumber Dana Per kegiatan</a></b></h5>
 <fieldset>
 <div id="gaya">
<td width="922px" colspan="2"><input type="radio" name="cetak" value="1" onclick="opt1(this.value)" /><b>Keseluruhan</b></td></tr>
       ...
       <div id="div_sdana">
			<table style="width:100%;" border="0">
				...
				<td width="79%" style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;"><input id="sdana" name="sdana" style="width: 100px;" />
                </td>
			</table>
  	</div>
