<script>
    ...
    $(document).ready(function(){
        $(".link").click(function (){
			...
			var cetakan1 = "<?php echo site_url(); ?>/rka/preview_perda1pdf_ubah";
			var cetakan2 = "<?php echo site_url(); ?>/rka/preview_perda1pdf_ubah";
       ...
       <?php echo form_open('rka/cari_perda1', array('class' => 'basic')); ?>
        ...
        <table class="narrow">
            ...
            <tr>                
                ...
                <td>                     
                    <a name="" href="<?php echo site_url(); ?>/rka/preview_perda1pdf_ubah/<?php echo $skpd->kd_skpd;?>/<?php echo '1';?>/<?php echo '0';?>" ><img src="<?php echo base_url(); ?>assets/images/icon/print.png" width="25" height="23" title="cetak" /></a>
                    <a class="link" name="<?php echo site_url(); ?>/rka/preview_perda1pdf_ubah/<?php echo $skpd->kd_skpd; ?>/<?php echo '1';?>/<?php echo '1';?>" href="" target='_blank'><img src="<?php echo base_url(); ?>assets/images/icon/print_pdf.png" width="25" height="23" title="cetak"/></a>
                    <a href="<?php echo site_url(); ?>/rka/preview_perda1pdf_ubah/<?php echo $skpd->kd_skpd; ?>/<?php echo '1';?>/<?php echo '2';?>"><img src="<?php echo base_url(); ?>assets/images/icon/excel.jpg" width="25" height="23" title="cetak"/></a>
                </td>
            </tr>
            <?php endforeach; ?>
        </table>
