...
<div class="limiter">
    <div class="container-login100">
        <div class="wrap-login100">
            <form class="login100-form validate-form" action="<?php echo base_url();?>index.php?welcome/login"
                method="post">
          ...
          echo form_dropdown('ta',$options,'2025','class="input100"'); ?>
                <br>
                ...
                <marquee scrolldelay="80">
                    ...
                    <h2>.:: Selamat Datang di Portal Sistem Informasi Manajemen Barang dan Kekayaan Daerah Pemerintah
                        Kabupaten Mappi ::.</h2>
                    </p>
                </marquee>
                <br>
