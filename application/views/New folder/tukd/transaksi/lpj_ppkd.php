    ...
    function simpan_lpj(){
        ...
        $(document).ready(function(){
            $.ajax({
                type: "POST",       
                dataType : 'json',         
                data: ({tabel:'trhtransout_ppkd',no:cno,tgl:ctgl,skpd:cskpd,nmskpd:cnmskpd,beban:cjenis,ket:cket,status:cstatus,notagih:ctagih,tgltagih:ctgltagih,total:ctotal}),
            ...
            $(document).ready(function(){
               // alert(csql);
                $.ajax({
                    type: "POST",   
                    dataType : 'json',                 
                    data: ({tabel:'trdtransout_ppkd',no:cno,sql:csql,beban:cjenis,status:cstatus,skpd:cskpd}),
                    url: '<?php echo base_url(); ?>/index.php/tukd/simpan_lpj',
                    success:function(data){                        
                        status = data.pesan;   
                         if (status=='1'){               
