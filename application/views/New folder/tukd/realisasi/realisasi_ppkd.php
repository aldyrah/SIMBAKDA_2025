...
<head>
	...
	$(function(){
		...
		function cetak()
        {
			...
			var url    = "<?php echo site_url(); ?>/tukd/cetak_sp2d_hibah/1/";  
		...
		function cetak_ex()
        {
			...
			var url    = "<?php echo site_url(); ?>/tukd/cetak_sp2d_hibah/2/";  
			lc= '?posx='+periode1+'&posy='+periode2;
				window.open(url+lc, '_blank');
				window.focus();
        }
...
<div id="content"> 
<div id="accordion">
  <h5 align="center"><b><a href="#" id="section1"> REALISASI SP2D PPKD</a></b></h5>
 <fieldset>
