...
<head>
	...
	$(function(){
		...
		function cetak()
        {
			...
			var url    = "<?php echo site_url(); ?>/tukd/reg_sp2d_richard/1/";  
 ...
 <fieldset>
     <table align="center" style="width:100%;" border="0">
			...
			<tr>
				...
				<td width="200px" align="right"><input type="number" id="space" min="0" max="100" step="1" value ="0" style="width:40px;"/></td>
