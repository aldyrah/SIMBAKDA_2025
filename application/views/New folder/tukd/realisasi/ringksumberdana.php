...
<head>
	...
	$(function(){
	    ...
	    function tes(){
       //alert("aaaaaaaa")
	   var url    = "<?php echo site_url(); ?>/tukd/ringksumberdana1";  
	   window.open(url);
			window.focus();
    }
	function cetak(){
		...
		var tglttd = $('#ttd').combogrid("getValue");
		var chal = document.getElementById('hal').value;
		
		if(APBD=='0'){
		var url    = "<?php echo site_url(); ?>/tukd/cetak_ringksumberdana/1/";  
		lc= '?tgl1='+periode1+'&tgl2='+periode2+'&sdana='+sdana+'&tglttd='+tglttd+'+&space='+chal+'&APBD='+APBD;
		}else{
			var url    = "<?php echo site_url(); ?>/tukd/cetak_ringksumberdanaubah/1/";  
		lc= '?tgl1='+periode1+'&tgl2='+periode2+'&sdana='+sdana+'&tglttd='+tglttd+'+&space='+chal+'&APBD='+APBD;
			}
	...
	function cetak_ex(){
		...
		var chal = document.getElementById('hal').value;
		if(APBD=='0'){
		var url    = "<?php echo site_url(); ?>/tukd/cetak_ringksumberdana/2/";  
		lc= '?tgl1='+periode1+'&tgl2='+periode2+'&sdana='+sdana+'&tglttd='+tglttd+'+&space='+chal+'&APBD='+APBD;
		}else{
			var url    = "<?php echo site_url(); ?>/tukd/cetak_ringksumberdanaubah/2/";  
		lc= '?tgl1='+periode1+'&tgl2='+periode2+'&sdana='+sdana+'&tglttd='+tglttd+'+&space='+chal+'&APBD='+APBD;
			}
...
<div id="content"> 
<div id="accordion">
<h5 align="center"><b><a href="#" id="section1">RINGKASAN REALISASI PERKEGIATAN BERDASAKAN SUMBER DANA</a></b></h5>
<fieldset>
<!-- <table>
			    	<tr>
        <td>
        <a class="easyui-linkbutton" iconCls="icon-remove" plain="true" onclick="javascript:tes();">BUKA FORM UNTUK REALISASI PER SKPD SUMBER DANA</a>    
        </td>
        </tr>
        </table> -->
      <div id="div_sdana">
			<table style="width:100%;" border="0">
				...
				<td width="79%" style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;">
						<input id="sdana" name="rek3" style="width: 100px;" />
                </td>
			</table>
  	</div>
		  ...
		  <div id="div_su">
			<table style="width:100%;" border="0">
				  <td width="20%" style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;">&nbsp;SUMBER DANA APBD</td>
				<td width="1%" style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;">:</td>
				<td width="79%" style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;"><select  name="APBD" id="APBD" >
    ...
    <div id="div_sdana">
			<table style="width:100%;" border="0">
				<td width="20%" style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;">&nbsp;Tanggal TTD</td>
				<td width="1%" style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;">:</td>
				<td width="79%" style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;">
