...
<head>
     ...
     $('#dg').edatagrid({
        ...
        $('#nomor').combogrid({  
           ...
           onSelect:function(rowIndex,rowData){
               ...
               nilai =rowData.total;
			   nilaix =number_format(rowData.total,2,'.',',');
    ...
    function get(nomorkas,tglkas,nomor,tgl,kode,lckdbank,lckdgiat,lcket,lcjnskeg,lcrekbank,lctotal){
		...
		$("#jumlahtotalx").attr("value",lctotal);
    }
...
<h3><a href="#" id="section2" >Surat Tanda Setoran</a></h3>
   ...
   <td align="right"><input type="text" id="jumlahtotal" readonly="true" style="border:0; width: 200px;" hidden/><input type="text" id="jumlahtotalx" readonly="true" style="border:0; width: 200px;"/></td>
   </tr>
   </table>
