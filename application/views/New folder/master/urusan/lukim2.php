...
<head>   
  ...
  <script type="text/javascript">
   ...
   $('#dg').edatagrid({
		url: '<?php echo base_url(); ?>/index.php/master/load_lukim2',
        idField:'id',            
        rownumbers:"true", 
        fitColumns:"true",
        singleSelect:"true",
...
<div id="content"> 
<h3 align="center"><u><b><a>KEGIATAN ATAU PROGRAM YANG SUDAH DI PAKAI</a></b></u> OLEH SKPD LAIN</h3>
    <div align="center">
    <p align="center">     
    <table style="width:400px;" border="0">
        ...
        <option value="3">program & giat</option>
    </select>
        </td>
