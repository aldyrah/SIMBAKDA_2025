...
<head>
  ...
  <style>   
    ...
    function cetak(){
			...
			var url ="<?php echo site_url(); ?>/akuntansi/prognosis2106/1";			
			ctglttd = $('#dcetak2').datebox('getValue');
			
			window.open(url+'?kdskpd='+skpd+'&tgl_ctk='+ctglttd);
			window.focus();
    }
    ...
    function cetakex(){
            var skpd   = kdskpd; 
			var url ="<?php echo site_url(); ?>/akuntansi/prognosis2106/2";		
			ctglttd = $('#dcetak2').datebox('getValue');
...
<div id="content">
<h3>CETAK LAPORAN REALISASI SEMESTER</h3>
<div id="accordion">
    <p align="right">         
        <table>          
		...
		<tr >
            ...
            <a class="easyui-linkbutton" iconCls="icon-excel" plain="true" onclick="javascript:cetakex();">Cetak Excel</a></td>
		</tr>
