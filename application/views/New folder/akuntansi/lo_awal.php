...
<head>
    ...
    var lcstatus = '';
     ...
     $(function(){ 
     $('#dg').edatagrid({
		//url: '<?php echo base_url(); ?>/index.php/master/load_lo_awal/'+skpd,
		url: '<?php echo base_url(); ?>/index.php/master/load_lo_awal/',
        idField:'id',            
        rownumbers:"true", 
        fitColumns:"true",
        singleSelect:"true",
        ...
        onDblClickRow:function(rowIndex,rowData){
          ...
          //-----combo grid kode skpd---------
			...
			//	fitColumns:true,  
			//	columns:[[  
			//		{field:'kode',title:'KODE SKPD',width:70},  
			//		{field:'nama',title:'NAMA SKPD',align:'left',width:300}								
			//	]],
			//	onSelect:function(rowIndex,rowData){
       ...
       function simpan(){        
        ...
        if(lcstatus=='tambah'){              
         ...
         //lcquery = "UPDATE ms_lo_kab_lalu SET uraian='"+curaian+"',seq='"+cseq+"',nilai_lalu='"+lnnilai+"',kd_skpd='"+cskpd+"' where kode='"+cno+"'";
		    lcquery = "UPDATE map_lo_kab SET uraian='"+curaian+"',seq='"+cseq+"',thn_m1='"+lnnilai+"' where nor='"+cno+"'";
            $(document).ready(function(){
            $.ajax({
                type: "POST",
