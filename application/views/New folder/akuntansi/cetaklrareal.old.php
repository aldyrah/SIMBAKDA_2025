    ...
    <script type="text/javascript">
     ...
     function openWindow( url ){
		...
		cbulan 			= $('#bulan').combogrid('getValue');
         ...
         lc = '?nbulan='+cbulan+'&tgl_ttd='+ctglttd+'&spasi='+spasi;
    ...
    <h3 align="center"><b>CETAK LRA BERDASARKAN SP2D TERBIT</b></h3>
     <table align="center" style="width:100%;" border="0">                    
            ...
            <tr>
                ...
                <a href="<?php echo site_url(); ?>/akuntansi/cetak_lra_real" class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:openWindow(this.href);return false">Cetak</a>
                </td>                
            </tr>
        </table>  
