	...
	function ambil_nomor(){
     ...
     function simpan_ambilsmp(){
        ...
        if (lcstatus=='tambah'){ 
                    ...
                    lcquery = "UPDATE tr_ambilsimpanan SET tgl_kas='"+ctgl+"', kd_skpd='"+cskpd+"', nilai='"+lnnilai+"', bank='"+cbank+"', nm_rekening='"+cnmrek+"', keterangan='"+lcket+"' where no_kas='"+cno+"' and kd_skpd='"+cskpd+"'";

					 lcquery2 = "UPDATE tr_ambilsimpanan_ppkd SET tgl_kas='"+ctgl+"', kd_skpd='"+cskpd+"', nilai='"+lnnilai+"', bank='"+cbank+"', nm_rekening='"+cnmrek+"', keterangan='"+lcket+"' where no_kas='"+cno+"' and kd_skpd='"+cskpd+"'";
