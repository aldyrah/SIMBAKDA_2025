  ...
  function gabung()
  {
    ...
    function hsimpan(){        
        ...
        if (lcstatus=='tambah') { 
            ...
            lcinsert = "(no_spp,   no_spm,     kd_skpd, keperluan,   bulan,   no_spd,    jns_spp, bank,   nmrekan,  no_rek,  npwp,    nm_skpd,  tgl_spp, status, username,     last_update,   nilai,    no_bukti,     kd_kegiatan,  nm_kegiatan,  kd_program,  nm_program,  pimpinan,  no_tagih,    tgl_tagih,  sts_tagih, no_bukti2, no_bukti3, no_bukti4, no_bukti5, no_spd2, no_spd3, no_spd4,jns_beban)"; 
            lcvalues = "('"+a+"','"+aspm+"', '"+kode+"', '"+e+"',   '"+d+"', '"+spd+"', '"+c+"', '"+g+"', '"+f+"',  '"+i+"', '"+h+"', '"+j+"',  '"+b+"', '0',       '',           '',       '"+k+"',       '',         '"+kegi+"',   '"+l+"',      '"+m+"',     '"+n+"',     '"+f1+"',  '"+p+"',     '"+q+"',    '"+o+"',     '',       '',         '',        '',        '',      '',      ''  ,'"+tahap+"' )";
    ...
    function detsimpan(){
        ...
        for(var i=0;i<rows.length;i++){            
            ...
            $(document).ready(function(){      
                ...
                type     : 'POST',
                url      : "<?php  echo base_url(); ?>index.php/tukd/dsimpan",
                data     : ({cno_spp:a,cskpd:kode,cgiat:ckdgiat,crek:ckdrek,ngiat:cnmgiat,nrek:cnmrek,nkod:ckdkmp,nilai:cnilai,kd:no,no_bukti1:cnobukti1,cp:cnospd}),
                dataType : "json"
                });
            });
        }
       ...
       function append_save() {
        sisa_anggaran();
           ...
           if(vrek_reke==''){
            ...
            $('#dgsppls').edatagrid('appendRow',{kdkegiatan:vrek_kegi,no_spd:nospd,kdrek5:vrek_reke,nmrek5:vnm_rek_reke,kdkmp:vrek_kmp,nilai1:cnilai,idx:pidx});
            $("#dialog-modal-rek").dialog('close'); 
            simpan_ctrl();
...
<div id="dialog-modal-rek" title="Input Rekening">
    ...
    <table height="505" border="0" align="center" style="width:100%;">
            ...
            <tr>
                ...
                <td>:</td>
                <td><input type="text" id="rek_nilai_ang" style="width: 196px; text-align: right;background-color:#CDCDCD; " readonly="true" />                  <input type="text" id="rek_nilai_spp" style="width: 196px; text-align: right;background-color:#CDCDCD; " readonly="true" /></td> 
            </tr>
