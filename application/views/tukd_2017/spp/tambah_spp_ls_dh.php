...
<head>
  ...
  var jns ='';
    ...
    if (row.sss>0){
      return 'background-color:skyblue;';
            ...
            sss       = rowData.sss;    
                      $('#hal').attr("value",0);
                      get(no_spp,no_spm,kode,sp,tg,bl,jn,kep,np,rekan,bk,ning,status,kegi,nm,kprog,nprog,dir,notagih,tgltagih,sttagih,spp,spp2,spm,spm2,sss,jns_beban);
                      det();       
                      detail_trans_3();   
                      validate_kegiatan();
                ...
                url: '<?php echo base_url(); ?>/index.php/tukd/kegi',  
                    ...
                    if(kegi=='1.20.1.20.05.01.00.04'){
            beban_spd='62';
            $('#sp').combogrid({url: '<?php echo base_url(); ?>/index.php/tukd/spd3_ls_ppkd',
                      queryParams:({beban:'62'}) });
                      ambil_nomor();  
                    }else if(kegi=='1.20.1.20.05.01.00.02'){
            beban_spd='51';
            $('#sp').combogrid({url: '<?php echo base_url(); ?>/index.php/tukd/spd3_ls_ppkd',
                      queryParams:({beban:'51'}) });
                      ambil_nomor();  
          }                                                       
                    }    
                });
      ...
      function sisa_anggaran(){
        ...
        $("#rek_nilai_sisax").attr("value",number_format(slalu,2,'.',','));   
        if (slalu < 0){
    ...
    if(jnsb==5){
      ...
      $.ajax({
        ...
        success: function(data){
          ...
          sppa="/SPP/"+jns+"/"+data.bukti+"/"+smbrdana+"/"+data.thn;
          spmb="/SPM/"+jns+"/"+data.bukti+"/"+smbrdana+"/"+data.thn;
  ...
  function gabung()
  {
    ...
    function sisa_anggaran_kmp(){
        ...
        sisa = ang - lalu;
        slalu = (sisa - nil); 
        $("#rek_nilai_sisa1").attr("value",number_format(slalu,2,'.',','));   
        if (slalu < 0){
    ...
    function sisa_anggaran_hibah(){
        ...
        sisa = ang - lalu;
        slalu = (sisa - nil); 
        $("#rek_nilai_sisa_hibah").attr("value",number_format(slalu,2,'.',','));   
        if (slalu < 0){
    ...
    function det(){   
     ...
     function get(no_spp,no_spm,kd_skpd,no_spd,tgl_spp,bulan,jns_spp,keperluan,npwp,rekanan,bank,rekening,status,giat,nmgiat,prog,nmprog,pim,notagih,tgltagih,ststagih,spp,spp2,spm,spm2,sss,jns_beban){
...
/*    
     ...
     if ( cd == '' ||cd == 0){
        ...
        if (lcstatus=='tambah') { 
            ...
            lcvalues = "('"+a+"','"+aspm+"', '"+kode+"', '"+e+"',   '"+d+"', '"+spd+"', '"+c+"', '"+g+"', '"+f+"',  '"+i+"', '"+h+"', '"+j+"',  '"+b+"', '0',   '"+user+"',  '"+tgl_update+"',       '"+k+"',       '',         '"+kegi+"',   '"+l+"',      '"+m+"',     '"+n+"',     '"+f1+"',  '"+p+"',     '"+q+"',    '"+o+"',     '',       '',         '',        '',        '',      '',      ''  ,'"+tahap+"','"+sd+"' )";
...
<h3><a href="#" id="section1" onclick="javascript:$('#spp').edatagrid('reload')">List SPP</a></h3>
    ...
    <p align="right">         
        <a class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="javascript:section2();javascript:kosong();">Tambah</a>
...
<h3><a href="#" id="section2">Input SPP</a></h3>
 ...
 <tr style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;border-right-style:hidden;" >   
   ...
   <td style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;border-right-style:hidden;">&nbsp;
        ...
        <input type="text" id="spp_format2" style="width: 200px;" onclick="javascript:select();"  disabled="disabled" readonly/>
 ...
 <tr style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;">
   ...
   <td style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;border-right-style:hidden;">&nbsp;
      ...
      <input type="text" id="spm_format2" style="width: 200px;" onclick="javascript:select();"  disabled="disabled" readonly/>
 ...
 <tr style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;border-right-style:hidden;">
   ...
   <td width='31%' style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;"><textarea name="ketentuan" id="ketentuan" cols="30" rows="1" ></textarea>
   ...
   <td width='31%' style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;">&nbsp;<input type="text" name="rekening" id="rekening"  value="" style="width:190px"/></td>
     ...
     <tr style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;border-right-style:hidden;">
       ...
       <tr style="border-spacing: 3px;padding:3px 3px 3px 3px;">
                ...
                <a class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="javascript:mspph();javascript:kosong();">Baru</a>
                <a id="save" class="easyui-linkbutton" iconCls="icon-save" plain="true"  onclick="javascript:hsimpan();">Simpan</a>
                <a id="poto" class="easyui-linkbutton" iconCls="icon-redo" plain="true" onclick="javascript:cek_pot();">Potongan</a>
                ...
                <a class="easyui-linkbutton" iconCls="icon-undo" plain="true" onclick="javascript:mspph();javascript:section1();">Kembali</a>
                <a class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:cetak();">cetak</a>
              <a class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:cetakspm();">cetak SPM</a></td>                
       </tr>
</table>
        ...
        <table border='0' style="width:100%;height:5%;"> 
             ...
             <td width='32%'><input type="hidden" id="spdtemp" name="spdtemp" style="width: 196px; text-align: right; " readonly="true" /><input class="right" type="text" name="nilaispd" id="nilaispd"  style="width:140px" align="right" readonly="true" ></td>
        </table>
        </fieldset>
        <!------------------------------------------------------------------------------------------------------------------>
...
<div id="dialog-modal-rek" title="Input Rekening">
    ...
    <fieldset>
    <table height="505" border="0" align="center" style="width:100%;">
        ...
        <tr>
           ...
           <tr>
            ...
            <tr>
                <td>NILAI</td>
                <td>:</td>
                <td><input type="text" id="rek_nilai" style="width: 196px; text-align: right;" onkeypress="return(currencyFormat(this,',','.',event))" onkeyup="javascript:sisa_anggaran();"/></td> 
            </tr>
            ...
            <tr>
                ...
                <a class="easyui-linkbutton" iconCls="icon-undo" plain="true" onclick="javascript:keluar_rek();">Keluar</a></td>
            </tr>
