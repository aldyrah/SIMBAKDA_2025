...
<h3 align="center"><u><b><a href="#" id="section1">INPUTAN PENETAPAN PPKD</a></b></u></h3>
    ...
    <p align="right">         
        ...
        <a class="easyui-linkbutton" id="ha" iconCls="icon-remove" plain="false" onclick="javascript:hapus();">Hapus</a>
    ...
    <fieldset>
     <table align="center" style="width:100%;" border="0">
            <tr>
                <td>No. TETAP</td>
                <td></td>
                <td><input type="text" id="nomor" style="width: 200px;" readonly/></td>  
            </tr>            
            <tr>
                <td>Tanggal</td>
                <td></td>
