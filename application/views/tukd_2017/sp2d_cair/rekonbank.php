	...
	lc = '?tgl1='+ctgl1+'&tgl_ttd='+ctglttd+'&ttdd='+ttdd;
...
<div id="content1" align="center"> 
    <h3 align="center"><b>CETAK REKONSILIASI BANK</b></h3>
 ...
 <div id="div_ptd">
            ...
            <tr>
                ...
                <a href="<?php echo site_url(); ?>/tukd/cetak_rekonbank" class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:openWindow(this.href);return false">Cetak</a>
                </td>                
            </tr>
        </table>  
</div>	
