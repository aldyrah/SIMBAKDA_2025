...
<div id="content"> 
<div id="accordion">
<h5 align="center"><b><a href="#" id="section1">LAPORAN - LAPORAN SUMBER</a></b></h5>

 <fieldset>
     <table align="center" style="width:100%;" border="0">
			<tr>
			  <td width="99%" align="left"><input type="radio" name="cetak" value="28" onclick="opt(this.value)" />&nbsp;Realisasi SPD Per Sumber Dana</td>
