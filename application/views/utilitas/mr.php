...
$(document).ready(function(){
	...
	function cetak(ctk)
	{
		...
		var cspp	= $('#cspp').combogrid('getValue');	
		...
		var url = "<?php echo site_url(); ?>/cmr/cetak_mr/";  
		
		window.open(url+lc+'/'+cetak+'/'+corder+'/'+csort+'/'+cspp, '_blank');
		window.focus();	
	}
...
<div id="content"> 
<div id="accordion">
<h1 align="center" style="color:#6666FF">LAPORAN REKAPITULASI PERTANGGUNGJAWABAN SP2D BERDASARKAN SPJ</h1> 
	...
	<div id="div_ptd">
			...
			<tr>
				<td width="20%" style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;"><b> Tanggal Cetak</b></td>
