...
//all modified by wasisw 26-07-17
	function cetak(){   
		var spasi 		= document.getElementById('hal').value;
		var cbulan		= $('#bulan').combogrid('getValue');
		var skpd 		= $('#sskpd').combogrid("getValue");//skpd
		if (cbulan==''){
			alert ('Silahkan Pilih Bulan');
			exit();
		}
		if(ctk=='1'){
			var url    = "<?php echo site_url(); ?>/crealisasi/cetak_rth_ww/1/";  
			lc= '?bulan='+cbulan+'&spasi='+spasi;
		}else if(ctk=='2'){
			var url    = "<?php echo site_url(); ?>/crealisasi/cetak_dth_ww/1/";  
			lc= '?bulan='+cbulan+'&skpd='+skpd+'&spasi='+spasi;
		}
	...
	function cetakex(){   
		...
		var skpd 		= $('#sskpd').combogrid("getValue");//skpd
		var ctglttd 	= $('#tglttd').datebox('getValue');//tgl ttd
		if (idsp2d==''){
			alert ('Silahkan Pilih SP2D Cair / Terbit');
			exit();
		}
		if (cbulan==''){
			alert ('Silahkan Pilih Bulan');
		...
		if(ctk=='1'){
			var url    = "<?php echo site_url(); ?>/akuntansi/cetak_lra_real/2/";  
			lc= '?nbulan='+cbulan+'&tgl_ttd='+ctglttd+'&kd_skpd='+skpd+'&idsp2d='+idsp2d+'&spasi='+spasi;
		}else if(ctk=='2'){
			var url    = "<?php echo site_url(); ?>/akuntansi/cetak_lra_real1/2/";  
			lc= '?nbulan='+cbulan+'&tgl_ttd='+ctglttd+'&kd_skpd='+skpd+'&idsp2d='+idsp2d+'&spasi='+spasi;
		}
...
<div id="content"> 
<div id="accordion">
<h1 align="center" style="color:#6666FF">DATA TRANSAKSI HARIAN</h1> 
 ...
 <fieldset>
     <table align="center" style="width:100%;" border="0">  
			...
			<tr>
			    ...
			    &nbsp;<b>REKAPITULASI TRANSAKSI HARIAN (RTH)</b>
				<br />
				<input type="radio" name="cetak" value="2" onclick="opt(this.value)" />
				&nbsp;<b>DAFTAR TRANSAKSI HARIAN&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(DTH)</b></td>
			</tr>
	 ...
	 <table style="width:100%;" border="0">
			<tr >
				...
				<td width="79%"><input id="sskpd" name="sskpd" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
     ...
     <div id="div_bulan">
			<table style="width:100%;" border="0">
				...
				<td width="1%" style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;">:</td>
				<td width="79%"><input type="text" id="bulan" style="width: 100px;" /></td>
			</table>
		</div>
