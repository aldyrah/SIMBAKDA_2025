...
<head>
    ...
    $(function(){ 
     $('#sp2d').edatagrid({
		url: '<?php echo base_url(); ?>/index.php/tukd/load_sp2d_ppkd',
        idField:'id',            
        rownumbers:"true", 
        fitColumns:"true",
        singleSelect:"true",
...
<h3><a href="#" id="section1" onclick="javascript:$('#sp2d').edatagrid('reload')">List SP2D PPKD</a></h3>
    <div>
    <p align="right">         
...
<h3><a href="#" id="section2" onclick="javascript:$('#dg').edatagrid('reload')" >LIHAT SP2D</a></h3>
...
<div id="dialog-modal" title="CETAK SP2D">
    ...
    <table>
        <tr>
            ...
            <td><input id="csp2d" name="csp2d" style="width: 200px;" /></td>
        </tr>
        <tr>
            <td width="110px">Penandatangan:</td>
            <td><input id="ttd" name="ttd" style="width: 200px;" /></td>
        </tr>
