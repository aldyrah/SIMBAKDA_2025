    ...
    var lcstatus = '';
     ...
     $('#dg').edatagrid({
        ...
        onSelect:function(rowIndex,rowData){
          ...
          get(nomor_kas,nomor,tgl,tgl_kas,kode,lckdbank,lckdgiat,lcket,lcjnskeg,lcrekbank,lctotal);   
          load_detail(nomor);        
          lcstatus  = 'edit';
        },
...
//       });
    ...
    {
        	$.ajax({
        		url:'<?php echo base_url(); ?>index.php/tukd/config_skpdxx',
        		type: "POST",
        		dataType:"json",                         
    ...
    function get(nomor_kas,nomor,tgl,tgl_kas,kode,lckdbank,lckdgiat,lcket,lcjnskeg,lcrekbank,lctotal){
    ...
    function hapus(){
		...
		function(isConfirm){
		  if (isConfirm) {
				$(document).ready(function(){
				 $.post(urll,({no:cnomor,no_kas:cnokas}),function(data){
					status = data;
					if (status=='0'){
    ...
    function simpan_sts(){
        ...
        if (cno==''){
			swal("Nomor STS Tidak Boleh Kosong!");
            exit();
        } 
        if (ctgl==''){
            swal("Tanggal STS Tidak Boleh Kosong!");
            exit();
        }
        if (cskpd==''){
           swal("Kode SKPD Tidak Boleh Kosong!");
            exit();
        }
            ...
            $(document).ready(function(){
                $.ajax({
                    ...
                    data: ({tabel:'trhkasin_pkd',cid:'no_sts',lckas:cnokas,lcid:cno,no:cno,bank:cbank,tgl:ctgl,tglkas:ctglkas,skpd:cskpd,ket:lcket,jnsrek:cjnsrek,giat:cgiat,rekbank:lcrekbank,total:lntotal,value_det:lcval_det,ccek:lcstatus,nomorx:cno_hide}),
                    dataType:"json",
                    success:function(data){
                        status = data ;
                        if (status=='0'){
                        ...
                        if (status=='1'){
                             swal("Oops...", "Pelase use another sts number!", "error"); 
                             exit();
                        } else  
                        if (status=='2'){
...
<div id="content"> 
<div id="accordion">
<h3><a href="#" id="section1">List Pengembalian Uang Kas PPKD</a></h3>
...
<h3><a href="#" id="section2" onclick="javascript:set_grid();">Pengembalian Sisa Uang Kas</a></h3>
   ...
   <p>       
        <table align="center" style="width:100%;" border="0">
            ...
            <tr>
                <td>Uraian</td>
                <td colspan="3"><textarea name="ket" id="ket" cols="40" rows="2" style="border: 0;"  ></textarea></td>                
            </tr>            
            <tr>
