	...
	{   var ttdd = $('#ttd').combogrid("getValue");
		...
		//var space = document.getElementById('space').value;
		 ...
		 if(ctk=='10'){
			...
			var url    = "<?php echo site_url(); ?>/tukd/cetak_sp2d_gj_btl_maman_bulan/1/";  
			lc= '?bulan='+bulan+'&chal='+chal+'&ttdd='+ttdd+'&tglttd='+tglttd+'&gaji='+gaji;
		
		
		}else if(ctk=='41'){
			var url    = "<?php echo site_url(); ?>/tukd/cetak_sp2d_gj_btl_maman_tahun/1/";  
			lc= '?bulan='+bulan+'&chal='+chal+'&ttdd='+ttdd+'&tglttd='+tglttd+'&gaji='+gaji;
...
<div id="content"> 
<div id="accordion">
<h5 align="center"><b><a href="#" id="section1">LAPORAN - LAPORAN GAJI</a></b></h5>
 ...
 <fieldset>
     <table align="center" style="width:100%;" border="0">  
			...
			<tr>
            	  <td width="50%" align="left"><input type="radio" name="cetak" value="10" onclick="opt(this.value)" />&nbsp;Rekapitulasi BTL SP2d Cair(GAJI) </td>
			</tr>
			...
			<tr>
              	  <td width="50%" align="left"><input type="radio" name="cetak" value="40" onclick="opt(this.value)" />&nbsp;Rekapitulasi Gaji SP2d Terbit(bulan)</td>
			</tr>
			<tr>
              	  <td width="50%" align="left"><input type="radio" name="cetak" value="41" onclick="opt(this.value)" />&nbsp;Rekapitulasi Gaji SP2d Terbit(tahun)</td>
			</tr>		
