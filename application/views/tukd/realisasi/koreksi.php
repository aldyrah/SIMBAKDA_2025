...
$(function(){
	...
	$(function(){
		...
		function cetak()
        {
			...
			var url    = "<?php echo site_url(); ?>/tukd/ctk_koreksi/1/";  
			lc= '?posx='+periode1+'&posy='+periode2+'&sp='+space+'&tglttd='+tglttd+'&skpd='+skpd;
		...
		function cetak_ex()
        {
			...
			var skpd=$('#sskpd').combogrid("getValue");
			var space = document.getElementById('space').value;
			var url    = "<?php echo site_url(); ?>/tukd/ctk_koreksi/2/";  
			lc= '?posx='+periode1+'&posy='+periode2+'&sp='+space+'&tglttd='+tglttd+'&skpd='+skpd;
				window.open(url+lc, '_blank');
				window.focus();
        }
...
<div id="content"> 
<div id="accordion">
<h5 align="center"><b><a href="#" id="section1">KOREKSI</a></b></h5>
 <fieldset>
     <table align="center" style="width:100%;" border="0">
            ...
            <tr>
                ...
                <td width="200px" align="LEFT"><input type="text" id="perid1" style="width: 140px;" /></td>
           ...
           <tr >
						<td width="22px" height="10%" >SKPD</td>
						<td colspan="4" width="900px"><input id="sskpd" name="sskpd" style="width: 150px;" />&nbsp;&nbsp;
            ...
            <tr>
				<td width="200px">TANGGAL TTD</td>
				<td width="200px" align="LEFT"><input id="tglttd" name="tglttd" style="width: 160px;" /></td>
