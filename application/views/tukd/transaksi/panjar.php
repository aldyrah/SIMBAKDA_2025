...
<head>
    ...
    var lcstatus = '';
     ...
     $('#dg').edatagrid({
        ...
        onSelect:function(rowIndex,rowData){
          ...
          lcpay = rowData.pay;
          lcidx = rowIndex;
          get(nomor,tgl,kode,lcket,lcrek,rek,lcnilai,lcpay);   
    ...
    function get(nomor,tgl,kode,lcket,lcrek,rek,lcnilai,lcpay){
       ...
       function simpan_tetap(){
        ...
        if (cskpd==''){
         ...
         if(lcstatus=='tambah'){ 
                    ...
                    lcinsert = "(no_kas,tgl_kas,no_panjar,tgl_panjar,kd_skpd,pengguna,nilai,keterangan,pay)";
                    lcvalues = "('"+cno+"','"+ctgl+"','"+cno+"','"+ctgl+"','"+cskpd+"','"+rek+"','"+lntotal+"','"+lcket+"','"+lctunai+"')";
                    ...
                    lcquery = "UPDATE tr_panjar SET tgl_panjar='"+ctgl+"',pengguna='"+rek+"',keterangan='"+lcket+"',nilai='"+lntotal+"',pay='"+lctunai+"' where no_panjar='"+cno+"'";
                    //alert(lcquery);
                    $(document).ready(function(){
                    $.ajax({
                        type: "POST",
