...
<head>
    ...
    $(function(){ 
     $('#sp2d').edatagrid({
        url: '<?php echo base_url(); ?>/index.php/tukd/load_sp2d_cair_pkd',
        idField:'id',            
        rownumbers:"true", 
        fitColumns:"true",
        singleSelect:"true",
    ...
    if (row.xx>0){
      return 'background-color:skyblue;';
        ...
        onSelect:function(rowIndex,rowData){
          ...
          getspm(no_sp2d,no_spm,tgs,st,nokas,dkas,nocek,nokas1,no_spp,kd_skpd,keperluan,tgl_spp);                                                      
        },
    ...
    $(function(){
        ...
        function getspm(no_sp2d,no_spm,tgl_sp2d,status,nokas,dkas,nocek,kas,no_spp,kd_skpd,keperluan,tgl_spp){
            $("#tgl_spp").attr("value",tgl_spp);
        ...
        function simpan_cair(){        
            ...
            $(function(){      
             $.ajax({
                ...
                dataType:"json",
                url:"<?php echo base_url(); ?>index.php/tukd/simpan_cair_ppkd",
                success:function(data){
                    if(data = 1){
                    }
                }
 ...
 function updatesp2d(){        
            ...
            $(function(){      
             $.ajax({
                ...
                data: ({nkas:nokas,tcair:tglcair,ncek:nocek,tot:total,nsp2d:nosp2d,skpd:cskpd,ket:cket,beban:cbeban}),
                dataType:"json",
                url:"<?php echo base_url(); ?>index.php/tukd/update_ppkd",
                success:function(data){
                    if(data = 1){
        ...
        function batal_cair(){        
            ...
            var total = document.getElementById('total').value;      
            var nosp2d = document.getElementById('no_sp2d').value; 
            alert(nokas+' '+total+' '+nosp2d);
            $(function(){      
             $.ajax({
                type: 'POST',
                data: ({nkas:nokas,tcair:tglcair,ncek:nocek,tot:total,nsp2d:nosp2d}),
                dataType:"json",
                url:"<?php echo base_url(); ?>index.php/tukd/batal_cair_ppkd",
                success:function(data){
                    if (data = 1){
                        $("#nokas").attr("Value",'');
...
<h3><a href="#" id="section1" onclick="javascript:$('#sp2d').edatagrid('reload')">PENCAIRAN SP2D</a></h3>
    ...
    <p align="right">         
        ...
        <table id="sp2d" title="List SP2D" style="width:870px;height:650px;" >  
        </table>                      
    </p> 
    </div>
...
<table border='0' style="font-size:11px" >
 ...
 <tr>
   <td >No Kas </td>
   <td><input type="text" name="nokas" id="nokas"  style="width:200px" ></td>
   <td>Tgl Kas </td>
   <td><input id="dkas" name="dkas" type="text"  style="width:100px" /></td>
   <td>No Ref</td>
   <td><input id="nocek" name="nocek" type="text"  style="width:100px" /></td>
   <td>Nilai</td>
   <td><input class="right" type="text" name="total" id="total"  style="width:155px" align="right" readonly="true" ></td>
 </tr>
</table>
...
<table border='0' style="font-size:11px" >
 ...
 <tr>
   <td width='8%'>NPWP</td>
   <td width='53%'><input type="text" name="npwp" id="npwp" value="" readonly="true" style="width:250px" disabled/></td>
   <td width='8%'>Rekening</td>
   <td width='31%'><input type="text" name="rekening" id="rekening"  value="" readonly="true" style="width:200px" disabled/></td>
 </tr>       
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<INPUT TYPE="button" name="btcair" id="btcair" VALUE="CAIRKAN" ONCLICK="cekdulu()" style="height:40px;width:100px">              
		<INPUT TYPE="button" name="btupdate" id="btupdate" VALUE="UPDATE" ONCLICK="update()" style="height:40px;width:100px"> 
