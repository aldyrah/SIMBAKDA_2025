    ...
    $(function(){ 
     $('#sp2d').edatagrid({
        ...
        onSelect:function(rowIndex,rowData){
		  ...
		  nokas1 = rowData.nomorz;
 		  dkas  = rowData.dkasbud;
		  nocek = rowData.nocek;
          getspm(no_sp2d,no_spm,tgs,st,nokas,dkas,nocek,nokas1);
        ...
        onDblClickRow:function(rowIndex,rowData){
		  ...
		  //nokas = rowData.nokasbud;
		  nokas1 = rowData.nomorz;
           $('#nokas').attr("disable","disable");
            $('#dkas').datebox("disable","disable");
 		 // dkas  = rowData.dkasbud;
		  nocek = rowData.nocek;
          getspm(no_sp2d,no_spm,tgs,st,nokas,dkas,nocek,nokas1); 
            section2(st);
...
function load_spmxxx(){
//	alert("xx");
    $(function(){
            $('#nospm').combogrid({  
                panelWidth:500,  
                url: '<?php echo base_url(); ?>/index.php/tukd/nospmxxx',  
                    idField:'no_spm',
        ...
        function getspm(no_sp2d,no_spm,tgl_sp2d,status,nokas,dkas,nocek,nokasx){
			var kas=nokas;
			var ckas=nokasx;
			$("#no_sp2d").attr("value",no_sp2d);
			$("#nospm").combogrid("setValue",no_spm);
			//$("#dd").datebox("setValue",tgl_sp2d);
			$("#dd").attr("value",tgl_sp2d);
			
			$("#nokas").attr("Value",kas);
			if (kas == '' || kas == null)
			{
				$("#nokas").attr("Value",ckas);	
			}		
    ...
    function keluar(){
     ...
     var kriteria = document.getElementById("txtcari").value; 
        ...
        var a1 = document.getElementById('no_sp2d').value;
		 var b1 = document.getElementById('dd').value;
       // var b1 = $('#dd').datebox('getValue');        
        ...
        function simpan_cair(){        
			...
			if(tglcair=='' || tglcair=='0000-00-00 00:00:00'){
			...
			swal({
			  title: 'STOP..!!',
			  text: "NOKAS <a style='color:red;font-size:large;'>"+nokas+"</a>  SUDAH DIPAKAI, GANTI NOKAS!!!",
			  html:true,
			  ...
			  showConfirmButton: true
							...
							alert('Proses Berhasil...!!!');
			                 swal("CAIR!", "Proses Berhasil", "success");
			 ...
			 $.ajax({
				...
				success:function(data){
					if (data = 1){
						...
						$("#nocek").attr("Value",'');
						swal("BATAL CAIR!", "Proses Berhasil", "success");
					}
				}
			 });
			});
    ...
    var a1 = document.getElementById('rekspm1').value;
	var b1 = document.getElementById('rektotal1').value;
	//alert(a1+"bbbbbbb"+b1);
	var c1 = a1-b1;
	 $("#bersih").attr("Value",number_format(c1,2,'.',','));
	// $("#bersih").attr("value",c1);
	
	
    }

    function cekdulu(){
		var sd=$('#dkas').datebox('getValue');
		var fd=document.getElementById('dd').value;
		
		  if (sd=='' || sd=='0000-00-00 00:00:00'){
            alert('Tanggal Kas Tidak Boleh Kosong');
            exit();
        }
		...
		if(thnsel<0)
		{
		   alert("Tahun Pencairan Tidak Boleh Lebih Kecil Dari Tahun SP2D");
		 exit();
		}
		if(blsel<0)
		{
		   alert("Bulan Pencairan Tidak Boleh Lebih Kecil Dari Bulan SP2D");
		 exit();
		}else if(blsel==0){
			 if(tglsel<0){
				 alert("Tanggal Pencairan Tidak Boleh Lebih Kecil Dari Tanggal SP2D");
				 }else{
					cair();
				 }
		}else if(blsel>0){
		 ...
		 function updatesp2d(){        
			...
			var cket = document.getElementById('ketentuan').value; 
			var cbeban = document.getElementById('jns_beban').value; 
			//alert(nokas+' '+tglcair+' '+nocek+' '+total+' '+nosp2d+' '+cskpd+' '+cket+' '+cbeban);
			if(tglcair == ''){
			...
			$(function(){      
			 $.ajax({
				type: 'POST',
					data: ({nkas:nokas,tcair:tglcair,ncek:nocek,tot:total,nsp2d:nosp2d,skpd:cskpd,ket:cket,beban:cbeban}),
				dataType:"json",
				url:"<?php echo base_url(); ?>index.php/tukd/update_cair_bud",
				success:function(data){
					if(data = 1){
	 ...
	 function update(){
		var cap=document.getElementById("btupdate").value;
		var nokas=document.getElementById("nokas").value;
		...
		{
			updatesp2d();
			document.getElementById("btupdate").value="UPDATE SP2D";
		}
	}
	...
	function cair(){
		...
		var nokas=document.getElementById("nokas").value;
        var tglkas=$('#dkas').datebox('getValue');
		
		if (nokas==''){
			alert('Nomor Kas Harus Diisi !!!');
			exit;
		}
        if (tglkas=='' || tglkas=='0000-00-00 00:00:00'){
            alert('Tanggal Kas Tidak Boleh Kosong');
            exit();
        }
		...
		if (cap=='CAIRKAN'){
			...
			swal({
			  ...
			  text: "ANDA AKAN MEMBATALKAN PENCAIRAN ???",
			  type: "warning",
...
<h3><a href="#" id="section1" onclick="javascript:$('#sp2d').edatagrid('reload')">PENCAIRAN SP2D BUD</a></h3>
    <div>
    <p align="right">         
...
<table border='0' style="font-size:11px" >
 ...
 <tr>
   <td >No Kas </td>
   <td><input type="text" name="nokas" id="nokas"  style="width:150px"  readonly="true" disabled></td>
   <td>Tgl Kas </td>
   <td><input id="dkas" name="dkas" type="text"  style="width:100px" readonly="true" disabled /></td>
   <td>No Cek</td>
   <td><input id="nocek" name="nocek" type="text"  style="width:50px" /></td>
   <td>Nilai</td>
   <td><input class="right" type="text" name="total" id="total"  style="width:200px" align="right" readonly="true" ></td>
 </tr>
</table>
...
<table border='0' style="font-size:11px" >
 ...
 <tr>   
   ...
   <td><input id="nospp" name="nospp" readonly="true" style="width:300px" disabled/></td>
   <td>Tgl SPP </td>
   <td><input id="tgl_spp" name="tgl_spp" type="text" readonly="true" style="width:150px" disabled/></td>   
    </tr>
 <tr>
   <td width='8%'>SKPD</td>
   <td width="53%" >     
      <input id="dn" name="dn"  readonly="true" style="width:150px" disabled/></td> 
   <td width='8%'>Bulan</td>
 ...
 <tr>
   ...
   <td width='31%'><textarea name="ketentuan" id="ketentuan" cols="30" rows="2" readonly="true" disabled></textarea></td>
 </tr>
 <tr>
   <td width='8%'>No SPD</td>
   <td><input id="sp" name="sp" style="width:300px" readonly="true" disabled /></td>
   <td width='8%'>Rekanan</td>
   <td><textarea id="rekanan" name="rekanan" cols="30" rows="1" readonly="true" disabled> </textarea></td>
 </tr>
 ...
 <tr>
   <td width='8%'>NPWP</td>
   <td width='53%'><input type="text" name="npwp" id="npwp" value="" readonly="true" style="width:300px" disabled/></td>
   <td width='8%'>Rekening</td>
   <td width='31%'><input type="text" name="rekening" id="rekening"  value="" readonly="true" style="width:150px" disabled/></td>
 </tr>       
     ...
     <table id="dg" title=" Detail SPM" style="width:850%;height:250%;" >  
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;		<B>Total</B>&nbsp;&nbsp;
		<input class="right" type="text" name="rekspm" id="rekspm"  style="width:200px" align="right" readonly="true" ><br />
		
		<input class="right" type="text" name="rekspm1" id="rekspm1"  style="width:140px" align="right" readonly="true" hidden="true" >
       ...
       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<B>Total</B>&nbsp;&nbsp;
		<input class="right" type="text" name="rektotal" id="rektotal"  style="width:200px" align="right" readonly="true" >
		<input class="right" type="text" name="rektotal1" id="rektotal1"  style="width:140px" align="right" readonly="true" hidden="true" >
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <B>BERSIH</B><input class="right" type="text" name="bersih" id="bersih"  style="width:200px" align="right" readonly="true" >
    <!-- <?php echo form_close(); ?> -->

	</p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	 <INPUT TYPE="button" name="btback" id="btback" VALUE="KEMBALI" ONCLICK="javascript:section1();" style="height:30px;width:100px">			   	 
 <INPUT TYPE="button" name="btcair" id="btcair" VALUE="CAIRKAN" ONCLICK="cekdulu()" style="height:30px;width:100px">	
   <INPUT TYPE="button" name="btupdate" id="btupdate" VALUE="UPDATE" ONCLICK="update()" style="height:30px;width:100px">	
</div>  
</div>
</div> 
