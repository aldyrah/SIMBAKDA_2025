...
<head>
  ...
  <style>   
    ...
    function cetak(){
            var skpd   = kdskpd; 			
			if (ctk=='1'){
				var url ="<?php echo site_url(); ?>/akuntansi/cetak_perda1_semester_pemda";
			} else{
				var url ="<?php echo site_url(); ?>/akuntansi/cetak_perda1_semester_skpd";
			}	
			ctglttd = $('#dcetak2').datebox('getValue');
			
			window.open(url+'?cetak='+ctk+'&kdskpd='+skpd+'&tgl_ctk='+ctglttd);
			window.focus();
    }
...
<div id="accordion">
    <p align="right">         
		...
		<tr >
			<td align="center" colspan="3"><a class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:cek();">Cetak</a></td>
		</tr>
