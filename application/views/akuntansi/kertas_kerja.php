...
<head>
  ...
  <style>    
    ...
    function cetak($ctk)
        {
            var cetak =$ctk;            
            var url    = "<?php echo site_url(); ?>/akuntansi/cetak_kertas_kerja1";   
       ...
       var url    = "<?php echo site_url(); ?>/akuntansi/cetak_rekening";  
       window.open(url);
            window.focus();
    }
...
<h3>CETAK KERTAS KERJA </h3>       
<div id="accordion">
    
    <p align="left">        <a class="easyui-linkbutton" iconCls="icon-remove" plain="true" onclick="javascript:tes();">BUKA FORM</a>
