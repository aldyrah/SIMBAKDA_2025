...
ctk='2';
   var apbd = document.getElementById('APBD').value;  
        ...
        var url ="<?php echo site_url(); ?>/akuntansi/cetak_lra_skpd/1";
		var ctk='1';
		var skpd='1.20.05.01';  
		//alert("aa");
...
window.open(url+'?cetak='+ctk+'&bulan='+ctgl1+'&kdskpd='+skpd+'&tgl_ctk='+ctglttd+'&apbd='+apbd);
window.focus();
     }  
...
<div id="content1" align="center"> 
    <h3 align="center"><b>CETAK LAPORAN REALISASI ANGGARAN</b></h3>
     ...
     <table align="center" style="width:100%;" border="0">
         ...
         <tr>
			...
			<td align="center" colspan="3"><a class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:cetakan();">Cetak</a>
            <a class="easyui-linkbutton" iconCls="icon-excel" plain="true" onclick="javascript:cetakan_ex();">Export</a>
