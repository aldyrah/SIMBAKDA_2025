...
//all modified by wasisw 26-07-17
	function cetak(){   
		...
		if(ctk=='1'){
			var url    = "<?php echo site_url(); ?>/akuntansi/cetak_lra_real/1/";  
			lc= '?nbulan='+cbulan+'&tgl_ttd='+ctglttd+'&kd_skpd='+skpd+'&idsp2d='+idsp2d+'&spasi='+spasi;
		}else if(ctk=='2'){
			var url    = "<?php echo site_url(); ?>/akuntansi/cetak_lra_real1/1/";  
			lc= '?nbulan='+cbulan+'&tgl_ttd='+ctglttd+'&kd_skpd='+skpd+'&idsp2d='+idsp2d+'&spasi='+spasi;
		}
	...
	function cetakex(){   
	 ...
	 function opt(val){        
        ...
        if (ctk=='1'){
			...
			$("#div_ptd").show();
			$("#div_skpd").hide();
			$("#gaya").show();//raddio buttton seluruh/skpd
		}else if (ctk=='2'){
			$("#div_gaji_pot").hide();
			$("#div_sdana").hide();
		    $("#reke").hide();
...
<div id="content"> 
<div id="accordion">
<h5 align="center"><b><a href="#" id="section1">LAPORAN REALISASI ANGGARAN </a></b></h5>
...
<td width="922px" colspan="2"><input type="radio" name="cetak" value="1" onclick="opt1(this.value)" /><b>Keseluruhan</b></td></tr>
		...
		<div id="div_bulan">
			<table style="width:100%;" border="0">
				<td width="20%" style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;">&nbsp;JENIS SP2D</td>
