...
<script type="text/javascript">
  ...
  function cetak($cek){
    ...
    var url     = "<?php echo site_url(); ?>/laporan_bhp/lap_masukbhp_dh";
    ...
    //if(oto=='01'){
      if(ctk=='1'){
        if(cskpd==''){
          ...
          swal({
          title: "Error!",
          text: "MOHON KEGIATAN DIISI.!!",
          type: "error",
          confirmButtonText: "OK"
          });
          exit();
        }else{
          lc = '?pilih='+cpilih+'&tampil='+cini+'&skpd='+cskpd+'&nmskpd='+cnmskpd+'&bidang='+cbid+'&nmbid='+cnm_bid+'&bulan='+bulan+'&tahun='+tahun+'&tglcetak='+lctgl2+'&pilctk='+pilctk+'&jenis='+jenis+'&nmjenis='+nmjenis;
        }
      }else if(ctk=='2'){
        if(cskpd==''){
          swal({
    ...
    $(function(){
      $('#kdskpd').combogrid({  
           ...
           onSelect:function(rowIndex,rowData){
               ...
               $('#jenis').combogrid({url:'<?php echo base_url(); ?>index.php/master/ambil_keg',queryParams:({kdskpd:lcskpd,unit:''}) });
        ...
        $('#kdubidskpd').combogrid({  
           ...
           onSelect:function(rowIndex,rowData){
              ...
              // $('#kdubidskpd').combogrid({url:'<?php echo base_url(); ?>index.php/master/ambil_uskpd',queryParams:({kduskpd:lcskpd}) });
               ...
               $('#jenis').combogrid({url:'<?php echo base_url(); ?>index.php/master/ambil_keg',queryParams:({kdskpd:cskpd,unit:lcskpd}) });
