...
<head>
    ...
    $(function(){
	       ...
	       $('#dg').edatagrid({
				url           : '<?php echo base_url(); ?>/index.php/rka/select_rka_tn',
                 idField      : 'id',
                 toolbar      : "#toolbar",              
                 rownumbers   : "true", 
                 fitColumns   : "true",
				...
				columns:[[
					...
					{field:'kd_rek5',title:'Rekening',width:12,align:'left'},
					{field:'nm_rek5',title:'Nama Rekening',width:78},
					{field:'nilai',title:'Nilai Rekening',width:30,align:'right'},
                    {field:'nilai_ubah',title:'Nilai Rekening Ubah',width:30,align:'right'},
                    {field:'sumber',title:'Sumber',width:25,align:'left'},
                    {field:'sumber_ubah',title:'Sumber Ubah',width:25,align:'left'},
					{field:'rinci',title:'Detail',width:10,align:'center', 
            ...
            $("#sdana3").combogrid({
				...
				function load_sum_skpd(kode){                
		
		$(function(){      
         $.ajax({
            type: 'POST',
            data:({skpd:kode}),
            url:"<?php echo base_url(); ?>index.php/rka/load_sum_skpd_ms_lunc",
            dataType:"json",
            success:function(data){ 
                $.each(data, function(i,n){
                    $("#rektotal2").attr("value",n['rektotal2']);
                });
            }
         });
        });
        ...
        function validate_giat(){
          ...
          $("#sdana1").combogrid("setValue",'');
            ...
            textField  : 'kd_kegiatan',  
            mode       : 'remote',
            url        : '<?php echo base_url(); ?>index.php/rka/pgiat_ms_dh/'+kdskpd,  
            columns    : [[  
                {field:'kd_kegiatan',title:'Kode SKPD',width:130},  
                {field:'nm_kegiatan',title:'Nama Kegiatan',width:420},
                {field:'sumber',title:'Sumber',width:70},
                {field:'sumber_ubah',title:'Sumber Ubah',width:70},
                {field:'nilai',title:'Nilai',align:'right',width:110},
                {field:'nilai_ubah',title:'Nilai Ubah',align:'right',width:110}   
            ]],
            onSelect:function(rowIndex,rowData){
              sumber_ubah= rowData.sumber_ubah;
                ...
                $("#kdrek5").combogrid("disable");
                $("#kdrek5").combogrid("setValue",'');
                $("#sdana1").combogrid("setValue",sumber_ubah);
		 ...
		 function cekrealisasi(kdkegi){
 // alert(kdkegi);

var urll= '<?php echo base_url(); ?>/index.php/rka/cek_reali';   

 $(document).ready(function(){
    $.post(urll,({kegi:kdkegi}),
      function(data){
      	kevin =number_format(data,0,'.',',');
        if(data>0){
		document.getElementById("p3").innerHTML="Kegiatan Sudah Ada Realisasi Senilai: "+kevin+" ";
		$("#sdana1").combogrid("disable");
		}else{
			document.getElementById("p3").innerHTML="";
			$("#sdana1").combogrid("enable");
			}
  });	
        ...
        function simpan(baru,lama,nilai,sdana){		
    		...
    		if (lama==''){
    			...
    			$(function(){
    				$('#dg').edatagrid({
    				     url: '<?php echo base_url(); ?>/index.php/rka/tsimpan_rinci_dhm/'+cskpd+'/'+cgiat+'/'+baru+'/'+lama+'/'+nilai+'/'+sdana,
    					 idField:'id',
    					 toolbar:"#toolbar",              
    					 rownumbers:"true", 
    					 fitColumns:"true",
      ...
      var sdana1 = $("#sdana1").combogrid("getValue");       
            $(function(){
			$('#dg').edatagrid({
				 url: '<?php echo base_url(); ?>/index.php/rka/select_rka_tn/'+cgiat,
                 idField     : 'id',
                 toolbar     : "#toolbar",              
                 rownumbers  : "true", 
                 fitColumns  : "true",
				 ...
				 onSelect:function(rowIndex,rowData){							
                              ...
                              if(vvsdana1==''){
                                $("#sdana1").combogrid("setValue",sdana1);
                              }else{
				...
				columns:[[
	                {field:'id',title:'id',width:10,hidden:true},
					{field:'kd_rek5',title:'Rekening',width:15,align:'left'},
					{field:'nm_rek5',title:'Nama Rekening',width:78},
					{field:'nilai',title:'Nilai Rekening',width:30,align:'right'},
                    {field:'nilai_ubah',title:'Nilai Rekening Ubah',width:30,align:'right'},
                    {field:'sumber',title:'Sumber',width:25,align:'left'},
        ...
        function validate_rek(){
			...
			$('#dg_rek').edatagrid({
				...
				nowrap       : false,				 
				columns:[[
	                {field:'ck',title:'ck',checkbox:true,hidden:true},
					{field:'kd_rek5',title:'Kode Rekening',width:20,align:'left'},
					{field:'nm_rek5',title:'Nama Rekening',width:80}
				]],
		...
		function hapus(){
				...
				if  (del==true){
					$(function(){
						$('#dg').edatagrid({
							 url: '<?php echo base_url(); ?>/index.php/rka/thapus_tn/'+cskpd+'/'+cgiat+'/'+rek,
							 idField:'id',
							 toolbar:"#toolbar",              
							 rownumbers:"true", 
							 fitColumns:"true",
                    ...
                    $('#kdgiat').combogrid('grid').datagrid('reload');
                    $("#kdrek5").combogrid("disable");
                    $("#kdrek5").combogrid("setValue",'');
                    $("#nilairek").attr("value",0);
                    document.getElementById('nmrek5').value = '';
		...
		function hapus_rinci(){
                ...
                var cek  = document.getElementById('nreal').value;
                var cek_ubah =angka(document.getElementById('rektotal_ubah_cek').value);
                var cek_nilkeg =angka(document.getElementById('nilkeg').value);
                var total_awal = angka(document.getElementById('rektotal_rinci_ubah').value) ;
                
                var rows        = $('#dg1').edatagrid('getSelected');
                    urai        = rows.uraian ;
             		ntotal      = rows.total;
                var total_rinci = angka(rows.total_ubah) ;
				
				 if ( ntotal!=0 ){
                    alert("APBD TERDAPAT NILAI MURNI YANG TELAH DI SAHKAN...!!!  DATA TIDAK DAPAT DI HAPUS...!!!");
                    exit();
                }
                ...
                if ( cfm == true ){
                    ...
                    var sel = total_rincian - cek;

                    if(total_awal<total_rinci){
                     // alert("awal"+total_awal+"         rinci"+total_rinci);
                      //var ss=total_rinci-total_awal;
                      var qq=cek_ubah+ss;
                      $("#rektotal_ubah_cek").attr("value",number_format(qq,0,'',''));
                    }else{
                     // alert("rinci"+total_rinci+"       awal"+total_awal);
                      //var ss=total_awal-total_rinci;
                      var qq=cek_ubah-total_rinci;
                      var ww=qq-cek_nilkeg;
                      $("#rektotal_ubah_cek").attr("value",number_format(qq,0,'',''));
                      $("#selisih").attr("value",number_format(ww,0,'',''));
                    }

                    $("#rektotal_rinci_ubah").attr("value",number_format(total_rincian,"2",'.',','));
                    $("#total_rinci_ubah").attr("value",number_format(total_rincian,"0",'',''));
                    $("#again").attr("value",number_format(sel,"0",'',''));
                    //load_sum_dh();
                }
		}
	...
	function load_sum_rek(){                
        ...
        $(function(){      
         $.ajax({
          ...
          $("#rektotal_ubah_cek").attr("value",number_format(n['rektotal_ubah_cek'],0,'',''));
                });
            }
         });
        });
...
//cek nilai realisasi
    function load_sum_dh(a){ 
	               
    var cgiat = document.getElementById('giat').value;
    var cekk  = document.getElementById('total_rinci_ubah').value;
    var cexx  = document.getElementById('rektotal_ubah_cek').value;
   
            $("#nreal").attr("value",0);
			$("#nrealnumber").attr("value",0);
            $("#nilkeg").attr("value",0);
         $.ajax({
            type: 'POST',
            data:({rek:a,keg:cgiat}),
            url:"<?php echo base_url(); ?>index.php/rka/cek_demansyah",
            dataType:"json",
            success:function(data){ 
                $.each(data, function(i,n){
					
					 var realisasi = n['nilreal'];
           var realisasikeg=n['nilkeg'];
		            $("#nilkeg").attr("value",number_format(n['nilkeg'],0,'',''));
         $("#nreal").attr("value",n['nilreal']);
		 $("#nrealnumber").attr("value",number_format(n['nilreal'],"2",'.',','));
		
         var jumadi = cekk-realisasi;
    $("#again").attr("value",jumadi);
          var ikin = cexx-realisasikeg;
          $("#selisih").attr("value",ikin);
                });
            }
         });
    ...
    function load_sum_rek_rinci(c){                
        ...
        $(function(){      
         $.ajax({
          ...
          $("#total_rinci_ubah").attr("value",number_format(n['total_rinci_ubah'],0,'',''));
                });
            }
         });
        });
	  ...
	  function input(){
        var sumber = $("#sdana1").combogrid("getValue");
        ...
        $("#kdrek5").combogrid("setValue",'');
        $("#sdana1").combogrid("setValue",sumber);
        $("#sdana1").combogrid("disable");
        /* $("#sdana1").combogrid("setValue",'');
        $("#sdana2").combogrid("setValue",'');
        $("#sdana3").combogrid("setValue",'');
    ...
    function tambah(){
        ...
        $.ajax({
           type     : "POST",
           dataType : "json",
           data     : ({kd_skpd:skpd,kd_kegiatan:kegi,kd_rek5:reke,nilai:nrek,dana1:sdana1}),
           url      : '<?php echo base_url(); ?>index.php/rka/tsimpan_ar_ms_dh', 
           success  : function(data){
                      st12 = data;
                      if ( st12 == '1' ){
    ...
    function enter(ckey,_cid){
       ...
       function insert_row() {
            ...
            if ( idx_ins == -1){
				...
				$('#dg1').edatagrid('insertRow',{index:idx_ins,row:{id:id,no_po:idx_ins,uraian:uraian,volume1:'',satuan1:'',volume:'',harga1:'',total:'',volume_ubah1:vol1,satuan_ubah1:sat1,volume_ubah:tvol,harga_ubah1:harga,total_ubah:total,id:idx_ins}});
				$("#dg1").datagrid("unselectAll");
				kosong();
			}
        ...
        $(function(){
			...
			$('#dg1').edatagrid({
				...
				columns:[[
					...
					{field:'uraian',title:'Uraian',width:260},

                    {field:'volume1',title:'V ',width:35,align:'right',hidden:true},
                    {field:'satuan1',title:'S ',width:50,align:'center',hidden:true},
					{field:'volume',title:'T-VL',width:35,align:'center',hidden:true},
					{field:'harga1',title:'Harga',width:90,align:'right',hidden:true},
					{field:'total',title:'Total',width:100,align:'right',hidden:true},

                    {field:'volume_ubah1',title:'V ubah',width:35,align:'right'},
                    {field:'satuan_ubah1',title:'S Ubah',width:50,align:'center'},
				    {field:'volume_ubah',title:'T-VL Ubah',width:35,align:'center',hidden:true},
   					{field:'harga_ubah1',title:'Hrg Ubah',width:90,align:'right'},
					{field:'total_ubah',title:'Tot Ubah',width:100,align:'right'},
                    {field:'realisasi_lalu',title:'Tot Real',width:100,align:'right'},
                    {field:'sisa_real',title:'Sisa',width:100,align:'right'}
				]]	
			});
		});
	 ...
	 var idx_ins_edit=0;   
    function pilih_edit(){
             var realisasisa = document.getElementById('nreal').value;
             var xx =angka(document.getElementById('rektotal_ubah_cek').value);
             var dx =angka(document.getElementById('nilkeg').value);
            ...
            var real_edit   = document.getElementById('realisasi_lalu_edit').value;

            var real_edit   =angka(real_edit);
            var harga_edit  = angka(nilai_edit) ;
            var tvol_edit   = volu1_edit;
            var total_edit  = volu1_edit*harga_edit;
            var sisa_edit   = total_edit-real_edit;
            var real_edit   = number_format(real_edit,2,'.',',');
            var fharga_edit = number_format(harga_edit,2,'.',',');           
            var ftotal_edit = number_format(total_edit,2,'.',',');
            var fsisa_edit  = number_format(sisa_edit,2,'.',',');

                  
            
            var idx_ins_edit  = document.getElementById('noid_edit').value;
            $('#dg1').edatagrid('updateRow',{index: idx_ins_edit,row:{uraian:uraian_edit,volume_ubah1:vol1_edit,satuan_ubah1:sat1_edit,volume_ubah:tvol_edit,harga_ubah1:fharga_edit,total_ubah:ftotal_edit,realisasi_lalu:real_edit,sisa_real:fsisa_edit}});
            $("#dg1").datagrid("unselectAll");
            ...
            var total_rinci_edit = sisa_edit;
                total_rinci_edit = total_rinci_edit + total_awal_edit - total_pertama ; 
            // alert(total_awal_edit+" q  "+total_rinci_edit+" x "+total_pertama+"z"+xx);

             var a = number_format(total_awal_edit,0,'','');
             var b = number_format(total_rinci_edit,0,'','');
            // alert(a+"asshole"+b);

             if(a<b){

               var xy=b-a;
               var xyx = number_format(xy,0,'','');
               var q =xx+xy;
               var sel =q-dx;
               //var r = angka(document.getElementById('q').value);
               //alert(xy+"//"+q+"/////"+b+"asdfghj"+xyx);
               $("#rektotal_ubah_cek").attr("value",q);
               $("#selisih").attr("value",sel);
               $("#total_rinci_ubah").attr("value",total_rinci_edit);
             }else{
               var xy=a-b;
               var xyx = number_format(xy,0,'','');
               var q =xx-xy;
	  ...
	  var jumadi = total_rinci_edit-realisasisa;
	  $("#again").attr("value",jumadi);
	 ...
	 function section(kdrek){
		 //alert(kdrek);
            ...
            $(document).ready(function(){
                ...
                $(function(){
        			$('#dg1').edatagrid({
       				     url          : '<?php echo base_url(); ?>/index.php/rka/rka_rinci_lunc/'+mskpd+'/'+mgiat+'/'+kdrek,
                         idField      : 'id',
                         toolbar      : "#toolbar1",              
                         rownumbers   : "true", 
                         fitColumns   : false,
						 ...
						 onSelect     : function(rowIndex,rowData){
                                       ...
                                       $("#vol1_edit").attr("value",rowData.volume_ubah1) ;
                                       $("#sat1_edit").attr("value",rowData.satuan_ubah1) ;
                                       $("#harga_edit").attr("value",rowData.harga_ubah1) ;
                                       $("#nopo_edit").attr("value",rowData.no_po) ;
                                       $("#realisasi_lalu_edit").attr("value",rowData.realisasi_lalu);
                                       $("#sisa_real_edit").attr("value",rowData.sisa_real);
                                       ...
                                       var harga_e = rowData.harga_ubah1 ;
                                       var reali   = rowData.realisasi_lalu;
                                       if ( vol1_e == '' ){
                                            var vvol1_e = 1 ;
                                       } else {
                                            var vvol1_e = vol1_e ;
                                       ...
                                       var nt_edit     = ntotal_edit-angka(reali);
                                       
                                       $("#noid_edit").attr("value",idx_ins_e);
                                       $("#total_edit").attr("value",nt_edit);
                                       
                       },
                       onDblClickRow  : function(rowIndex,rowData){
                                        $("#dialog-modal-edit").dialog('open');
										jezz=document.getElementById('uraian_edit').value;//toni
										if(jezz==''){
											document.getElementById('uraian_edit').focus() ;
										}else{
                       ...
                       onAfterEdit  : function(rowIndex, rowData, changes){								
										...
										vol1=rowData.volume_ubah1;
										sat1=rowData.satuan_ubah1;
										har1=rowData.harga_ubah1;

										simpan_rincian(idx,urai,vol1,sat1,har1,kdrek);
								     },
						onLoadSuccess:function(data){
		...
		function simpan_rincian(idx,uraian,volum1,satuan1,harga1,rk){		
			var cgiat = document.getElementById('giat').value;
			var cskpd = document.getElementById('skpd').value;
			...
			if (satuan1==""){
				...
				$.ajax({
					type     : "POST",       
					dataType : 'json',         
					data     : ({skpd:cskpd,giat:cgiat,rek:rk,id:idx,uraian:uraian,volum1:volum1,satuan1:satuan1,harga1:harga1}),
					url      : '<?php echo base_url(); ?>/index.php/rka/tsimpan_rinci_tn',
					success  : function(data){
						status = data.pesan;
  ...
  function detsimpan(){    
        ...
        var crek        = document.getElementById('reke').value;
        var norka       = cskpd+'.'+cgiat+'.'+crek;
        var nilaireal   = document.getElementById('nreal').value;
        var cc          = document.getElementById('total_rinci_ubah').value;
        var again1      = document.getElementById('again').value;
        var cekkk       = document.getElementById('rektotal_ubah_cek').value;
        var ckeg        = document.getElementById('nilkeg').value;
        var relkeg      =number_format(ckeg,2,',','.');

        
        var again1x = cekkk-ckeg;
        $("#selisih").attr("value",again1x);
       var xxx = cc -nilaireal;
       
       $("#again").attr("value",xxx);
       if(again1x < 0){
        alert("Nilai Perubahan Tidak Boleh Lebih Kecil Dari Yang Telah Direalisasikan Senilai "+relkeg+" ...!!!!");
         exit();
       }

       if(xxx < 0){
        alert("Nilai Perubahan Senilai "+cekkk+" Tidak Boleh Lebih Kecil Dari Yang Telah Direalisasikan Senilai "+relkeg+" ...!!!!");
         exit();
       }
        ...
        for(var i=0;i<rows.length;i++){     
			...
			cvolume_ubah  = rows[i].volume_ubah1;
            csatuan_ubah  = rows[i].satuan_ubah1;
            cvolume_ubah  = rows[i].volume_ubah;
            charga_ubah   = angka(rows[i].harga_ubah1);
            ctotal_ubah   = angka(rows[i].total_ubah);
            ctotal_real   = angka(rows[i].realisasi_lalu);
            ctotal_sisa   = angka(rows[i].sisa_real); 
            no            = i + 1 ;  
            ...
            if ( i > 0 ) {
                csql = csql+","+"('"+no+"','"+norka+"','"+curaian+"','"+cvolume1+"','"+csatuan1+"','"+cvolume+"','"+charga1+"','"+ctotal+"','"+cvolume_ubah+"','"+csatuan_ubah+"','"+cvolume_ubah+"','"+charga_ubah+"','"+ctotal_sisa+"','"+ctotal_real+"','"+ctotal_ubah+"')";
            } else {
                csql = "values('"+no+"','"+norka+"','"+curaian+"','"+cvolume1+"','"+csatuan1+"','"+cvolume+"','"+charga1+"','"+ctotal+"','"+cvolume_ubah+"','"+csatuan_ubah+"','"+cvolume_ubah+"','"+charga_ubah+"','"+ctotal_sisa+"','"+ctotal_real+"','"+ctotal_ubah+"')";                                            
            } 
			
        } 
		 $.ajax({
			type: "POST",
			url: '<?php echo base_url(); ?>/index.php/rka/tsimpan_rinci_dh',
   ...
   function detsimpan_ubah(){    
        ...
        for(var i=0;i<rows.length;i++){     
			...
			if ( i > 0 ) {
                csql = csql+","+"('"+no+"','"+norka+"','"+curaian+"','"+cvolume1+"','"+csatuan1+"','"+cvolume+"','"+charga1+"','"+ctotal+"','"+cvolume_ubah+"','"+csatuan_ubah+"','"+cvolume_ubah+"','"+charga_ubah+"','"+ctotal_ubah+"')";
            } else {
                csql = "values('"+no+"','"+norka+"','"+curaian+"','"+cvolume1+"','"+csatuan1+"','"+cvolume+"','"+charga1+"','"+ctotal+"','"+cvolume_ubah+"','"+csatuan_ubah+"','"+cvolume_ubah+"','"+charga_ubah+"','"+ctotal_ubah+"')";                                            
            } 
			
        } 
		 $.ajax({
			type: "POST",
			url: '<?php echo base_url(); ?>/index.php/rka/tsimpan_rinci_dh_ubah',
			data: ({no:norka,sql:csql,skpd:cskpd,giat:cgiat}),
			dataType:"json",
			success:function(data){    
				status = data.pesan;  
  ...
  function proses_four(){
   var cgiat = document.getElementById('giat').value;
    var cskpd = document.getElementById('skpd').value;
        if(cskpd==''){
      alert('Silahkan isi Terlebih Dahulu Kode SKPD');
      exit();
    }else{
      ...
      $(function(){      
       $.ajax({
        type: 'POST',
        data: ({csts:'susun',cskpdx:cskpd,cg:cgiat}),
        dataType:"json",
        url:"<?php echo base_url(); ?>index.php/rka/simpan_trskpd_four_ubah_dh",
        success:function(data){
          if (data = 1){
            alert('Anggaran Kas Berhasil di Proses...!!!');
            $('#kdgiat').combogrid('grid').datagrid('reload');
          }else{
    ...
    function append_save() {
            ...
            var norka       = cskpd+'.'+cgiat+'.'+crek;
            var cek         = document.getElementById('nreal').value;
            var cek_nilkeg  =angka(document.getElementById('rektotal_ubah_cek').value);  
            var cek_sel     =angka(document.getElementById('nilkeg').value);  
            ...
            var sat1   = document.getElementById('sat1').value;
            var nilai  = document.getElementById('harga').value ;
            var realisasi   =document.getElementById('realisasi_lalu').value; 
            var harga  = angka(nilai) ;
            var realisasi=angka(realisasi);
            var tvol   = volu1;
            var total  = volu1*harga;
            var sisa   = total-realisasi;
            
            var fharga = number_format(harga,2,'.',',');           
            var ftotal = number_format(total,2,'.',',');
            var reali  = number_format(realisasi,2,'.',',');
            var sisaa  = number_format(sisa,2,'.',',');           
           
            var id     = jgrid  ;
            
			$('#dg1').edatagrid('appendRow',{id:id,uraian:uraian,volume1:'',satuan1:'',volume:'',harga1:'',total:'',volume_ubah1:vol1,satuan_ubah1:sat1,volume_ubah:tvol,harga_ubah1:fharga,total_ubah:ftotal,realisasi_lalu:reali,sisa_real:sisaa});
            $("#dg1").datagrid("unselectAll");
            
            var total_awal  = angka(document.getElementById('rektotal_rinci_ubah').value) ;
            var total_rinci = sisa;
                total_rinci = total_rinci + total_awal; 
            var sel = total_rinci - cek;
            var aa=cek_nilkeg+sisa; 
            var cek_hela= aa-cek_sel;         
			$("#rektotal_rinci_ubah").attr("value",number_format(total_rinci,2,'.',','));
            $("#total_rinci_ubah").attr("value",number_format(total_rinci,0,'',''));
            $("#again").attr("value",number_format(sel,0,'',''));
            $("#rektotal_ubah_cek").attr("value",number_format(aa,0,'',''));
            $("#selisih").attr("value",number_format(cek_hela,0,'',''));
                  kosong();
    ...
    function kosong(){
            ...
            $("#realisasi_lalu").attr("value",'');
            $("#sisa_real").attr("value",'');
			...
			function cetak(){
                ...
                var keg     = $('#kdgiat').combogrid("getValue");
                var url     = "<?php echo site_url(); ?>/rka/preview_dpal_dh/";  
                window.open(url+skpd+'/'+keg+'/'+1, '_blank');
                window.focus();
    }
    ...
    function hit_sisa(){
        ...
        if (realisasi=='' || realisasi=='undefined'){
            realisasi='0.00';
        }else{
            realisasi=realisasi;
        }
        ...
        var fsisa  = number_format(sisa,2,'.',',');
        $('#sisa_real').attr('value',fsisa);

    }

    function hit_sisa_edit(){
        var vol1   = document.getElementById('vol1_edit').value; 
        var nilai  = document.getElementById('harga_edit').value ;
        var realisasi   =document.getElementById('realisasi_lalu_edit').value;
        if ( vol1 == '' ){
                 volu1=1;
            }else{
                volu1=vol1
        ...
        var fsisa  = number_format(sisa,2,'.',',');
        $('#sisa_real_edit').attr('value',fsisa);
...
<div id="content">
   ...
   <?php echo $prev; ?><p id="p1" style="font-size: x-large;color: red;"></p><br />
    <p id="p3" style="font-size:18px;color: red;"></p><br />
   ...
   <tr style="border-style:hidden;">
	   <td>S K P D</td>
	   <td><input id="sskpd" name="sskpd" readonly="true" style="width:170px;border: 0;" />
	   <input id="nmskpd" name="nmskpd" readonly="true" style="width: 520px; border:0;"/></td>
   </tr>
   <tr style="border-style:hidden;">
   <td>TOTAL BL</td>
   <td><input class="right" type="text" name="rektotal2" id="rektotal2"  style="width:170px;text-align:right;"  readonly="true"/></td>
   </tr>
   <tr style="border-style:hidden;">
	   <td>KEGIATAN</td>
	   <td><input id="kdgiat" name="kdgiat" style="width:170px;" />  
   ...
   <tr style="border-spacing:3px;padding:3px 3px 3px 3px;border-collapse:collapse;border-bottom-style:hidden;">
	   <td>SUMBER DANA</td>
	   <td><input id="sdana1" name="sdana1" style="width:170px;"/><!--   
	   <input id="sdana2" name="sdana2" style="width:170px;"/>  
	   <input id="sdana3" name="sdana3" style="width:170px;"/> 
	   <input id="sdana4" name="sdana4" style="width:170px;"/> --></td> 
   </tr>
...
<h2><a href="#" id="section1" onclick="javascript:validate_combo()">Rekening Anggaran Perubahan</a></h2>
   ...
   <div  style="height:700px;">      
       ...
       <tr>
		   ...
		   <td style="border-spacing:3px;padding:3px 3px 3px 3px;border-collapse:collapse;width:770px;border-bottom-style:hidden;" colspan="4"><input id="kdrek5" name="kdrek5" style="width:150px;" />  
		   <input id="nmrek5" name="nmrek5" readonly="true" style="width:300px;border:0;background-color:transparent;color:black;" disabled="true" />
		   </td>
       </tr>
       ...
       <table id="dg" title="Input Rekening Rencana Kegiatan Anggaran Perubahan" style="width:880px;height:400px;" >          
       </table>  
        <div id="toolbarx">
			...
			<td align="left">
                    <button id="print" class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:cetak()">Cetak DPAL</button>&nbsp;&nbsp;&nbsp;&nbsp;
                    <!-- <button id="print" class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:cetak2()">Cetak DPA UBAH</button> -->
            </td >
			
			<td align="right">
            <B>Total</B>&nbsp;&nbsp;<input class="right" type="text" name="rektotal" id="rektotal"  style="width:150px;text-align:right;"  readonly="true"/>&nbsp;&nbsp;<input class="right" type="text" name="rektotal_ubah" id="rektotal_ubah"  style="width:150px;text-align:right;"  readonly="true"/>
            <input class="right" type="hidden" name="rektotal_ubah_cek" id="rektotal_ubah_cek"  style="width:150px;text-align:right;"  readonly="true"/><input class="right" type="hidden" name="nilkeg" id="nilkeg"  style="width:150px;text-align:right;"  readonly="true"/><input class="right" type="hidden" name="selisih" id="selisih"  style="width:150px;text-align:right;"  readonly="true"/>
            </td></tr>
            </table>
        </div>
    </div>
    
<h3><a href="#" id="section2">Rincian Rekening Perubahan</a></h3>
    
    <div>

        <table border='1' style="width:800px;">
        <tr style="border-spacing:3px ;padding:3px 3px 3px 3px;border-collapse:collapse;border-bottom-style:hidden;">
            <td colspan='6' style="border-spacing:3px ;padding:3px 3px 3px 3px;border-collapse:collapse;border-bottom-style:hidden;"><input type="hidden" id="noid" style="width: 200px;" /><input type="hidden" id="nopo" style="width: 200px;" /><input type="hidden" id="reke" style="width: 200px;" /></td>
        </tr>
        <tr style="border-spacing:3px ;padding:3px 3px 3px 3px;border-collapse:collapse;border-bottom-style:hidden;">
			...
			<td style="border-bottom-style:hidden; border-spacing:3px ;padding:3px 3px 3px 3px;border-collapse:collapse;" colspan="6"><input type="text" id="uraian" style="width: 800px;" onkeypress="javascript:enter(event.keyCode,'vol1');"/></td>
        </tr>
        <tr style="border-spacing:3px ;padding:3px 3px 3px 3px;border-collapse:collapse;border-bottom-style:hidden;">
            ...
            <td style="border-right-style:hidden; border-bottom-style:hidden;border-spacing:3px ;padding:3px 3px 3px 3px;border-collapse:collapse;">Vol Ubah</td>
            <td style="border-right-style:hidden; border-bottom-style:hidden;border-spacing:3px ;padding:3px 3px 3px 3px;border-collapse:collapse;">Sat Ubah</td>
            <td style="border-right-style:hidden; border-bottom-style:hidden;border-spacing:3px ;padding:3px 3px 3px 3px;border-collapse:collapse;">Harga</td>
            <td style="border-right-style:hidden; border-bottom-style:hidden;border-spacing:3px ;padding:3px 3px 3px 3px;border-collapse:collapse;">Realisasi</td>
            <td style="border-bottom-style:hidden;border-spacing:3px ;padding:3px 3px 3px 3px;border-collapse:collapse;">Sisa</td>
        </tr>
        <tr style="border-spacing:3px ;padding:3px 3px 3px 3px;border-collapse:collapse;">
            ...
            <td style="border-right-style:hidden; border-bottom-color:black;border-style-bottom:hidden;border-spacing:3px ;padding:3px 3px 3px 3px;border-collapse:collapse;"><input type="text" id="vol1" style="width: 90px;" onkeypress="javascript:enter(event.keyCode,'sat1');" onkeyup="hit_sisa();"/></td>
            ...
            <td style="border-right-style:hidden; border-bottom-color:black;border-style-bottom:hidden;border-spacing:3px ;padding:3px 3px 3px 3px;border-collapse:collapse;"><input type="text" id="harga" style="width: 175px; text-align: right;"  onkeypress="javascript:enter(event.keyCode,'realisasi_lalu');return(currencyFormat(this,',','.',event));" onkeyup="hit_sisa();"/></td>
            <td style="border-right-style:hidden; border-bottom-color:black;border-style-bottom:hidden;border-spacing:3px ;padding:3px 3px 3px 3px;border-collapse:collapse;"><input type="text" id="realisasi_lalu" style="width: 175px;text-align: right;" onkeypress="javascript:enter(event.keyCode,'uraian');return(currencyFormat(this,',','.',event));" onkeyup="hit_sisa();"/></td>
            <td style="border-spacing:3px ;padding:3px 3px 3px 3px;border-bottom-color:black;"><input type="text" id="sisa_real" name="sisa_real" style="width: 175px; text-align: right;" disabled="true"/></td>
        </tr>   
        </table>
        ...
        <tr style="border-style: hidden;">
			...
			<B>Total</B>&nbsp;&nbsp;&nbsp;&nbsp;<input class="right" type="text" name="rektotal_rinci" id="rektotal_rinci"  style="width:130px" align="right" readonly="true" />&nbsp;&nbsp;<input class="right" type="text" name="rektotal_rinci_ubah" id="rektotal_rinci_ubah"  style="width:130px" align="right" readonly="true" /><br />
          <B>REALISASI</B> <input name="nreal" id="nreal"  style="width:130px; background:#FCA4AD; text-align:right"  readonly="true" hidden />
          <input name="nrealnumber" id="nrealnumber"  style="width:130px; background:#FCA4AD; text-align:right"  readonly="true" />
            <input class="right" type="hidden" name="total_rinci_ubah" id="total_rinci_ubah"  style="width:130px" align="right" readonly="true" />
            <input class="right" type="hidden" name="again" id="again"  style="width:130px" align="right" readonly="true" />
			</td>
        </tr>
        </table>
    </div>   
        ...
        $(function(){
			...
			$('#dg2').edatagrid({
				url: '<?php echo base_url(); ?>/index.php/rka/rka_hukum_ms/'+mskpd+'/'+mgiat,
                 ...
                 singleSelect:false,
				 columns:[[
 					{field:'kd_hukum',title:'kode',width:5,hidden:true,editor:{type:"text"}},
					{field:'nm_hukum',title:'Dasar Hukum',width:780,editor:{type:"text"}},
                    {field:'ck',title:'ck',width:5,checkbox:true}
				]]	
...
//kegiatan
	function simpan_det_keg(){
		...
		$(function(){      
         $.ajax({
            ...
            dataType:"json",
            url:"<?php echo base_url(); ?>index.php/rka/simpan_det_keg_tn",
			success:function(data){ 
					alert('Data Tersimpan');
					section1();
					}
    ...
    function load_detail_keg(){                
		var a = document.getElementById('skpd').value;
        var b = document.getElementById('giat').value;
		var s = 'Rp. '+document.getElementById('rektotal_ubah').value;
        $(function(){      
         $.ajax({
            type: 'POST',
            data:({skpd:a,keg:b}),
            url:"<?php echo base_url(); ?>index.php/rka/load_det_keg_tn",
            dataType:"json",
            success:function(data){ 
				$("#m_ck").attr("value",s);
                $.each(data, function(i,n){
					if(n['lokasi'] == ''){  
						n['lokasi'] ='Biak Numfor';
					}
					if( n['m_tu']== ''){
						n['m_tu']= 'Sejumlah Dana';
					}
...
<div id="dialog-modal-edit" title="Edit Rincian Rekening">
    ...
    <table border='0' style="width:800px;">
        <tr>
            <td><input type="hidden" id="noid_edit" style="width: 200px;" /><input type="hidden" id="nopo_edit" style="width: 200px;" /><input type="hidden" id="total_edit" style="width: 200px;" /><input type="hidden" id="reke" style="width: 200px;" /></td>
        </tr>
        <tr>
			<td>Uraian&nbsp;&nbsp;&nbsp;</td>
			<td colspan="5"><input type="text" id="uraian_edit" style="width: 800px;" onkeypress="javascript:enter(event.keyCode,'vol1_edit');"/></td>
        </tr>
        <tr>
            <td></td>
            <td style="width: 90px;" align="left">Vol Ubah</td>
            <td style="width: 90px;" align="left">Sat Ubah</td>
            <td style="width: 175px;" align="left">Harga Ubah</td>
            <td style="width: 175px;" align="left">Realisasi</td>
            <td style="width: 175px;" align="left">Sisa</td>

        </tr>
        <tr>
            <td></td>
            <td style="width: 90px;"><input type="text" id="vol1_edit" style="width: 90px;" onkeypress="javascript:enter(event.keyCode,'sat1_edit');" onkeyup="hit_sisa_edit();"/></td>
            <td style="width: 90px;"><input type="text" id="sat1_edit" style="width: 90px;" onkeypress="javascript:enter(event.keyCode,'harga_edit');" /></td>
            <td style="width: 620px;"><input type="text" id="harga_edit" style="width: 175px; text-align: right;"  onkeypress="javascript:enter(event.keyCode,'realisasi_lalu_edit');return(currencyFormat(this,',','.',event));" onkeyup="hit_sisa_edit();"/></td>
            <td style="width: 620px;"><input type="text" id="realisasi_lalu_edit" style="width: 175px; text-align: right;"  onkeypress="javascript:doSomething(this, event); return(currencyFormat(this,',','.',event))" onkeyup="hit_sisa_edit();"/></td>
            <td style="width: 620px;"><input type="text" id="sisa_real_edit" style="width: 175px;" disabled="true"/></td>
        </tr>  
        ...
        <tr>
			<td colspan="6" align="center">
				<button class="easyui-linkbutton" iconCls="icon-save" plain="true" onclick="javascript:pilih_edit();">Pilih</button>
