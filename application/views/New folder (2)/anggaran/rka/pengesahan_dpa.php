...
<head>   
  ...
  <script type="text/javascript">
    ...
    var lcstatus = '';
     ...
     $('#dg').edatagrid({
        ...
        onSelect:function(rowIndex,rowData){
		  ...
		  srka =rowData.status_rka;
          get(ckd_skpd,csts_dpa,csts_dppa,cno_dpa,ctgl_dpa,cno_dppa,ctgl_dppa,srka); 
          lcidx = rowIndex;                           
        },
    ...
    function get(ckd_skpd,csts_dpa,csts_dppa,cno_dpa,ctgl_dpa,cno_dppa,ctgl_dppa,srka){
		...
		if (srka==2){            
            $("#rka").attr("checked",true);
        } else {
            $("#rka").attr("checked",false);
        }
    ...
    $(function(){ 
     ...
     function simpan_pengesahan(){
		...
		var crk2 = document.getElementById('rka').checked;
        if (crk2==false){
           crk2=0;
        }else{
            crk2=2;
        ...
        if (ckd==''){
            ...
            $(document).ready(function(){
                $.ajax({
                    ...
                    data: ({tabel:'trhrka',kdskpd:ckd,stdpa:cst1,stdppa:cst2,no:cno1,tgl:ctgl1,no2:cno2,tgl2:ctgl2,crka:crk2}),
                    dataType:"json"
                });
            });
...
<h3 align="center"><u><b><a>PENGESAHAN DPA & DPPA</a></b></u></h3>
    ...
    <table style="width:400px;" border="0">
        ...
        <tr>
        <td colspan="4">
        <table id="dg" title="LISTING DATA PENGESAHAN" style="width:900px;height:440px;" >  
        </table>
        </td>
        </tr>
    </table>    
...
<div id="dialog-modal" title="">
    ...
    <fieldset>
     <table align="center" style="width:100%;" border="0">
			...
			<td width="30%">Koreksi RKA</td>
				<td width="1%">:</td>
				<td><input type="checkbox" id="rka"  onclick="javascript:runEffect();"/></td>
			</tr>
            <tr>
