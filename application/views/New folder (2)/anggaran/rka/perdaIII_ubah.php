        ...
        <div style="font-size: 12px"><center>
            ...
            <table class="narrow">
                ...
                <tr>                
                    ...
                    <td>                     
                        <a href="<?php echo site_url(); ?>/rka/preview_perdaIII_ubah/<?php echo $skpd->kd_skpd;?>/0" >
...
<a class="link" name ="<?php echo site_url(); ?>/rka/preview_perdaIII_ubah/<?php echo $skpd->kd_skpd; ?>/1" target='_blank'>
<img src="<?php echo base_url(); ?>assets/images/icon/print_pdf.png" width="25" height="23" title="cetak"/></a>
                        
<a href="<?php echo site_url(); ?>/rka/preview_perdaIII_ubah/<?php echo $skpd->kd_skpd; ?>/2">
