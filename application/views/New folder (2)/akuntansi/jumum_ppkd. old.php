...
<head>
    ...
    $(function(){ 
     $('#dg').edatagrid({
        ...
        onSelect:function(rowIndex,rowData){    
           ...
           get(nomor,tgl,skpd,nmskpd,ket,total_d,total_k,identitas);
           load_detail();
        },
    ...
    function get(nomor,tgl,skpd,nmskpd,ket,total_d,total_k,identitas){
...
<h3><a href="#" id="section2">JURNAL UMUM</a></h3>
   ...
   <p>         
        <table align="center" style="width:100%;">
            ...
            <td>jenis jurnal</td>
            <td>
                    <select name="jns_jurnal" id="jns_jurnal">
                        <option value="">......</option>     
                        <option value="Penyesuaian">Penyesuaian</option>
                        <option value="Koreksi">Kokreksi</option>
                    </select>
                </td>			
