...
<head>
    ...
    var lcstatus = '';
     ...
     $(function(){ 
     $('#dg').edatagrid({
		url: '<?php echo base_url(); ?>/index.php/akuntansi/load_neraca_ppkd_awal',
        idField:'id',            
        rownumbers:"true", 
        fitColumns:"true",
        singleSelect:"true",
    ...
    function kosong(){
       ...
       function simpan(){
        ...
        if(lcstatus=='tambah'){ 
            ...
            lcquery = "UPDATE map_neraca_ppkd SET uraian='"+curaian+"',nilai='"+lntotal+"' where kode='"+cno+"'";
            //alert(lcquery);
			var cek_kd = lparent;
			//alert(cek_kd);
            $(document).ready(function(){
            $.ajax({
                type: "POST",
                url: '<?php echo base_url(); ?>/index.php/akuntansi/update_master_ppkd_tamp',
