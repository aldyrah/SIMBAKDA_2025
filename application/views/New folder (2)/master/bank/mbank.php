  ...
  <script type="text/javascript">
    ...
    $(function(){ 
        ...
        if(lcstatus=='tambah'){ 
            ...
            $(document).ready(function(){
                $.ajax({
                    ...
                    data: ({tabel:'ms_bank',kolom:lcinsert,nilai:lcvalues,cid:'kode',lcid:ckode}),
                    dataType:"json"
                });
            });   
            ...
            lcquery = "UPDATE ms_bank SET nama='"+cnama+"' where kode='"+ckode+"'";
     ...
     function hapus(){
        ...
        $(document).ready(function(){
         $.post(urll,({tabel:'ms_bank',cnid:ckode,cid:'kode'}),function(data){
            status = data;
            if (status=='0'){
                alert('Gagal Hapus..!!');
                exit();
...
<div id="content"> 
<h3 align="center"><u><b><a>INPUTAN MASTER BANK</a></b></u></h3>
    <div align="center">
    <p align="center">     
