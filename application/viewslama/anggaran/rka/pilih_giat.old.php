        ...
        function append_jak(){  
            ...
            $(document).ready(function(){
               $.ajax({
                      ...
                      data     : ({urusan:vurus,skpd:vkdskpd,kegiatan:vkdkegi,jns:jenis}),
                      dataType : "json",
...
<div id="content">   
  ...
  <tr style="border-collapse:collapse; border-spacing:3px; padding: 3px 3px 3px 3px;border-bottom-color:transparent;">    
  <td style="border-collapse:collapse; border-spacing:3px; padding: 3px 3px 3px 3px;border-bottom-color:transparent;">
  <input type="hidden" id="jns_giat" name="jns_giat" style="width: 70px;" /><input type="hidden" id="ljt" name="ljt" style="width: 70px;" /></td>
  </tr>
