...
<h5 align="center"><b><a href="#" id="section1">PAJAK</a></b></h5>
 ...
 <fieldset>
     <table align="center" style="width:100%;" border="0">  
			<tr>
				<td colspan="2" align="center" style="border-top:solid 1px red;border-bottom:solid 1px red"><i>DPPA SKPD</i></td>
			</tr>
			<tr>
				<td width="64%" />&nbsp;</td>
            ...
            <tr>
			  <td width="64%" align="left"><input type="radio" name="cetak" value="2" onclick="opt(this.value)"/>
				&nbsp;DPPA1</td>
			  <td width="2%" align="left"><input type="radio" name="cetak" value="6" onclick="opt(this.value)"/>&nbsp;DPA1&nbsp;</td>
			</tr>
			<tr>
			  <td width="64%" align="left"><input type="radio" name="cetak" value="3" onclick="opt(this.value)"/>
				DPPA21</td>
			  <td width="2%" align="left"><input type="radio" name="cetak" value="7" onclick="opt(this.value)"/>&nbsp;DPA21&nbsp;</td>
			</tr>
            <tr>
			  <td width="64%" align="left"><input type="radio" name="cetak" value="4" onclick="opt(this.value)"/>
				DPPA22</td>
			  <td width="2%" align="left"><input type="radio" name="cetak" value="8" onclick="opt(this.value)"/>&nbsp;DPA22&nbsp;&nbsp;</td>
			</tr>
