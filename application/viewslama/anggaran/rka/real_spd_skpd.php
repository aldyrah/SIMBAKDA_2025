...
<head>
	...
	$('#sskpd').combogrid({  
		...
		function cetak()
        {
			...
			var url    = "<?php echo site_url(); ?>/rka/preview_real_spd_hibah/1/";  
			lc= '?posx='+periode1+'&posy='+periode2+'&skpd='+skpd;
...
<div id="content"> 
<div id="accordion">
<h5 align="center"><b><a href="#" id="section1">REALISASISPD</a></b></h5>
 <fieldset>
     <table align="left" style="width:100%;" border="0">
            <tr>
                <td colspan="5" align="left">PERIODE</td>
            </tr>            
            <tr>
                <td width="47">Tanggal</td>
                <td width="140" align="left"><input type="text" id="perid1" style="width: 140px;" /></td>
				<td width="42" align="left">s . d </td>
				<td width="140" align="left"><input type="text" id="perid2" style="width: 140px;" /></td>
				<td width="722" align="left">&nbsp;</td>
            </tr>
	 </table>
