  ...
  <script type='text/javascript'>
    ...
    $(function(){
      $('.autocomplete').autocomplete({
        serviceUrl: site+'/rka/ambil_urai',
    ...
    $(function(){
	       ...
	       $('#dg').edatagrid({
            ...
            {field:'sumber',title:'Sumber',width:25,align:'left'},
					 {field:'rinci',
					  ...
					  formatter:function(value,rec){
							...
							return "<a href=\"javascript:void(0)\" style=\"color:blue\" onclick=\"section('"+rek+"','"+nmrek+"')\" >Rincian</a>";
						}
			 		}
                    /*
                    ,
            ...
            columns    : [[  
                ...
                {field:'nm_rek5',title:'Nama ',width:600}    
            ]],
            onSelect:function(rowIndex,rowData){
            ...
            $("#sdana1").combogrid({
                ...
                textField :'nm_sdana',
                mode      :'remote',
                url       : '<?php echo base_url(); ?>index.php/rka/ambil_sdana_ms',
                columns   : [[
        ...
        function validate_giat(){
          ...
          $("#sdana1").combogrid("setValue",'');
            ...
            columns    : [[  
                ...
                {field:'sumber',title:'Sumber',width:200},
                {field:'nilai',title:'Nilai',align:'right',width:120}
            ]],
            onSelect:function(rowIndex,rowData){
   ...
   function detsimpan(){    
        ...
        for(var i=0;i<rows.length;i++){     
		 ...
		 $.ajax({
			type: "POST",
			url: '<?php echo base_url(); ?>/index.php/rka/tsimpan_rinci_toni',
   ...
   var cgiat = document.getElementById('giat').value;
    var cskpd = document.getElementById('skpd').value;
      ...
      $(function(){      
       $.ajax({
        ...
        dataType:"json",
        url:"<?php echo base_url(); ?>index.php/rka/simpan_trskpd_four_dh",
        success:function(data){
          if (data = 1){
	...
	function load_sum_skpd(){                
		var a = document.getElementById('skpd').value;
        $(function(){      
         $.ajax({
            type: 'POST',
            data:({skpd:a}),
            url:"<?php echo base_url(); ?>index.php/rka/load_sum_skpd_ms",
            dataType:"json",
            success:function(data){ 
                $.each(data, function(i,n){
    ...
    function input(){
        ...
        //$("#sdana2").combogrid("disable");
        //$("#sdana3").combogrid("disable");
        //$("#sdana4").combogrid("disable");
    ...
    function tambah(){
        ...
        $.ajax({
           ...
           url      : '<?php echo base_url(); ?>index.php/rka/tsimpan_ar_dh', 
           success  : function(data){
                      st12 = data;
                      if ( st12 == '1' ){
    ...
    function load_detail_keg(){                
		var a = document.getElementById('skpd').value;
        var b = document.getElementById('giat').value;
		var s = 'Rp. '+document.getElementById('rektotal').value;
    var d = 'Sejumlah Dana';
        $(function(){      
         $.ajax({
            type: 'POST',
    ...
    function append_save() {
            ...
            if(harga==null || harga=='' || harga==0||harga==0.00){
            harga=0.00;
           } 
    ...
    function pilih_edit(){
            ...
            //alert(harga_edit);
            if(harga_edit==null || harga_edit=='' || harga_edit==0||harga_edit==0.00){
            harga_edit=0.00;
           }
	...
	function cetak(){
        ...
        var keg = $('#kdgiat').combogrid("getValue");
            ...
            var url    = "<?php echo site_url(); ?>/rka/preview_rka221/";  
    ...
    function cetak2(){
        ...
        var keg = $('#kdgiat').combogrid("getValue");
            ...
            var url    = "<?php echo site_url(); ?>/rka/preview_dpa221/";  
            //lc= skpd/keg/1;
            window.open(url+skpd+'/'+keg+'/'+1, '_blank');
            window.focus();
    }
...
<div id="content">
   ...
   <tr style="border-spacing:3px;padding:3px 3px 3px 3px;border-collapse:collapse;border-bottom-style:hidden;">
       <td>SUMBER DANA</td>
       <td><input id="sdana1" name="sdana1" style="width:170px;" readonly="true"/>  
...
<h2><a href="#" id="section1" onclick="javascript:validate_combo()">Rekening Anggaran</a></h2>
   ...
   <div  style="height:700px;">      
       ...
       <td style="border-spacing:3px;padding:3px 3px 3px 3px;border-collapse:collapse;width:170px;border-bottom-style:hidden;border-right-style:hidden;"><input id="nilairek" name="nilairek" style="width:170px;text-align:right;" readonly="true"/><input type='hidden' id="cek_kas" name="cek_kas" style="width:170px;text-align:right;"/></td>
       ...
       <button id="add" class="easyui-linkbutton" iconCls="icon-save" plain="true" onclick="javascript:tambah()">Simpan</button><br><br>
       ...
       <table id="dg" title="Input Rekening Rencana Kegiatan Anggaran" style="width:880px;height:400px;" >          
        ...
        <div id="toolbarx">
            ...
            <tr>
			<td align="left">
                    <button id="print" class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:cetak()">Cetak RKA</button>&nbsp;&nbsp;&nbsp;&nbsp;
                    <button id="print" class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:cetak2()">Cetak DPA</button>
            </td ><td align="right">
...
<h3><a href="#" id="section2">Rincian Rekening</a></h3>
    ...
    <div>
        ...
        <td style="border-bottom-style:hidden; border-spacing:3px ;padding:3px 3px 3px 3px;border-collapse:collapse;" colspan="3"><input type="text" id="uraian" style="width: 800px;" onkeypress="javascript:enter(event.keyCode,'vol1');" value="" class='autocomplete'/></td>
        </tr>
        <tr style="border-spacing:3px ;padding:3px 3px 3px 3px;border-collapse:collapse;border-bottom-style:hidden;">
        ...
        <tr style="border-spacing:3px ;padding:3px 3px 3px 3px;border-collapse:collapse;">
            ...
            <input type="hidden" id="vol2" style="width: 90px;" onkeypress="javascript:enter(event.keyCode,'sat2');"/>
            <input type="hidden" id="sat2" style="width: 90px;" onkeypress="javascript:enter(event.keyCode,'vol3');"/>
            <input type="hidden" id="vol3" style="width: 90px;" onkeypress="javascript:enter(event.keyCode,'sat3');"/>
            <input type="hidden" id="sat3" style="width: 90px;" onkeypress="javascript:enter(event.keyCode,'harga');"/></td>
...
<h3><a href="#" id="section4" onclick="javascript:load_detail_keg();" >Detail Kegiatan</a></h3>
	...
	<tr style="border-spacing:0px;padding:0px 0px 0px 0px;border-collapse:collapse;border-style:hidden;" >
		...
		<td style="border-spacing:0px;padding:0px 0px 0px 0px;border-collapse:collapse;">&nbsp;&nbsp;</td>
		<td style="border-spacing:0px;padding:0px 0px 0px 0px;border-collapse:collapse;" align="center"><textarea id="m_tu" name="m_tu" rows='2' cols="45" readonly="true" > </textarea></td>
		<td style="border-spacing:0px;padding:0px 0px 0px 0px;border-collapse:collapse;">&nbsp;&nbsp;</td>
		<td style="border-spacing:0px;padding:0px 0px 0px 0px;border-collapse:collapse;" align="center"><textarea id="m_ck" name="m_ck" rows='2' cols="45" readonly="true" > </textarea></td>
	</tr>
	<tr style="border-spacing:0px;padding:0px 0px 0px 0px;border-collapse:collapse;border-style:hidden;" >
...
<div id="dialog-modal-edit" title="Edit Rincian Rekening">
    ...
    <table border='0' style="width:800px;">
        ...
        <tr style="border-spacing:3px ;padding:3px 3px 3px 3px;border-collapse:collapse;border-bottom-style:hidden;">
        <td style="border-right-style:hidden;  border-bottom-style:hidden; border-spacing:3px ;padding:3px 3px 3px 3px;border-collapse:collapse;">Uraian&nbsp;&nbsp;&nbsp;</td>
        <td style="border-bottom-style:hidden; border-spacing:3px ;padding:3px 3px 3px 3px;border-collapse:collapse;" colspan="7"><input type="text" id="uraian_edit" style="width: 800px;" onkeypress="javascript:enter(event.keyCode,'vol1_edit');"/></td>
        </tr>
        <tr style="border-spacing:3px ;padding:3px 3px 3px 3px;border-collapse:collapse;border-bottom-style:hidden;">
            <td style="border-right-style:hidden; border-bottom-style:hidden;border-spacing:3px ;padding:3px 3px 3px 3px;border-collapse:collapse;"></td>
            <td style="border-right-style:hidden; border-bottom-style:hidden;border-spacing:3px ;padding:3px 3px 3px 3px;border-collapse:collapse;">Vol1</td>
        ...
        <tr style="border-spacing:3px ;padding:3px 3px 3px 3px;border-collapse:collapse;">
            <td style="text-align:center; border-right-style:hidden; border-bottom-color:black;border-style-bottom:hidden;border-spacing:3px ;padding:3px 3px 3px 3px;border-collapse:collapse;"></td>
            <td style="border-right-style:hidden; border-bottom-color:black;border-style-bottom:hidden;border-spacing:3px ;padding:3px 3px 3px 3px;border-collapse:collapse;"><input type="text" id="vol1_edit" style="width: 90px;" onkeypress="javascript:enter(event.keyCode,'sat1_edit');"/></td>
            <td style="border-right-style:hidden; border-bottom-color:black;border-style-bottom:hidden;border-spacing:3px ;padding:3px 3px 3px 3px;border-collapse:collapse;"><input type="text" id="sat1_edit" style="width: 90px;" onkeypress="javascript:enter(event.keyCode,'harga_edit');"/>
            <input type="hidden" id="vol2_edit" style="width: 90px;" onkeypress="javascript:enter(event.keyCode,'sat2');"/>
            <input type="hidden" id="sat2_edit" style="width: 90px;" onkeypress="javascript:enter(event.keyCode,'vol3');"/>
            <input type="hidden" id="vol3_edit" style="width: 90px;" onkeypress="javascript:enter(event.keyCode,'sat3');"/>
            <input type="hidden" id="sat3_edit" style="width: 90px;" onkeypress="javascript:enter(event.keyCode,'harga');"/></td>
            <td style="border-spacing:3px ;padding:3px 3px 3px 3px;border-bottom-color:black;"><input type="text" id="harga_edit" style="width: 175px; text-align: right;"  onkeypress="javascript:doSomething(this, event); return(currencyFormat(this,',','.',event))"/></td>
            </td>
        </tr>  
