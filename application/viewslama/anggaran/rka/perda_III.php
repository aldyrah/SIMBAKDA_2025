	   ...
	   <hr>
        ...
        <table class="narrow">
            ...
            <tr>                
                ...
                <td>                     
                    <a href="<?php echo site_url(); ?>/rka/preview_perdaIII/<?php echo $skpd->kd_skpd; ?>"><img src="<?php echo base_url(); ?>assets/images/icon/print.png" width="25" height="23" title="preview"/></a>
                    <a class="link" name="<?php echo site_url(); ?>/rka/preview_perdaIIIpdf/<?php echo $skpd->kd_skpd; ?>" href="" target='_blank'><img src="<?php echo base_url(); ?>assets/images/icon/print_pdf.png" width="25" height="23" title="cetak pdf"/></a>
					                    <a class="link" name="<?php echo site_url(); ?>/rka/preview_perdaIIIexcel/<?php echo $skpd->kd_skpd; ?>" href="" target='_blank'><img src="<?php echo base_url(); ?>assets/images/icon/excel.jpg" width="25" height="23" title="cetak excel"/></a></td>
					</tr>
            <?php endforeach; ?>
        </table>
