...
$(function(){ 
    $('#trh').edatagrid({
        url: '<?php echo base_url(); ?>index.php/transaksi/trh_isianbrg_522',
        idField:'no_dokumen',            
        rownumbers:"true", 
        fitColumns:"true",
        singleSelect:"true",
        ...
        onSelect:function(rowIndex,rowData){
            ...
            getData(no_bukti,no,tgl,nilkon,nilapbd,kdcomp,kdmilik,kdwilayah,kduskpd,kd_unit,jnsdana,tahunang,buktibyr,dasaroleh,nooleh,tgloleh,tahunoleh,tot,cr_oleh,nrek5,sts_kdp);            
            updt = 't';            
...
$(function(){
    $('#cmbjenis').combogrid({           
        ...
        mode:'remote',
        panelWidth:400,
        url:'<?php echo base_url(); ?>index.php/master/ambil_gol_52',
        columns:[[  
...
$('#cmbjenis_u').combogrid({           
   ...
   $('#nomor').combogrid({  
            ...
            loadMsg:"Tunggu Sebentar....!!", 
            mode:'remote',
            url:'<?php echo base_url(); ?>index.php/master/ambil_nomor_kontrak_522',  
            columns:[[  
...
function getData(no_bukti,no,tgl,nilkon,nilapbd,kdcomp,kdmilik,kdwilayah,kduskpd,kd_unit,jnsdana,tahunang,buktibyr,dasaroleh,nooleh,tgloleh,tahunoleh,tot,cr_oleh,nrek5,sts_kdp)
    {
    //kosong();
...
<div id="content">    
<div id="accordion">
<h3><a href="#" id="section1"><i>PERENCANAAN & PENGAWASAN</i></a></h3>
<div>
    <p align="left">
    ...
    <p align="center">
      <table align="center" id="trh" title="LIST PERENCANAAN & PENGAWASAN" style="width:915px;height:350px;" >  
        </table>
    </p>
    </div> 
...
<!-- <div id="tabs" class="easyui-tabs"> -->
		<!-- <p><h3 align="center">FORMULIR PENGADAAN BARANG 522</h3></p>
    ...
    <!-- </div>  -->
    <h3><a href="#" id="section2"><i>INPUT PERENCANAAN & PENGAWASAN</i></a></h3>
    <div>  
        <br /><br />
