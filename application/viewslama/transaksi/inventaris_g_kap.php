...
<script type="text/javascript">
    ...
    //susut();
     ...
     $('#dg').edatagrid({
		url: '<?php echo base_url(); ?>index.php/transaksi/ambil_kib_g_kap',
        idField:'id',            
        rownumbers:"true", 
        fitColumns:"true",
        singleSelect:"true",
...
function load_detail(no_bukti,kd_skpd){
  ...
  $(function(){
            $('#dg_detail').edatagrid({
                url: '<?php echo base_url(); ?>/index.php/transaksi/load_dkap_g',
            ...
            columns:[[  
             ...
             onSelect:function(rowIndex,rowData){
                ...
                if(lcstatus =='tambah'){
                  ...
                  $('#tahun').attr('value','');
                  $('#alamat1').attr('value','');
                  $('#kib').combogrid({url:'<?php echo base_url(); ?>index.php/transaksi/kib_g_kap',
...
//           alert(test);
    ...
    function simpan(){
		...
		$(document).ready(function(){
                $.ajax({
                    type: "POST",
                    url: '<?php echo base_url(); ?>index.php/transaksi/simpan_trkib_g_kap',
                    data: ({tabel:'trkib_g_kap',
    ...
    function simpan_trdkapb_dh(){
        ...
        for(var p=0;p<rows.length;p++){
              ...
              if(p>0){ 
                ...
                $.ajax({
                    ...
                    dataType:'json', 
                    url: '<?php echo base_url(); ?>/index.php/transaksi/simpan_trkib_g_kap',   
                    data: ({tabel:'trdkibg_kap',bukti:nomor_bukti,skpd:skpd,unit:unit,id_b:id_b,sql:csql,gab:gab,jns_trans:jns_trans}),
     ...
     function hapus(){
      ...
      if(jns_trans=='1' && sts_reklas=='SR'){
		...
		if (del==true){     
        var urll = '<?php echo base_url(); ?>index.php/transaksi/hapus_trkib_g_kap_dh';
        $(document).ready(function(){
...
//alert(frek);
  if(sts_inp==1){
    ...
    $('#nodok').combogrid({  
       ...
       mode:'remote',
       loadMsg:"Tunggu Sebentar....!!",
       url:'<?php echo base_url(); ?>index.php/master/ambil_nomor_kontrak_kap_g',
...
<h3><a href="#" id="section1"><i>LIST KAPITALISASI KIB G / ATB</i></a></h3>
    <div>
      <p align="left">
    ...
    <p align="center">
      <table align="center" id="dg" title="LIST KAPITALISASI KIB G / ATB" style="width:940px;height:350px;" >  
        </table>
    </p>
    </div> 

<h3><a href="#" id="section2"><i>INPUT KAPITALISASI KIB G / ATB</i></a></h3>
<div >
