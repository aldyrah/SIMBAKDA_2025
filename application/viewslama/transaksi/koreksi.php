    ...
    //susut();
     ...
     $('#dg').edatagrid({
        ...
        columns:[[
            ...
            {field:'nm_skpd',title:'SKPD',width:22,align:"left"},
        ...
        onDblClickRow:function(rowIndex,rowData){
		  ...
		  get1(no_bukti,tgl_kap,no_reg,id_barang,no,no_dokumen,kd_brg,nm_brg,tgl_perolehan,hrg_perolehan,bidang,nm_bidang,keterangan,kd_skpd,nm_skpd,kd_unit,nm_unit,tahun,ket_kap,total_oleh_kap,jns_trans,luas,kondisi,alamat1);  
      load_detail(no_bukti,kd_skpd);
...
function load_detail(no_bukti,kd_skpd){
  ...
  $(function(){
            $('#dg_detail').edatagrid({
                url: '<?php echo base_url(); ?>/index.php/transaksi/load_dkap_a',
...
$('#bidang').combogrid({  
            ...
            columns:[[  
             ...
             onSelect:function(rowIndex,rowData){
                ...
                if(lcstatus =='tambah'){
                  ...
                  $('#tahun').attr('value','');
                  $('#alamat1').attr('value','');
                  $('#kib').combogrid({url:'<?php echo base_url(); ?>index.php/transaksi/kib_a_kap',
  ...
  function susut(){
    ...
    function get1(no_bukti,tgl_kap,no_reg,id_barang,no,no_dokumen,kd_brg,nm_brg,tgl_perolehan,hrg_perolehan,bidang,nm_bidang,keterangan,kd_skpd,nm_skpd,kd_unit,nm_unit,tahun,ket_kap,total_oleh_kap,jns_trans,luas,kondisi,alamat1){
    ...
    function simpan_trdkapb_dh(){
        ...
        for(var p=0;p<rows.length;p++){
              ...
              if(p>0){ 
                ...
                $.ajax({
                    ...
                    dataType:'json', 
                    url: '<?php echo base_url(); ?>/index.php/transaksi/simpan_trkib_a_kap',   
                    data: ({tabel:'trdkiba_kap',bukti:nomor_bukti,skpd:skpd,unit:unit,id_b:id_b,sql:csql,gab:gab,jns_trans:jns_trans}),
     ...
     function hapus(){
      ...
      if(jns_trans=='1' && sts_reklas=='SR'){
		...
		if (del==true){     
        var urll = '<?php echo base_url(); ?>index.php/transaksi/hapus_trkib_a_kap_dh';
        $(document).ready(function(){
...
function set_grid2(){
   ...
   function tambah_dkap(){
    ...
    //$('#dg_detail2').edatagrid('reload');
      if(skpd==''){
        swal({
          title: "Kode SKPD Tidak Boleh Kosong.!!",
          type:"warning"
          });
        exit();
      }
...
//alert(frek);
  if(sts_inp==1){
    ...
    $('#nodok').combogrid({  
       ...
       mode:'remote',
       loadMsg:"Tunggu Sebentar....!!",
       url:'<?php echo base_url(); ?>index.php/master/ambil_nomor_kontrak_kap_a',
...
<h3><a href="#" id="section1"><i>LIST KOREKSI KIB</i></a></h3>
    <div>
      <p align="left">
    ...
    <p align="center">
      <table align="center" id="dg" title="LIST KOREKSI KIB" style="width:940px;height:350px;" >  
        </table>
    </p>
    </div> 

<h3><a href="#" id="section2"><i>INPUT KOREKSI KIB </i></a></h3>
<div >
                    ...
                    <table align="left" style="width:100%;" border="1">
                      <!-- aktifkan checkbox bila perlu -->
                        ...
                        <tr >
                            ...
                            <td width="20%">: <input id="nomor_bukti" name="nomor_bukti" style="width: 130px;" placeholder="AutoNumber" disabled="true"/></td> 
                            <td width="15%">Tanggal Koreksi</td>
                            <td >: <input id="tgl_kap" name="tgl_kap" style="width: 100px;border:0;"/></td>
                       </tr> 
                      <tr>
                            <td width="15%">SKPD</td>
                            <td >: <input type="text" id="skpd" name="skpd" style="width: 150px;" /> </td>
                            <td colspan="2"><input id="nmskpd" name="nmskpd" style="border:0;width: 450px;" readonly="true"/></td>
                       </tr>
                      <tr>
                            <td width="15%">Unit</td>
                            <td >: <input type="text" id="uskpd" name="uskpd" style="width: 150px;border:0;" readonly="true" /></td> 
                            <td colspan="2"><input id="nmunit" name="nmunit" style="border:0;width: 450px;" readonly="true"/></td>
                       </tr>

                      <tr>
                            <td width="15%">Nama Bidang</td>
                            <td>: <input type="text" id="bidang" name="bidang" style="width: 150px;" /></td> 
                            <td colspan="2"><input id="nm_bidang" name="nm_bidang" style="border:0;width: 450px;" readonly="true"/></td>
                       </tr>
                       <tr>
                            <td width="15%">Nama Barang</td>
                            <td >: <input type="text" id="kib" name="kib" style="width: 150px;" /></td> 
                            <td colspan="2"><input id="nm_brg" name="nm_brg" style="border:0;width: 450px;" readonly="true"/></td>
                       </tr>
                       
                       <tr>
                            <td>No Dokumen</td>
                            <td colspan="2">: <input id="dok" name="dok" style="width: 300px;" readonly /></td>
                            <td></td>
                       </tr>
                       <tr width="10%">
                            <td>Tanggal Perolehan</td>
                            <td>: <input type="text" id="tanggal" style="width: 100px;" disabled="true" /></td>
                            <td>Harga Perolehan</td>
                            <td>: <input id="peroleh" name="peroleh" style="width: 150px;text-align: right;" readonly/> </td>
                       </tr>
                       <tr>
                            <td>Jenis Koreksi</td>
                            <td><select name="sts_kor" id="sts_kor" style="height: 27px; width: 150px;">
                                   <option value="">-----</option>
                                   <option value="KP">Koreksi Penyusutan</option> 
                                   <!-- <option value="B">Bukan KDP</option> -->
                                   <!-- <option value="L">Pencairan Lanjutan KDP</option> -->     
                                 </select></td>
                            <td hidden="true">Masa Manfaat / Terpakai Selama : <input id="terpakai" name="terpakai" style="width: 30px;text-align: right;border:0;" readonly/> Tahun</td>
                       </tr>
                       <tr hidden="true">
                       <td>Persentase</td>
                        <td>:<input style="width: 60px;text-align: right;border:0;" id="persen" name="persen" readonly="true"/>%</td>
                        <td hidden="true">Tambahan Masa Manfaat &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:
