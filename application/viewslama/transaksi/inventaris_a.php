...
<script type="text/javascript">
    ...
    var lpdok 		= '';
    var no_urut		= 0;
   //this view has modify by wisnu fn msm MAPPI
	...
	$('#nodok').combogrid({  
      ...
      cad          = rowData.cad;
           ...
           get(no_dokumen,kd_brg,kd_unit,kd_uskpd,nm_brg,jumlah,harga,total,keterangan,s_dana,kd_milik,kd_wilayah,b_dasar,b_nomor,tahun,b_tanggal,kd_cr_oleh,kd_bidang,jns_barang,no_bukti,cad);
        cek_status(no_dokumen,no_bukti,cad);   
		   //lutji();
	   }  
     });
  ...
  function cek_status(no_dokumen,no_bukti,cad){
    ...
    $.ajax({
      type:'post',
      data:({nodok:no_dokumen,kdbrg:kdbrg,no_bukti:no_bukti,cad:cad}),
    ...
    $('#skpd2').combogrid({  
     ...
     $('#kondisi_tnh').combogrid({  
       ...
       columns:[[  
           ...
           {field:'nmkondisi',title:'Nama Kondisi',width:150}
       ]],
        onSelect:function(rowIndex,rowData){
           lckondisi = rowData.kode;
           $("#kon").attr("value",rowData.kondisi.toUpperCase());
	...
	$('#kd_riwayat').combogrid({  
     ...
     $('#dg').edatagrid({
        ...
        columns:[[
            ...
            {field:'kd_skpd',title:'KODE OPD',width:30,align:"left"},
            ...
            {field:'nilai1',title:'HARGA',width:30,align:"right"},
        ...
        onSelect:function(rowIndex,rowData){
          ...
          cad         = rowData.cad;
		      get_riwayat(no_bukti,cad,kd_skpd,kd_unit,kdbrg,nm_brg,id_barang,nilai,tahun,no_furut,tgl_riwayat,kd_riwayat,detail_riwayat,nm_skpd);
        },
        onDblClickRow:function(rowIndex,rowData){
          ...
          get1(no_bukti,cad,id_barang,noreg,no,tgl_reg,no_oleh,tgl_oleh,milik,wilayah,kd_skpd,kd_unit,asal,dsr_peroleh,nilai,nilai_baru,tahun,nodok,kdbrg,nmbrg,detail_brg,sta_thn,kondisi,ls,penggunaan,sk,tgl_sk,ket,alamat1,alamat2,alamat3,lokasi,lat,lon,gol,bida,foto1,foto2,foto3,foto4);
          edit_data(); 
          cek_status();  
        }
        });
    ...
    function get(no_dokumen,kd_brg,kd_unit,kd_uskpd,nm_brg,jumlah,harga,total,keterangan,s_dana,kd_milik,kd_wilayah,b_dasar,b_nomor,tahun,b_tanggal,kd_cr_oleh,kd_bidang,jns_barang,no_bukti,cad){
    ...
    function get1(no_bukti,cad,id_barang,noreg,no,tgl_reg,no_oleh,tgl_oleh,milik,wilayah,kd_skpd,kd_unit,asal,dsr_peroleh,nilai,nilai_baru,tahun,nodok,kdbrg,nmbrg,detail_brg,sta_thn,kondisi,ls,penggunaan,sk,tgl_sk,ket,alamat1,alamat2,alamat3,lokasi,lat,lon,gol,bida,foto1,foto2,foto3,foto4){ //get1(id_barang,noreg,no,tgl_reg,no_oleh,tgl_oleh,milik,wilayah,kd_skpd,kd_unit,asal,dsr_peroleh,nilai,nilai_baru,tahun,nodok,kdbrg,detail_brg,sta_thn,kondisi,ls,penggunaan,sk,tgl_sk,ket,alamat1,alamat2,alamat3,lokasi,foto,gol,bida){
		       $('#nomor_bukti').attr('value',no_bukti);
           $('#cad').attr('value',cad);
	...
	function get_riwayat(no_bukti,cad,kd_skpd,kd_unit,kdbrg,nm_brg,id_barang,nilai,tahun,no_furut,tgl_riwayat,kd_riwayat,detail_riwayat,nm_skpd){
    ...
    $(function(){
     $('#dg').edatagrid({
		    url: '<?php echo base_url();?>index.php/transaksi/ambil_kib_a',
        queryParams:({cari:kriteria,cari2:skpd})
        });        
     });
    }
    ...
    function simpan(){
        ...
        lcinsert = "(no_bukti,no_reg,id_barang,no,no_oleh,tgl_reg,tgl_oleh,no_dokumen,kd_golongan,kd_bidang,kd_brg,nm_brg,detail_brg,status_tanah,kondisi,asal,dsr_peroleh,no_sertifikat,tgl_sertifikat,luas,nilai,jumlah,total,penggunaan,alamat1,alamat2,alamat3,keterangan,milik,wilayah,kd_skpd,kd_unit,username,tgl_update,tahun,foto1,foto2,foto3,foto4,no_urut,lat,lon,cad,masa_manfaat)";
        ...
        for(var i=0;i<jml;i++){
            ...
            no_urt = tambah_urut(no_urut,7); 
			      nomor  = no_urt; urutan = no_urt;
            no_gabung = kd_brg+'/'+no_urt+'/'+kd_unit ;
            id_barang = kd_unit+'.'+tahun+'.'+kd_brg+'.'+no_urt+'.'+urutan ;
            if(i>0){
				lcvalues = lcvalues+",('"+no_bukti+"','"+nomor+"','"+id_barang+"','"+no_gabung+"','"+no_dok+"','"+tgl_reg+"','"+tgl_oleh+"','"+no_dokumen+"','"+kd_gol+"','"+kd_bidang+"','"+kd_brg+"','"+nm_barang+"','"+detail+"','"+st_tanah+"','"+kondisi+"','"+perolehan+"','"+dsr_peroleh+"','"+no_sertifikat+"','"+tgl_sertifikat+"','"+luas+"','"+nilai+"','"+jml+"','"+nilai_baru+"','"+penguna+"','"+alamat1+"','"+alamat2+"','"+alamat3+"','"+keterangan+"','"+milik+"','"+wilayah+"','"+kd_skpd+"','"+kd_unit+"','"+username+"','"+tgl_update+"','"+tahun+"','"+file_gbr1+"','"+file_gbr2+"','"+file_gbr3+"','"+file_gbr4+"','"+urutan+"','"+clat+"','"+clon+"','"+cad+"','"+mm+"')";
			}else{
				lcvalues = lcvalues+"('"+no_bukti+"','"+nomor+"','"+id_barang+"','"+no_gabung+"','"+no_dok+"','"+tgl_reg+"','"+tgl_oleh+"','"+no_dokumen+"','"+kd_gol+"','"+kd_bidang+"','"+kd_brg+"','"+nm_barang+"','"+detail+"','"+st_tanah+"','"+kondisi+"','"+perolehan+"','"+dsr_peroleh+"','"+no_sertifikat+"','"+tgl_sertifikat+"','"+luas+"','"+nilai+"','"+jml+"','"+nilai_baru+"','"+penguna+"','"+alamat1+"','"+alamat2+"','"+alamat3+"','"+keterangan+"','"+milik+"','"+wilayah+"','"+kd_skpd+"','"+kd_unit+"','"+username+"','"+tgl_update+"','"+tahun+"','"+file_gbr1+"','"+file_gbr2+"','"+file_gbr3+"','"+file_gbr4+"','"+urutan+"','"+clat+"','"+clon+"','"+cad+"','"+mm+"')";
			}                 
		} 
            $(document).ready(function(){
                $.ajax({
                    ...
                    data: ({tabel:'trkib_a',urut:urutan,reg:no_urt,unit:kd_unit,no:no_dokumen,lkd_brg:kd_brg,kolom:lcinsert,lcvalues:lcvalues,nilai:nilai,no_bukti:no_bukti,cad:cad}),
                    dataType:"json",
                    success:function(data){                                          
                        $.each(data,function(i,n){                                    
                            pesan = n['pesan'];
    ...
    var del = confirm("Apakah Anda Yakin ingin menghapus data   "+id_brg+"?");
        ...
        $(document).ready(function(){
         $.post(urll,({no:id_barang,dok:nodok,no_urut:no_furut,skpd:kd_skpd,no_bukti:no_bukti,cad:cad}),function(data){
            status = data;
            if (status=='0'){
                alert('Gagal Hapus..!!');
                exit();
...
<div><h3 align="center"><b>.:INPUTAN INVENTARIS TANAH:.</b></h3></div>
    ...
    <table style="width:400px;" border="0">
        <tr>
        <td width="10%">
        <a class="easyui-linkbutton" iconCls="icon-add" plain="false" onclick="javascript:kosong();tambah();">Tambah</a></td>               
        ...
        <td>OPD:&nbsp;<input type="text" value="" id="skpd2" style="width:150px;"/></td>
        </tr>
        <tr>
        <td colspan="4">
               ...
               <td width="50%" valign="top">
                    <table align="left" style="width:100%;" border="0">
                       ...
                       <tr hidden="true">
                         <td>Jumlah</td>
                         <td>:</td>
                         <td><input name="jml" type="text" id="jml" disabled="true" style="width:150px;" readonly="true"/></td>
                       </tr>
                    </table> 
               </td>
               <td width="50%" valign="top">
