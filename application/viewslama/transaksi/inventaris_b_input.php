...
/*	function lutji(){
  ...
  function cek_status(no_dokumen){
    ...
    var kdbrg   = $('#kdbrg').combogrid('getValue');
    $(document).ready(function(){
    $.ajax({
      type:'post',
   ...
   /*   $('#ruang').combogrid({  
    ...
    function get(no_dokumen,kd_brg,kd_unit,kd_uskpd,nm_brg,jumlah,harga,total,keterangan,s_dana,kd_milik,kd_wilayah,b_dasar,b_nomor,tahun,b_tanggal,kd_cr_oleh,jns_barang,kd_bidang){
           ...
           $("#kd_bidang").combogrid("setValue",kd_bidang);
   ...
   function  cokot(foto,lc){
    ...
    function kosong(){
        ...
        $('#jns_barang').attr("value",'02');
        $('#kd_bidang').combogrid("clear");
        $("#kd_skpd").attr("value",'');
        $("#nm_skpd").attr("value",'');
        nomer_akhir();
    }
    ...
    function simpan(){
      ...
      var kd_bidang = $('#kd_bidang').combogrid('getValue');
        ...
        for(var i=0;i<jml;i++){
            ...
            if(i>0){
				   lcvalues = lcvalues+",('"+nomor+"','"+id_barang+"','"+no_gabung+"','"+no_oleh+"','"+tgl_reg+"','"+tgl_oleh+"','"+no_dokumen+"','"+kd_gol+"','"+kd_bidang+"','"+kd_brg+"','"+nmbrg+"','"+detail+"','"+nilai+"','"+perolehan+"','"+dsr_peroleh+"','"+bagi+"','"+nilai_baru+"','"+merek+"','"+tipe+"','"+warna+"','"+bahan+"','"+satuan+"','"+norangka+"','"+nomesin+"','"+nopolisi+"','"+silinder+"','"+nostnk+"','"+tglstnk+"','"+nobpkb+"','"+tglbpkb+"','"+kondisi+"','"+keterangan+"','"+kd_ruang+"','"+skpd+"','"+kd_unit+"','"+milik+"','"+wilayah+"','"+username+"','"+tgl_update+"','"+tahun+"','"+file_gbr+"','"+file_gbr2+"','"+file_gbr3+"','"+file_gbr4+"','"+urutan+"','"+metode+"','"+masa_manfaat+"','"+nilai_sisa+"','"+milik+"')";
				}else{
					lcvalues = lcvalues+"('"+nomor+"','"+id_barang+"','"+no_gabung+"','"+no_oleh+"','"+tgl_reg+"','"+tgl_oleh+"','"+no_dokumen+"','"+kd_gol+"','"+kd_bidang+"','"+kd_brg+"','"+nmbrg+"','"+detail+"','"+nilai+"','"+perolehan+"','"+dsr_peroleh+"','"+bagi+"','"+nilai_baru+"','"+merek+"','"+tipe+"','"+warna+"','"+bahan+"','"+satuan+"','"+norangka+"','"+nomesin+"','"+nopolisi+"','"+silinder+"','"+nostnk+"','"+tglstnk+"','"+nobpkb+"','"+tglbpkb+"','"+kondisi+"','"+keterangan+"','"+kd_ruang+"','"+skpd+"','"+kd_unit+"','"+milik+"','"+wilayah+"','"+username+"','"+tgl_update+"','"+tahun+"','"+file_gbr+"','"+file_gbr2+"','"+file_gbr3+"','"+file_gbr4+"','"+urutan+"','"+metode+"','"+masa_manfaat+"','"+nilai_sisa+"','"+milik+"')";
				}         
			no_urut=no_urt;    
                    ...
                    <table align="left" style="width:100%;" border="0">
					   ...
					   <tr>
						...
						<tr>
							<td>Bidang Barang</td>
							<td>:</td>
							<td><input id="kd_bidang" name="kd_bidang" />  </td>                            
						</tr> 
						<!-- <tr>
           ...
           <tr>
            <td colspan="2" align="center">
              <table  align="left" style="width:100%;" border="1">
				...
				<tr>
                <td colspan="2" align="center"><a class="easyui-linkbutton" id="save" iconCls="icon-save" plain="true" onclick="javascript:simpan();">Simpan</a>                
