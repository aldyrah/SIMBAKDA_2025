    ...
    var no_urut=0;
     ...
     $(function(){
      ...
      //$('#tgl_oleh').datebox('setValue',tgl_reg);
       $('#nodok').combogrid({url: '<?php echo base_url(); ?>/index.php/transaksi/ambil_dok_b9',
      ...
      $('#nodok').combogrid({  
       ...
       mode:'remote',
       url:'<?php echo base_url(); ?>index.php/transaksi/ambil_dok_b9',  
       columns:[[  
  ...
  function cek_status(no_dokumen,kd_uskpd,no_bukti,cad){
   ...
   /*   $('#ruang').combogrid({  
	...
	$('#kd_riwayat').combogrid({  
     ...
     $('#dg').edatagrid({
		url: '<?php echo base_url(); ?>index.php/transaksi/ambil_kib_b9',
        idField:'id',            
        rownumbers:"true", 
        fitColumns:"true",
        singleSelect:"true",
