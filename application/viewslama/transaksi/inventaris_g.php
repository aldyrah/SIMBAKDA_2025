...
<script type="text/javascript">
     ...
     $(function(){
      ...
      $('#nodok').combogrid({  
       ...
       columns:[[  
           ...
           {field:'total2',title:'NILAI KONTRAK',width:200,align:"right"}    
       ]],  
       onSelect:function(rowIndex,rowData){
      ...
      kd_bidang   = rowData.kd_bidang;
           get(no_dokumen,kd_brg,kd_unit,kd_uskpd,nm_brg,jumlah,harga,total,keterangan,s_dana,kd_milik,kd_wilayah,b_dasar,b_nomor,tahun,b_tanggal,kd_cr_oleh,jns_barang,kd_bidang);
           //lutji();   
		    }  
     });
	...
	$('#skp').combogrid({  
     ...
     $('#dg').edatagrid({
        ...
        nowrap:"true",                       
        columns:[[
            {field:'kd_skpd',title:'KODE SKPD',width:27,align:"left"},
        ...
        onDblClickRow:function(rowIndex,rowData){
          ...
          nm_brg        = rowData.nm_brg;
          get1(id_barang,noreg,no,no_oleh,tgl_reg,nodok,kdbrg,detail_brg,kd_tnh,kondi,kontr,jenis,bangunan,ls,tgl_awal,sta_thn,nilai_kontrak,ket,alamat1,alamat2,alamat3,milik,wilayah,kd_skpd,asal,tahun,nilai,nilai_baru,jumlah,tgl_oleh,dsr_peroleh,kd_unit,foto,foto2,lat,lon,kdgol,bidang,nm_brg);
          edit_data(); 
          cek_status(); 
        }
    ...
    function  get1(id_barang,noreg,no,no_oleh,tgl_reg,nodok,kdbrg,detail_brg,kd_tnh,kondi,kontr,jenis,bangunan,ls,tgl_awal,sta_thn,nilai_kontrak,ket,alamat1,alamat2,alamat3,milik,wilayah,kd_skpd,asal,tahun,nilai,nilai_baru,jumlah,tgl_oleh,dsr_peroleh,kd_unit,foto,foto2,lat,lon,kdgol,bidang,nm_brg){//get1(id_barang,noreg,no,no_oleh,tgl_reg,nodok,kdbrg,detail_brg,kd_tnh,kondi,kontr,jenis,bangunan,ls,tgl_awal,sta_thn,nilai_kontrak,nilai_baru,ket,alamat1,alamat2,alamat3,milik,wilayah,kd_skpd,asal,tahun,nilai,jumlah,tgl_oleh,dsr_peroleh,kd_unit,foto,foto2,lat,lon,kdgol,bidang){
    ...
    function get(no_dokumen,kd_brg,kd_unit,kd_uskpd,nm_brg,jumlah,harga,total,keterangan,s_dana,kd_milik,kd_wilayah,b_dasar,b_nomor,tahun,b_tanggal,kd_cr_oleh,jns_barang,kd_bidang){
   ...
   function cari(){
    ...
    function simpan(){
        ...
        lcinsert = "(no_reg,id_barang,no,no_oleh,tgl_reg,tgl_oleh,no_dokumen,kd_golongan,kd_bidang,kd_brg,nm_brg,detail_brg,kd_tanah,nilai,asal,dsr_peroleh,total,kondisi,konstruksi,jenis,bangunan,luas,jumlah,tgl_awal_kerja,status_tanah,nilai_kontrak,alamat1,alamat2,alamat3,keterangan,kd_skpd,kd_unit,milik,wilayah,username,tgl_update,tahun,foto,foto2,no_urut,lat,lon)";
        ...
        for(var i=0;i<jml;i++){
            ...
            nomor = no_urt ;
            urutan = no_urt;
			id_barang = kd_unit+'.'+tahun+'.'+kd_brg+'.'+no_urt+'.'+no_urt ;
            no_gabung = kd_brg+'/'+no_urt+'/'+kd_unit ; 
            if(i>0){
				lcvalues = lcvalues+",('"+nomor+"','"+id_barang+"','"+no_gabung+"','"+no_oleh+"','"+tgl_reg+"','"+tgl_oleh+"','"+no_dokumen+"','"+kdgol+"','"+bidang+"','"+kd_brg+"','"+nmbrg+"','"+detail+"','"+kd_tanah+"','"+nilai+"','"+perolehan+"','"+dsr_peroleh+"','"+nilai_baru+"','"+kondisi+"','"+kontruksi+"','"+jenis+"','"+bangunan+"','"+luas+"','"+jumlah+"','"+tgl_awal+"','"+st_tanah+"','"+nilai_kontrak+"','"+alamat1+"','"+alamat2+"','"+alamat3+"','"+keterangan+"','"+skpd+"','"+kd_unit+"','"+milik+"','"+wilayah+"','"+username+"','"+tgl_update+"','"+tahun+"','"+file_gbr1+"','"+file_gbr2+"','"+urutan+"','"+clat+"','"+clon+"')";
			}else{
				lcvalues = lcvalues+"('"+nomor+"','"+id_barang+"','"+no_gabung+"','"+no_oleh+"','"+tgl_reg+"','"+tgl_oleh+"','"+no_dokumen+"','"+kdgol+"','"+bidang+"','"+kd_brg+"','"+nmbrg+"','"+detail+"','"+kd_tanah+"','"+nilai+"','"+perolehan+"','"+dsr_peroleh+"','"+nilai_baru+"','"+kondisi+"','"+kontruksi+"','"+jenis+"','"+bangunan+"','"+luas+"','"+jumlah+"','"+tgl_awal+"','"+st_tanah+"','"+nilai_kontrak+"','"+alamat1+"','"+alamat2+"','"+alamat3+"','"+keterangan+"','"+skpd+"','"+kd_unit+"','"+milik+"','"+wilayah+"','"+username+"','"+tgl_update+"','"+tahun+"','"+file_gbr1+"','"+file_gbr2+"','"+urutan+"','"+clat+"','"+clon+"')";
			}              
           no_urut=no_urt;  
           ...
           $(document).ready(function(){
                $.ajax({
                    ...
                    data: ({tabel:'trkib_g',urut:urutan,reg:no_urt,unit:kd_unit,no:no_dokumen,kolom:lcinsert,lcvalues:lcvalues,kd_brg:kd_brg}),
                    dataType:"json",
    ...
    if (del==true){          
        var urll = '<?php echo base_url(); ?>index.php/transaksi/hapus_trkib_g';
        $(document).ready(function(){
         $.post(urll,({no:id_barang,dok:nodok,no_urut:no_furut,kdbrg:kdbrg,skpd:skpd}),function(data){
            status = data;
            if (status=='0'){
                alert('Gagal Hapus..!!');
                exit();
  ...
  function nomer_akhir(){
    ...
    $.ajax({
      ...
      url :"<?php echo base_url(); ?>/index.php/transaksi/brg_twujud_dh",
      dataType:"json",
      success:function(data){
        $.each(data,function(i,n){
            var st = n['invent'];
...
<div align="center">
    ...
    <table style="width:400px;" border="0">
        ...
        <tr>
        <td colspan="4">
        <table id="dg" align="center" title="LISTING INVENTARIS ASET TAK BERWUJUD" style="width:900px;height:365px;" >  
        </table>
        </td>
        </tr>
    </table>    
               ...
               <td width="50%" valign="top">
                    <table  align="left" style="width:100%;" border="0">
                       ...
                       <tr>
                            ...
                            <td valign="top">:</td>
                            <td><textarea rows="10" cols="50" id="keterangan" name="keterangan" style="width: 300px;"></textarea></td>
                       </tr>
                       <tr hidden="true">
                            <td>Latitude</td>
                            <td>:</td>
