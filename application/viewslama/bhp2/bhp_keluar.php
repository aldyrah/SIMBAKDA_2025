    ...
    function append_save(){
        ...
        if (kd != '' && jml != '' && hrg != ''){        
            if (updt == 'f') {
                ...
                $('#trd_stock').edatagrid('appendRow',{nama:nm,sisa:sisa,harga:hrg});  
            } else {
       ...
       if (ckdskpd==''){
        ...
        $(document).ready(function(){
            $.ajax({
                type: "POST",       
                dataType : 'json',         
                data: ({tabel:'trh_keluar_bhp',no:cno,tgl:ctgl,uskpd:cuskpd,kdskpd:ckdskpd,nmuskpd:cnmuskpd,tahun:cthn,total:ctotal,penerima:cpenerima,kdruang:kdruang}),
