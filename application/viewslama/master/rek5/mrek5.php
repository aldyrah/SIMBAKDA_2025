...
//            align:"center"}
        ...
        onSelect:function(rowIndex,rowData){
          ...
          get(kd_s,kd_u,kd_u_64,nm_s,lo,lra,kd_64,nm_64,nm_lo); 
          lcidx = rowIndex;  
    ...
    function get(kd_s,kd_u,kd_u_64,nm_s,lo,lra,kd_64,nm_64,nm_lo) {
    ...
    function simpan_rek5(){
        ...
        var cnamalo = document.getElementById('namalo').value;
        ...
        if(lcstatus=='tambah'){ 
            ...
            $(document).ready(function(){
                $.ajax({
                    type: "POST",
                    url: '<?php echo base_url(); ?>/index.php/master/tn_master5',
                    data: ({tabel:'ms_rek5',kolom:lcinsert,nilai:lcvalues,kolom1:lcinsert1,nilai1:lcvalues1,cid:'kd_rek64',lcid:ckode64,cid1:'kd_rek5',lcid1:clo,xcode5:ckode}),
                    dataType:"json",
            ...
            //lcquery = "UPDATE ms_rek5 SET kd_rek5='"+ckode+"',nm_rek5='"+cnama+"',kd_rek64='"+ckode64+"',nm_rek64='"+cnama64+"',kd_rek4_64='"+crek64+"',kd_rek4='"+crek4+"',map_lra1='"+clra+"',map_lo='"+clo+"' where kd_rek64='"+ckode1_64+"'";
			lcquery = "UPDATE ms_rek5 SET nm_rek5='"+cnama+"',kd_rek64='"+ckode64+"',nm_rek64='"+cnama64+"',kd_rek4_64='"+crek64+"',kd_rek4='"+crek4+"',map_lra1='"+clra+"',map_lo='"+clo+"' where kd_rek5='"+ckode+"'";
			//alert(lcquery);
            $(document).ready(function(){
            $.ajax({
                type: "POST",
                url: '<?php echo base_url(); ?>/index.php/master/update_master5tn',
                data: ({st_query:lcquery,xcode5:ckode1}),
                dataType:"json",
                success:function(data){
                        status = data;
                        if (status=='0'){
...
<h3 align="center"><u><b><a>INPUTAN MASTER REKENING RINCIAN OBJEK</a></b></u></h3>
    ...
    <table style="width:400px;" border="0">
        ...
        <td><input type="text" value="" id="txtcari" style="width:300px;" onkeypress="doSomething(this, event)"/></td>
        </tr>
        <tr>
        <td colspan="4">
     ...
     <table align="center" style="width:100%;" border="0">
           ...
           <tr>
            ...
            <tr>
             ...
             <tr>
                <td width="30%">NAMA REKENING AKRUAL</td>
                <td width="1%">:</td>
                <td><input type="text" id="namalo" style="width:360px;"/></td>  
            </tr> 
            <tr>
