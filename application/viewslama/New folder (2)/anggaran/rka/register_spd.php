...
<head>
	...
	$(function(){
		...
		function cetak()
        {
			...
			var url    = "<?php echo site_url(); ?>/rka/preview_regspd/1/";  
		...
		function cetak_ex()
        {
			var periode1 = $('#perid1').datebox('getValue'); 
			var periode2 = $('#perid2').datebox('getValue');
			var url    = "<?php echo site_url(); ?>/rka/preview_regspd/2/";  
			lc= '?posx='+periode1+'&posy='+periode2;
				window.open(url+lc, '_blank');
				window.focus();
        }
...
<div id="content"> 
<div id="accordion">
<h5 align="center"><b><a href="#" id="section1">REGISTER SPD</a></b></h5>
 <fieldset>
     <table align="center" style="width:100%;" border="0">
            <tr>
                <td colspan="5" align="center"><b>PERIODE</b></td>
            </tr>            
            <tr>
