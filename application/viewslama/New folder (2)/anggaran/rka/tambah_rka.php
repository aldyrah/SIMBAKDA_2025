...
//        }	
        ...
        function validate_hrg(){    
            $(function(){
			$('#dg_harga').edatagrid({
				url: '<?php echo base_url(); ?>/index.php/rka/ld_harga/'+oldRek,
                 idField:'id',                  
                 rownumbers:"true", 
                 fitColumns:"true",
                 singleSelect:"true",
				...
				columns:[[
                 ...
                 onClickRow:function(rowIndex, rowData){                                
                    cidx = rowIndex;
                    crk = rowData.kd_rek5;
                    curaian = rowData.uraian;
                    cvolume1= 1;
                    csatuan1= rowData.satuan;
                    cvolume2= '';
                    csatuan2= '';
                    cvolume3= '';
                    csatuan3= '';
                    charga1 = rowData.harga;
                    simpan_rincian(cidx,curaian,cvolume1,csatuan1,charga1,cvolume2,csatuan2,cvolume3,csatuan3,crk);  
...
<h3><a href="#" id="section2">Rincian Rekening</a></h3>
    <div>
        ...
        <div id="toolbar1x">
            ...
            <button class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="javascript:standar()">Standar Harga</button>            
...
<div id="dialog-modal1" title="Input Standar Harga">
    <p class="validateTips">...</p> 
    ...
    <table align="center">
        ...
        <td><a class="easyui-linkbutton" iconCls="icon-undo" plain="true" onclick="javascript:keluar_s();">Keluar</a> </td>
        </tr>
    </table>   
    </fieldset> 
    <fieldset>        
        <table id="dg_harga" title="Pilih Standar harga" style="width:730px;height:250px;"  >  
        </table>  
