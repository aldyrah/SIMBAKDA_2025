        ...
        <table class="narrow">
            ...
            <tr>                
                ...
                <td>                     
                    ...
                    <a class="link" name ="<?php echo site_url(); ?>/rka/preview_perkada/<?php echo $skpd->kd_skpd; ?>/<?php echo '1';?>" href="" target='_blank'><img src="<?php echo base_url(); ?>assets/images/icon/print_pdf.png" width="25" height="23" title="cetak"/></a>
