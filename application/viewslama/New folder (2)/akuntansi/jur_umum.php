...
<head>
	...
	function cetakjumasuk(){
		dcetak = $('#dcetak').datebox('getValue');
		dcetak2 = $('#dcetak2').datebox('getValue');
		cskpd = $('#sskpd').combogrid('getValue');
		var url    = "<?php echo site_url(); ?>/akuntansi/ctk_jurum";  
		lc = '?dcetak='+dcetak+'&dcetak2='+dcetak2+'&skpd='+cskpd;
		...
		<p align="right">         
			<table id="sp2d" title="Cetak Buku Besar" style="width:870px;height:300px;" >  
				...
				<tr >
					...
					<td width="80%"> <INPUT TYPE="button" VALUE="CETAK" ONCLICK="cetakjumasuk()" style="height:40px;width:100px" >
					</td>
				</tr>
				<tr >
					<td >&nbsp</td>
