...
<head>
  ...
  <style>   
    ...
    function cetak(){
            ...
            var skpd   = kdskpd; 			
			if (ctk=='1'){
				var url ="<?php echo site_url(); ?>/akuntansi/cetak_perda1_semester_pemda/1";
			} else{
				var url ="<?php echo site_url(); ?>/akuntansi/cetak_perda1_semester_skpd/1";
			}	
			ctglttd = $('#dcetak2').datebox('getValue');
			
			window.open(url+'?cetak='+ctk+'&kdskpd='+skpd+'&tgl_ctk='+ctglttd+'&halamanwehgeus='+halaman);
			window.focus();
    }
    ...
    function cetak1(){
            ...
            var skpd   = kdskpd; 			
			if (ctk=='1'){
				var url ="<?php echo site_url(); ?>/akuntansi/cetak_perda1_semester_pemda/2";
			} else{
				var url ="<?php echo site_url(); ?>/akuntansi/cetak_perda1_semester_skpd/2";
			}	
			ctglttd = $('#dcetak2').datebox('getValue');
...
<div id="content">
<h3>CETAK LAPORAN REALISASI APBD SEMESTER I</h3>
<div id="accordion">
    <p align="right">         
        <table>  
        ...
        <tr><td width="922px" colspan="2"><input type="radio" name="cetak" value="2" id="status" onclick="opt(this.value)" /><b>Per SKPD</b>
			...
			<div id="tagih">
				<table>
					<tr >
						<td width="22px" height="20%" ><B>SKPD</B></td>
						<td width="900px"><input id="sskpd" name="sskpd" style="width: 150px;" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input id="nmskpd" name="nmskpd" style="width: 500px; border:0;" /></td>
					</tr>
					<tr>
						<td width="20%">DI MULAI DARI HALAMAN</td>
						<td><input style="background-color: yellow" type="text" name="hal" id="hal" value="1"/></td>
                    </tr>
				</table> 
			</div>
        </td>
