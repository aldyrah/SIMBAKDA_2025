     ...
     function openWindow( url ){
        // var ckdskpd = $('#skpd').combogrid('getValue');
         ...
         if(ctk==1){
            ...
            lc = '?tgl1='+ctgl1+'&tgl2='+ctgl2+'&tgl_ttd='+ctglttd+'&chal='+chal+'&cpilih=1';
         }else{
            cbulan = $('#bulan').combogrid('getValue');
            lc = '?bulan='+cbulan+'&tgl_ttd='+ctglttd+'&chal='+chal+'&cpilih=2';
         }
...
<div id="content1" align="center"> 
    <h3 align="center"><b>BUKU PENERIMAAN PPKD</b></h3>
    <fieldset style="width: 70%;">
     <table align="center" style="width:100%;" border="0">
            ...
            <tr>
                ...
                <a href="<?php echo site_url(); ?>/tukd/cetak_terima_ppkd" class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:openWindow(this.href);return false">Cetak</a>
                </td>                
            </tr>
        </table>  
