...
<head>
    ...
    $(document).ready(function() {
     ...
     $(function(){ 
		$('#dg').edatagrid({
			...
			nowrap:"true",                       
			columns:[[
				{field:'no_advise',title:'Nomor ADVISE',width:150,align:"justify"},
    ...
    function sp2d(){
		...
		if(no_advises==''){
			alert('No Advise Tidak Boleh Kosong !!!!');
			...
			$('#dg2').edatagrid({
			url: '<?php echo base_url(); ?>/index.php/tukd/ambil_sp2d',
    ...
    function append_save(){
		...
		for(var i=0; i<rows.length; i++){  
            ...
            $('#dg1').edatagrid('appendRow',{no_sp2d:cno_sp2d,tgl_sp2d:ctgl_sp2d,kd_skpd:ckd_skpd,nm_skpd:cnm_skpd,nospm:cspm,nilai:cnilai,nilai1:cnilai1});
			$("#dg1").datagrid("unselectAll");
    ...
    function simpan_advise(){
        ...
        if (cno==''){
            alert('Nomor ADVISE Tidak Boleh Kosong');
            exit();
        } 
        if (ctgl==''){
            alert('Tanggal ADVISE Tidak Boleh Kosong');
            exit();
        }
        $(document).ready(function(){
            $.ajax({
                ...
                success:function(data){
					...
					if(status =='1'){
						...
						alert('No Advise '+cno+' telah Terpakai  ..!!');
					}
                }
            });
        });
  ...
  function save_detail(x){
		...
		if (kim =='1'){
			...
			for(var p=0;p<rows.length;p++){
                ...
                cnilai		= rows[p].nilai;                 
                if (p>0) {
                    csql = csql+","+"('"+cnoadvise+"','"+cnosp2d+"','"+cspm+"','"+ctglsp2d+"','"+ckdskpd+"','"+cnmskpd+"','"+cnilai+"')";
                } else {
                    csql = "values('"+cnoadvise+"','"+cnosp2d+"','"+cspm+"','"+ctglsp2d+"','"+ckdskpd+"','"+cnmskpd+"','"+cnilai+"')";                                            
                } 
			}
...
<div id="content">    
<div id="accordion">
<h3><a href="#" id="section1">List ADVISE</a></h3>
    <div>
    <p align="right">         
...
<h3><a href="#" id="section2">A D V I S E</a></h3>
   ...
   <p>       
        ...
        <table align="center" border='0' style="width:850px;">
            ...
            <tr style="border-bottom-style:hidden;padding:3px;border-spacing:5px 5px 5px 5px;">
                <td style="border-bottom-style:hidden;padding:3px;border-spacing:5px 5px 5px 5px;border-right-style:hidden;">No. A D V I S E</td>
                ...
                <td style="border-bottom-style:hidden;padding:3px;border-spacing:5px 5px 5px 5px;border-right-style:hidden;">Tanggal ADVISE</td>
