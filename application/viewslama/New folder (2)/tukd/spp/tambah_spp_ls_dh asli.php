...
<head>
    ...
    $(document).ready(function() {
      ...
      function sisa_anggaran(){
        ...
        sisa = ang - lalu;
        slalu = (sisa - nil); 
        $("#rek_nilai_sisa").attr("value",number_format(slalu,2,'.',','));   
        if (slalu < 0){
      ...
      success:function(data){
       ...
       function append_save() {
            ...
            var vrek_reke = $('#rek_reke').combobox('getValue');	
			      var vrek_kmp = $('#rek_kmp').combobox('getValue');					
            ...
            var nospd = $('#sp').combobox('getValue');
...
<div id="dialog-modal-rek" title="Input Rekening">
    ...
    <table height="505" border="0" align="center" style="width:100%;">
            ...
            <tr>
                <td>NO SPD</td>
                <td>:</td>
                <td><input id="sp" name="sp" style="width: 200px;" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" id="sdana" style="border:0;width: 300px;" readonly="true"/></td>                            
            </tr>
            <tr>
                <td>SISA SPD</td>
                <td>:</td>
			...
			<tr>
                ...
                <td>:</td>
                <td><input type="text" id="rek_nilai_ang1" style="width: 196px; text-align: right; " readonly="true" /></td> 
            </tr>
            
            <tr>
                <td>REAL KAMPUNG LALU</td>
                <td>:</td>
                <td><input type="text" id="rek_nilai_spp1" style="width: 196px; text-align: right; " readonly="true" /></td> 
            </tr>

            <tr>
                <td>SISA ANGGARAN KAMPUNG</td>
                <td>:</td>
                <td><input type="text" id="rek_nilai_sisa1" style="width: 196px; text-align: right; " readonly="true" /></td> 
            </tr>
            ...
            <tr>
                <td>SISA ANGGARAN</td>
                <td>:</td>
                <td><input type="text" id="rek_nilai_sisa" style="width: 196px; text-align: right;background-color:#FFFF00; " readonly="true" /></td> 
            </tr>
