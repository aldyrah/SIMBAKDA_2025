	...
	function openWindow($cek){
       ...
       // var ruangan 	= document.getElementById('ruangan').value;
		...
		iz = '?kd_skpd='+cskpd+'&kd_bid='+cbidang+'&nm_skpd='+cnmskpd+'&nm_bid='+cnmbid+'&bend='+cbend+'&tahu='+ctahu+'&tgl_reg='+tgl_reg+'&tahun='+ctahun+'&jenis='+cjenis+'&tgl='+ctgl+'&fa='+cpilih;
...
<div id="content1"> 
    <h3 align="center"><b>CETAK EKSTRA COUNTING ASSET (ECA)<br>
