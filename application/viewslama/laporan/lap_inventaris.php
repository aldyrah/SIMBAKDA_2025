	...
	function openWindow($cek){
        ...
        var cnmbend 	= $('#bend').combogrid('getValue'); //alert(cnmbend+"-"+cnmtahu);
		...
		iz = '?kd_skpd='+cskpd+'&kd_bid='+cbidang+'&nm_skpd='+cnmskpd+'&nm_bid='+cnmbid+'&bend='+cbend+'&tahu='+ctahu+'&nmbend='+cnmbend+'&nmtahu='+cnmtahu+'&tgl='+ctgl+'&tahun='+ctahun+'&jenis='+cjenis+'&tgl_reg='+tgl_reg+'&fa='+cpilih;
    ...
    $(function(){
	 ...
	 $('#jenis_kib').combobox({
        ...
        data:[{kode:'1',nama:'.:CETAK SEMUA:.'},{kode:'2',nama:'KIB A'},{kode:'3',nama:'KIB B'},{kode:'4',nama:'KIB C'},{kode:'5',nama:'KIB D'},{kode:'6',nama:'KIB E'},{kode:'7',nama:'KIB F'}]
	 });
