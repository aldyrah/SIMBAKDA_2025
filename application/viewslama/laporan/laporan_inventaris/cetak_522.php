...
<script type="text/javascript">
	...
	function openWindow($cek){
        ...
        var bln         = $('#bulan').combogrid('getValue');
		//var cjenis		= ''; 
		//var cnmjenis 	= ''; 
		if (lctgl2 ==''){
			swal({
        ...
        if (bln ==''){
            swal({
            title: "Error!",
            text: "MOHON DILENGKAPI BULAN CETAK.!!",
            type: "error",
            confirmButtonText: "OK"
            });
            exit();
        }
		var url		= "<?php echo site_url(); ?>/laporan_inventaris/lap_522";
		iz = '?cpilih='+cpilih+'&tglcetak='+lctgl2+'&bln='+bln;
...
<div id="content1"> 
    ...
    REALISASI PERENCANAAN,PENGAWASAN DAN PEMELIHARAAN</b></h3>
    <fieldset>
              ...
              <td colspan="3">
                <div id="div_bulan">
                  <table style="width:100%;" border="0">
                    ...
                    <td width="1%">:</td>
                    <td><input  name="bulan" id="bulan" style="width: 150px;" ></td>
                  </table>
                </div>
              </td>
            </tr>
