	...
	function openWindow($cek){
		...
		if (cpilih == '3'){				
		var url			= "<?php echo site_url(); ?>/laporan_lainnya/lap_aset_lapukx";
		}else if(cpilih != '3'){
		var url			= "<?php echo site_url(); ?>/laporan_lainnya/lap_lapuk";
		}
...
<div id="content1"> 
    <h3 align="center"><b>CETAK LAPORAN ASET LAPUK UMUR PENGGUNAAN</b></h3>
    <fieldset>
