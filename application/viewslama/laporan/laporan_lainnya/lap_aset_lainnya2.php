	...
	function openWindow($cek){
		...
		if (cpilih == '3'){				
		var url			= "<?php echo site_url(); ?>/laporan_lainnya/lap_aset_lainnya2x";
		}else if(cpilih != '3'){
		var url			= "<?php echo site_url(); ?>/laporan_lainnya/lap_aset_lainnya2";
		}
...
<div id="content1"> 
    <h3 align="center"><b>CETAK LAPORAN ASET LAINNYA</b></h3>
    <fieldset>
