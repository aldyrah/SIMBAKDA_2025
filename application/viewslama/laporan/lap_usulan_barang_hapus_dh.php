...
<script type="text/javascript">
    ...
    function opt(val){        
        ...
        if (ctk=='1'){
            ...
            $('#nomor').combogrid({url:'<?php echo base_url(); ?>index.php/transaksi/ambil_dok_hapus2',queryParams:({kduskpd:'',unit:''}) });
        } else if (ctk=='3'){
            $("#skpd").show();
            $("#div_skpd").hide();
            $("#model_ctk").hide();
  ...
  function cetak($cek){
    ...
    var url     = "<?php echo site_url(); ?>/laporan/lap_usulan_barang_hapus_dh";
    ...
    $(function(){
      $('#kdskpd').combogrid({  
           ...
           onSelect:function(rowIndex,rowData){
               ...
               if(ctk=='1'){
                  $('#nomor').combogrid({url:'<?php echo base_url(); ?>index.php/transaksi/ambil_dok_hapus2',queryParams:({kduskpd:lcskpd,unit:''}) });
        ...
        $('#kdubidskpd').combogrid({  
           ...
           onSelect:function(rowIndex,rowData){
              ...
              // $('#kdubidskpd').combogrid({url:'<?php echo base_url(); ?>index.php/master/ambil_uskpd',queryParams:({kduskpd:lcskpd}) });
               ...
               $('#nomor').combogrid({url:'<?php echo base_url(); ?>index.php/transaksi/ambil_dok_hapus2',queryParams:({kduskpd:skpd,unit:lcskpd}) });
        ...
        $('#tahu').combogrid({  
         ...
         $('#nomor').combogrid({  
           ...
           textField:'no_hapus',  
           mode:'remote',
           //url:'<?php echo base_url(); ?>index.php/transaksi/ambil_dok_hapus2', 
           rownumbers:true,
           singleSelect:true,
           columns:[[  
