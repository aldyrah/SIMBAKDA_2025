...
<script type="text/javascript">
  ...
  function cetak($cek){
    ...
    var url     = "<?php echo site_url(); ?>/laporan_inventaris/lap_kib_b_dh";
    ...
    //if(oto=='01'){
      if(ctk=='1'){
        ...
        if(tahun1=='' || tahun2==''){
          ...
          lc = '?pilih='+cpilih+'&tampil='+cini+'&skpd='+cskpd+'&nmskpd='+cnmskpd+'&bidang='+cbid+'&nmbid='+cnm_bid+'&tahun1='+tahun1+'&tahun2='+tahun2+'&tglcetak='+lctgl2+'&pilctk='+pilctk+'&spasi='+spasi+'&jenis='+jenis+'&nmjenis='+nmjenis;
        }
