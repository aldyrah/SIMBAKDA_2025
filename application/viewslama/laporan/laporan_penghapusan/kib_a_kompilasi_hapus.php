...
<script type="text/javascript">
  ...
  function cetak($cek){
    ...
    var url     = "<?php echo site_url(); ?>/laporan_penghapusan/lap_kib_a_hapus";
    var jenis   = $('#jenis').combogrid('getValue');
    //alert(jenis);
    var nmjenis = document.getElementById('nmjenis').value; 
    var cjenis_aset = document.getElementById('jenis_aset').value;
    ...
    //if(oto=='01'){
      if(ctk=='1'){
        ...
        if(bulan=='' && blnthn=='01'){
          ...
          if(blnthn=='01'){
            lc = '?pilih='+cpilih+'&tampil='+cini+'&skpd='+cskpd+'&nmskpd='+cnmskpd+'&bidang='+cbid+'&nmbid='+cnm_bid+'&jenis='+jenis+'&nmjenis='+nmjenis+'&bulan='+bulan+'&tahun='+tahun+'&tglcetak='+lctgl2+'&pilctk='+pilctk+'&blnthn='+blnthn+'&cjenis_aset='+cjenis_aset;
          }else{
            lc = '?pilih='+cpilih+'&tampil='+cini+'&skpd='+cskpd+'&nmskpd='+cnmskpd+'&bidang='+cbid+'&nmbid='+cnm_bid+'&jenis='+jenis+'&nmjenis='+nmjenis+'&tahun1='+tahun1+'&tahun2='+tahun2+'&tahun3='+tahun3+'&tglcetak='+lctgl2+'&pilctk='+pilctk+'&blnthn='+blnthn+'&cjenis_aset='+cjenis_aset;
          }
        ...
        if(cskpd==''){
          ...
          if(blnthn=='01'){
            ...
            lc = '?pilih='+cpilih+'&tampil='+cini+'&skpd='+cskpd+'&nmskpd='+cnmskpd+'&bidang='+cbid+'&nmbid='+cnm_bid+'&jenis='+jenis+'&nmjenis='+nmjenis+'&tahun1='+tahun1+'&tahun2='+tahun2+'&tglcetak='+lctgl2+'&pilctk='+pilctk+'&blnthn='+blnthn+'&cjenis_aset='+cjenis_aset;
          }
    ...
    <fieldset>
     <table align="center" style="width:100%;" border="0">
            ...
            <tr>
                ...
                <div id="div_jenis">
                        <table style="width:100%;" border="0">
                            ...
                            <td width="1%">:</td>
                            <td width="79%">
                              <input id="jenis" name="jenis" style="width: 300px;" />
            ...
            <tr>
                ...
                <div id="div_jenis">
                        <table style="width:100%;" border="0">
                            <td width="20%">PILIH JENIS CETAK ASET</td>
                            <td width="1%">:</td>
                            <td width="79%">
                              <select name="jenis_aset" id="jenis_aset"  style="width:200px" >
                                <option value="1">ASET TETAP</option>
                                <option value="2" >ASET LAIN LAIN</option>
                                <option value="3">TRANSFER KE PROVINSI</option>
            ...
            <tr>
                ...
                <div id="div_tgl">
                    <table style="width:100%;" border="0">
                        ...
                        <td width="1%">:</td>
                        <td><input type="text" id="tgl_cetak" style="width: 140px;" disabled/></td>  
                    </table>
                </div>
                </td> 
