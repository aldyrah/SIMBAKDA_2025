...
<script type="text/javascript">
    ...
    $("#price").hide();
      ...
      function cetak(){
        ...
        if (urut == 11){
          var docLocation = 'http://10.10.11.44/simbakda_2023/files/b/11.pdf';
          window.open(docLocation,"resizeable,scrollbar"); 


        }else if (urut==21){
          var docLocation = 'http://10.10.11.44/simbakda_2023/files/b/21.pdf';
          window.open(docLocation,"resizeable,scrollbar"); 
        }else if (urut==23){
          var docLocation = 'http://10.10.11.44/simbakda_2023/files/b/23.pdf';
          window.open(docLocation,"resizeable,scrollbar"); 
        }else if (urut==31){
          var docLocation = 'http://10.10.11.44/simbakda_2023/files/b/31.pdf';
          window.open(docLocation,"resizeable,scrollbar"); 
        }else if (urut==33){
          var docLocation = 'http://10.10.11.44/simbakda_2023/files/b/33.pdf';
          window.open(docLocation,"resizeable,scrollbar"); 
        }else{
