...
<script type="text/javascript">
    ...
    $("#price").hide();
      ...
      function cetak(){
        ...
        if (urut == 44){
          var docLocation = 'http://10.10.11.44/simbakda_2023/files/l/44.pdf';
          window.open(docLocation,"resizeable,scrollbar"); 


        }else if (urut==116){
          var docLocation = 'http://10.10.11.44/simbakda_2023/files/l/116.pdf';
          window.open(docLocation,"resizeable,scrollbar"); 
        }else if (urut==1220){
          var docLocation = 'http://10.10.11.44/simbakda_2023/files/l/1220.pdf';
          window.open(docLocation,"resizeable,scrollbar"); 
        }else{
...
<div id="content1"> 
    ...
    <option value="44">FORMAT IV. L.4.4</option>
    <option value="116">FORMAT IV.A.1.1.6</option>
    <option value="1220">FORMAT IV.A.1.2.20</option>
</select>
