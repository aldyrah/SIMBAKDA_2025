<script type="text/javascript">
	...
	function openWindow($cek){
		...
		var url			= "<?php echo site_url(); ?>/laporan_eca/rekap_aset_eca";
		var cthn	= $('#tahun').combogrid('getValue'); 
		
		if (oto=='01'){
				iz = '?kd_skpd='+cskpd+'&nm_skpd='+cnmskpd+'&kd_bid='+cbidang+'&nm_bid='+cnmbid+'&lctahu='+lctahu+'&lcbend='+lcbend+'&cnmbend='+cnmbend+'&cnmtahu='+cnmtahu+'&tgl_reg='+tgl_reg+'&lctgl2='+lctgl2+'&tahun='+cthn+'&fa='+cpilih;
...
<div id="content1"> 
    <h3 align="center"><b>REKAP ASET ECA</b></h3>
    <fieldset>
