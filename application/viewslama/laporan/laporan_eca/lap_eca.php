	...
	function openWindow($cek){
		...
		if (cpilih == '3'){				
		var url			= "<?php echo site_url(); ?>/laporan_eca/lap_ecax";
		}else if(cpilih != '3'){
		var url			= "<?php echo site_url(); ?>/laporan_eca/lap_eca";
		}
		
	if (oto=='01'){
			iz = '?kd_skpd='+cskpd+'&nm_skpd='+cnmskpd+'&kd_bid='+cbidang+'&nm_bid='+cnmbid+'&bend='+cbend+'&tahu='+ctahu+'&nmbend='+cnmbend+'&nmtahu='+cnmtahu+'&tgl_reg='+tgl_reg+'&tgl='+ctgl+'&tahun='+cthn+'&fa='+cpilih;
		    ...
		    if(u=='01'){
				if(cskpd == ''){
					alert('Belum Pilih SKPD')
						...
						alert('Belum Pilih Tanggal Pertanggal')
					}else if(ctgl == ''){
					alert('Belum Pilih Tanggal Cetak')
				}
				else if (20+""+tgl_reg.substring(0,3)<cthn){
					alert('MOHON TAHUN TIDAK MELEBIH DARI KIB PER TANGGAL.!!');
					exit();
				}
				else{
				iz = '?kd_skpd='+cskpd+'&nm_skpd='+cnmskpd+'&kd_bid='+cbidang+'&nm_bid='+cnmbid+'&bend='+cbend+'&tahu='+ctahu+'&nmbend='+cnmbend+'&nmtahu='+cnmtahu+'&tgl_reg='+tgl_reg+'&tgl='+ctgl+'&tahun='+cthn+'&fa='+cpilih;
...
<div id="content1"> 
    <h3 align="center"><b>CETAK EKSTRA COUNTING ASSET (ECA)</b></h3>
    <fieldset>
