...
<script type="text/javascript">
    ...
    function cetak(format) {
        ...
        if (urut == 111) {
            docLocation = 'http://localhost/simbakda_2023/laporan/a. Laporan Perolehan atau Penerimaan IV.A/LAMPIRAN IV.A.1.1.1';
        } else if (urut == 121) {
            docLocation = 'http://localhost/simbakda_2023/laporan/a. Laporan Perolehan atau Penerimaan IV.A/LAMPIRAN IV.A.1.2.1';
        } else if (urut == 122) {
            docLocation = 'http://localhost/simbakda_2023/laporan/a. Laporan Perolehan atau Penerimaan IV.A/LAMPIRAN IV.A.1.2.2';
        } else if (urut == 131) {
            docLocation = 'http://localhost/simbakda_2023/laporan/a. Laporan Perolehan atau Penerimaan IV.A/LAMPIRAN IV.A.1.3.1';
        } else if (urut == 21) {
            docLocation = 'http://localhost/simbakda_2023/laporan/a. Laporan Perolehan atau Penerimaan IV.A/LAMPIRAN IV.A.2.1';
        } else if (urut == 31) {
            docLocation = 'http://localhost/simbakda_2023/laporan/a. Laporan Perolehan atau Penerimaan IV.A/LAMPIRAN IV.A.3.1';
        } else if (urut == 41) {
            docLocation = 'http://localhost/simbakda_2023/laporan/a. Laporan Perolehan atau Penerimaan IV.A/LAMPIRAN IV.A.4.1';
        } else if (urut == 51) {
            docLocation = 'http://localhost/simbakda_2023/laporan/a. Laporan Perolehan atau Penerimaan IV.A/LAMPIRAN IV.A.5.1';
        } else if (urut == 61) {
            docLocation = 'http://localhost/simbakda_2023/laporan/a. Laporan Perolehan atau Penerimaan IV.A/LAMPIRAN IV.A.6.1';
        } else if (urut == 71) {
            docLocation = 'http://localhost/simbakda_2023/laporan/a. Laporan Perolehan atau Penerimaan IV.A/LAMPIRAN IV.A.7.1';
        } else if (urut == 81) {
            docLocation = 'http://localhost/simbakda_2023/laporan/a. Laporan Perolehan atau Penerimaan IV.A/LAMPIRAN IV.A.8.1';
        } else if (urut == 91) {
            docLocation = 'http://localhost/simbakda_2023/laporan/a. Laporan Perolehan atau Penerimaan IV.A/LAMPIRAN IV.A.9.1';
        } else if (urut == 101) {
            docLocation = 'http://localhost/simbakda_2023/laporan/a. Laporan Perolehan atau Penerimaan IV.A/LAMPIRAN IV.A.10.1';
        } else {
                ...
                <td colspan="3">
                    <div id="div_cetak">
                        <table style="width:100%;" border="0">
                            ...
                            <td width="1%"></td>
                            <td width="79%">
                                <a class="easyui-linkbutton" onclick="cetak(1);return false;">CETAK PDF</a>
                                <a class="easyui-linkbutton" onclick="cetak(2);return false;">CETAK EXCEL</a>
                                <a class="easyui-linkbutton" onclick="cetak(3);return false;">CETAK WORD</a>
                                <a class="easyui-linkbutton" onclick="cetak(4);return false;">CETAK HTML</a>
                            </td>
                        </table>
                    </div>
                </td>
