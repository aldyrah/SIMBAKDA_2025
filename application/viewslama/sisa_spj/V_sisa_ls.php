...
//       });
      ...
      $('#bulan').combogrid({  
        ...
        textField  : 'no_sp2d',  
        mode       : 'remote',
        url        : '<?php echo base_url(); ?>/index.php/sisa_spj/C_sisa_spj_ls/load_sp2d',  
        columns    : [[    
...
<div id="content1" align="center"> 
    <h3 align="center"><b>CETAK LAPORAN SISA SPJ LS<br>
   </b></h3>
     ...
     <table align="center" style="width:100%;" border="0">
            <tr>
                <td>
                    ...
                    <input type="radio" name="cetak" value="2" onclick="opt(this.value)" />SP2D
                </td>
                <td>&ensp;</td>
                <td>&nbsp</td>
            </tr>
            ...
            <tr>
                ...
                <a href="<?php echo site_url(); ?>/sisa_spj/C_sisa_spj_ls/cetak_sisa_ls" class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:openWindow(this.href);return false">Cetak</a>
                <a href="<?php echo site_url(); ?>/sisa_spj/C_sisa_spj_ls/cetak_sisa_ls/2/" class="easyui-linkbutton" iconCls="icon-excel" plain="true" onclick="javascript:openWindow(this.href);return false">export</a>
                </td>                
            </tr>
        </table>  
