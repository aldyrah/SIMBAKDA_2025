  ...
  <style>   
    ...
    function cetak(){
		   ...
		   //alert("aaaaaaaaa");
			...
			//alert(tgl1+" "+ctglttd);
			var url ="<?php echo site_url(); ?>/akuntansi/kas_bul";
			
			
			
			window.open(url+'?bulan='+tgl1+'&tgl_ctk='+ctglttd);
			window.focus();
    }
...
<div id="accordion">
    <p align="right">         
		...
		<tr >
			<td align="center" colspan="3"><a class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:cetak();">Cetak</a></td>
		</tr>
