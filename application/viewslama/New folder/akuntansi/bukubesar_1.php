   ...
   $(function(){
	...
	function valid_ttd(x){
		$(function(){
			$('#ttd').combogrid({  
				panelWidth:500,  
				url: '<?php echo base_url(); ?>/index.php/tukd/list_ttd/'+x,  
					idField:'nip',                    
					textField:'nama',
					mode:'remote',  
					fitColumns:true,  
		...
		function cetakbb()
        {
			...
			//window.open(url+'/'+dcetak+'/'+ttd1+'/'+skpd+'/'+rek5+'/'+dcetak2, '_blank');
			window.open(url+'?dcetak='+dcetak+'&ttd1='+ttd1+'&skpd='+skpd+'&rek5='+rek5+'&dcetak2='+dcetak2, '_blank');
			window.focus();
        }
