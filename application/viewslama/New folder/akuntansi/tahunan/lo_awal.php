...
<head>
    ...
    var lcstatus = '';
     ...
     $(function(){ 
     $('#dg').edatagrid({
		url: '<?php echo base_url(); ?>/index.php/master/load_lo_awal_tamp/',
        idField:'id',            
        rownumbers:"true", 
        fitColumns:"true",
        singleSelect:"true",
...
if (row.seq=='35' ||row.seq=='75' ||row.seq=='100'
||row.seq=='125' ||row.seq=='130' ||row.seq=='155'
||row.seq=='160' ||row.seq=='220' ||row.seq=='260'
||row.seq=='265'||row.seq=='275'||row.seq=='310'||row.seq=='340'||row.seq=='400'||row.seq=='380'){
        ...
        if(lcstatus=='tambah'){              
            ...
            $(document).ready(function(){
                $.ajax({
					...
					data: ({tabel:'map_lo_kab',kolom:lcinsert,nilai:lcvalues,cid:'nor',lcid:cno}),
                    dataType:"json",
         ...
         //lcquery = "UPDATE ms_lo_kab_lalu SET uraian='"+curaian+"',seq='"+cseq+"',nilai_lalu='"+lnnilai+"',kd_skpd='"+cskpd+"' where kode='"+cno+"'";
		    lcquery = "UPDATE map_lo_kab SET uraian='"+curaian+"',seq='"+cseq+"',nilai_tamp='"+lnnilai+"' where nor='"+cno+"'";
            $(document).ready(function(){
            $.ajax({
                type: "POST",
                url: '<?php echo base_url(); ?>/index.php/master/update_master_lalu_lo',
...
<div id="content"> 
<div id="accordion">
<h3 align="center"><u><b><a href="#" id="section1">Data LO Lalu</a></b></u></h3>
    <div>
    <p align="right">         
        ...
        <table id="dg" title="Listing Data LO Lalu" style="width:870px;height:450px;" >  
        </table>
