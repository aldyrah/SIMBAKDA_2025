...
$(function(){
	...
	//var ttd = $('#ttd').datebox('getValue'); 
		...
		if(ctk=='1'){
			var url    = "<?php echo site_url(); ?>/akuntansi/cetak_realisasiangg_MURNI/1/";  
	...
	var ttd = $('#ttd').datebox('getValue'); 
		...
		if(ctk=='1'){
			var url    = "<?php echo site_url(); ?>/akuntansi/cetak_realisasiangg_MURNI/2/";  
			lc= '?skpd='+kdskpd+'&cpilih=1';
		}else if(ctk=='2'){
			var url    = "<?php echo site_url(); ?>/akuntansi/cetak_realisasiangg_MURNI/2/";  
			lc= '?skpd='+kdskpd+'&keg='+kdgiat+'&cpilih=2';
...
<div id="content"> 
<div id="accordion">
<h5 align="center"><b><a href="#" id="section1">CETAK REALISASI ANGGARAN MURNI</a></b></h5>
