...
<head>   
  ...
  <script type="text/javascript">
    ...
    function get(kd_s,kd_u,nm_s,kel,lra) {
    ...
    $(function(){ 
     $('#dg').edatagrid({
       ...
       function simpan_rek2(){
		...
		var ckel = document.getElementById('kel').value;
		...
		if (clra==''){
            alert('Kode LRA  Tidak Boleh Kosong');
            exit();
        }
        ...
        if(lcstatus=='tambah'){ 
            ...
            lcinsert = "(kd_rek3,kd_rek2,nm_rek3,kelompok,lra)";
            lcvalues = "('"+ckode+"','"+crek2+"','"+cnama+"','"+ckel+"','"+clra+"')";
            ...
            lcquery = "UPDATE ms_rek3 SET nm_rek3='"+cnama+"',kd_rek2='"+crek2+"',kelompok='"+ckel+"',lra='"+clra+"' where kd_rek3='"+ckode+"'";
     ...
     <table align="center" style="width:100%;" border="0">
           ...
           <tr>
			...
			<tr>
                <td width="30%">KODE KELOMPOK</td>
                <td width="1%">:</td>
                <td><input type="text" id="kel" maxlength="5" style="width:100px;"/></td>  
            </tr>

			<tr>
                <td width="30%">KODE LRA</td>
                <td width="1%">:</td>
                <td><input type="text" id="lra" maxlength="5" style="width:100px;"/></td>  
            </tr>
