...
<head>
    ...
    function cekdulu(){
        ...
        var fd=$('#dd').datebox('getValue');
        var a= sd.length;
           
        var bulanspp = fd.substr(3,2);
        var tglspp = fd.substr(0,2);
        var tahunspp = fd.substr(6,4);
 ...
 <tr>
   ...
   <td width='31%'><input type="text" name="rekening" id="rekening"  value="" readonly="true" style="width:150px" /></td>
     ...
     <table id="dg" title=" Detail SPM" style="width:850%;height:250%;" >  
		...
		<input class="right" type="text" name="rekspm1" id="rekspm1"  style="width:140px" align="right" readonly="true" >
       ...
       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<input class="right" type="text" name="rektotal1" id="rektotal1"  style="width:140px" align="right" readonly="true" >
    <!-- <?php echo form_close(); ?> -->
