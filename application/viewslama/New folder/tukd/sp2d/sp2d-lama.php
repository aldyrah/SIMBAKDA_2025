...
<head>
    ...
    $(function(){ 
     $('#sp2d').edatagrid({
        ...
        onSelect:function(rowIndex,rowData){
		  ...
		  ning  = rowData.no_rek;
		  nm  = rowData.nm_skpd;
		 getspm(no_sp2d,no_spm1,tgs,st,tgspm,no_spp,dn,sp,tg,bl,jn,kep,np,rekan,bk,ning,nm);                                    
		 detail();
		 pot();  
        },
    ...
    $(function(){
        ...
        function  getspm(no_sp2d,no_spm1,tgs,st,tgspm,no_spp,dn,sp,tg,bl,jn,kep,np,rekan,bk,ning,nm){
...
<table border='1' style="font-size:11px" >
 ...
 <tr  style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;">
   ...
   <td  style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;border-right-style:hidden;"><input type="text" name="no_sp2d" id="no_sp2d" onclick="javascript:select();"  style="width:200px ;"/></td>
