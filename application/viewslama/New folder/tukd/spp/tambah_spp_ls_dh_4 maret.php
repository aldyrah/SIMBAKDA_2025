...
<head>
             ...
             $('#dgpajak').edatagrid({
                ...
                url: '<?php echo base_url(); ?>/index.php/tukd/load_no_penagihan',  
                    ...
                    onSelect:function(rowIndex,rowData){
                      ...
                      spm2  = rowData.spm2;     
					            $('#hal').attr("value",0);
                      get(no_spp,no_spm,kode,sp,tg,bl,jn,kep,np,rekan,bk,ning,status,kegi,nm,kprog,nprog,dir,notagih,tgltagih,sttagih,spp,spp2,spm,spm2);
                      det();       
                      detail_trans_3();   
                      validate_kegiatan();
  ...
  function gabung()
  {
    ...
    function det(){   
     ...
     function get(no_spp,no_spm,kd_skpd,no_spd,tgl_spp,bulan,jns_spp,keperluan,npwp,rekanan,bank,rekening,status,giat,nmgiat,prog,nmprog,pim,notagih,tgltagih,ststagih,spp,spp2,spm,spm2){
    ...
    function hsimpan(){        
        ...
        if (lcstatus=='tambah') { 
            ...
            lcinsert = "(no_spp,   no_spm,     kd_skpd, keperluan,   bulan,   no_spd,    jns_spp, bank,   nmrekan,  no_rek,  npwp,    nm_skpd,  tgl_spp, status, username,     last_update,   nilai,    no_bukti,     kd_kegiatan,  nm_kegiatan,  kd_program,  nm_program,  pimpinan,  no_tagih,    tgl_tagih,  sts_tagih, no_bukti2, no_bukti3, no_bukti4, no_bukti5, no_spd2, no_spd3, no_spd4 )"; 
            lcvalues = "('"+a+"','"+aspm+"', '"+kode+"', '"+e+"',   '"+d+"', '"+spd+"', '"+c+"', '"+g+"', '"+f+"',  '"+i+"', '"+h+"', '"+j+"',  '"+b+"', '0',       '',           '',       '"+k+"',       '',         '"+kegi+"',   '"+l+"',      '"+m+"',     '"+n+"',     '"+f1+"',  '"+p+"',     '"+q+"',    '"+o+"',     '',       '',         '',        '',        '',      '',      ''   )";
            ...
            lcquery = " UPDATE trhspp SET kd_skpd='"+kode+"', keperluan='"+e+"', bulan='"+d+"', no_spd='"+spd+"', jns_spp='"+c+"', bank='"+g+"', nmrekan='"+f+"', no_rek='"+i+"', npwp='"+h+"', nm_skpd='"+j+"', tgl_spp='"+b+"', status='0', nilai='"+k+"', kd_kegiatan='"+kegi+"', nm_kegiatan='"+l+"', kd_program='"+m+"', nm_program='"+n+"', pimpinan='"+f1+"', no_tagih='"+p+"', tgl_tagih='"+q+"', sts_tagih='"+o+"', no_spp='"+a+"', no_spm='"+aspm+"' where no_spp='"+a_hide+"' "; 
            if (k > spd1){
        alert('Nilai SPP='+k+'Melebihi SPD='+spd1);
      } else {
            $(document).ready(function(){
