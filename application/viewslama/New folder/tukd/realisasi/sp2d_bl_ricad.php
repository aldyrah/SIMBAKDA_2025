...
<head>
	...
	$(function(){
		...
		function cetak()
        {
			...
			var url    = "<?php echo site_url(); ?>/tukd/reg_sp2d_ricad/1/";  
			lc= '?posx='+periode1+'&posy='+periode2+'&sp='+space+'&ttdd='+ttdd+'&tglttd='+tglttd;
		...
		function cetak_ex()
        {
			...
			var periode2 = $('#perid2').datebox('getValue');
			var space = document.getElementById('space').value;
			var url    = "<?php echo site_url(); ?>/tukd/reg_sp2d_ricad/2/";  
