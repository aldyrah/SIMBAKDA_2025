...
<head>
    ...
    $(document).ready(function(){
     ...
     $(function(){ 
     $('#dg').edatagrid({
		url: '<?php echo base_url(); ?>/index.php/tukd/load_pajakmasuk',
        idField:'id',            
        rownumbers:"true", 
        fitColumns:"true",
        singleSelect:"true",
        ...
        $('#bank').combogrid({  
           ...
           textField:'kode',  
           mode:'remote',
           url:'<?php echo base_url(); ?>index.php/tukd/config_rek',  
           columns:[[  
     ...
     function simpan_ambilsmp(){
        ...
        if (lcstatus=='tambah'){ 
			...
			$(document).ready(function(){;
				$.ajax({
					type: "POST",
					url: '<?php echo base_url(); ?>/index.php/tukd/simpan_pajakmasuk',
					data: ({tabel:'tr_pajakmasuk',kolom:lcinsert,nilai:lcvalues,cid:'no_kas',lcid:cno}),
					dataType:"json",
					success:function(data){
						status = data;
						if (status=='2'){
			...
			lcquery = "UPDATE tr_pajakmasuk SET tgl_kas='"+ctgl+"',kd_skpd='"+cskpd+"',nilai='"+lnnilai+"',bank='"+cbank+"',nm_rekening='"+cnmrek+"',keterangan='"+lcket+"' where no_kas='"+cno+"' and kd_skpd='"+cskpd+"'";
			$(document).ready(function(){
				$.ajax({
					type: "POST",
					url: '<?php echo base_url(); ?>/index.php/tukd/update_pajakmasuk',
    ...
    function hapus(){
        var urll = '<?php echo base_url(); ?>index.php/tukd/hapus_pajakmasuk';
		swal({
		  title: "Are you sure?",
	...
	function ambil_nomor(){
		$.ajax({
			type: "POST",
			url: '<?php echo base_url(); ?>/index.php/tukd/nomorkas',
			dataType:"json",
				success: function(data){
...
<div id="content"> 
<div id="accordion">
<h3 align="center"><u><b><a href="#" id="section1">INPUTAN PAJAK MASUK BUD</a></b></u></h3>
    <div>
    <p align="right">         
