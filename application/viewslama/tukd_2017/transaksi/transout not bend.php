...
//       });              
        ...
        $('#giat').combogrid({  
           ...
           onSelect:function(rowIndex,rowData){
               ...
               var kode = document.getElementById('skpd');
               $("#nmgiat").attr("value",rowData.nm_kegiatan);
               $("#sp2d").combogrid({url:'<?php echo base_url(); ?>index.php/tukd/load_sp2d_transout_ppkd',queryParams:({jenis:jnsbeban,giat:giat,bukti:nomor})});                                                                                                                                                        
           }  
        });
...
//        }           
    ...
    function hapus_giat(){
     ...
     function hapus(){
		...
		var cskpd = document.getElementById('skpd').value;
        var urll = '<?php echo base_url(); ?>index.php/tukd/hapus_transout_ppkd';
    ...
    function simpan_transout(){
        ...
        $(document).ready(function(){
            $.ajax({
                type: "POST",       
                dataType : 'json',         
                data: ({tabel:'trhtransout_ppkd',no:cno,tgl:ctgl,skpd:cskpd,nmskpd:cnmskpd,beban:cjenis,ket:cket,status:cstatus,notagih:ctagih,tgltagih:ctgltagih,total:ctotal,cpay:cjenis_bayar}),
...
<div id="content">    
<div id="accordion">
<h3><a href="#" id="section1" >List Pembayaran Transaksi PPKD</a></h3>
    <div>
    <p align="right">         
...
<h3><a href="#" id="section2">PEMBAYARAN TRANSAKSI PPKD</a></h3>
