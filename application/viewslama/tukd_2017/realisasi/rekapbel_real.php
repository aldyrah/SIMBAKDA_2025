...
$(function(){
	...
	{   
		...
		if(ctk=='1'){
			var url    = "<?php echo site_url(); ?>/tukd/rekapbel_real/1/";  
			lc= '?posx='+skpd+'&cpilih=1';
		}else if(ctk=='2'){
			var url    = "<?php echo site_url(); ?>/tukd/rekapbel_real/1/";  
			lc= '?posx='+skpd+'&keg='+kdgiat+'&cpilih=2';
		}
...
<div id="content"> 
<div id="accordion">
<h5 align="center"><b><a href="#" id="section1">REKAPITULASI REALISASI BELANJA PER-SKPD</a></b></h5>
 ...
 <fieldset>
     <table align="center" style="width:100%;" border="0">  
			...
			<tr>
				<td width="100%" align="center">&nbsp;REKAPITULASI REALISASI BELANJA PER-SKPD</td>
