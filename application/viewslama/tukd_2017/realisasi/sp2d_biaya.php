...
$(function(){ 
	...
	{   var ttdd = $('#ttd').combogrid("getValue");
		...
		if(ctk=='1'){
			var url    = "<?php echo site_url(); ?>/tukd/pembiayaan/1/";  
			lc= '?bulan='+bulan+'&chal='+chal+'&ttdd='+ttdd+'&tglttd='+tglttd;
		}else if(ctk=='2'){
			var url    = "<?php echo site_url(); ?>/tukd/cetak_pfk_pembiayaan/1/";  
			lc= '?bulan='+bulan+'&chal='+chal+'&ttdd='+ttdd+'&tglttd='+tglttd;
		}else if(ctk=='3'){
			var url    = "<?php echo site_url(); ?>/tukd/pembiayaan2/1/";  
			lc= '?bulan='+bulan+'&chal='+chal+'&ttdd='+ttdd+'&tglttd='+tglttd;
		}else if(ctk=='4'){
			var url    = "<?php echo site_url(); ?>/tukd/mod/1/";  
	lc= '?awal='+tgl1+'&akhir='+tgl2+'&chal='+chal+'&ttdd='+ttdd+'&tglttd='+tglttd+'&sdana='+sdana+'&skpd='+skpd;
		}else if(ctk=='5'){
			var url    = "<?php echo site_url(); ?>/tukd/mod1/1/";  
			lc= '?awal='+tgl1+'&akhir='+tgl2+'&chal='+chal+'&ttdd='+ttdd+'&tglttd='+tglttd+'&sdana='+sdana;
		}
	...
	{   var ttdd = $('#ttd').combogrid("getValue");
		...
		//var space = document.getElementById('space').value;
		if(ctk=='1'){
			var url    = "<?php echo site_url(); ?>/tukd/pembiayaan/2/";  
			lc= '?bulan='+bulan+'&chal='+chal+'&ttdd='+ttdd+'&tglttd='+tglttd;
		}else if(ctk=='2'){
			var url    = "<?php echo site_url(); ?>/tukd/cetak_pfk_pembiayaan/2/";  
			lc= '?bulan='+bulan+'&chal='+chal+'&ttdd='+ttdd+'&tglttd='+tglttd;
		}else if(ctk=='3'){
			var url    = "<?php echo site_url(); ?>/tukd/pembiayaan2/2/";  
			lc= '?bulan='+bulan+'&chal='+chal+'&ttdd='+ttdd+'&tglttd='+tglttd;
		}else if(ctk=='4'){
			var url    = "<?php echo site_url(); ?>/tukd/mod/2/";  
	lc= '?awal='+tgl1+'&akhir='+tgl2+'&chal='+chal+'&ttdd='+ttdd+'&tglttd='+tglttd+'&sdana='+sdana+'&skpd='+skpd;
		}else if(ctk=='5'){
			var url    = "<?php echo site_url(); ?>/tukd/mod1/2/";  
			lc= '?awal='+tgl1+'&akhir='+tgl2+'&chal='+chal+'&ttdd='+ttdd+'&tglttd='+tglttd+'&sdana='+sdana;
		}
...
<h5 align="center"><b><a href="#" id="section1">LAPORAN - LAPORAN BELANJA LANGSUNG</a></b></h5>
 ...
 <fieldset>
     <table align="center" style="width:100%;" border="0">  
			...
			<tr>
				<td width="100%" align="left"><input type="radio" name="cetak" value="1" onclick="opt(this.value)" />&nbsp;Register SP2D Pembiayaan Keluar</td>
			...
			<tr>
				<td width="100%" align="left"><input type="radio" name="cetak" value="3" onclick="opt(this.value)" />&nbsp;Daftar Realisasi Pembiayaan Keluar</td>
				<td width="0%" align="left">&nbsp;</td>
			</tr>
			<tr>
				<td width="100%" align="left"><input type="radio" name="cetak" value="4" onclick="opt(this.value)" />&nbsp;Daftar Realisasi Belanja Modal per Bulan</td>
				<td width="0%" align="left">&nbsp;</td>
			</tr>
            
            <tr>
				<td width="100%" align="left"><input type="radio" name="cetak" value="5" onclick="opt(this.value)" />&nbsp;Daftar Realisasi Belanja Modal per SUMBER DANA</td>
				<td width="0%" align="left">&nbsp;</td>
			</tr>
	  ...
	  <div id="cetak">
		<p align="center">         
			<a class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:cetak();">cetak</a>   
          		<a class="easyui-linkbutton" iconCls="icon-excel" plain="true" onclick="javascript:EXPORT();">EXPORT</a>   
		</p> 
	  </div>  
</fieldset>
