	...
	var apbd =document.getElementById('apbd').value;
       ...
       // var skpd = $('#sskpd123').combogrid("getValue");
		...
		if(ctk=='1'){
				...
				if(apbd=='0'){
		var url    = "<?php echo site_url(); ?>/tukd/cetak_ringksumberdanarekap/1/";  
		lc= '?tgl1='+periode1+'&tgl2='+periode2+'&sdana='+sdana+'&tglttd='+ctglttd+'+&space='+spasi+'&APBD='+apbd;
		}else{
			var url    = "<?php echo site_url(); ?>/tukd/cetak_ringksumberdanaubahrekap/1/";  
		lc= '?tgl1='+periode1+'&tgl2='+periode2+'&sdana='+sdana+'&tglttd='+ctglttd+'+&space='+spasi+'&APBD='+apbd;
			}
	...
	var apbd =document.getElementById('apbd').value;
       ...
       // var skpd = $('#sskpd123').combogrid("getValue");
		...
		if(ctk=='1'){
				...
				if(apbd=='0'){
		var url    = "<?php echo site_url(); ?>/tukd/cetak_ringksumberdanarekap/2/";  
		lc= '?tgl1='+periode1+'&tgl2='+periode2+'&sdana='+sdana+'&tglttd='+ctglttd+'+&space='+spasi+'&APBD='+apbd;
		}else{
			var url    = "<?php echo site_url(); ?>/tukd/cetak_ringksumberdanaubahrekap/2/";  
		lc= '?tgl1='+periode1+'&tgl2='+periode2+'&sdana='+sdana+'&tglttd='+ctglttd+'+&space='+spasi+'&APBD='+apbd;
			}
...
<h5 align="center"><b><a href="#" id="section1">PAJAK</a></b></h5>
 ...
 <table style="width:100%;" border="0">
   <tr>
     ...
     <option value="0">1 | Penyusunan</option>
     <option value="1">2 | Perubahan</option>
   </select></td> 
                            </tr>
                            </table>
                            </div>
