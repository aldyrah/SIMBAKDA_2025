    ...
    $(function(){ 
        $('#dg').edatagrid({
            ...
            onSelect:function(rowIndex,rowData){
              ...
              nil_tetap = number_format(rowData.nil_tetap,2,'.',',');
              cekit     = 0;
              cekidot   = 0;
              lcidx     = rowIndex;
            ...
            onDblClickRow:function(rowIndex,rowData){
              ...
              lcrek     = rowData.kd_rek5;
              rek       = rowData.kd_rek;
              lcnilai   = number_format(rowData.nilai,2,'.',',');
              sts       = rowData.sts_tetap;
              nil_tetap = number_format(rowData.nil_tetap,2,'.',',');
              cekit     = 0;
              cekidot   = 0;
        ...
        $('#notetap').combogrid({  
           ...
           onSelect:function(rowIndex,rowData){
            ...
            $("#nilai_tetap").attr("value",number_format(rowData.nilai,2,'.',','));  
            }  
        });
    ...
    function tambah(){
        $('#notetap').combogrid({  
           ...
           onSelect:function(rowIndex,rowData){
            ...
            $("#nilai").attr("value",number_format(rowData.sisa_byr,2,'.',','));
            $("#nilai_tetap").attr("value",number_format(rowData.nilai,2,'.',','));  
           }
        });
        $("#notetap").combogrid("clear");
          ...
          $.ajax({
            ...
            success:function(data){
              $.each(data,function(i,n){
                  ...
                  var byr = number_format(bayar,2,',','.');
                  var hasil= bayar+nil; 
                  var sel2 = nil_t-bayar;
                  var s = number_format(sel2,2,',','.');
                  if(hasil>nil_t){
...
<div id="dialog-modal" title="">
    ...
    <table align="center" style="width:100%;" border="0">
        ...
        <tr>
            <td>Rekening</td>
            <td></td>
            <td><input id="rek" name="rek" style="width: 140px;" /> <input id="rek1" style="width: 140px;" readonly="true"/><input type="hidden" id="giat" style="width: 140px;" readonly="true"/>
             <input type="text" id="nmrek" style="border:0;width: 600px;" readonly="true"/></td>                
        </tr>            
        <tr>
            <td>Nilai</td>
            <td></td>
            <td><input type="text" id="nilai" style="width: 200px; text-align: right;" onkeypress="return(currencyFormat(this,',','.',event))"/>
               &nbsp;&nbsp; Nilai Penetapan &nbsp;&nbsp; <input type="text" id="nilai_tetap" style="width: 200px; text-align: right;" readonly="true" onkeypress="return(currencyFormat(this,',','.',event))"/></td> 
        </tr>
        <tr>
            <td>Keterangan</td>
