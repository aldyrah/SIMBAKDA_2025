    ...
    function validate1(){
     ...
     function get_skpd()
		...
		function cetak()
        {
			...
			var url    = "<?php echo site_url(); ?>/tukd/cetak_bppanjar";  
			window.open(url+'/'+skpd+'/'+bulan+'/'+tglttd, '_blank');
			window.focus();
        }
    ...
    <p align="right">         
        ...
        <tr >
		 ...
		 <tr >
			...
			<td style="border-top:none;border-bottom:none;"><input type="text" id="tgl_ttd" style="width: 100px;" /> </td>
		</tr>
		<tr >
