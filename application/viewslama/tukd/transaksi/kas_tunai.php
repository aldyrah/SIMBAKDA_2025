    ...
    <h3 align="center"><b>BUKU KAS TUNAI</b></h3>
     ...
     <table align="center" style="width:100%;" border="0">
            ...
            <tr>
                ...
                <a href="<?php echo site_url(); ?>/tukd/cetak_kas_tunai/1" class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:openWindow(this.href);return false">Cetak</a>
                <!-- <a href="<?php echo site_url(); ?>/tukd/cetak_kas_tunai/2" class="easyui-linkbutton" iconCls="icon-excel" plain="true" onclick="javascript:openWindow(this.href);return false">Export</a> -->
                </td>                
            </tr>
        </table>  
