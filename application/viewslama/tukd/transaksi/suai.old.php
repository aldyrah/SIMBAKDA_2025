		...
		alert('aaa');
		 ...
		 $('#dg1').datagrid('selectAll');
			...
			for(var p=0;p<rows.length;p++){
				...
				if (p>0) {
                csql = csql+","+"('"+cnobukti+"','"+ctgl+"','"+cskpd+"','"+ckdgiat+"','"+cnmgiat+"','"+crek+"','"+cnmrek+"','"+cnilaid+"','"+cnilaik+"','"+ckn+"','"+cket+"')";
                } else {
                csql = "values('"+cnobukti+"','"+ctgl+"','"+cskpd+"','"+ckdgiat+"','"+cnmgiat+"','"+crek+"','"+cnmrek+"','"+cnilaid+"','"+cnilaik+"','"+ckn+"','"+cket+"')";                                            
                }      
