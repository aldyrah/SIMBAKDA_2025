...
<div id="accordion">
    ...
    <p align="right">         
		...
		<tr >
			...
			<td width="80%" style="border-top:none;border-bottom:none;"><input id="sskpd" name="sskpd" style="width: 80px;" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id="nmskpd" name="nmskpd" style="width: 500px; border:0;" /></td>
		</tr>
        <tr >
