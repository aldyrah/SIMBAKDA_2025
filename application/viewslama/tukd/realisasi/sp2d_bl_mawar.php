...
$(function(){ 
	...
	var rekeninggen = document.getElementById('rekeninggen').value;
		...
		if(ctk=='1'){
			var url    = "<?php echo site_url(); ?>/tukd/reg_sp2d_mawar1/1/CAIR/";  
			lc= '?posx='+tgl1+'&posy='+tgl2;

		}else if(ctk=='2'){
			var url    = "<?php echo site_url(); ?>/tukd/reg_sp2d_mawar1/1/";  
lc= '?posx='+tgl1+'&posy='+tgl2;
		}else if(ctk=='3'){
			var url    = "<?php echo site_url(); ?>/tukd/reg_sp2d_mawar1/1/TERBIT";  
lc= '?posx='+tgl1+'&posy='+tgl2;
		}else if(ctk=='4'){
	var url    = "<?php echo site_url(); ?>/tukd/reg_sp2d_mawar1_pemb/1/TERBIT";   
			lc= '?posx='+tgl1+'&posy='+tgl2;
	...
	var rekeninggen = document.getElementById('rekeninggen').value;
		//var space = document.getElementById('space').value;
		if(ctk=='1'){
	var url    = "<?php echo site_url(); ?>/tukd/reg_sp2d_mawar1/2/CAIR/";   
			lc= '?posx='+tgl1+'&posy='+tgl2;
		}else if(ctk=='2'){
			var url    = "<?php echo site_url(); ?>/tukd/reg_sp2d_mawar1/2/";  
			lc= '?posx='+tgl1+'&posy='+tgl2;
		}else if(ctk=='3'){
	var url    = "<?php echo site_url(); ?>/tukd/reg_sp2d_mawar1/2/TERBIT";   
			lc= '?posx='+tgl1+'&posy='+tgl2;
		}else if(ctk=='4'){
	var url    = "<?php echo site_url(); ?>/tukd/reg_sp2d_mawar1_pemb/2/TERBIT";   
			lc= '?posx='+tgl1+'&posy='+tgl2;
...
<div id="content"> 
<div id="accordion">
<h5 align="center"><b><a href="#" id="section1">SP2D</a></b></h5>
