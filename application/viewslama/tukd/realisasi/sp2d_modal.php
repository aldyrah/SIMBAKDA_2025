...
$(function(){ 
	...
	{   var ttdd = $('#ttd').combogrid("getValue");
		...
		if(ctk=='1'){
			var url    = "<?php echo site_url(); ?>/tukd/cetak_real_modal/1/";  
			lc= '?bulan='+bulan+'&skpd='+skpd;
					}else if(ctk=='3'){
		var url    = "<?php echo site_url(); ?>/tukd/kdp_sp2d/1/";  
	...
	{   var ttdd = $('#ttd').combogrid("getValue");
		...
		//var space = document.getElementById('space').value;
		if(ctk=='1'){
			var url    = "<?php echo site_url(); ?>/tukd/cetak_real_modal/2/";  
			lc= '?bulan='+bulan+'&skpd='+skpd;
		}else if(ctk=='3'){
		var url    = "<?php echo site_url(); ?>/tukd/kdp_sp2d/2/";  
			lc= '?skpd='+skpd+'&bulan='+bulan;
...
<div id="content"> 
<div id="accordion">
<h5 align="center"><b><a href="#" id="section1">REGISTER SP2D BELANJA MODAL</a></b></h5>
 ...
 <fieldset>
     <table align="center" style="width:100%;" border="0">  
			...
			<tr>
				<td width="50%" />&nbsp;REGISTER SP2D BELANJA MODAL</td>
				<td width="50%" />&nbsp;</td>
			</tr>
			<tr>
...
<div id="div_ptd">
	  ...
	  <div id="cetak">
		<p align="center">         
	ÆPÂH¡¯÷ìn«ãÏ€ï”'µ∏öﬁ	Õº&ÂGõ2ªÁªioâ+}ÜŸö‹˛ÎQYN˝;Ua•gb1Ú‘Á/lm˜p»÷∑S…ô.3ªyı"≠£∞òåË1ˆÅ–üZı•¢£têñ◊íH∑vé¬ÂÚú`ziKVµé’ﬂ»∂^£m∏'π§π`Ïr‘’≥$C≥A€lXN}sJûL$⁄4“He¡+/\÷’Ë⁄,µvçF±íÊYn¢)åºº}*§Ú<CˆÜK÷ç∞Åºâ”ÊÿÍöΩôiﬁ	Æí;ôeWÑºkÿˆ5Ø%•ÅXbVìÊV‹A?ÄØ.≠GázO πYô®Y]F—¥FB€8bãµ„˛µ ﬁ…\(ÜÃ≤3m2vœΩtaÎ9I3∂ãºyå´˚4˘