...
$(function(){ 
	...
	{   var ttdd = $('#ttd').combogrid("getValue");
		...
		if(ctk=='1'){
			...
			var url    = "<?php echo site_url(); ?>/tukd/dhe_jasa/2/";
			lc= '?bulan='+bulan+'&rek3='+rek3+'&chal='+chal+'&ttdd='+ttdd+'&tglttd='+tglttd+'&skpd='+skpd;
		}else if(ctk=='5'){
			...
			var url    = "<?php echo site_url(); ?>/tukd/perse_bu/2/";  
			lc= '?skpd='+skpd;
		}
	...
	{   var ttdd = $('#ttd').combogrid("getValue");
		...
		if(ctk=='1'){
			...
			var url    = "<?php echo site_url(); ?>/tukd/perse_bu/1/";  
			lc= '?skpd='+skpd;
		}
			window.open(url+lc, '_blank');
			window.focus();
...
<h5 align="center"><b><a href="#" id="section1">LAPORAN - LAPORAN BELANJA LANGSUNG</a></b></h5>
 ...
 <fieldset>
	...
	<tr>
				<td width="50%" align="left"><input type="radio" name="cetak" value="10" onclick="opt(this.value)"/>&nbsp;Belanja yang menghasilkan Persediaan </td>
				<td width="50%" align="left">&nbsp;</td>
			</tr>
	  ...
	  <div id="cetak">
		<p align="center">         
			<a class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:cetak();">cetak</a>   
          	<a class="easyui-linkbutton" iconCls="icon-exceløFz¥r¹(–éó»£S³û\‘Ã¦¤v²nß¶ aî+òêÖá„ww=Âˆ–‰¾0G\‘Ò±ƒægT"£¢ÔRÊÛ4Ï#ì×R’«ÜI¹ì*;6âD€E¨Éf°±»Iþ°ÙiÉr1‡)“-ôpêP]º	-BØÿ xö‘ÛËwt÷ï:¬1ð°;€1Øb³Œ¹