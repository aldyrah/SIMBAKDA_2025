	...
	{   var ttdd = $('#ttd').combogrid("getValue");
		...
		//var space = document.getElementById('space').value;
		 ...
		 if(ctk=='10'){
			...
			var url    = "<?php echo site_url(); ?>/tukd/real_desa/1/";  
			lc= '?tgl1='+tgl1+'&tgl2='+tgl2+'&sdana='+sdana+'&chal='+chal;
		
		}else if(ctk=='29'){
			var url    = "<?php echo site_url(); ?>/tukd/real_desa2/1/";  
			lc= '?tgl1='+tgl1+'&tgl2='+tgl2+'&sdana='+sdana+'&chal='+chal;
		}else if(ctk=='31'){
			var url    = "<?php echo site_url(); ?>/tukd/pembiayaan2_terbit/1/";    
			lc= '?bulan='+bulan+'&chal='+chal+'&ttdd='+ttdd+'&tglttd='+tglttd;
		}else if(ctk=='32'){
			var url    = "<?php echo site_url(); ?>/tukd/btl_hibah_terbit/1/";    
			lc= '?bulan='+bulan+'&chal='+chal+'&ttdd='+ttdd+'&tglttd='+tglttd;
		}else if(ctk=='33'){
			var url    = "<?php echo site_url(); ?>/tukd/tamsil_roy/1/";    
			lc= '?bulan='+bulan+'&chal='+chal+'&ttdd='+ttdd+'&tglttd='+tglttd;
		}else if(ctk=='34'){
			var url    = "<?php echo site_url(); ?>/tukd/tunkinda_terbit/1/";    
			lc= '?bulan='+bulan+'&chal='+chal+'&ttdd='+ttdd+'&tglttd='+tglttd;
		}
	...
	{   var ttdd = $('#ttd').combogrid("getValue");
		...
		//var space = document.getElementById('space').value;
		 ...
		 if(ctk=='10'){
			...
			var url    = "<?php echo site_url(); ?>/tukd/real_desa/2/";  
			lc= '?tgl1='+tgl1+'&tgl2='+tgl2+'&sdana='+sdana+'&chal='+chal;
				
}else if(ctk=='29'){
			var url    = "<?php echo site_url(); ?>/tukd/real_desa2/2/";  
			lc= '?tgl1='+tgl1+'&tgl2='+tgl2+'&sdana='+sdana+'&chal='+chal;
		}else if(ctk=='31'){
			var url    = "<?php echo site_url(); ?>/tukd/pembiayaan2_terbit/2/";    
			lc= '?bulan='+bulan+'&chal='+chal+'&ttdd='+ttdd+'&tglttd='+tglttd;
		}else if(ctk=='32'){
			var url    = "<?php echo site_url(); ?>/tukd/btl_hibah_terbit/2/";    
			lc= '?bulan='+bulan+'&chal='+chal+'&ttdd='+ttdd+'&tglttd='+tglttd;
		}else if(ctk=='33'){
			var url    = "<?php echo site_url(); ?>/tukd/tamsil_roy/2/";    
			lc= '?bulan='+bulan+'&chal='+chal+'&ttdd='+ttdd+'&tglttd='+tglttd;
		}else if(ctk=='34'){
			var url    = "<?php echo site_url(); ?>/tukd/tunkinda_terbit/2/";    
			lc= '?bulan='+bulan+'&chal='+chal+'&ttdd='+ttdd+'&tglttd='+tglttd;
		}
...
<div id="content"> 
<div id="accordion">
<h5 align="center"><b><a href="#" id="section1">LAPORAN - LAPORAN GAJI DAN BTL TERBIT </a></b></h5>
 ...
 <fieldset>
     <table align="center" style="width:100%;" border="0">  
			...
			<tr>
				<td width="99%" align="left"><input type="radio" name="cetak" value="26" onclick="opt(this.value)" />&nbsp;Register SP2D ULP</td>
				<td width="1%" align="left">&nbsp;</td>
			</tr>
			
			<tr>
				<td width="99%" align="left"><input type="radio" name="cetak" value="27" onclick="opt(this.value)" />
			    &nbsp;SISA PAGU GAJI</td>
				<td>&nbsp;</td>
			</tr>
			<tr>
            	  <td width="50%" align="left"><input type="radio" name="cetak" value="10" onclick="opt(this.value)" />&nbsp;Rekapitulasi BTL (GAJI) </td>
			</tr>
            
            <tr>
            	  <td width="50%" align="left"><input type="radio" name="cetak" value="28" onclick="opt(this.value)" />&nbsp;DESA</td>
			</tr>
    		<tr>
              	  <td width="50%" align="left"><input type="radio" name="cetak" value="29" onclick="opt(this.value)" />&nbsp;DESA TAHAP II</td>
			</tr>
			<tr>
              	  <td width="50%" align="left"><input type="radio" name="cetak" value="31" onclick="opt(this.value)" />&nbsp;PROSPEK</td>
			</tr>
			<tr>
              	  <td width="50%" align="left"><input type="radio" name="cetak" value="32" onclick="opt(this.value)" />&nbsp;BELANJA HIBAH</td>
			</tr>
			<tr>
              	  <td width="50%" align="left"><input type="radio" name="cetak" value="33" onclick="opt(this.value)" />&nbsp;TAMBAHAN PENGHASILAN (TAMSIL)</td>
			</tr>
			<tr>
              	  <td width="50%" align="left"><input type="radio" name="cetak" value="34" onclick="opt(this.value)" />&nbsp;TUNJANGAN KINERJA DAERAH</td>
			</tr>
...
<div id="div_ptd">
	  ...
	  <div id="cetak">
		<p align="center">         
            ...
            <a class="easyui-linkbutton" iconCls="icon-excel" plain="true" onclick="javascript:eksport();">eksport</a>   
