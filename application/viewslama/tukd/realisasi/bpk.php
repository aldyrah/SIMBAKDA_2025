...
$(function(){ 
	...
	var rekeninggen = document.getElementById('rekeninggen').value;
		//var space = document.getElementById('space').value;
		if(ctk=='1'){
			var url    = "<?php echo site_url(); ?>/tukd/spj_pak/1/";  
			lc= '?bulan='+bulan+'&skpd='+skpd;
		}else if(ctk=='2'){
			var url    = "<?php echo site_url(); ?>/tukd/cetak_real_modal2/1/";  
			lc= '?bulan='+bulan+'&skpd='+skpd+'&reke='+rekeninggen;
		}else if(ctk=='3'){
			var url    = "<?php echo site_url(); ?>/tukd/spj_pak_up/1/";  
			lc= '?skpd='+skpd+'&bulan='+bulan;
		}else if(ctk=='4'){
			var url    = "<?php echo site_url(); ?>/tukd/spj_pak_all/1/";  
			lc= '?skpd='+skpd+'&bulan='+bulan;
				}else if(ctk=='5'){
			var url    = "<?php echo site_url(); ?>/tukd/PNTPN/1/";  
			lc= '?skpd='+skpd+'&bulan='+bulan;
		}
	...
	var rekeninggen = document.getElementById('rekeninggen').value;
		//var space = document.getElementById('space').value;
		if(ctk=='1'){
			var url    = "<?php echo site_url(); ?>/tukd/spj_pak/2/";  
			lc= '?bulan='+bulan+'&skpd='+skpd;
		}else if(ctk=='2'){
			var url    = "<?php echo site_url(); ?>/tukd/cetak_real_modal2/2/";  
			lc= '?bulan='+bulan+'&skpd='+skpd+'&reke='+rekeninggen;
		}else if(ctk=='3'){
			var url    = "<?php echo site_url(); ?>/tukd/spj_pak_up/2/";  
			lc= '?skpd='+skpd+'&bulan='+bulan;
			}else if(ctk=='4'){
			var url    = "<?php echo site_url(); ?>/tukd/spj_pak_all/2/";  
			lc= '?skpd='+skpd+'&bulan='+bulan;
				}else if(ctk=='5'){
			var url    = "<?php echo site_url(); ?>/tukd/PNTPN/2/";  
			lc= '?skpd='+skpd+'&bulan='+bulan;
		}
			window.open(url+lc, '_blank');
			window.focus();
            ...
            <tr>
             ...
             <tr>
			  <td width="50%" align="left"><input type="radio" name="cetak" value="4" onclick="opt(this.value)"/>
				PAJAK UP,GU,TU,LS</td>
			  <td width="50%" align="left">&nbsp;</td>
			</tr>
			  <tr>
			  <td width="50%" align="left"><input type="radio" name="cetak" value="5" onclick="opt(this.value)"/>
				PAJAK NTPN</td>
			  <td width="50%" align="left">&nbsp;</td>
			</tr>
...
<div id="div_ptd">
 ...
 <div id="div_reke">
			<table style="width:100%;" border="0">
				<td width="20%" style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;">&nbsp;REKENING</td>
				<td width="1%" style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;">:</td>
 <td style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;border-right-style:hidden;"><select  name="rekeninggen" id="rekeninggen" style="height: 27px; width: 190px;">
     <option value="">...Pilih Jenis rekening... </option>     
     <option value="523">523 || Belanja Modal</option>
     <option value="5222301">5222301 || Belanja Barang Yang Akan Diserahkan
Kepada Masyarakat </option>
     <!--<option value="5">LS PPKD</option>-->
     <option value="5222302">5222302 || Belanja Barang Yang Akan Diserahkan
Kepada Pihak Ketiga</option>
   </select></td>
