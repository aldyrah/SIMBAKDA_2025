 ...
 <fieldset>
     <table align="center" style="width:100%;" border="0">  
			...
			<tr>
				...
				<td width="50%" align="left"><input type="radio" name="cetak" value="16" onclick="opt(this.value)" />&nbsp;Laporan OTSUS / DAK</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td width="50%" align="left"><input type="radio" name="cetak" value="23" onclick="opt(this.value)" />&nbsp;Daftar Belanja Bantuan sosial</td>
			</tr>
			<tr>
			...
			<tr>
				<td width="50%" align="left"><input type="radio" name="cetak" value="26" onclick="opt(this.value)" />&nbsp;Register SP2D ULP</td>
				<td width="50%" align="left"><input type="radio" name="cetak" value="27" onclick="opt(this.value)" />&nbsp;SISA PAGU GAJI</td>
			</tr>
			<tr>
				<td width="50%" align="left"><input type="radio" name="cetak" value="28" onclick="opt(this.value)" />&nbsp;Realisasi SPD Per Sumber Dana</td>
				<td>&nbsp;</td>
			</tr>
