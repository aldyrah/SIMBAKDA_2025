...
$(function(){ 
	...
	function cetak(){   
		...
		var gaji_pot = document.getElementById('gaji_pot').value;
		...
		if(ctk=='1'){
			...
			var url    = "<?php echo site_url(); ?>/tukd/cetak_pfk_pembiayaan_21/1/";  
			lc= '?bulan='+bulan+'&chal='+chal+'&ttdd='+ttdd+'&tglttd='+tglttd;
		}else if(ctk=='3'){
...
//===============================================================================
		...
		if(gaji=='19'){
			var url    = "<?php echo site_url(); ?>/tukd/btl_as/1/";  
		}else{
			var url    = "<?php echo site_url(); ?>/tukd/cetak_sp2d_gj_btl/1/";  
		}
		
			lc= '?bulan='+bulan+'&chal='+chal+'&ttdd='+ttdd+'&tglttd='+tglttd+'&gaji='+gaji;
		}else if(ctk=='11'){
			...
			var url    = "<?php echo site_url(); ?>/tukd/cetak_pfk_21/1/";  
			...
			lc= '?tgl1='+tgl1+'&tgl2='+tgl2+'&sdana='+sdana+'&chal='+chal+'&ttdd='+ttdd+'&tglttd='+tglttd;
		}else if(ctk=='17'){
			var url    = "<?php echo site_url(); ?>/tukd/reg_sp2d_btl/1/";  
			lc= '?bulan='+bulan+'&chal='+chal+'&ttdd='+ttdd+'&tglttd='+tglttd+'&skpd='+skpd;
		}else if(ctk=='18'){
			...
			lc= '?bulan='+bulan+'&chal='+chal+'&ttdd='+ttdd+'&tglttd='+tglttd;
								...
								if(gaji_pot=='1'||gaji_pot=='2'||gaji_pot=='3'||gaji_pot=='13'||gaji_pot=='10' ||gaji_pot=='18'   ||gaji_pot=='12' ||gaji_pot=='14' || gaji_pot=='15'){
		var url    = "<?php echo site_url(); ?>/tukd/cetak_pfk_btl_baru21/1/"; 						
					}else if(gaji_pot==16){
						var url    = "<?php echo site_url(); ?>/tukd/cetak_pfk_btl_baru_kppn/1/"; 			
						
											}else if(gaji_pot=='19'){
						var url    = "<?php echo site_url(); ?>/tukd/cetak_pfk_btl_baru_kppn1_21/1/"; 						
			
					}else{
						var url    = "<?php echo site_url(); ?>/tukd/cetak_pfk_btl_21/1/"; 						
						}

			 
			lc= '?bulan='+bulan+'&chal='+chal+'&ttdd='+ttdd+'&tglttd='+tglttd+'&gjpot='+gaji_pot;
		}else if(ctk=='23'){
			...
			var url    = "<?php echo site_url(); ?>/tukd/cetak_pfk_btl_skpd_21/1/";  
			lc= '?bulan='+bulan+'&chal='+chal+'&ttdd='+ttdd+'&skpd='+skpd+'&tglttd='+tglttd;
		}else if(ctk=='26'){
			var url    = "<?php echo site_url(); ?>/tukd/reg_sp2d_ulp/1/";  
			lc= '?bulan='+bulan+'&chal='+chal;
		}else if(ctk=='27'){
			var url    = "<?php echo site_url(); ?>/rka/sisa_pagu_gaji/1/";  
			lc= '?bulan='+bulan;
		}else if(ctk=='28'){
			var url    = "<?php echo site_url(); ?>/tukd/cetak_lap_spd_sdana/1/";  
			lc= '?tgl1='+tgl1+'&tgl2='+tgl2+'&sdana='+sdana+'&chal='+chal;
		}else if(ctk=='29'){
			var url    = "<?php echo site_url(); ?>/tukd/gajidprd/1/";  
			lc= '?bulan='+bulan+'&chal='+chal+'&ttdd='+ttdd+'&tglttd='+tglttd;
		}else if(ctk=='30'){
			var url    = "<?php echo site_url(); ?>/tukd/tampengguru/1/";  
			lc= '?bulan='+bulan+'&chal='+chal+'&ttdd='+ttdd+'&tglttd='+tglttd;		
		}else if(ctk=='31'){
			var url    = "<?php echo site_url(); ?>/tukd/tunkinda/1/";  
			lc= '?bulan='+bulan+'&chal='+chal+'&ttdd='+ttdd+'&tglttd='+tglttd;	
		}else if(ctk=='32'){
			var url    = "<?php echo site_url(); ?>/tukd/preskerja/1/";  
			lc= '?bulan='+bulan+'&chal='+chal+'&ttdd='+ttdd+'&tglttd='+tglttd;	
		}else if(ctk=='33'){
			var url    = "<?php echo site_url(); ?>/tukd/pungpajak/1/";  
			lc= '?bulan='+bulan+'&chal='+chal+'&ttdd='+ttdd+'&tglttd='+tglttd;				
		}else if(ctk=='34'){
			var url    = "<?php echo site_url(); ?>/tukd/general_cekup/1/";  
			lc= '?bulan='+bulan+'&chal='+chal+'&ttdd='+ttdd+'&tglttd='+tglttd;
		}else if(ctk=='36'){
			var url    = "<?php echo site_url(); ?>/tukd/biaya_ttg/1/";  
			lc= '?bulan='+bulan+'&chal='+chal+'&ttdd='+ttdd+'&tglttd='+tglttd;
		}else if(ctk=='37'){	
					var url    = "<?php echo site_url(); ?>/tukd/reg_sp2d_btl/1/";  
			lc= '?bulan='+bulan+'&chal='+chal+'&ttdd='+ttdd+'&tglttd='+tglttd+'&skpd='+'1.01.01';
			}else if(ctk=='38'){
			var url    = "<?php echo site_url(); ?>/tukd/pemb/1/";  
			lc= '?bulan='+bulan+'&chal='+chal+'&ttdd='+ttdd+'&tglttd='+tglttd;
		}else if(ctk=='39'){
		...
		if(gaji=='19'){
			...
			var url    = "<?php echo site_url(); ?>/tukd/cetak_sp2d_gj_btl_/1/";  
		}
		
			lc= '?bulan='+bulan+'&chal='+chal+'&ttdd='+ttdd+'&tglttd='+tglttd+'&gaji='+gaji;
		}else if(ctk=='40'){
			var url    = "<?php echo site_url(); ?>/tukd/cetak_tunjkhus/1/";  
			lc= '?bulan='+bulan+'&chal='+chal+'&ttdd='+ttdd+'&tglttd='+tglttd;
		}
	...
	function cetakex(){   
		...
		if(ctk=='1'){
			...
			var url    = "<?php echo site_url(); ?>/tukd/cetak_pfk_pembiayaan_21/2/";  
			lc= '?bulan='+bulan+'&chal='+chal+'&ttdd='+ttdd+'&tglttd='+tglttd;
		}else if(ctk=='3'){
...
//===============================================================================
		...
		if(gaji=='19'){
			var url    = "<?php echo site_url(); ?>/tukd/btl_as/2/";  
		}else{
		...
		//	var url    = "<?php echo site_url(); ?>/tukd/cetak_sp2d_gj_btl/2/";  
			...
			var url    = "<?php echo site_url(); ?>/tukd/cetak_pfk_21/2/";  
			lc= '?bulan='+bulan+'&chal='+chal+'&ttdd='+ttdd+'&tglttd='+tglttd+'&rekap='+rekap;
		}else if(ctk=='14'){
			...
			lc= '?bulan='+bulan+'&chal='+chal+'&ttdd='+ttdd+'&tglttd='+tglttd;
									...
									if(gaji_pot=='1'||gaji_pot=='2'||gaji_pot=='3'||gaji_pot=='13'||gaji_pot=='10' ||gaji_pot=='18'   ||gaji_pot=='12' ||gaji_pot=='14' || gaji_pot=='15'){
		var url    = "<?php echo site_url(); ?>/tukd/cetak_pfk_btl_baru21/2/"; 						
					}else if(gaji_pot==16){
						var url    = "<?php echo site_url(); ?>/tukd/cetak_pfk_btl_baru_kppn/2/"; 			
						
											}else if(gaji_pot=='19'){
						var url    = "<?php echo site_url(); ?>/tukd/cetak_pfk_btl_baru_kppn1_21/2/"; 						
			
					}else{
						var url    = "<?php echo site_url(); ?>/tukd/cetak_pfk_btl_21/2/"; 						
						}
			...
			var url    = "<?php echo site_url(); ?>/tukd/cetak_pfk_btl_skpd_21/2/";  
			lc= '?bulan='+bulan+'&chal='+chal+'&ttdd='+ttdd+'&skpd='+skpd+'&tglttd='+tglttd;
		}else if(ctk=='26'){
			var url    = "<?php echo site_url(); ?>/tukd/reg_sp2d_ulp/2/";  
			lc= '?bulan='+bulan+'&chal='+chal;
		}else if(ctk=='27'){
			var url    = "<?php echo site_url(); ?>/rka/sisa_pagu_gaji/2/";  
			lc= '?bulan='+bulan;
		}else if(ctk=='28'){
			var url    = "<?php echo site_url(); ?>/tukd/cetak_lap_spd_sdana/2/";  
			lc= '?tgl1='+tgl1+'&tgl2='+tgl2+'&sdana='+sdana+'&chal='+chal;
		}else if(ctk=='29'){
			var url    = "<?php echo site_url(); ?>/tukd/gajidprd/2/";  
			lc= '?bulan='+bulan+'&chal='+chal+'&ttdd='+ttdd+'&tglttd='+tglttd;
		}else if(ctk=='30'){
			var url    = "<?php echo site_url(); ?>/tukd/tampengguru/2/";  
			lc= '?bulan='+bulan+'&chal='+chal+'&ttdd='+ttdd+'&tglttd='+tglttd;		
		}else if(ctk=='31'){
			var url    = "<?php echo site_url(); ?>/tukd/tunkinda/2/";  
			lc= '?bulan='+bulan+'&chal='+chal+'&ttdd='+ttdd+'&tglttd='+tglttd;	
		}else if(ctk=='32'){
			var url    = "<?php echo site_url(); ?>/tukd/preskerja/2/";  
			lc= '?bulan='+bulan+'&chal='+chal+'&ttdd='+ttdd+'&tglttd='+tglttd;	
		}else if(ctk=='33'){
			var url    = "<?php echo site_url(); ?>/tukd/pungpajak/2/";  
			lc= '?bulan='+bulan+'&chal='+chal+'&ttdd='+ttdd+'&tglttd='+tglttd;				
		}else if(ctk=='34'){
			var url    = "<?php echo site_url(); ?>/tukd/general_cekup/2/";  
			lc= '?bulan='+bulan+'&chal='+chal+'&ttdd='+ttdd+'&tglttd='+tglttd;
		}else if(ctk=='36'){
			var url    = "<?php echo site_url(); ?>/tukd/biaya_ttg/2/";  
			lc= '?bulan='+bulan+'&chal='+chal+'&ttdd='+ttdd+'&tglttd='+tglttd;
		}else if(ctk=='37'){	
					var url    = "<?php echo site_url(); ?>/tukd/reg_sp2d_btl/2/";  
			lc= '?bulan='+bulan+'&chal='+chal+'&ttdd='+ttdd+'&tglttd='+tglttd+'&skpd='+skpd;
			}else if(ctk=='38'){
			var url    = "<?php echo site_url(); ?>/tukd/pemb/2/";  
		}else if(ctk=='39'){
		
		if(gaji=='19'){
			var url    = "<?php echo site_url(); ?>/tukd/btl_as/2/";  
		}else{
			var url    = "<?php echo site_url(); ?>/tukd/cetak_sp2d_gj_btl_/2/";  
		}
		
		//	var url    = "<?php echo site_url(); ?>/tukd/cetak_sp2d_gj_btl/2/";  
			lc= '?bulan='+bulan+'&chal='+chal+'&ttdd='+ttdd+'&tglttd='+tglttd+'&gaji='+gaji;
		}else if(ctk=='40'){
			var url    = "<?php echo site_url(); ?>/tukd/cetak_tunjkhus/2/";  
			lc= '?bulan='+bulan+'&chal='+chal+'&ttdd='+ttdd+'&tglttd='+tglttd;
		}
...
<div id="content"> 
<div id="accordion">
<h5 align="center"><b><a href="#" id="section1">LAPORAN - LAPORAN BTL</a></b></h5>
 ...
 <fieldset>
     <table align="center" style="width:100%;" border="0">  
			...
			<tr>
				<td width="50%" align="center" style="border-top:solid 1px red;border-bottom:solid 1px red"><i>BTL</i></td>
				<td width="50%" align="center" style="border-top:solid 1px red;border-bottom:solid 1px red"><i>BL</i></td>
			</tr>
			<!-- <tr>
			  <td width="50%" align="left"><input type="radio" name="cetak" value="10" onclick="opt(this.value)" />
			    &nbsp;Rekapitulasi BTL (GAJI) </td>
			  <td width="50%" align="left"><input type="radio" name="cetak" value="23" onclick="opt(this.value)" />
		      &nbsp;BTL (Bantuan sosial)</td>
			</tr> -->
			<tr>
				<td width="50%" align="left"><input type="radio" name="cetak" value="22" onclick="opt(this.value)" />
			    &nbsp;Register Perhitungan Fihak Ketiga(PFK) BTL</td>
			...
			<tr>
				<td width="50%" align="left"><input type="radio" name="cetak" value="25" onclick="opt(this.value)" />
			    &nbsp;Register Perhitungan Fihak Ketiga(PFK) BTL per SKPD</td>
				
                <td width="50%" align="left">&nbsp;</td>
			</tr>

			<tr>
				<td colspan="2" width="50%" align="center" style="border-top:solid 1px red;border-bottom:solid 1px red"><i>Pembiayaan</i></td>
				
			</tr>

			<tr>
				<td width="50%" align="left"><input type="radio" name="cetak" value="2" onclick="opt(this.value)" />
			    &nbsp;Register Perhitungan Fihak Ketiga(PFK) Pembiayaan Keluar</td>
				
                <td width="50%" align="left">&nbsp;</td>
			</tr>
			<!-- <tr>
				<td width="50%" align="left"><input type="radio" name="cetak" value="17" onclick="opt(this.value)" />
			    &nbsp;Daftar SP2D BTL</td>
				<td width="50%" align="left"><input type="radio" name="cetak" value="24" onclick="opt(this.value)" />
				  &nbsp;BTL (Bantuan Keuangan)</td>
			</tr> -->
			<!-- <tr>
				<td width="50%" align="left"><input type="radio" name="cetak" value="15" onclick="opt(this.value)" />
				&nbsp;BTL (Belanja Hibah)</td>
				
			</tr> -->
            <!-- <tr>
				<td width="50%" align="left"><input type="radio" name="cetak" value="19" onclick="opt(this.value)" />
				  &nbsp;Daftar Belanja Tidak langsung (KDH)</td>
				<td width="50%" align="left"><input type="radio" name="cetak" value="20" onclick="opt(this.value)" />
				  &nbsp;Tunjangan Profesi Guru</td>
			</tr> -->
			
            <!-- <tr>
				<td width="50%" align="left"><input type="radio" name="cetak" value="29" onclick="opt(this.value)" />
				  &nbsp;Daftar Belanja Tidak langsung (DPRD)</td>
				<td width="50%" align="left"><input type="radio" name="cetak" value="30" onclick="opt(this.value)" />
				  &nbsp;Tambahan Penghasilan Guru</td>
			</tr>	
            	<tr>
				<td width="50%" align="left"><input type="radio" name="cetak" value="31" onclick="opt(this.value)" />
				  &nbsp;Tunjangan Kinerja Daerah</td>
				<td width="50%" align="left"><input type="radio" name="cetak" value="32" onclick="opt(this.value)" />
				  &nbsp;Prestasi Kerja, Kondisi Kerja dan Kelangkaan Profesi</td>
			</tr>
            	<tr>
				<td width="50%" align="left"><input type="radio" name="cetak" value="33" onclick="opt(this.value)" />
				  &nbsp;Biaya Pemungutan Pajak</td>
				<td width="50%" align="left"/><input type="radio" name="cetak" value="34" onclick="opt(this.value)" />
				  Rekap General Cek UP</td>
			</tr>
			<tr>
					<td width="50%" align="left"><input type="radio" name="cetak" value="37" onclick="opt(this.value)" />
				&nbsp;Daftar sp2d btl disdik dan sekolah </td>
				<td width="50%" align="left"/><input type="radio" name="cetak" value="36" onclick="opt(this.value)" />
				  Rekap Belanja Tidak Terduga</td>
			</tr>	
            </tr>	
            <tr>
				<td width="50%" align="left"><input type="radio" name="cetak" value="38" onclick="opt(this.value)" />
				  &nbsp; Pembiayaan & Bunga Pinjaman</td>
				<td width="50%" align="left"><input type="radio" name="cetak" value="39" onclick="opt(this.value)" />
				  &nbsp; Tugas Kaban</td>
			</tr>
			<tr>
				<td width="50%" align="left"><input type="radio" name="cetak" value="40" onclick="opt(this.value)" />
				  &nbsp;Tunjangan Khusu Guru</td>
				<td width="50%" align="left"></td>
			</tr> -->		
	 </table><br>
...
<td width="922px" colspan="2"><input type="radio" name="cetak" value="1" onclick="opt1(this.value)" /><b>Keseluruhan</b></td></tr>
			...
			<table style="width:100%;" border="0">
				...
				<td width="79%" style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;"><select name="gaji" id="gaji" >
							 ...
							 <option value="6">6 | Duka</option>
							  <option value="18">7 | GAJI 14</option>
							  <option value="19">8 | TOTAL</option>
	...
	<div id="div_gaji_pot">
			<table style="width:100%;" border="0">
				<td width="20%" style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;">&nbsp;GAJI</td>
				<td width="1%" style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;">:</td>
				<td width="79%" style="border-bottom:hidden;border-spacing: 3px;padding:3px 3px 3px 3px;"><select name="gaji_pot" id="gaji_pot" >
							 <option value="">...Pilih Jenis Gaji... </option>
							 <option value="1">1 | Regular</option>
							 <option value="2">2 | Susulan</option>
							 <option value="3">3 | Rapel</option>
							 <option value="4">4 | Tambahan Penghasilan</option>
							 <option value="5">5 | Tunjangan Kinerja daerah</option>
							 <option value="6">6 | Potongan Gaji DPRD</option>
							 <option value="7">7 | Biaya Pungutan Pajak Daerah</option>
							 <option value="8">8 | Tunjangan Profesi Guru</option>
							 <option value="9">9 | Tambahan Penghasilan Guru</option>
							 <option value="10">10 | Gaji 13</option>
							 <option value="11">11 | Tunjangan Tambahan Prestasi Kerja Dan Kondisi Kerja</option>
                              <!-- <option value="12">12 | Rapel Gaji Pokok</option>
							 <option value="13">13 | Keseluruhan</option>
							  <option value="14">14 | Keseluruhan gaji</option> -->
							   <option value="15">12 | Keseluruhan tunjangan</option>
							   <!-- <option value="16">16 | Rekonsiliasi Keseluruhan</option>
							   <option value="17">17 | Rekonsiliasi BPJS/KPPN</option>
							   <option value="18">18 | GAJI 14</option> -->
                                <option value="19">13 | REKONSILIASI PAJAK PRATAMA</option>
