...
<head>
      ...
      $("#tanggal").datebox("setValue",asik);
        ...
        $('#rek').combogrid({  
          ...
          $('#cmb_sts').combogrid({  
           ...
           url:'<?php echo base_url(); ?>index.php/tukd/load_sts_ppkd',  
           columns:[[  
               {field:'no_sts',title:'Nomor Bukti',width:100},  
  ...
  //get(nomorkas,tglkas,nomor,tgl,kode,lckdbank,lckdgiat,lcket,lcjnskeg,lcrekbank,lctotal){
    ...
    $("#jumlahtotalx").attr("Value",number_format(lctotal,0,'.',','));
  ...
  function cek_simpan_sts(){
        ...
        if (cskpd==''){
   		...
   		$(document).ready(function(){              
            $.ajax({
                type: "POST",
                url: '<?php echo base_url(); ?>/index.php/tukd/cek_simpan_sts_ppkd',        
                ...
                success:function(data){
					if(data == '0'){
								  if(cekidot==1){
										swal({
										title: 'No STS Sudah Dipakai..!!',
										text: "Cek Ulang No STS <a style='color:red;font-size:large;'>"+cno+"</a>!!!",
										html:true,
									...
									swal({
									title:"<a style='font-size:large;'>Ubah Data No STS</a> <a style='color:red;font-size:large;'>"+cno+"</a> <a style='font-size:large;'>?</a>" ,
									html:true,
...
<h3><a href="#" id="section1">List STS</a></h3>
    ...
    <p align="right">         
        ...
        <a class="easyui-linkbutton" iconCls="icon-cancel" plain="false" onclick="javascript:hapus();section1();">Hapus</a>
...
<h3><a href="#" id="section2" >Surat Tanda Setoran</a></h3>
   ...
   <p>       
        <table align="center" style="width:100%;" border="0">
            ...
            <tr>
                ...
                <td>Tanggal Bukti</td>
                <td><input type="text" id="tanggal" style="width: 140px;" disabled="disabled"/></td>   
            </tr>
            <tr>
                <td>Uraian</td>
                <td colspan="3"><input type="text" id="ket" style="width: 700px;" disabled="disabled"/></td>                
            </tr>            
            <tr>
                <td>Jenis Transaksi</td>
                <td colspan="3">
                <input  id="jns_trans" name="jns_trans" style="border:0;width: 150px;" disabled="disabled"/>                 
                </td> 
            </tr>
            <tr>
            <td>Kegiatan</td>
            <td colspan="3"><input id="giat" name="skpd" style="width: 180px;" disabled="disabled"/>&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" id="nmgiat" style="border:0;width: 450px;" readonly="true"/></td>
            </tr>
        ...
        <a id="b1" class="easyui-linkbutton" iconCls="icon-cancel" plain="false" onclick="javascript:hapus_rek();">Hapus Rekening</a>       
        </div>
   ...
   <tr>
	   ...
	   <td align="right"><input type="text" id="jumlahtotal" readonly="true" style="border:0; width: 200px;" /><input type="text" id="jumlahtotalx" readonly="true" style="border:0; width: 200px;"/></td>
   </tr>
   <tr>
                <td colspan="4" align="center"><a class="easyui-linkbutton" iconCls="icon-save" plain="false" onclick="javascript:cek_simpan_sts();">Simpan</a>
