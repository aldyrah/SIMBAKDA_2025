       ...
       if (a==''||a==0){
           swal("Oops...", "nilai Tidak Boleh nol!");
            ...
            if(i>0){
				if (beban=='3'){
					ckdrek2 = '1110301' ;
            		lcval_det = lcval_det+",('"+cskpd+"','"+cnosts+"','"+ckdrek2+"','"+cnilai+"','"+ckdrek+"')";
				}else{
					ckdrek2 = '' ;
					lcval_det = lcval_det+",('"+cskpd+"','"+cnosts+"','"+ckdrek+"','"+cnilai+"','"+ckdrek2+"')";
				}
          }else{
		       if (beban=='3'){
			   		ckdrek2 = '1110301' ;
            ...
            $(document).ready(function(){
                $.ajax({
                    type: "POST",
                    url: '<?php echo base_url(); ?>/index.php/tukd/simpan_setor',
