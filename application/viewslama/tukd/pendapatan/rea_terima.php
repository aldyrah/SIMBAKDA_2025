    ...
    var ctk = '';
     ...
     function openWindow( url ){
         ...
         if(ctk==1){
            ...
            if(ctk2==1){
                var ckdskpd = $('#skpd').combogrid('getValue');
                lc = '?kd_skpd='+ckdskpd+'&tgl1='+ctgl1+'&tgl2='+ctgl2+'&tgl_ttd='+ctglttd+'&cpilih=1'+'&cpilih2=1';
            }else{
                var ckdskpd = "";
                lc = '?kd_skpd='+ckdskpd+'&tgl1='+ctgl1+'&tgl2='+ctgl2+'&tgl_ttd='+ctglttd+'&cpilih=1'+'&cpilih2=2';
            }
          // alert(lc);        
            ...
            if(ctk2==1){
                var ckdskpd = $('#skpd').combogrid('getValue');
                lc = '?kd_skpd='+ckdskpd+'&bulan='+cbulan+'&tgl_ttd='+ctglttd+'&cpilih=2'+'&cpilih2=1';
            }else{
                var ckdskpd = "";
                lc = '?kd_skpd='+ckdskpd+'&bulan='+cbulan+'&tgl_ttd='+ctglttd+'&cpilih=2'+'&cpilih2=2   ';
            }
...
<div id="content1" align="center"> 
    <h3 align="center"><b>REALISASI PENDAPATAN</b></h3>
    <fieldset style="width: 70%;">
     <table align="center" style="width:100%;" border="0">
            ...
            <tr>
                <td><input type="radio" name="cetak2" value="1" onclick="opt2(this.value)" />SKPD &ensp;
                <input type="radio" name="cetak2" value="2" id="pilskp" onclick="opt2(this.value)" />ALL
                </td>
                <td>&ensp;</td>
                <td>&nbsp</td>
            </tr>
            ...
            <tr>
                ...
                <a href="<?php echo site_url(); ?>/tukd/cetak_reaterima" class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:openWindow(this.href);return false">Cetak</a>
                </td>                
            </tr>
        </table>  
