...
<head>
    ...
    var lcstatus = '';
     ...
     $(function(){ 
     $('#dg').edatagrid({
		url: '<?php echo base_url(); ?>/index.php/master/load_lra_ppkd_awal',
        idField:'id',            
        rownumbers:"true", 
        fitColumns:"true",
        singleSelect:"true",
        ...
        if(lcstatus=='tambah'){ 
            ...
            $(document).ready(function(){
                $.ajax({
                    ...
                    data: ({tabel:'map_lra_ppkd_kab',kolom:lcinsert,nilai:lcvalues,cid:'kode',lcid:cno}),
                    dataType:"json",
            ...
            lcquery = "UPDATE map_lra_ppkd_kab SET uraian='"+curaian+"',thn_m1='"+lntotal+"' where nor='"+cno+"'";
            //alert(lcquery);
            $(document).ready(function(){
            $.ajax({
                type: "POST",
...
<div id="content"> 
<div id="accordion">
<h3 align="center"><u><b><a href="#" id="section1">SALDO AWAL LRA PPKD</a></b></u></h3>
    <div>
    <p align="right">         
        ...
        <table id="dg" title="Listing LRA PPKD AWAL" style="width:870px;height:450px;" >  
        </table>
