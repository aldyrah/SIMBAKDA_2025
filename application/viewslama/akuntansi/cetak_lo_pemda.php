...
<head>
  ...
  <style>   
    ...
    function cetak(){
			...
			if (ctk=='1'){
				var url ="<?php echo site_url(); ?>/akuntansi/cetak_lo_pemda/1";
			} else{


                if(skpd=='1.20.05.01'){
				var url ="<?php echo site_url(); ?>/akuntansi/ctk_lra_lo_ppkd/1";
}else{
            var url ="<?php echo site_url(); ?>/akuntansi/cetak_lo_skpd/1";
			...
			window.open(url+'?cetak='+ctk+'&bulan='+tgl1+'&kdskpd='+skpd+'&tgl_ctk='+ctglttd+'&tgl1='+tgl1+'&tgl_ttd='+ctglttd+'&uye='+uye);
			window.focus();
    }
    ...
    function cetak1(){
			...
			var tgl1 =  cbulan = $('#bulan').combogrid('getValue');			
			if (ctk=='1'){
				var url ="<?php echo site_url(); ?>/akuntansi/cetak_lo_pemda/2";
			} else{
				             if(skpd=='1.20.05.01'){
                var url ="<?php echo site_url(); ?>/akuntansi/ctk_lra_lo_ppkd/2";
}else{
            var url ="<?php echo site_url(); ?>/akuntansi/cetak_lo_skpd/2";
...
<div id="content">
<h3>CETAK LAPORAN OPERASIONAL (LO)</h3>
<div id="accordion">
    <p align="right">         
        <table>          
