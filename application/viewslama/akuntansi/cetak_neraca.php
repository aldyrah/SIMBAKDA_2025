...
<head>
  ...
  <style>   
    ...
    function cetak(){
			...
			if (ctk=='1'){
				var url ="<?php echo site_url(); ?>/akuntansi/rpt_neraca_pemda/1";
			} else{

                if(skpd=='1.20.05.01'){
				var url ="<?php echo site_url(); ?>/akuntansi/rpt_neraca_ppkd/1";
            }else{
    var url ="<?php echo site_url(); ?>/akuntansi/rpt_neraca_skpd/1";
	    ...
	    function cetak_ex(){
			...
			var tgl1 =  cbulan = $('#bulan').combogrid('getValue');			
			if (ctk=='1'){
				var url ="<?php echo site_url(); ?>/akuntansi/rpt_neraca_pemda/2";
			} else{
				   if(skpd=='1.20.05.01'){
                var url ="<?php echo site_url(); ?>/akuntansi/rpt_neraca_ppkd/2";
            }else{
    var url ="<?php echo site_url(); ?>/akuntansi/rpt_neraca_skpd/2";
