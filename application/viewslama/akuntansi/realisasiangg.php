...
$(function(){
  ...
  function tes(){
       //alert("aaaaaaaa")
	   var url    = "<?php echo site_url(); ?>/akuntansi/realisasiangg1";  
	   window.open(url);
			window.focus();
    }
        function tes1(){
       //alert("aaaaaaaa")
	   var url    = "<?php echo site_url(); ?>/akuntansi/cetak_realisasiangg_MURNI1";  
	   window.open(url);
			window.focus();
    }
	...
	var ttd = $('#ttd').datebox('getValue'); 
		...
		if(ctk=='1'){
			var url    = "<?php echo site_url(); ?>/akuntansi/cetak_realisasiangg/1/";  
...
if(ttd==""){
	alert("pilih tanggal terlebih dahulu");
			...
			var url    = "<?php echo site_url(); ?>/akuntansi/cetak_realisasiangg_seluruh/1/";  
			lc= '?skpd=o'+'&cpilih=1'+'&tgl='+ttd;
	...
	var ttd = $('#ttd').datebox('getValue'); 
		...
		if(ctk=='1'){
			var url    = "<?php echo site_url(); ?>/akuntansi/cetak_realisasiangg/2/";  
			lc= '?skpd='+kdskpd+'&cpilih=1'+'&tgl='+ttd;
		}else if(ctk=='2'){
			var url    = "<?php echo site_url(); ?>/akuntansi/cetak_realisasiangg/2/";  
			lc= '?skpd='+kdskpd+'&keg='+kdgiat+'&cpilih=2'+'&tgl='+ttd;
...
<h5 align="center"><b><a href="#" id="section1">CETAK REALISASI ANGGARAN</a></b></h5>
 ...
 <fieldset>
	...
	<tr>
				<td colspan="2" align="center" style="border-top:solid 1px red;border-bottom:solid 1px red"><i>UP,GU,TU,LS BENDAHARA DIAMBIL DARI TRANSAKSI , LS GAJI,LS PPKD & LS BARANG JASA DIAMBIL DARI SP2D TERBIT</i></td>
			</tr>
...
<TR>
	<TD>
			  <a class="easyui-linkbutton" iconCls="icon-remove" plain="true" onclick="javascript:tes();">BUKA FORM</a>    
          <a class="easyui-linkbutton" iconCls="icon-remove" plain="true" onclick="javascript:tes1();">BUKA FORM MURNI</a>    
        </td>
    </TR>
...
<div id="giat">
	  ...
	  <div id="cetak">
		<p align="center">         
			...
			<a class="easyui-linkbutton" iconCls="icon-excel" plain="true" onclick="javascript:allofme();">seluruh</a>   
