...
<script type="text/javascript">
  ...
  function cetak($cek){
    ...
    var url     = "<?php echo site_url(); ?>/laporan_kebijakan/kibd_dh";
    ...
    //if(oto=='01'){
      if(ctk=='1'){
		...
		if(tahun1=='' && blnthn=='02'){
          ...
          if(blnthn=='01'){
            lc = '?pilih='+cpilih+'&tampil='+cini+'&skpd='+cskpd+'&nmskpd='+cnmskpd+'&bulan='+bulan+'&tahun='+tahun+'&tglcetak='+lctgl2+'&pilctk='+pilctk+'&blnthn='+blnthn;
          }else if(blnthn=='03'){
		  	lc = '?pilih='+cpilih+'&tampil='+cini+'&skpd='+cskpd+'&nmskpd='+cnmskpd+'&bulan='+bulan+'&tahun3='+tahun3+'&tglcetak='+lctgl2+'&pilctk='+pilctk+'&blnthn='+blnthn;
		  }else{
            lc = '?pilih='+cpilih+'&tampil='+cini+'&skpd='+cskpd+'&nmskpd='+cnmskpd+'&tahun1='+tahun1+'&tahun2='+tahun2+'&tglcetak='+lctgl2+'&pilctk='+pilctk+'&blnthn='+blnthn;
          }          
        }
      }else if(ctk=='2'){
        if(cskpd==''){
		...
		if(tahun=='' && blnthn=='01' ){
          ...
          if(blnthn=='01'){
            lc = '?pilih='+cpilih+'&tampil='+cini+'&skpd='+cskpd+'&nmskpd='+cnmskpd+'&bidang='+cbid+'&nmbid='+cnm_bid+'&bulan='+bulan+'&tahun='+tahun+'&tglcetak='+lctgl2+'&pilctk='+pilctk+'&blnthn='+blnthn;
		  	...
		  	lc = '?pilih='+cpilih+'&tampil='+cini+'&skpd='+cskpd+'&nmskpd='+cnmskpd+'&bidang='+cbid+'&nmbid='+cnm_bid+'&bulan='+bulan+'&tahun3='+tahun3+'&tglcetak='+lctgl2+'&pilctk='+pilctk+'&blnthn='+blnthn;
		  }else{
            lc = '?pilih='+cpilih+'&tampil='+cini+'&skpd='+cskpd+'&nmskpd='+cnmskpd+'&bidang='+cbid+'&nmbid='+cnm_bid+'&tahun1='+tahun1+'&tahun2='+tahun2+'&tglcetak='+lctgl2+'&pilctk='+pilctk+'&blnthn='+blnthn;
          }          
        }
...
<div id="content1"> 
    <h3 align="center"><b>CETAK DAFTAR PENYUSUTAN ASET TETAP KIB D<br>JALAN, IRIGASI DAN JARINGAN</b></h3>
    <fieldset>
            ...
            <tr>
                ...
                <div id="pilihancetak">
                        <table style="width:100%;" border="0">
							...
							<td><input type="radio" name="cetak2" value="03" onclick="opt2(this.value)" />
							Penyusutan Per Bulan dan Tahun &ensp;</td>
                        </table>
                </div>
                </td>
            </tr>
