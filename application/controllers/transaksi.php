...
class Transaksi extends CI_Controller {
    ...
    function trh_isianbrg(){
	    ...
	    $offset 	= ($page-1)*$rows;        
        $kriteria   = $this->input->post('cari');
        $kriteria1  = $this->input->post('cari1');
        $where 		='';
        if ($kriteria <> ''){                               
            $where="and (upper(a.no_dokumen) like upper('%$kriteria%') or a.tgl_dokumen like '%$kriteria%' 
                or upper(a.kd_comp) like upper('%$kriteria%') or upper(a.nm_comp) like upper('%$kriteria%') 
                or upper(a.kd_uskpd) like upper('%$kriteria%')) ";            
        }
        $where2      ='';
        if ($kriteria1 <> ''){                               
            $where2="and year(a.tgl_dokumen)='$kriteria1' ";            
        }
        		 
        $sql = "SELECT count(*) as total from trh_isianbrg a $where1 $where $where2" ;
        $query1 = $this->db->query($sql);
        $total = $query1->row();
     ...
     /*   $sql = "SELECT DISTINCT(d.nilai_spp) AS nilai_spp,a.*,a.nm_comp,c.nm_milik,a.total as tothead,d.invent,upper(e.nm_skpd) as nm_skpd  
        ...
        $sql = "SELECT DISTINCT(d.nilai_spp) AS nilai_spp,a.*,a.nm_comp,c.nm_milik,a.total as tothead,d.invent,upper(e.nm_skpd) as nm_skpd  
                 ...
                 left join mmilik c on a.kd_milik = c.kd_milik 
                 join ms_skpd e on a.kd_uskpd=e.kd_skpd $where1 $where $where2 GROUP BY a.no_bukti,a.no_dokumen
                 order by a.no_bukti desc limit $offset,$rows";
...
//demansyah 23 febuari 2016
    ...
    function hapus_kib(){
        ...
        $jenis_aset         = $this->input->post('cjenis');
        ...
        //$cjenis_aset   = explode('||', $jenis_aset);
            ...
            for($i=0;$i<$pj;$i++){
                ...
                //if($sql){
                    ...
                    $this->db->query("insert into trd_penghapusan(no_bukti,no_reg,id_barang,no,no_oleh,tgl_reg,tgl_oleh,no_dokumen,kd_brg,nm_brg,detail_brg,status_tanah,kondisi,asal,dsr_peroleh,no_sertifikat,tgl_sertifikat,luas,nilai,jumlah,total,penggunaan,alamat1,alamat2,alamat3,no_mutasi,tgl_mutasi,no_pindah,tgl_pindah,no_hapus,tgl_hapus,keterangan,kd_lokasi2,milik,wilayah,kd_skpd,kd_unit,kd_skpd_lama,username,tgl_update,tahun,foto,foto2,foto3,foto4,no_urut,lat,lon,kd_riwayat,tgl_riwayat,detail_riwayat,kd_golongan,kd_bidang,pemeliharaan_ke,jenis_aset)
                                      ...
                                      '$riwayat','".$ckd_golongan[$i]."','".$ckd_bidang[$i]."','".$cpemeliharaan_ke[$i]."','$jenis_aset')");
                    }
                    if($kdbrg=='02'){
                    ...
                    $this->db->query("insert into trd_penghapusan(no_bukti,no_reg,id_barang,no,no_oleh,tgl_reg,tgl_oleh,no_dokumen,kd_brg,nm_brg,detail_brg,nilai,asal,dsr_peroleh,jumlah,total,merek,tipe,pabrik,kd_warna,kd_bahan,kd_satuan,no_rangka,no_mesin,no_polisi,silinder,no_stnk,tgl_stnk,no_bpkb,tgl_bpkb,kondisi,tahun_produksi,dasar,no_sk,tgl_sk,keterangan,no_mutasi,tgl_mutasi,no_pindah,tgl_pindah,no_hapus,tgl_hapus,kd_ruang,kd_lokasi2,kd_skpd,kd_unit,kd_skpd_lama,milik,wilayah,username,tgl_update,tahun,foto,foto2,foto3,foto4,foto5,no_urut,metode,masa_manfaat,nilai_sisa,kd_riwayat,tgl_riwayat,detail_riwayat,kd_golongan,kd_bidang,pemeliharaan_ke,jenis_aset)
                                      ...
                                      '".$cnilai_sisa[$i]."','".$ckd_riwayat[$i]."','".$ctgl_riwayat[$i]."','$riwayat','".$ckd_golongan[$i]."','".$ckd_bidang[$i]."','".$cpemeliharaan_ke[$i]."','$jenis_aset')");
                    }
                    if($kdbrg=='03'){
                    ...
                    $this->db->query("insert into trd_penghapusan(no_bukti,no_reg,id_barang,no,no_oleh,tgl_reg,tgl_oleh,no_dokumen,kd_brg,nm_brg,detail_brg,nilai,jumlah,asal,dsr_peroleh,total,luas_gedung,jenis_gedung,luas_tanah,status_tanah,alamat1,alamat2,alamat3,no_mutasi,tgl_mutasi,no_pindah,tgl_pindah,no_hapus,tgl_hapus,konstruksi,konstruksi2,luas_lantai,kondisi,dasar,tgl_sk,keterangan,kd_lokasi2,kd_skpd,kd_unit,kd_skpd_lama,milik,wilayah,kd_tanah,username,tgl_update,tahun,foto,foto2,foto3,foto4,no_urut,lat,lon,metode,masa_manfaat,nilai_sisa,hibah,kd_riwayat,tgl_riwayat,detail_riwayat,kd_golongan,kd_bidang,pemeliharaan_ke,jenis_aset)
                                      ...
                                      '".$ctgl_riwayat[$i]."','$riwayat','".$ckd_golongan[$i]."','".$ckd_bidang[$i]."','".$cpemeliharaan_ke[$i]."','$jenis_aset')");                    
                                      }
                    if($kdbrg=='04'){
                    ...
                    $this->db->query("insert into trd_penghapusan(no_bukti,no_reg,id_barang,no,no_oleh,tgl_reg,tgl_oleh,no_dokumen,kd_brg,nm_brg,detail_brg,kd_tanah,nilai,asal,total,kondisi,status_tanah,panjang,luas,lebar,konstruksi,alamat1,alamat2,alamat3,no_mutasi,tgl_mutasi,no_pindah,tgl_pindah,no_hapus,tgl_hapus,perolehan,dasar,jumlah,keterangan,kd_skpd,kd_unit,kd_skpd_lama,milik,wilayah,penggunaan,username,tgl_update,tahun,foto,foto2,foto3,no_urut,lat,lon,metode,masa_manfaat,nilai_sisa,kd_riwayat,tgl_riwayat,detail_riwayat,kd_golongan,kd_bidang,pemeliharaan_ke,jenis_aset)
                                      ...
                                      '".$ckd_riwayat[$i]."','".$ctgl_riwayat[$i]."','$riwayat','".$ckd_golongan[$i]."','".$ckd_bidang[$i]."','".$cpemeliharaan_ke[$i]."','$jenis_aset')");                 
                                      }
                    if($kdbrg=='05'){
    ...
    function inventaris_b1()
    {
        $data['page_title']= 'Alat Besar';
        $this->template->set('title', 'Alat Besar');   
        $this->template->load('index','transaksi/inventaris_b1',$data) ;         
    }
    function inventaris_b2()
    {
        $data['page_title']= 'Alat Angkutan';
        $this->template->set('title', 'Alat Angkutan');   
        $this->template->load('index','transaksi/inventaris_b2',$data) ;         
    }
    function inventaris_b3()
    {
        $data['page_title']= 'Alat Bengkel dan Alat Ukur';
        $this->template->set('title', 'Alat Bengkel dan Alat Ukur');   
        $this->template->load('index','transaksi/inventaris_b3',$data) ;         
    }
    function inventaris_b4()
    {
        $data['page_title']= 'Alat Pertanian atau Peternakan';
        $this->template->set('title', 'Alat Pertanian atau Peternakan');   
        $this->template->load('index','transaksi/inventaris_b4',$data) ;         
    }
    function inventaris_b5()
    {
        $data['page_title']= 'Alat Kantor dan Alat Rumah Tangga';
        $this->template->set('title', 'Alat Kantor dan Alat Rumah Tangga');   
        $this->template->load('index','transaksi/inventaris_b5',$data) ;         
    }
    function inventaris_b6()
    {
        $data['page_title']= 'Alat Studio dan Alat Komunikasi';
        $this->template->set('title', 'Alat Studio dan Alat Komunikasi');   
        $this->template->load('index','transaksi/inventaris_b6',$data) ;         
    }
    function inventaris_b7()
    {
        $data['page_title']= 'Alat Kedokteran';
        $this->template->set('title', 'Alat Kedokteran');   
        $this->template->load('index','transaksi/inventaris_b7',$data) ;         
    }
    function inventaris_b8()
    {
        $data['page_title']= 'Alat Laboratorium';
        $this->template->set('title', 'Alat Laboratorium');   
        $this->template->load('index','transaksi/inventaris_b8',$data) ;         
    }
    function inventaris_b9()
    {
        $data['page_title']= 'Alat Keamanan';
        $this->template->set('title', 'Alat Keamanan');   
        $this->template->load('index','transaksi/inventaris_b9',$data) ;         
    }
	...
	function riwayat_f()
    {
     ...
     function ambil_dok_a() {
        ...
        $sql ="SELECT a.no_bukti,a.cad,a.no_dokumen,a.jns_barang,a.kd_bidang,a.kd_brg,a.kd_unit,a.kd_uskpd,a.nm_brg,a.jumlah,a.harga,a.total,
			  ...
			  $where1 $where2 and b.status_kdp='B' and (a.no_bukti,a.no_dokumen,a.kd_brg,a.kd_uskpd,a.harga,a.cad) 
...
//05072019
     ...
     //          NOT IN (SELECT no_bukti,no_dokumen,kd_brg,kd_skpd,nilai,cad FROM trkib_b WHERE no_dokumen<>'') order by b.tahun";
        ...
        $sql ="SELECT a.no_bukti,a.cad,a.no_dokumen,a.jns_barang,a.kd_bidang,a.kd_brg,a.kd_unit,a.kd_uskpd,a.nm_brg,a.jumlah,a.harga,a.total,
              ...
              b.b_tanggal,b.kd_cr_oleh from trh_isianbrg b left join  
              trd_isianbrg a ON a.no_bukti=b.no_bukti AND a.no_dokumen=b.no_dokumen 
              $where1 $where2 and b.status_kdp='B' AND a.no_dokumen
              NOT IN (SELECT b.no_dokumen FROM trkib_b b 
WHERE a.no_dokumen=b.no_dokumen) order by b.tahun";
// die($sql);
        $query1 = $this->db->query($sql);  
        $result = array();
        $ii = 0;
...
//05072019
        ...
        //     $where1 = "where LEFT(a.kd_brg,2)='02' and b.kd_uskpd like '%' ";
        // }else if($oto == '01' && $skpd<>'1.20.05.01'){
            // $where1 = "where LEFT(a.kd_brg,5)='02.06' and year(b.tgl_dokumen)='$thn' and month(b.tgl_dokumen)='$bln' and b.kd_uskpd ='$skpd' ";
            $where1 = "where LEFT(a.kd_brg,5)='02.02' and b.tgl_dokumen='$tgl_reg' and b.kd_uskpd ='$skpd' ";
        // }else if($oto=='02' && $skpd<>'1.20.05.01'){
        //     $where1 = "where LEFT(a.kd_brg,2)='02' and b.kd_uskpd ='$skpd' ";
        // }else if($oto=='02' && $skpd=='1.20.05.01'){
        //     $where1 = "where LEFT(a.kd_brg,2)='02' and b.kd_uskpd like '%' ";
...
//05072019
        ...
        // }else if($oto == '01' && $skpd<>'1.20.05.01'){
            // $where1 = "where LEFT(a.kd_brg,5)='02.06' and year(b.tgl_dokumen)='$thn' and month(b.tgl_dokumen)='$bln' and b.kd_uskpd ='$skpd' ";
            $where1 = "where LEFT(a.kd_brg,5)='02.03' and b.tgl_dokumen='$tgl_reg' and b.kd_uskpd ='$skpd' ";
        // }else if($oto=='02' && $skpd<>'1.20.05.01'){
        //     $where1 = "where LEFT(a.kd_brg,2)='02' and b.kd_uskpd ='$skpd' ";
        // }else if($oto=='02' && $skpd=='1.20.05.01'){
        //     $where1 = "where LEFT(a.kd_brg,2)='02' and b.kd_uskpd like '%' ";
...
//05072019
        ...
        // }else if($oto == '01' && $skpd<>'1.20.05.01'){
            // $where1 = "where LEFT(a.kd_brg,5)='02.06' and year(b.tgl_dokumen)='$thn' and month(b.tgl_dokumen)='$bln' and b.kd_uskpd ='$skpd' ";
            $where1 = "where LEFT(a.kd_brg,5)='02.04' and b.tgl_dokumen='$tgl_reg' and b.kd_uskpd ='$skpd' ";
        // }else if($oto=='02' && $skpd<>'1.20.05.01'){
        //     $where1 = "where LEFT(a.kd_brg,2)='02' and b.kd_uskpd ='$skpd' ";
        // }else if($oto=='02' && $skpd=='1.20.05.01'){
        //     $where1 = "where LEFT(a.kd_brg,2)='02' and b.kd_uskpd like '%' ";
...
//05072019
        ...
        // }else if($oto == '01' && $skpd<>'1.20.05.01'){
            // $where1 = "where LEFT(a.kd_brg,5)='02.06' and year(b.tgl_dokumen)='$thn' and month(b.tgl_dokumen)='$bln' and b.kd_uskpd ='$skpd' ";
            $where1 = "where LEFT(a.kd_brg,5)='02.05' and b.tgl_dokumen='$tgl_reg' and b.kd_uskpd ='$skpd' ";
        // }else if($oto=='02' && $skpd<>'1.20.05.01'){
        //     $where1 = "where LEFT(a.kd_brg,2)='02' and b.kd_uskpd ='$skpd' ";
        // }else if($oto=='02' && $skpd=='1.20.05.01'){
        //     $where1 = "where LEFT(a.kd_brg,2)='02' and b.kd_uskpd like '%' ";
...
//05072019
        ...
        // }else if($oto == '01' && $skpd<>'1.20.05.01'){
            // $where1 = "where LEFT(a.kd_brg,5)='02.06' and year(b.tgl_dokumen)='$thn' and month(b.tgl_dokumen)='$bln' and b.kd_uskpd ='$skpd' ";
            $where1 = "where LEFT(a.kd_brg,5)='02.06' and b.tgl_dokumen='$tgl_reg' and b.kd_uskpd ='$skpd' ";
        // }else if($oto=='02' && $skpd<>'1.20.05.01'){
        //     $where1 = "where LEFT(a.kd_brg,2)='02' and b.kd_uskpd ='$skpd' ";
        // }else if($oto=='02' && $skpd=='1.20.05.01'){
        //     $where1 = "where LEFT(a.kd_brg,2)='02' and b.kd_uskpd like '%' ";
     ...
     //          NOT IN (SELECT no_bukti,no_dokumen,kd_brg,kd_skpd,nilai,cad FROM trkib_b WHERE no_dokumen<>'') order by b.tahun";
        ...
        $sql ="SELECT a.no_bukti,a.cad,a.no_dokumen,a.jns_barang,a.kd_bidang,a.kd_brg,a.kd_unit,a.kd_uskpd,a.nm_brg,a.jumlah,a.harga,a.total,
              ...
              $where1 $where2 and b.status_kdp='B' AND a.no_dokumen
              NOT IN (SELECT b.no_dokumen FROM trkib_b b 
WHERE b.kd_bidang='02.06' and b.tgl_reg='$tgl_reg' and b.kd_skpd ='$skpd') order by b.tahun";
// die($sql);
        $query1 = $this->db->query($sql);  
        $result = array();
        $ii = 0;
...
//05072019
        ...
        // }else if($oto == '01' && $skpd<>'1.20.05.01'){
            // $where1 = "where LEFT(a.kd_brg,5)='02.06' and year(b.tgl_dokumen)='$thn' and month(b.tgl_dokumen)='$bln' and b.kd_uskpd ='$skpd' ";
            $where1 = "where LEFT(a.kd_brg,5)='02.07' and b.tgl_dokumen='$tgl_reg' and b.kd_uskpd ='$skpd' ";
        // }else if($oto=='02' && $skpd<>'1.20.05.01'){
        //     $where1 = "where LEFT(a.kd_brg,2)='02' and b.kd_uskpd ='$skpd' ";
        // }else if($oto=='02' && $skpd=='1.20.05.01'){
        //     $where1 = "where LEFT(a.kd_brg,2)='02' and b.kd_uskpd like '%' ";
...
//05072019
        ...
        // }else if($oto == '01' && $skpd<>'1.20.05.01'){
            // $where1 = "where LEFT(a.kd_brg,5)='02.06' and year(b.tgl_dokumen)='$thn' and month(b.tgl_dokumen)='$bln' and b.kd_uskpd ='$skpd' ";
            $where1 = "where LEFT(a.kd_brg,5)='02.08' and b.tgl_dokumen='$tgl_reg' and b.kd_uskpd ='$skpd' ";
        // }else if($oto=='02' && $skpd<>'1.20.05.01'){
        //     $where1 = "where LEFT(a.kd_brg,2)='02' and b.kd_uskpd ='$skpd' ";
        // }else if($oto=='02' && $skpd=='1.20.05.01'){
        //     $where1 = "where LEFT(a.kd_brg,2)='02' and b.kd_uskpd like '%' ";
...
//05072019
        ...
        // }else if($oto == '01' && $skpd<>'1.20.05.01'){
            // $where1 = "where LEFT(a.kd_brg,5)='02.06' and year(b.tgl_dokumen)='$thn' and month(b.tgl_dokumen)='$bln' and b.kd_uskpd ='$skpd' ";
            $where1 = "where LEFT(a.kd_brg,5)='02.09' and b.tgl_dokumen='$tgl_reg' and b.kd_uskpd ='$skpd' ";
        // }else if($oto=='02' && $skpd<>'1.20.05.01'){
        //     $where1 = "where LEFT(a.kd_brg,2)='02' and b.kd_uskpd ='$skpd' ";
        // }else if($oto=='02' && $skpd=='1.20.05.01'){
        //     $where1 = "where LEFT(a.kd_brg,2)='02' and b.kd_uskpd like '%' ";
...
//05072019
        ...
        // }else if($oto == '01' && $skpd<>'1.20.05.01'){
            // $where1 = "where LEFT(a.kd_brg,5)='02.06' and year(b.tgl_dokumen)='$thn' and month(b.tgl_dokumen)='$bln' and b.kd_uskpd ='$skpd' ";
            $where1 = "where LEFT(a.kd_brg,5)='02.10' and b.tgl_dokumen='$tgl_reg' and b.kd_uskpd ='$skpd' ";
        // }else if($oto=='02' && $skpd<>'1.20.05.01'){
        //     $where1 = "where LEFT(a.kd_brg,2)='02' and b.kd_uskpd ='$skpd' ";
        // }else if($oto=='02' && $skpd=='1.20.05.01'){
        //     $where1 = "where LEFT(a.kd_brg,2)='02' and b.kd_uskpd like '%' ";
    ...
    function ambil_dok_c(){
		...
		$oto  = $this->session->userdata('otori');
         $tgl_reg=$this->input->post('tgl_reg');
            ...
            $where1 = "where LEFT(a.kd_brg,2)='03' and b.tgl_dokumen='$tgl_reg' and b.kd_uskpd ='$skpd' ";
        ...
        $sql ="SELECT a.no_bukti,a.cad,a.no_dokumen,a.jns_barang,a.kd_bidang,a.kd_brg,a.kd_unit,a.kd_uskpd,a.nm_brg,a.jumlah,a.harga,a.total,
			  ...
			  trd_isianbrg a ON  a.no_bukti=b.no_bukti AND a.no_dokumen=b.no_dokumen 
			  $where1 $where2 AND a.no_dokumen
              NOT IN (SELECT b.no_dokumen FROM trkib_c b 
WHERE a.no_dokumen=b.no_dokumen) and b.status_kdp='B' and (a.no_bukti,a.no_dokumen,a.kd_brg,a.kd_uskpd,a.harga,a.cad) NOT IN (SELECT no_bukti,no_dokumen,kd_brg,kd_skpd,nilai,cad FROM trkib_c WHERE no_dokumen<>'') order by b.tahun";
        // die($sql);
        $query1 = $this->db->query($sql);  
        $result = array();
        $ii = 0;
    ...
    function ambil_dok_d() {
        ...
        $sql ="SELECT a.no_bukti,a.cad,a.no_dokumen,a.jns_barang,a.kd_bidang,a.kd_brg,a.kd_unit,a.kd_uskpd,a.nm_brg,a.jumlah,a.harga,a.total,
			  ...
			  b.b_tanggal,b.kd_cr_oleh,b.no_rencana,b.no_awas from trh_isianbrg b left join  
			  trd_isianbrg a ON a.no_bukti=b.no_bukti AND a.no_dokumen =b.no_dokumen 
			  $where1 $where2 and b.status_kdp='B' and (a.no_bukti,a.no_dokumen,a.kd_brg,a.kd_uskpd,a.harga,a.cad) NOT IN (SELECT no_bukti,no_dokumen,kd_brg,kd_skpd,nilai,cad FROM trkib_d WHERE no_dokumen<>'') order by b.tahun";
              // die($sql);
        $query1 = $this->db->query($sql);  
        $result = array();
        $ii = 0;
    ...
    function ambil_dok_e() {
        ...
        $sql = "SELECT a.no_dokumen,a.jns_barang,a.kd_bidang,a.kd_brg,a.kd_unit,a.kd_uskpd,a.nm_brg,a.jumlah,a.harga,a.total,
			  ...
			  b.b_tanggal,b.kd_cr_oleh from trh_isianbrg b left join  
			  trd_isianbrg a ON a.no_bukti=b.no_bukti AND a.no_dokumen=b.no_dokumen  
			  where LEFT(a.kd_brg,2)='05' and b.kd_uskpd ='$skpd' $where2 and b.status_kdp='B' 
               AND a.no_dokumen
              NOT IN (SELECT b.no_dokumen FROM trkib_e b 
WHERE a.no_dokumen=b.no_dokumen)
              order by b.tahun";
        // die($sql);
        $query1 = $this->db->query($sql);  
        $result = array();
    ...
    function ambil_dok_f() {
        ...
        $sql = "select a.no_bukti,a.no_dokumen,a.kd_brg,a.kd_unit,a.kd_uskpd,a.nm_brg,a.jumlah,a.harga,a.total,
			  ...
			  trd_isianbrg a ON a.no_bukti=b.no_bukti AND a.no_dokumen=b.no_dokumen  
			  $where1 and LEFT(a.kd_brg,2) in ('02','03','04','06') AND b.status_kdp='K' AND 
              (a.no_bukti,a.no_dokumen,a.kd_brg,a.kd_uskpd) NOT IN 
              (SELECT DISTINCT no_bukti,no_dokumen,kd_brg,kd_skpd FROM trkib_f) $where2 order by b.tahun";
        $query1 = $this->db->query($sql);  
        $result = array();
        $ii = 0;
        foreach($query1->result_array() as $resulte)
  ...
  function ambil_kib_a() {
    ...
    function ambil_kib_b() {
        ...
        $kriteria = $this->input->post('cari');
        $kriteria2 = $this->input->post('cari2');
        $kriteria4 = $this->input->post('cari4');
        ...
        $where4='';
        if($kriteria4<>''){
            $where4="AND a.tahun='$kriteria4'";
        }
        
        $sql = "SELECT count(*) as tot from trkib_b a left join mbarang b on b.kd_brg = a.kd_brg $where1 $where3 $where2 $where4" ;
        $query1 = $this->db->query($sql);
        $total = $query1->row();
        
        $sql = "SELECT a.*,b.nm_brg,c.nm_skpd FROM trkib_b a left join
				mbarang b on b.kd_brg = a.kd_brg LEFT JOIN ms_skpd c ON a.kd_skpd=c.kd_skpd $where1 $where3 $where2 $where4 order by a.tahun,a.kd_brg,a.no_reg,a.tgl_reg limit $offset,$rows";
    ...
    function ambil_kib_b1() {
        ...
        //     $where1 = "where a.kd_skpd ='$skpd'";
        // }else if($oto == '02' && $skpd<>'1.20.05.01'){
            $where1 = "where a.kd_skpd ='$skpd' and left(a.kd_bidang,5)='02.02'";
        // }else if($oto == '02' && $skpd=='1.20.05.01'){
        //     if($kriteria3<>''){
        //         $where1 = "where a.kd_skpd ='$kriteria3'";
        //     }else{
    ...
    function ambil_kib_b2() {
        ...
        //     $where1 = "where a.kd_skpd ='$skpd'";
        // }else if($oto == '02' && $skpd<>'1.20.05.01'){
            $where1 = "where a.kd_skpd ='$skpd' and left(a.kd_bidang,5)='02.03'";
        // }else if($oto == '02' && $skpd=='1.20.05.01'){
        //     if($kriteria3<>''){
        //         $where1 = "where a.kd_skpd ='$kriteria3'";
        //     }else{
    ...
    function ambil_kib_b3() {
        ...
        //     $where1 = "where a.kd_skpd ='$skpd'";
        // }else if($oto == '02' && $skpd<>'1.20.05.01'){
            $where1 = "where a.kd_skpd ='$skpd' and left(a.kd_bidang,5)='02.04'";
        // }else if($oto == '02' && $skpd=='1.20.05.01'){
        //     if($kriteria3<>''){
        //         $where1 = "where a.kd_skpd ='$kriteria3'";
        //     }else{
    ...
    function ambil_kib_b4() {
        ...
        //     $where1 = "where a.kd_skpd ='$skpd'";
        // }else if($oto == '02' && $skpd<>'1.20.05.01'){
            $where1 = "where a.kd_skpd ='$skpd' and left(a.kd_bidang,5)='02.05'";
        // }else if($oto == '02' && $skpd=='1.20.05.01'){
        //     if($kriteria3<>''){
        //         $where1 = "where a.kd_skpd ='$kriteria3'";
        //     }else{
    ...
    function ambil_kib_b5() {
        ...
        //     $where1 = "where a.kd_skpd ='$skpd'";
        // }else if($oto == '02' && $skpd<>'1.20.05.01'){
            $where1 = "where a.kd_skpd ='$skpd' and left(a.kd_bidang,5)='02.06'";
        // }else if($oto == '02' && $skpd=='1.20.05.01'){
        //     if($kriteria3<>''){
        //         $where1 = "where a.kd_skpd ='$kriteria3'";
        //     }else{
    ...
    function ambil_kib_b6() {
        ...
        //     $where1 = "where a.kd_skpd ='$skpd'";
        // }else if($oto == '02' && $skpd<>'1.20.05.01'){
            $where1 = "where a.kd_skpd ='$skpd' and left(a.kd_bidang,5)='02.07'";
        // }else if($oto == '02' && $skpd=='1.20.05.01'){
        //     if($kriteria3<>''){
        //         $where1 = "where a.kd_skpd ='$kriteria3'";
        //     }else{
    ...
    function ambil_kib_b7() {
        ...
        //     $where1 = "where a.kd_skpd ='$skpd'";
        // }else if($oto == '02' && $skpd<>'1.20.05.01'){
            $where1 = "where a.kd_skpd ='$skpd' and left(a.kd_bidang,5)='02.08'";
        // }else if($oto == '02' && $skpd=='1.20.05.01'){
        //     if($kriteria3<>''){
        //         $where1 = "where a.kd_skpd ='$kriteria3'";
        //     }else{
    ...
    function ambil_kib_b8() {
        ...
        //     $where1 = "where a.kd_skpd ='$skpd'";
        // }else if($oto == '02' && $skpd<>'1.20.05.01'){
            $where1 = "where a.kd_skpd ='$skpd' and left(a.kd_bidang,5)='02.09'";
        // }else if($oto == '02' && $skpd=='1.20.05.01'){
        //     if($kriteria3<>''){
        //         $where1 = "where a.kd_skpd ='$kriteria3'";
        //     }else{
    ...
    function ambil_kib_b9() {
        ...
        //     $where1 = "where a.kd_skpd ='$skpd'";
        // }else if($oto == '02' && $skpd<>'1.20.05.01'){
            $where1 = "where a.kd_skpd ='$skpd' and left(a.kd_bidang,5)='02.10'";
        // }else if($oto == '02' && $skpd=='1.20.05.01'){
        //     if($kriteria3<>''){
        //         $where1 = "where a.kd_skpd ='$kriteria3'";
        //     }else{
...
//            $asg = $this->db->query($sql);
    ...
    function hapus_trkib_c(){
        ...
        $skpd      = $this->input->post('skpd');
        $keterangan      = $this->input->post('keterangan');
        $sql = "delete from trkib_c where id_barang ='$nomor' and no_urut='$no_urut' and kd_skpd='$skpd' and keterangan='$keterangan'";
        $asg = $this->db->query($sql);
        $sql2 = "update trd_isianbrg set invent='2' where no_dokumen='$nomor_dok' and kd_brg='$kdbrg' and kd_uskpd='$skpd' and keterangan='$keterangan'";
                $asg2 = $this->db->query($sql2);
        if ($asg){
            echo '1'; 
        } else{
...
function simpan_peliharabrg(){
    ...
    function hps_trd_trpelihara(){
     ...
     function hapus_peliharabrg(){
        ...
        $ok = "SELECT * FROM temp_pelihara WHERE no_dokumen='$nomor' AND kd_uskpd='$skpd' AND kd_unit='$unit' AND umur_lama!=''";
        $sql1 =$this->db->query($ok);
        // die($ok);
  ...
  function ambil_trmbrg(){
    ...
    function ambil_mutasi_head(){
        ...
        // $sql = "SELECT count(*) as total from trh_mutasi a" ;
        $query1 = $this->db->query($sql);
        $total = $query1->row();
        $result["total"] = $total->total; 
        $query1->free_result(); 
      ...
      function ambil_mutasi_detail(){
        ...
        $sql = "SELECT a.*,
                ...
                FROM trd_mutasi a INNER JOIN trh_mutasi c ON a.no_bukti=c.no_bukti
                inner join mbarang b on b.kd_brg=a.kd_brg 
                where a.kd_skpd_lama='$skpd' and c.no_mutasi='$no_mutasi' AND a.no_bukti='$bukti'";
        $query1 = $this->db->query($sql);  
        $result = array();
        $ii = 0;
        foreach($query1->result_array() as $resulte)
    ...
    //--Penghapusan----------------------------------------------------------------------------------------------------------
	 ...
	 function penghapusan_tetap(){
      ...
      function penghapusan_lain(){
        $data['page_title']= 'PENGHAPUSAN BARANG LAIN LAIN';
        $this->template->set('title', 'PENGHAPUSAN BARANG LAIN LAIN');   
        $this->template->load('index','transaksi/penghapusan_lain',$data) ;         
     }
    ...
    function ambil_hapus_head(){
        ...
        $where2 ='';
        if ($kriteria <> ''){                               
            $where2 ="and (upper(a.kd_skpd) like upper('%$kriteria%')) 
            or (upper(a.no_hapus) like upper('%$kriteria%'))";            
        }
 ...
 function tes() {
    ...
    { 
        ...
        AND CONCAT(a.no_reg,'.',a.kd_skpd,'.',a.kd_brg,'.',a.no_dokumen) 
        NOT IN (SELECT CONCAT(no_reg,'.',kd_skpd,'.',kd_brg,'.',no_dokumen) FROM trd_penghapusan WHERE kd_skpd=a.kd_skpd) AND 
        a.kondisi='RB' $id_b" ;
        $query1 = $this->db->query($sqlx);
        $total = $query1->row();
        $result["total"] = $total->total; 
 ...
 */    $sql="SELECT a.no_reg,a.id_barang,a.no,a.no_oleh,a.tgl_reg,a.tgl_oleh,a.no_dokumen,a.kd_golongan,a.kd_bidang,a.kd_brg,a.nm_brg,
                ...
                INNER JOIN mbarang b ON b.kd_brg=a.kd_brg
                INNER JOIN ms_skpd c ON c.kd_skpd=a.kd_skpd 
                WHERE a.kd_skpd ='$kdskpd' AND a.kd_unit='$unit' $where AND (a.no_hapus IS NULL OR a.no_hapus='') 
                AND (a.no_mutasi is null or a.no_mutasi='')
                AND CONCAT(a.no_reg,'.',a.kd_skpd,'.',a.kd_brg,'.',a.no_dokumen) 
                NOT IN (SELECT CONCAT(no_reg,'.',kd_skpd,'.',kd_brg,'.',no_dokumen) FROM trd_penghapusan WHERE kd_skpd=a.kd_skpd) 
                $id_b
                order by a.id_barang limit $offset,$rows";   
...
'' AS tahun_terbit,'' AS penerbit,'' AS jenis,'' AS bangunan,'' AS tgl_awal_kerja,'' AS nilai_kontrak,
        ...
        $sql="SELECT a.no_reg,a.id_barang,a.no,a.no_oleh,a.tgl_reg,a.tgl_oleh,a.no_dokumen,a.kd_golongan,a.kd_bidang,a.kd_brg,a.nm_brg,a.detail_brg,a.nilai,
                ...
                c.nm_skpd,a.pemeliharaan_ke FROM trkib_c a 
                INNER JOIN mbarang b ON b.kd_brg=a.kd_brg
                INNER JOIN ms_skpd c ON c.kd_skpd=a.kd_skpd WHERE a.kd_skpd ='$kdskpd'  $where AND (a.no_hapus IS NULL OR a.no_hapus='') AND (a.no_mutasi is null or a.no_mutasi='')
                AND CONCAT(a.no_reg,'.',a.kd_skpd,'.',a.kd_brg,'.',a.no_dokumen) NOT IN (SELECT CONCAT(no_reg,'.',kd_skpd,'.',kd_brg,'.',no_dokumen) FROM trd_penghapusan WHERE kd_skpd=a.kd_skpd)
                $id_b
                order by a.id_barang limit $offset,$rows";
...
a.nilai_kontrak,
    ...
    function simpan_hps_skpd(){
        ...
        $asgh = $this->db->query($sqlh);
        if($asgh){
        $sql = "INSERT INTO trh_penghapusan(no_bukti,no_hapus,tgl_hapus,kd_unit,kd_skpd,kd_skpd_lama,ket,username,tgl_update,jenis_aset) 
                                     values('$no_bukti','$no_hapus','$tanggal','$unitb','$cuskpd','','$ket','$username','$update','$jenis_aset')";
        $asg = $this->db->query($sql);
        }
            if($asg){   
                 $msg = array('pesan'=>'1');
