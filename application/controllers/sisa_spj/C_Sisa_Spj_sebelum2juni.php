	...
	function cetak_sisa_tu() {  
      ...
      //$kd_skpd  = $this->session->userdata('kdskpd');
        ...
        $no_sp2d = $_REQUEST['bulan'];
         ...
         $csql3 = "SELECT DISTINCT a.no_sp2d,a.tgl_sp2d,a.nilai AS jum_sp2d,b.no_bukti,d.kd_kegiatan,d.kd_rek5,b.total AS jum_spj, c.total  
           FROM trhsp2d a LEFT JOIN trhtransout b ON a.no_sp2d=b.no_sp2d
           LEFT JOIN trhkasin_pkd c ON c.tk = a.no_sp2d
           LEFT JOIN trdtransout d ON d.no_sp2d = a.no_sp2d
         ...
         $j_jum_spj = number_format($n_jum_spj ,0,',','.');
          ...
          $j_total_kas = number_format($n_total_kas ,0,',','.');
            ...
            $cRet .= 
                  ...
                  <td align=\"right\" style=\"font-size:16px\">NILAI SP2D</td>
                         </tr>";
           ...
           $cRet .="<table style=\"border-collapse:collapse;\" width=\"100%\" align=\"center\" border=\"1\" cellspacing=\"1\" cellpadding=\"1\">
            <thead>
                <tr>
                    ...
                    <td align=\"center\" width=\"30%\" style=\"font-size:12px\">KEPERLUAN</td>
                ...
                <tr>
                    ...
                    <td align=\"center\" colspan=\"10\" style=\"font-size:12px\">4</td>
